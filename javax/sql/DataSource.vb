...
Namespace javax.sql
	...
	Public Interface DataSource
		Inherits CommonDataSource, java.sql.Wrapper
	  ...
	  ''' <exception cref="java.sql.SQLTimeoutException">  when the driver has determined that the
	  ...
	  ''' @since 1.4 </exception>
	  Function getConnection(ByVal username As String, ByVal password As String) As java.sql.Connection
	End Interface
