...
Namespace javax.sql
	...
	Public Interface RowSetListener
	  ...
	  ''' </summary>
	  ''' <param name="event"> a <code>RowSetEvent</code> object that contains
	  '''         the <code>RowSet</code> object that is the source of the event </param>
	  Sub rowSetChanged(ByVal [event] As RowSetEvent)
	  ...
	  ''' <param name="event"> a <code>RowSetEvent</code> object that contains
	  '''         the <code>RowSet</code> object that is the source of the event </param>
	  Sub rowChanged(ByVal [event] As RowSetEvent)
	  ...
	  ''' <param name="event"> a <code>RowSetEvent</code> object that contains
	  '''         the <code>RowSet</code> object that is the source of the event </param>
	  Sub cursorMoved(ByVal [event] As RowSetEvent)
	End Interface
