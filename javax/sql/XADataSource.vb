...
Namespace javax.sql
	...
	Public Interface XADataSource
	  ...
	  ''' </summary>
	  ''' <returns>  an {@code XAConnection} object, which represents a
	  '''          physical connection to a data source, that can be used in
	  '''          a distributed transaction </returns>
	  ...
	  ''' @since 1.4 </exception>
	  ReadOnly Property xAConnection As XAConnection
	  ...
	  ''' current database connection attempt
	  ''' @since 1.4 </exception>
	  Function getXAConnection(ByVal user As String, ByVal password As String) As XAConnection
	End Interface
