...
Namespace javax.sql
    ...
    Public Interface PooledConnection
        ...
        ''' <seealso cref="PooledConnection interface description"/> for more information.
        ''' </summary>
        ''' <returns>  a <code>Connection</code> object that is a handle to
        '''          this <code>PooledConnection</code> object </returns>
        ...
        ''' this method
        ''' @since 1.4 </exception>
        ReadOnly Property connection As java.sql.Connection
        ...
        ''' <P>
        ''' See the <seealso cref="PooledConnection interface description"/> for more
        ''' information.
        ''' </summary>
        ''' <exception cref="SQLException"> if a database access error occurs </exception>
        ''' <exception cref="java.sql.SQLFeatureNotSupportedException"> if the JDBC driver does not support
        ...
        ''' <seealso cref= #removeConnectionEventListener </seealso>
        Sub addConnectionEventListener(ByVal listener As ConnectionEventListener)
        ...
        '''        a listener </param>
        ''' <seealso cref= #addConnectionEventListener </seealso>
        Sub removeConnectionEventListener(ByVal listener As ConnectionEventListener)
        ...
        ''' <p> </summary>
        ''' <param name="listener">      an component which implements the <code>StatementEventListener</code>
        '''                                      interface that is to be registered with this <code>PooledConnection</code> object
        ''' <p>
        ''' @since 1.6 </param>
        Sub addStatementEventListener(ByVal listener As StatementEventListener)
        ...
        ''' <p>
        ''' @since 1.6 </param>
        Sub removeStatementEventListener(ByVal listener As StatementEventListener)
