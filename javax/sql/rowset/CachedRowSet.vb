...
Namespace javax.sql.rowset
	...
	Public Interface CachedRowSet
	   ...
	   ''' </summary>
	   ''' <param name="data"> the <code>ResultSet</code> object containing the data
	   ''' to be read into this <code>CachedRowSet</code> object </param>
	   ''' <exception cref="SQLException"> if a null <code>ResultSet</code> object is supplied
	   ''' or this <code>CachedRowSet</code> object cannot
	   ''' retrieve the associated <code>ResultSetMetaData</code> object </exception>
	   ''' <seealso cref= #execute </seealso>
	   ''' <seealso cref= java.sql.ResultSet </seealso>
	   ''' <seealso cref= java.sql.ResultSetMetaData </seealso>
		Sub populate(ByVal data As ResultSet)
	   ...
	   ''' </summary>
	   ''' <param name="conn"> a standard JDBC <code>Connection</code> object with valid
	   ''' properties </param>
	   ''' <exception cref="SQLException"> if an invalid <code>Connection</code> object is supplied
	   ''' or an error occurs in establishing the connection to the
	   ''' data source </exception>
	   ''' <seealso cref= #populate </seealso>
	   ''' <seealso cref= java.sql.Connection </seealso>
		Sub execute(ByVal conn As Connection)
	   ...
	   ''' </summary>
	   ''' <exception cref="SyncProviderException"> if the underlying
	   ''' synchronization provider's writer fails to write the updates
	   ''' back to the data source </exception>
	   ''' <seealso cref= #acceptChanges(java.sql.Connection) </seealso>
	   ''' <seealso cref= javax.sql.RowSetWriter </seealso>
	   ''' <seealso cref= javax.sql.rowset.spi.SyncFactory </seealso>
	   ''' <seealso cref= javax.sql.rowset.spi.SyncProvider </seealso>
	   ''' <seealso cref= javax.sql.rowset.spi.SyncProviderException </seealso>
	   ...
	   ''' <code>commit</code> or <code>rollback</code> methods as appropriate.
	   ''' </summary>
	   ''' <param name="con"> a standard JDBC <code>Connection</code> object </param>
	   ''' <exception cref="SyncProviderException"> if the underlying
	   ''' synchronization provider's writer fails to write the updates
	   ''' back to the data source </exception>
	   ''' <seealso cref= #acceptChanges() </seealso>
	   ''' <seealso cref= javax.sql.RowSetWriter </seealso>
	   ''' <seealso cref= javax.sql.rowset.spi.SyncFactory </seealso>
	   ''' <seealso cref= javax.sql.rowset.spi.SyncProvider </seealso>
	   ''' <seealso cref= javax.sql.rowset.spi.SyncProviderException </seealso>
	   ''' <seealso cref= javax.sql.rowset.spi.SyncResolver </seealso>
		Sub acceptChanges(ByVal con As Connection)
	   ...
	   ''' </summary>
	   ''' <exception cref="SQLException"> if an error occurs rolling back the current value of
	   '''       this <code>CachedRowSet</code> object to its previous value </exception>
	   ''' <seealso cref= javax.sql.RowSetListener#rowSetChanged </seealso>
		Sub restoreOriginal()
	   ...
	   ''' </summary>
	   ''' <exception cref="SQLException"> if an error occurs flushing the contents of this
	   ''' <code>CachedRowSet</code> object </exception>
	   ''' <seealso cref= javax.sql.RowSetListener#rowSetChanged </seealso>
	   ''' <seealso cref= java.sql.ResultSet#close </seealso>
		Sub release()
	   ...
	   ''' </ul>
	   ''' </summary>
	   ''' <exception cref="SQLException"> if (1) the current row has not been deleted or
	   ''' (2) the cursor is on the insert row, before the first row, or
	   ''' after the last row </exception>
	   ''' <seealso cref= javax.sql.rowset.CachedRowSet#undoInsert </seealso>
	   ''' <seealso cref= java.sql.ResultSet#cancelRowUpdates </seealso>
		Sub undoDelete()
	   ...
	   ''' </ul>
	   ''' </summary>
	   ''' <exception cref="SQLException"> if (1) the current row has not been inserted or (2)
	   ''' the cursor is before the first row, after the last row, or on the
	   ''' insert row </exception>
	   ''' <seealso cref= javax.sql.rowset.CachedRowSet#undoDelete </seealso>
	   ''' <seealso cref= java.sql.ResultSet#cancelRowUpdates </seealso>
		Sub undoInsert()
	   ...
	   ''' </summary>
	   ''' <exception cref="SQLException"> if the cursor is before the first row or after the last
	   '''     row in in this <code>CachedRowSet</code> object </exception>
	   ''' <seealso cref= #undoDelete </seealso>
	   ''' <seealso cref= #undoInsert </seealso>
	   ''' <seealso cref= java.sql.ResultSet#cancelRowUpdates </seealso>
		Sub undoUpdate()
	   ...
	   ''' </summary>
	   ''' <param name="idx"> an <code>int</code> identifying the column to be checked for updates </param>
	   ''' <returns> <code>true</code> if the designated column has been visibly updated;
	   ''' <code>false</code> otherwise </returns>
	   ''' <exception cref="SQLException"> if the cursor is on the insert row, before the first row,
	   '''     or after the last row </exception>
	   ''' <seealso cref= java.sql.DatabaseMetaData#updatesAreDetected </seealso>
		Function columnUpdated(ByVal idx As Integer) As Boolean
	   ...
	   ''' <code>CachedRowSet</code> object has been updated.
	   ''' </summary>
	   ''' <param name="columnName"> a <code>String</code> object giving the name of the
	   '''        column to be checked for updates </param>
	   ''' <returns> <code>true</code> if the column has been visibly updated;
	   ''' <code>false</code> otherwise </returns>
	   ''' <exception cref="SQLException"> if the cursor is on the insert row, before the first row,
	   '''      or after the last row </exception>
	   ''' <seealso cref= java.sql.DatabaseMetaData#updatesAreDetected </seealso>
		Function columnUpdated(ByVal columnName As String) As Boolean
	   ...
	   ''' <P>
	   ''' </summary>
	   ''' <returns> a <code>Collection</code> object that contains the values in
	   ''' each row in this <code>CachedRowSet</code> object </returns>
	   ''' <exception cref="SQLException"> if an error occurs generating the collection </exception>
	   ''' <seealso cref= #toCollection(int) </seealso>
	   ''' <seealso cref= #toCollection(String) </seealso>
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		Function toCollection() As ICollection(Of ?)
	   ...
	   ''' </summary>
	   ''' <param name="column"> an <code>int</code> indicating the column whose values
	   '''        are to be represented in a <code>Collection</code> object </param>
	   ''' <returns> a <code>Collection</code> object that contains the values
	   ''' stored in the specified column of this <code>CachedRowSet</code>
	   ''' object </returns>
	   ''' <exception cref="SQLException"> if an error occurs generating the collection or
	   ''' an invalid column id is provided </exception>
	   ''' <seealso cref= #toCollection </seealso>
	   ''' <seealso cref= #toCollection(String) </seealso>
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		Function toCollection(ByVal column As Integer) As ICollection(Of ?)
	   ...
	   ''' in this <code>CachedRowSet</code> object.
	   ''' </summary>
	   ''' <param name="column"> a <code>String</code> object giving the name of the
	   '''        column whose values are to be represented in a collection </param>
	   ''' <returns> a <code>Collection</code> object that contains the values
	   ''' stored in the specified column of this <code>CachedRowSet</code>
	   ''' object </returns>
	   ''' <exception cref="SQLException"> if an error occurs generating the collection or
	   ...
	   ''' <seealso cref= #toCollection(int) </seealso>
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		Function toCollection(ByVal column As String) As ICollection(Of ?)
	   ...
	   ''' </summary>
	   ''' <returns> the <code>SyncProvider</code> object that was set when the rowset
	   '''      was instantiated, or if none was was set, the default provider </returns>
	   ''' <exception cref="SQLException"> if an error occurs while returning the
	   ''' <code>SyncProvider</code> object </exception>
	   ''' <seealso cref= #setSyncProvider </seealso>
		Property syncProvider As SyncProvider
	   ...
	   ''' object.
	   ''' </summary>
	   ''' <returns> number of rows in the rowset </returns>
	   ...
	   ''' </summary>
	   ''' <param name="md"> a <code>RowSetMetaData</code> object containing
	   ''' metadata about the columns in this <code>CachedRowSet</code> object </param>
	   ''' <exception cref="SQLException"> if invalid metadata is supplied to the
	   ''' rowset </exception>
	   ...
	   ''' </summary>
	   ''' <returns> a <code>ResultSet</code> object that contains the original value for
	   '''         this <code>CachedRowSet</code> object </returns>
	   ''' <exception cref="SQLException"> if an error occurs producing the
	   ''' <code>ResultSet</code> object </exception>
	   ...
	   ''' </UL>
	   ''' </summary>
	   ''' <returns> the original result set of the row </returns>
	   ''' <exception cref="SQLException"> if there is no current row </exception>
	   ''' <seealso cref= #setOriginalRow </seealso>
	   ...
	   ''' </summary>
	   ''' <exception cref="SQLException"> if there is no current row or an error is
	   ''' encountered resetting the contents of the original row </exception>
	   ''' <seealso cref= #getOriginalRow </seealso>
		Sub setOriginalRow()
	   ...
	   ''' </summary>
	   ''' <returns> a <code>String</code> object giving the name of the table that is the
	   '''         source of data for this <code>CachedRowSet</code> object or <code>null</code>
	   '''         if no name has been set for the table </returns>
	   ''' <exception cref="SQLException"> if an error is encountered returning the table name </exception>
	   ''' <seealso cref= javax.sql.RowSetMetaData#getTableName </seealso>
	   ...
	   '''       empty if no columns are representative of a primary key. </returns>
	   ''' <exception cref="SQLException"> if this <code>CachedRowSet</code> object is empty </exception>
	   ''' <seealso cref= #setKeyColumns </seealso>
	   ''' <seealso cref= Joinable#getMatchColumnIndexes </seealso>
	   ''' <seealso cref= Joinable#getMatchColumnNames </seealso>
		Property keyColumns As Integer()
	   ...
	   ''' </summary>
	   ''' <returns> a new shared <code>RowSet</code> object that has the same properties
	   '''         as this <code>CachedRowSet</code> object and that has a cursor over
	   '''         the same data </returns>
	   ''' <exception cref="SQLException"> if an error occurs or cloning is not
	   ''' supported in the underlying platform </exception>
	   ''' <seealso cref= javax.sql.RowSetEvent </seealso>
	   ''' <seealso cref= javax.sql.RowSetListener </seealso>
		Function createShared() As RowSet
	   ...
	   ''' </summary>
	   ''' <returns> a new <code>RowSet</code> object that is a deep copy
	   ''' of this <code>CachedRowSet</code> object and is
	   ''' completely independent of this <code>CachedRowSet</code> object </returns>
	   ''' <exception cref="SQLException"> if an error occurs in generating the copy of
	   ''' the of this <code>CachedRowSet</code> object </exception>
	   ''' <seealso cref= #createShared </seealso>
	   ''' <seealso cref= #createCopySchema </seealso>
	   ''' <seealso cref= #createCopyNoConstraints </seealso>
	   ''' <seealso cref= javax.sql.RowSetEvent </seealso>
	   ''' <seealso cref= javax.sql.RowSetListener </seealso>
		Function createCopy() As CachedRowSet
		...
		''' to export the <code>RowSet</code> schema definition to XML for future use. </summary>
		''' <returns> An empty copy of this {@code CachedRowSet} object </returns>
		''' <exception cref="SQLException"> if an error occurs in cloning the structure of this
		'''         <code>CachedRowSet</code> object </exception>
		''' <seealso cref= #createShared </seealso>
		''' <seealso cref= #createCopySchema </seealso>
		''' <seealso cref= #createCopyNoConstraints </seealso>
		''' <seealso cref= javax.sql.RowSetEvent </seealso>
		''' <seealso cref= javax.sql.RowSetListener </seealso>
		Function createCopySchema() As CachedRowSet
		...
		''' in the copy.
		''' </summary>
		''' <returns> a new <code>CachedRowSet</code> object that is a deep copy
		'''     of this <code>CachedRowSet</code> object and is
		'''     completely independent of this  <code>CachedRowSet</code> object </returns>
		''' <exception cref="SQLException"> if an error occurs in generating the copy of
		'''     the of this <code>CachedRowSet</code> object </exception>
		''' <seealso cref= #createCopy </seealso>
		''' <seealso cref= #createShared </seealso>
		''' <seealso cref= #createCopySchema </seealso>
		''' <seealso cref= javax.sql.RowSetEvent </seealso>
		''' <seealso cref= javax.sql.RowSetListener </seealso>
		Function createCopyNoConstraints() As CachedRowSet
		...
		''' </summary>
		''' <returns> RowSetWarning the first <code>RowSetWarning</code>
		''' object reported or null if there are none </returns>
		''' <exception cref="SQLException"> if this method is called on a closed RowSet </exception>
		''' <seealso cref= RowSetWarning </seealso>
		ReadOnly Property rowSetWarnings As RowSetWarning
		...
		'''         <code>false</code> otherwise </returns>
		''' <exception cref="SQLException"> if a rowset implementation is unable to
		''' to determine whether rows marked for deletion are visible </exception>
		''' <seealso cref= #setShowDeleted </seealso>
		Property showDeleted As Boolean
		...
		''' </summary>
		''' <exception cref="SQLException"> if a database access error occurs or this
		''' Connection object within this <code>CachedRowSet</code> is in auto-commit mode </exception>
		''' <seealso cref= java.sql.Connection#setAutoCommit </seealso>
		Sub commit()
		...
		''' </summary>
		''' <exception cref="SQLException"> if a database access error occurs or this Connection
		''' object within this <code>CachedRowSet</code> is in auto-commit mode. </exception>
		Sub rollback()
		...
		''' </summary>
		''' <param name="s"> A <code>Savepoint</code> transaction marker </param>
		''' <exception cref="SQLException"> if a database access error occurs or this Connection
		''' object within this <code>CachedRowSet</code> is in auto-commit mode. </exception>
		Sub rollback(ByVal s As Savepoint)
		...
		''' <seealso cref= #rollback </seealso>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
<Obsolete("Because this field is final (it is part of an interface),")> _
'		public static final boolean COMMIT_ON_ACCEPT_CHANGES = True;
		...
		''' </summary>
		''' <param name="event"> a <code>RowSetEvent</code> object that contains the
		'''     <code>RowSet</code> object that is the source of the events </param>
		''' <param name="numRows"> when populating, the number of rows interval on which the
		'''     <code>CachedRowSet</code> populated should fire; the default value
		'''     is zero; cannot be less than <code>fetchSize</code> or zero </param>
		''' <exception cref="SQLException"> {@code numRows < 0 or numRows < getFetchSize() } </exception>
		Sub rowSetPopulated(ByVal [event] As RowSetEvent, ByVal numRows As Integer)
		...
		''' of <code>execute</code> that takes a <code>ResultSet</code> object.
		''' </summary>
		''' <param name="startRow"> the position in the <code>ResultSet</code> from where to start
		'''                populating the records in this <code>CachedRowSet</code> </param>
		''' <param name="rs"> the <code>ResultSet</code> object containing the data
		''' to be read into this <code>CachedRowSet</code> object </param>
		''' <exception cref="SQLException"> if a null <code>ResultSet</code> object is supplied
		''' or this <code>CachedRowSet</code> object cannot
		''' retrieve the associated <code>ResultSetMetaData</code> object </exception>
		''' <seealso cref= #execute </seealso>
		''' <seealso cref= #populate(ResultSet) </seealso>
		''' <seealso cref= java.sql.ResultSet </seealso>
		''' <seealso cref= java.sql.ResultSetMetaData </seealso>
		Sub populate(ByVal rs As ResultSet, ByVal startRow As Integer)
		...
		''' </summary>
		''' <param name="size"> the page-size of the <code>CachedRowSet</code> </param>
		''' <exception cref="SQLException"> if an error occurs setting the <code>CachedRowSet</code>
		'''      page size or if the page size is less than 0. </exception>
		...
		''' </summary>
		''' <returns> true if more pages exist; false if this is the last page </returns>
		''' <exception cref="SQLException"> if an error occurs fetching the next page, or if this
		'''     method is called prematurely before populate or execute. </exception>
		...
		'''     is the first page. </returns>
		''' <exception cref="SQLException"> if an error occurs fetching the previous page, or if
		'''     this method is called prematurely before populate or execute. </exception>
