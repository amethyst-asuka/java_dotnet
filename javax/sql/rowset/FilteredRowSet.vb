...
Namespace javax.sql.rowset
	...
	Public Interface FilteredRowSet
	   ...
	   ''' objects change.
	   ''' </summary>
	   ''' <param name="p"> a <code>Predicate</code> object defining the filter for this
	   ''' <code>FilteredRowSet</code> object. Setting a <b>null</b> value
	   ''' will clear the predicate, allowing all rows to become visible.
	   ''' </param>
	   ''' <exception cref="SQLException"> if an error occurs when setting the
	   '''     <code>Predicate</code> object </exception>
		Property filter As Predicate
