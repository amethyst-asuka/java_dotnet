...
Namespace javax.sql.rowset
	...
	''' }</PRE>
	''' </summary>
	''' <seealso cref= javax.sql.rowset.JdbcRowSet </seealso>
	''' <seealso cref= javax.sql.rowset.CachedRowSet </seealso>
	''' <seealso cref= javax.sql.rowset.FilteredRowSet </seealso>
	''' <seealso cref= javax.sql.rowset.JoinRowSet </seealso>

	Public Interface WebRowSet
		Inherits CachedRowSet

	   ''' <summary>
	   ''' Reads a {@code WebRowSet} object in its XML format from the given
	   ''' {@code Reader} object.
	   ''' </summary>
	   ''' <param name="reader"> the {@code java.io.Reader} stream from which this
	   '''        {@code WebRowSet} object will be populated
	   ''' </param>
	   ''' <exception cref="SQLException"> if a database access error occurs </exception>
		Sub readXml(ByVal reader As java.io.Reader)

		''' <summary>
		''' Reads a stream based XML input to populate this {@code WebRowSet}
		''' object.
		''' </summary>
		''' <param name="iStream"> the {@code java.io.InputStream} from which this
		'''        {@code WebRowSet} object will be populated </param>
		''' <exception cref="SQLException"> if a data source access error occurs </exception>
		''' <exception cref="IOException"> if an IO exception occurs </exception>
		Sub readXml(ByVal iStream As java.io.InputStream)
	   ...
	   ''' </summary>
	   ''' <param name="rs"> the {@code ResultSet} object with which to populate this
	   '''        {@code WebRowSet} object </param>
	   ''' <param name="writer"> the {@code java.io.Writer} object to write to. </param>
	   ''' <exception cref="SQLException"> if an error occurs writing out the rowset
	   '''          contents in XML format </exception>
		Sub writeXml(ByVal rs As ResultSet, ByVal writer As java.io.Writer)
	   ...
	   ''' <param name="rs"> the {@code ResultSet} object with which to populate this
	   '''        {@code WebRowSet} object </param>
	   ''' <param name="oStream"> the {@code java.io.OutputStream} to write to </param>
	   ''' <exception cref="SQLException"> if a data source access error occurs </exception>
	   ''' <exception cref="IOException"> if a IO exception occurs </exception>
		Sub writeXml(ByVal rs As ResultSet, ByVal oStream As java.io.OutputStream)

	   ''' <summary>
	   ''' Writes the data, properties, and metadata for this {@code WebRowSet} object
	   ''' to the given {@code Writer} object in XML format.
	   ''' </summary>
	   ''' <param name="writer"> the {@code java.io.Writer} stream to write to </param>
	   ''' <exception cref="SQLException"> if an error occurs writing out the rowset
	   '''          contents to XML </exception>
		Sub writeXml(ByVal writer As java.io.Writer)

		''' <summary>
		''' Writes the data, properties, and metadata for this {@code WebRowSet} object
		''' to the given {@code OutputStream} object in XML format.
		''' </summary>
		''' <param name="oStream"> the {@code java.io.OutputStream} stream to write to </param>
		''' <exception cref="SQLException"> if a data source access error occurs </exception>
		''' <exception cref="IOException"> if a IO exception occurs </exception>
		Sub writeXml(ByVal oStream As java.io.OutputStream)
