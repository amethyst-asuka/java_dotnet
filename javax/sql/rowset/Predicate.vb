...
Namespace javax.sql.rowset
	...
	Public Interface Predicate
		...
		''' continue to ove the cursor until a valid row is found. </summary>
		''' <param name="rs"> The {@code RowSet} to be evaluated </param>
		''' <returns> <code>true</code> if there are more rows in the filter;
		'''     <code>false</code> otherwise </returns>
		Function evaluate(ByVal rs As RowSet) As Boolean
		...
		''' </summary>
		''' <param name="value"> An <code>Object</code> value which needs to be checked,
		'''        whether it can be part of this <code>FilterRowSet</code> object. </param>
		''' <param name="column"> a <code>int</code> object that must match the
		...
		'''        for filtering while initializing a <code>Predicate</code> </param>
		''' <returns> <code>true</code> if row value lies within the filter;
		'''     <code>false</code> otherwise </returns>
		''' <exception cref="SQLException"> if the column is not part of filtering criteria </exception>
		Function evaluate(ByVal value As Object, ByVal column As Integer) As Boolean
		...
		''' </param>
		''' <param name="columnName"> a <code>String</code> object that must match the
		...
		''' </param>
		''' <returns> <code>true</code> if value lies within the filter; <code>false</code> otherwise
		''' </returns>
		''' <exception cref="SQLException"> if the column is not part of filtering criteria </exception>
		Function evaluate(ByVal value As Object, ByVal columnName As String) As Boolean
