...
Namespace javax.sql.rowset
	...
	Public Interface JdbcRowSet
		...
		'''          to determine whether rows marked for deletion remain visible </exception>
		...
		''' </summary>
		''' <returns> the first <code>RowSetWarning</code>
		''' object reported on this <code>JdbcRowSet</code> object
		''' or <code>null</code> if there are none </returns>
		''' <exception cref="SQLException"> if this method is called on a closed
		''' <code>JdbcRowSet</code> object </exception>
	   ...
	   ''' Connection object within this <code>JdbcRowSet</code> is in auto-commit mode </exception>
	   ...
	   ''' </summary>
	   ''' <returns> {@code true} if auto-commit is enabled; {@code false} otherwise </returns>
	   ''' <exception cref="SQLException"> if a database access error occurs </exception>
	   ''' <seealso cref= java.sql.Connection#getAutoCommit() </seealso>
		...
		''' </summary>
		''' <exception cref="SQLException"> if a database access error occurs or this <code>Connection</code>
		''' object within this <code>JdbcRowSet</code> is in auto-commit mode. </exception>
		''' <seealso cref= #rollback(Savepoint) </seealso>
		 Sub rollback()
		...
		''' object. This method should be used only when auto-commit mode has been disabled. </summary>
		''' <param name="s"> The {@code Savepoint} to rollback to </param>
		''' <exception cref="SQLException"> if a database access error occurs or this <code>Connection</code>
		''' object within this <code>JdbcRowSet</code> is in auto-commit mode. </exception>
