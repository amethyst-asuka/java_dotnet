...
Namespace javax.sql.rowset.spi
	...
	Public Interface XmlWriter
	  ...
	  ''' </summary>
	  ''' <param name="caller"> the <code>WebRowSet</code> instance to be written,
	  '''        for which this <code>XmlWriter</code> object is the writer </param>
	  ''' <param name="writer"> the <code>java.io.Writer</code> object that serves
	  '''        as the output stream for writing <code>caller</code> as
	  '''        an XML document </param>
	  ''' <exception cref="SQLException"> if a database access error occurs or
	  '''            this <code>XmlWriter</code> object is not the writer
	  '''            for the given <code>WebRowSet</code> object </exception>
	  Sub writeXML(ByVal caller As WebRowSet, ByVal writer As java.io.Writer)
