...
Namespace javax.sql.rowset.spi
	...
	Public Interface TransactionalWriter
		Inherits javax.sql.RowSetWriter
		...
		'''         object is in auto-commit mode </exception>
		Sub commit()
		...
		''' </summary>
		''' <exception cref="SQLException"> if a database access error occurs or the <code>Connection</code>
		'''         object within this <code>CachedRowSet</code> object is in auto-commit mode </exception>
		Sub rollback()
		...
		''' </summary>
		''' <param name="s"> a <code>Savepoint</code> object marking a savepoint in the current
		'''        transaction.  All changes made before <i>s</i> was set will be undone.
		'''        All changes made after <i>s</i> was set will be made permanent. </param>
		''' <exception cref="SQLException"> if a database access error occurs or the <code>Connection</code>
		'''         object within this <code>CachedRowSet</code> object is in auto-commit mode </exception>
		Sub rollback(ByVal s As java.sql.Savepoint)
	End Interface
