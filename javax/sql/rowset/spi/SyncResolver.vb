...
'		public static int NO_ROW_CONFLICT = 3;
		...
		'''         <code>SyncResolver.NO_ROW_CONFLICT</code> </returns>
		...
		''' that caused a conflict.
		''' </summary>
		''' <param name="columnName"> a <code>String</code> object designating the column in this row of this
		'''        <code>SyncResolver</code> object from which to retrieve the value
		'''        causing a conflict </param>
		''' <returns> the value of the designated column in the current row of this
		'''         <code>SyncResolver</code> object </returns>
		''' <exception cref="SQLException"> if a database access error occurs </exception>
		Function getConflictValue(ByVal columnName As String) As Object
		...
		''' </summary>
		''' <param name="index"> an <code>int</code> giving the number of the column into which to
		'''        set the value to be persisted </param>
		''' <param name="obj"> an <code>Object</code> that is the value to be set in the
		'''        <code>RowSet</code> object and persisted in the data source </param>
		''' <exception cref="SQLException"> if a database access error occurs </exception>
		Sub setResolvedValue(ByVal index As Integer, ByVal obj As Object)
		...
		'''        into which to set the value to be persisted </param>
		''' <param name="obj"> an <code>Object</code> that is the value to be set in the
		'''        <code>RowSet</code> object and persisted in the data source </param>
		''' <exception cref="SQLException"> if a database access error occurs </exception>
		Sub setResolvedValue(ByVal columnName As String, ByVal obj As Object)
		...
		''' </summary>
		''' <returns> <code>true</code> if the new current row is valid; <code>false</code>
		'''         if there are no more rows </returns>
		''' <exception cref="SQLException"> if a database access error occurs or the result set type
		'''     is <code>TYPE_FORWARD_ONLY</code>
		'''  </exception>
		Function nextConflict() As Boolean
		...
		''' object's warning chain.
		''' </summary>
		''' <returns> <code>true</code> if the cursor is on a valid row; <code>false</code>
		'''     if it is off the result set </returns>
		''' <exception cref="SQLException"> if a database access error occurs or the result set type
		'''     is <code>TYPE_FORWARD_ONLY</code> </exception>
		Function previousConflict() As Boolean
