...
Namespace javax.swing.event
	...
	Public Interface TreeModelListener
		...
		''' </summary>
		Sub treeNodesChanged(ByVal e As TreeModelEvent)
		...
		''' </summary>
		Sub treeNodesInserted(ByVal e As TreeModelEvent)
		...
		''' </summary>
		Sub treeNodesRemoved(ByVal e As TreeModelEvent)
		...
		''' returns null.</p>
		''' </summary>
		Sub treeStructureChanged(ByVal e As TreeModelEvent)
