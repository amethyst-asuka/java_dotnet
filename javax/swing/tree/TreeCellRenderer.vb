...
Namespace javax.swing.tree
	...
	Public Interface TreeCellRenderer
		...
		''' </pre>
		''' </summary>
		''' <returns>  the <code>Component</code> that the renderer uses to draw the value </returns>
		Function getTreeCellRendererComponent(ByVal tree As javax.swing.JTree, ByVal value As Object, ByVal selected As Boolean, ByVal expanded As Boolean, ByVal leaf As Boolean, ByVal row As Integer, ByVal hasFocus As Boolean) As java.awt.Component
