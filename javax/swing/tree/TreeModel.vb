...
Namespace javax.swing.tree
	...
	Public Interface TreeModel
		...
		''' <returns>  the child of <code>parent</code> at index <code>index</code> </returns>
		Function getChild(ByVal parent As Object, ByVal index As Integer) As Object
		...
		''' </summary>
		''' <param name="parent">  a node in the tree, obtained from this data source </param>
		''' <returns>  the number of children of the node <code>parent</code> </returns>
		Function getChildCount(ByVal parent As Object) As Integer
		...
		''' </summary>
		''' <param name="node">  a node in the tree, obtained from this data source </param>
		''' <returns>  true if <code>node</code> is a leaf </returns>
		Function isLeaf(ByVal node As Object) As Boolean
		...
		''' </summary>
		''' <param name="path"> path to the node that the user has altered </param>
		''' <param name="newValue"> the new value from the TreeCellEditor </param>
		Sub valueForPathChanged(ByVal path As TreePath, ByVal newValue As Object)
		...
		'''    or don't belong to this tree model </returns>
		Function getIndexOfChild(ByVal parent As Object, ByVal child As Object) As Integer
	...
	'
		...
		Sub addTreeModelListener(ByVal l As TreeModelListener)
		...
		Sub removeTreeModelListener(ByVal l As TreeModelListener)
