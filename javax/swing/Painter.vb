...
Namespace javax.swing
	...
	''' <code>Painter</code> that only works with subclasses of <seealso cref="java.awt.Component"/>.
	...
	''' @author rbair
	''' </summary>
	Public Interface Painter(Of T)
		''' <summary>
		''' <p>Renders to the given <seealso cref="java.awt.Graphics2D"/> object. Implementations
		...
		''' between.</p>
		''' </summary>
		''' <param name="g"> The Graphics2D to render to. This must not be null. </param>
		''' <param name="object"> an optional configuration parameter. This may be null. </param>
		''' <param name="width"> width of the area to paint. </param>
		''' <param name="height"> height of the area to paint. </param>
		Sub paint(ByVal g As java.awt.Graphics2D, ByVal [object] As T, ByVal width As Integer, ByVal height As Integer)
	End Interface
