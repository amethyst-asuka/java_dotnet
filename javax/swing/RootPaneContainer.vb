...
Namespace javax.swing
	...
	Public Interface RootPaneContainer
		...
		''' </summary>
		''' <returns> this components single JRootPane child. </returns>
		''' <seealso cref= JRootPane </seealso>
		ReadOnly Property rootPane As JRootPane
		...
		'''            exception) if the content pane parameter is null </exception>
		''' <param name="contentPane"> the Container to use for the contents of this
		'''        JRootPane </param>
		''' <seealso cref= JRootPane#getContentPane </seealso>
		''' <seealso cref= #getContentPane </seealso>
		Property contentPane As java.awt.Container
		...
		''' <seealso cref= #getLayeredPane </seealso>
		''' <seealso cref= JRootPane#getLayeredPane </seealso>
		Property layeredPane As JLayeredPane
		...
		''' </summary>
		''' <seealso cref= #getGlassPane </seealso>
		''' <seealso cref= JRootPane#setGlassPane </seealso>
		Property glassPane As java.awt.Component
