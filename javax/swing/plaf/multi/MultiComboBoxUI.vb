...
Namespace javax.swing.plaf.multi
	...
	Public Class MultiComboBoxUI
		Inherits javax.swing.plaf.ComboBoxUI
	...
	'//////////////////
		...
		Public Overrides Function isFocusTraversable(ByVal a As javax.swing.JComboBox) As Boolean
			Dim returnValue As Boolean = CType(uis(0), javax.swing.plaf.ComboBoxUI).isFocusTraversable(a)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.ComboBoxUI).isFocusTraversable(a)
			Next i
			Return returnValue
		End Function
		...
		''' </summary>
		Public Overrides Sub setPopupVisible(ByVal a As javax.swing.JComboBox, ByVal b As Boolean)
			For i As Integer = 0 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.ComboBoxUI).popupVisibleble(a,b)
			Next i
		End Sub
		...
		''' <returns> the value obtained from the first UI, which is
		''' the UI obtained from the default <code>LookAndFeel</code> </returns>
		Public Overrides Function isPopupVisible(ByVal a As javax.swing.JComboBox) As Boolean
			Dim returnValue As Boolean = CType(uis(0), javax.swing.plaf.ComboBoxUI).isPopupVisible(a)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.ComboBoxUI).isPopupVisible(a)
			Next i
			Return returnValue
		End Function
	...
	'//////////////////
		...
		Public Shared Function createUI(ByVal a As javax.swing.JComponent) As javax.swing.plaf.ComponentUI
			Dim mui As javax.swing.plaf.ComponentUI = New MultiComboBoxUI
			Return MultiLookAndFeel.createUIs(mui, CType(mui, MultiComboBoxUI).uis, a)
		End Function
