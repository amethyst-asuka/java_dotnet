...
Namespace javax.swing.plaf.multi
	...
	'//////////////////
		...
		''' </summary>
		Public Overrides Sub selectInitialValue(ByVal a As javax.swing.JOptionPane)
			For i As Integer = 0 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.OptionPaneUI).selectInitialValue(a)
			Next i
		End Sub
		...
		Public Overrides Function containsCustomComponents(ByVal a As javax.swing.JOptionPane) As Boolean
			Dim returnValue As Boolean = CType(uis(0), javax.swing.plaf.OptionPaneUI).containsCustomComponents(a)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.OptionPaneUI).containsCustomComponents(a)
			Next i
			Return returnValue
		End Function
	...
	'//////////////////
		...
		Public Shared Function createUI(ByVal a As javax.swing.JComponent) As javax.swing.plaf.ComponentUI
			Dim mui As javax.swing.plaf.ComponentUI = New MultiOptionPaneUI
			Return MultiLookAndFeel.createUIs(mui, CType(mui, MultiOptionPaneUI).uis, a)
		End Function
