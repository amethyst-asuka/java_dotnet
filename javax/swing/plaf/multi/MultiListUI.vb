...
Namespace javax.swing.plaf.multi
	...
	Public Class MultiListUI
		Inherits javax.swing.plaf.ListUI
	...
	'//////////////////
		...
		Public Overrides Function locationToIndex(ByVal a As javax.swing.JList, ByVal b As java.awt.Point) As Integer
			Dim returnValue As Integer = CType(uis(0), javax.swing.plaf.ListUI).locationToIndex(a,b)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.ListUI).locationToIndex(a,b)
			Next i
			Return returnValue
		End Function
		...
		''' <returns> the value obtained from the first UI, which is
		''' the UI obtained from the default <code>LookAndFeel</code> </returns>
		Public Overrides Function indexToLocation(ByVal a As javax.swing.JList, ByVal b As Integer) As java.awt.Point
			Dim returnValue As java.awt.Point = CType(uis(0), javax.swing.plaf.ListUI).indexToLocation(a,b)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.ListUI).indexToLocation(a,b)
			Next i
			Return returnValue
		End Function
		...
		''' <returns> the value obtained from the first UI, which is
		''' the UI obtained from the default <code>LookAndFeel</code> </returns>
		Public Overrides Function getCellBounds(ByVal a As javax.swing.JList, ByVal b As Integer, ByVal c As Integer) As java.awt.Rectangle
			Dim returnValue As java.awt.Rectangle = CType(uis(0), javax.swing.plaf.ListUI).getCellBounds(a,b,c)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.ListUI).getCellBounds(a,b,c)
			Next i
			Return returnValue
		End Function
	...
	'//////////////////
		...
		Public Shared Function createUI(ByVal a As javax.swing.JComponent) As javax.swing.plaf.ComponentUI
			Dim mui As javax.swing.plaf.ComponentUI = New MultiListUI
			Return MultiLookAndFeel.createUIs(mui, CType(mui, MultiListUI).uis, a)
		End Function
