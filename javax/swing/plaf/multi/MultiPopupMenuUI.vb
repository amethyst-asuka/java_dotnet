...
Namespace javax.swing.plaf.multi
	...
	Public Class MultiPopupMenuUI
		Inherits javax.swing.plaf.PopupMenuUI
	...
	'//////////////////
		...
		''' @since 1.3 </returns>
		Public Overrides Function isPopupTrigger(ByVal a As java.awt.event.MouseEvent) As Boolean
			Dim returnValue As Boolean = CType(uis(0), javax.swing.plaf.PopupMenuUI).isPopupTrigger(a)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.PopupMenuUI).isPopupTrigger(a)
			Next i
			Return returnValue
		End Function
		...
		''' the UI obtained from the default <code>LookAndFeel</code>
		''' @since 1.4 </returns>
		Public Overrides Function getPopup(ByVal a As javax.swing.JPopupMenu, ByVal b As Integer, ByVal c As Integer) As javax.swing.Popup
			Dim returnValue As javax.swing.Popup = CType(uis(0), javax.swing.plaf.PopupMenuUI).getPopup(a,b,c)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.PopupMenuUI).getPopup(a,b,c)
			Next i
			Return returnValue
		End Function
	...
	'//////////////////
		...
		Public Shared Function createUI(ByVal a As javax.swing.JComponent) As javax.swing.plaf.ComponentUI
			Dim mui As javax.swing.plaf.ComponentUI = New MultiPopupMenuUI
			Return MultiLookAndFeel.createUIs(mui, CType(mui, MultiPopupMenuUI).uis, a)
		End Function
