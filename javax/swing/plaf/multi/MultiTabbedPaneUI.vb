...
Namespace javax.swing.plaf.multi
	...
	Public Class MultiTabbedPaneUI
		Inherits javax.swing.plaf.TabbedPaneUI
	...
	'//////////////////
		...
		Public Overrides Function tabForCoordinate(ByVal a As javax.swing.JTabbedPane, ByVal b As Integer, ByVal c As Integer) As Integer
			Dim returnValue As Integer = CType(uis(0), javax.swing.plaf.TabbedPaneUI).tabForCoordinate(a,b,c)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.TabbedPaneUI).tabForCoordinate(a,b,c)
			Next i
			Return returnValue
		End Function
		...
		''' <returns> the value obtained from the first UI, which is
		''' the UI obtained from the default <code>LookAndFeel</code> </returns>
		Public Overrides Function getTabBounds(ByVal a As javax.swing.JTabbedPane, ByVal b As Integer) As java.awt.Rectangle
			Dim returnValue As java.awt.Rectangle = CType(uis(0), javax.swing.plaf.TabbedPaneUI).getTabBounds(a,b)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.TabbedPaneUI).getTabBounds(a,b)
			Next i
			Return returnValue
		End Function
		...
		''' <returns> the value obtained from the first UI, which is
		''' the UI obtained from the default <code>LookAndFeel</code> </returns>
		Public Overrides Function getTabRunCount(ByVal a As javax.swing.JTabbedPane) As Integer
			Dim returnValue As Integer = CType(uis(0), javax.swing.plaf.TabbedPaneUI).getTabRunCount(a)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.TabbedPaneUI).getTabRunCount(a)
			Next i
			Return returnValue
		End Function
	...
	'//////////////////
		...
		Public Shared Function createUI(ByVal a As javax.swing.JComponent) As javax.swing.plaf.ComponentUI
			Dim mui As javax.swing.plaf.ComponentUI = New MultiTabbedPaneUI
			Return MultiLookAndFeel.createUIs(mui, CType(mui, MultiTabbedPaneUI).uis, a)
		End Function
