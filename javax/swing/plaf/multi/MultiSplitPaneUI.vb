...
Namespace javax.swing.plaf.multi
	...
	'//////////////////
		...
		''' </summary>
		Public Overrides Sub resetToPreferredSizes(ByVal a As javax.swing.JSplitPane)
			For i As Integer = 0 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.SplitPaneUI).resetToPreferredSizes(a)
			Next i
		End Sub
		...
		''' </summary>
		Public Overrides Sub setDividerLocation(ByVal a As javax.swing.JSplitPane, ByVal b As Integer)
			For i As Integer = 0 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.SplitPaneUI).dividerLocationion(a,b)
			Next i
		End Sub
		...
		Public Overrides Function getDividerLocation(ByVal a As javax.swing.JSplitPane) As Integer
			Dim returnValue As Integer = CType(uis(0), javax.swing.plaf.SplitPaneUI).getDividerLocation(a)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.SplitPaneUI).getDividerLocation(a)
			Next i
			Return returnValue
		End Function
		...
		''' <returns> the value obtained from the first UI, which is
		''' the UI obtained from the default <code>LookAndFeel</code> </returns>
		Public Overrides Function getMinimumDividerLocation(ByVal a As javax.swing.JSplitPane) As Integer
			Dim returnValue As Integer = CType(uis(0), javax.swing.plaf.SplitPaneUI).getMinimumDividerLocation(a)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.SplitPaneUI).getMinimumDividerLocation(a)
			Next i
			Return returnValue
		End Function
		...
		''' <returns> the value obtained from the first UI, which is
		''' the UI obtained from the default <code>LookAndFeel</code> </returns>
		Public Overrides Function getMaximumDividerLocation(ByVal a As javax.swing.JSplitPane) As Integer
			Dim returnValue As Integer = CType(uis(0), javax.swing.plaf.SplitPaneUI).getMaximumDividerLocation(a)
			For i As Integer = 1 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.SplitPaneUI).getMaximumDividerLocation(a)
			Next i
			Return returnValue
		End Function
		...
		''' </summary>
		Public Overrides Sub finishedPaintingChildren(ByVal a As javax.swing.JSplitPane, ByVal b As java.awt.Graphics)
			For i As Integer = 0 To uis.Count - 1
				CType(uis(i), javax.swing.plaf.SplitPaneUI).finishedPaintingChildren(a,b)
			Next i
		End Sub
	...
	'//////////////////
		...
		Public Shared Function createUI(ByVal a As javax.swing.JComponent) As javax.swing.plaf.ComponentUI
			Dim mui As javax.swing.plaf.ComponentUI = New MultiSplitPaneUI
			Return MultiLookAndFeel.createUIs(mui, CType(mui, MultiSplitPaneUI).uis, a)
		End Function
