...
Namespace javax.swing.plaf.nimbus
	...
	Friend NotInheritable Class SpinnerPanelSpinnerFormattedTextFieldPainter
		...
		Friend Const BACKGROUND_SELECTED_FOCUSED As Integer = 5
		...
		Private color9 As Color = decodeColor("nimbusBlueGrey", 0.055555582f, -0.1048766f, -0.08f, 0)
		Private color10 As Color = decodeColor("nimbusBlueGrey", 0.055555582f, -0.105624355f, 0.054901958f, 0)
		Private color11 As Color = decodeColor("nimbusBlueGrey", 0.0f, -0.110526316f, 0.25490195f, 0)
		Private color12 As Color = decodeColor("nimbusBlueGrey", 0.055555582f, -0.105344966f, 0.011764705f, 0)
		Private color13 As Color = decodeColor("nimbusLightBackground", 0.0f, 0.0f, 0.0f, 0)
		Private color14 As Color = decodeColor("nimbusFocus", 0.0f, 0.0f, 0.0f, 0)
		Private color15 As Color = decodeColor("nimbusBlueGrey", 0.055555582f, -0.1048766f, -0.05098039f, 0)
		...
		Private Function decodeRect6() As Rectangle2D
				rect.rectect(decodeX(0.22222222f), decodeY(0.13333334f), decodeX(2.916668f) - decodeX(0.22222222f), decodeY(2.75f) - decodeY(0.13333334f)) 'height - width - y - x
			Return rect
		End Function
		...
		Private Function decodeGradient4(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.1684492f,1.0f }, New Color() { color10, decodeColor(color10,color11,0.5f), color11})
		End Function
		...
		Private Function decodeGradient5(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.49573863f,0.99147725f }, New Color() { color8, decodeColor(color8,color15,0.5f), color15})
		End Function
