...
Namespace javax.swing.plaf.nimbus
	...
	Friend NotInheritable Class RadioButtonMenuItemPainter
		...
		Friend Const ICON_DISABLED As Integer = 8
		Friend Const ICON_ENABLED As Integer = 9
		Friend Const ICON_MOUSEOVER As Integer = 10
