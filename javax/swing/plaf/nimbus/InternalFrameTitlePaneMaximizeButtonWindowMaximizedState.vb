...
Namespace javax.swing.plaf.nimbus
	...
	Friend Class InternalFrameTitlePaneMaximizeButtonWindowMaximizedState
		Inherits State

		Friend Sub New()
			MyBase.New("WindowMaximized")
		End Sub
		...
		Protected Friend Overrides Function isInState(ByVal c As JComponent) As Boolean
								   ...
								   Loop
								   If TypeOf parent Is JInternalFrame Then Return CType(parent, JInternalFrame).maximum
								   Return False
		End Function
	End Class
