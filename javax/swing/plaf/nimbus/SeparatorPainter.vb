...
Namespace javax.swing.plaf.nimbus
	...
	Friend NotInheritable Class SeparatorPainter
		...
		Private Function decodeRect1() As Rectangle2D
				rect.rectect(decodeX(0.0f), decodeY(1.3333334f), decodeX(3.0f) - decodeX(0.0f), decodeY(1.6666667f) - decodeY(1.3333334f)) 'height - width - y - x
			Return rect
		End Function
