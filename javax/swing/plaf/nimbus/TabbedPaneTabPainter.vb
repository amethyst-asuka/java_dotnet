...
Namespace javax.swing.plaf.nimbus
	...
	Friend NotInheritable Class TabbedPaneTabPainter
		...
		Friend Const BACKGROUND_ENABLED_MOUSEOVER As Integer = 2
		Friend Const BACKGROUND_ENABLED_PRESSED As Integer = 3
		Friend Const BACKGROUND_DISABLED As Integer = 4
		Friend Const BACKGROUND_SELECTED_DISABLED As Integer = 5
		Friend Const BACKGROUND_SELECTED As Integer = 6
		Friend Const BACKGROUND_SELECTED_MOUSEOVER As Integer = 7
		Friend Const BACKGROUND_SELECTED_PRESSED As Integer = 8
		Friend Const BACKGROUND_SELECTED_FOCUSED As Integer = 9
		Friend Const BACKGROUND_SELECTED_MOUSEOVER_FOCUSED As Integer = 10
		Friend Const BACKGROUND_SELECTED_PRESSED_FOCUSED As Integer = 11
		...
		Private color1 As Color = decodeColor("nimbusBase", 0.032459438f, -0.55535716f, -0.109803945f, 0)
		Private color2 As Color = decodeColor("nimbusBase", 0.08801502f, 0.3642857f, -0.4784314f, 0)
		Private color3 As Color = decodeColor("nimbusBase", 0.08801502f, -0.63174605f, 0.43921566f, 0)
		Private color4 As Color = decodeColor("nimbusBase", 0.05468172f, -0.6145278f, 0.37647057f, 0)
		Private color5 As Color = decodeColor("nimbusBase", 0.032459438f, -0.5953556f, 0.32549018f, 0)
		Private color6 As Color = decodeColor("nimbusBase", 0.032459438f, -0.54616207f, -0.02352941f, 0)
		Private color7 As Color = decodeColor("nimbusBase", 0.08801502f, -0.6317773f, 0.4470588f, 0)
		Private color8 As Color = decodeColor("nimbusBase", 0.021348298f, -0.61547136f, 0.41960782f, 0)
		Private color9 As Color = decodeColor("nimbusBase", 0.032459438f, -0.5985242f, 0.39999998f, 0)
		Private color10 As Color = decodeColor("nimbusBase", 0.08801502f, 0.3642857f, -0.52156866f, 0)
		Private color11 As Color = decodeColor("nimbusBase", 0.027408898f, -0.5847884f, 0.2980392f, 0)
		Private color12 As Color = decodeColor("nimbusBase", 0.035931647f, -0.5553123f, 0.23137254f, 0)
		Private color13 As Color = decodeColor("nimbusBase", 0.029681683f, -0.5281874f, 0.18039215f, 0)
		Private color14 As Color = decodeColor("nimbusBase", 0.03801495f, -0.5456242f, 0.3215686f, 0)
		Private color15 As Color = decodeColor("nimbusBase", 0.032459438f, -0.59181184f, 0.25490195f, 0)
		Private color16 As Color = decodeColor("nimbusBase", 0.05468172f, -0.58308274f, 0.19607842f, 0)
		Private color17 As Color = decodeColor("nimbusBase", 0.046348333f, -0.6006266f, 0.34509802f, 0)
		Private color18 As Color = decodeColor("nimbusBase", 0.046348333f, -0.60015875f, 0.3333333f, 0)
		Private color19 As Color = decodeColor("nimbusBase", 0.004681647f, -0.6197143f, 0.43137252f, 0)
		Private color20 As Color = decodeColor("nimbusBase", 7.13408E-4f, -0.543609f, 0.34509802f, 0)
		Private color21 As Color = decodeColor("nimbusBase", -0.0020751357f, -0.45610264f, 0.2588235f, 0)
		Private color22 As Color = decodeColor("nimbusBase", 5.1498413E-4f, -0.43866998f, 0.24705881f, 0)
		Private color23 As Color = decodeColor("nimbusBase", 5.1498413E-4f, -0.44879842f, 0.29019606f, 0)
		Private color24 As Color = decodeColor("nimbusBase", 5.1498413E-4f, -0.08776909f, -0.2627451f, 0)
		Private color25 As Color = decodeColor("nimbusBase", 0.06332368f, 0.3642857f, -0.4431373f, 0)
		Private color26 As Color = decodeColor("nimbusBase", 0.004681647f, -0.6198413f, 0.43921566f, 0)
		Private color27 As Color = decodeColor("nimbusBase", -0.0022627711f, -0.5335866f, 0.372549f, 0)
		Private color28 As Color = decodeColor("nimbusBase", -0.0017285943f, -0.4608264f, 0.32549018f, 0)
		Private color29 As Color = decodeColor("nimbusBase", 5.1498413E-4f, -0.4555341f, 0.3215686f, 0)
		Private color30 As Color = decodeColor("nimbusBase", 5.1498413E-4f, -0.46404046f, 0.36470586f, 0)
		Private color31 As Color = decodeColor("nimbusBase", -0.57865167f, -0.6357143f, -0.54901963f, 0)
		Private color32 As Color = decodeColor("nimbusBase", -4.2033195E-4f, -0.38050595f, 0.20392156f, 0)
		Private color33 As Color = decodeColor("nimbusBase", 0.0013483167f, -0.16401619f, 0.0745098f, 0)
		Private color34 As Color = decodeColor("nimbusBase", -0.0010001659f, -0.01599598f, 0.007843137f, 0)
		Private color35 As Color = decodeColor("nimbusBase", 0.0f, 0.0f, 0.0f, 0)
		Private color36 As Color = decodeColor("nimbusBase", 0.0018727183f, -0.038398862f, 0.035294116f, 0)
		Private color37 As Color = decodeColor("nimbusFocus", 0.0f, 0.0f, 0.0f, 0)
		...
		Private Sub paintBackgroundSelectedAndDisabled(ByVal g As Graphics2D)
			path = decodePath7()
			g.paint = decodeGradient7(path)
			g.fill(path)
			path = decodePath2()
		...
		Private Sub paintBackgroundSelectedAndPressed(ByVal g As Graphics2D)
			path = decodePath8()
		...
		Private Sub paintBackgroundSelectedAndMouseOverAndFocused(ByVal g As Graphics2D)
			path = decodePath12()
			g.paint = decodeGradient11(path)
			g.fill(path)
			path = decodePath13()
		...
		Private Sub paintBackgroundSelectedAndPressedAndFocused(ByVal g As Graphics2D)
			path = decodePath12()
			g.paint = decodeGradient13(path)
			g.fill(path)
			path = decodePath13()
		...
		Private Function decodeGradient2(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.1f,0.2f,0.6f,1.0f }, New Color() { color3, decodeColor(color3,color4,0.5f), color4, decodeColor(color4,color5,0.5f), color5})
		End Function
		...
		Private Function decodeGradient3(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color6, decodeColor(color6,color2,0.5f), color2})
		End Function
		...
		Private Function decodeGradient4(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.1f,0.2f,0.6f,1.0f }, New Color() { color7, decodeColor(color7,color8,0.5f), color8, decodeColor(color8,color9,0.5f), color9})
		End Function
		...
		Private Function decodeGradient5(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color10, decodeColor(color10,color2,0.5f), color2})
		End Function
		...
		Private Function decodeGradient6(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.1f,0.2f,0.42096776f,0.64193547f,0.82096773f,1.0f }, New Color() { color11, decodeColor(color11,color12,0.5f), color12, decodeColor(color12,color13,0.5f), color13, decodeColor(color13,color14,0.5f), color14})
		End Function
		...
		Private Function decodeGradient8(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.1f,0.2f,0.6f,1.0f }, New Color() { color17, decodeColor(color17,color18,0.5f), color18, decodeColor(color18,color5,0.5f), color5})
		End Function
		...
		Private Function decodeGradient10(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color24, decodeColor(color24,color2,0.5f), color2})
		End Function
		...
		Private Function decodeGradient11(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color25, decodeColor(color25,color2,0.5f), color2})
		End Function
		...
		Private Function decodeGradient13(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color25, decodeColor(color25,color31,0.5f), color31})
		End Function
