...
Namespace javax.swing.plaf.nimbus
	...
	Friend NotInheritable Class DesktopPanePainter
		...
		Private color1 As Color = decodeColor("nimbusBase", -0.004577577f, -0.12867206f, 0.007843137f, 0)
		Private color2 As Color = decodeColor("nimbusBase", -0.0063245893f, -0.08363098f, -0.17254904f, 0)
		Private color3 As Color = decodeColor("nimbusBase", -3.6883354E-4f, -0.056766927f, -0.10196081f, 0)
		Private color4 As Color = decodeColor("nimbusBase", -0.008954704f, -0.12645501f, -0.12549022f, 0)
		Private color5 As New Color(255, 200, 0, 6)
		Private color6 As Color = decodeColor("nimbusBase", -8.028746E-5f, -0.084533215f, -0.05098042f, 0)
		Private color7 As Color = decodeColor("nimbusBase", -0.0052053332f, -0.12267083f, -0.09803924f, 0)
		Private color8 As Color = decodeColor("nimbusBase", -0.012559712f, -0.13136649f, -0.09803924f, 0)
		Private color9 As Color = decodeColor("nimbusBase", -0.009207249f, -0.13984653f, -0.07450983f, 0)
		Private color10 As Color = decodeColor("nimbusBase", -0.010750473f, -0.13571429f, -0.12549022f, 0)
		Private color11 As Color = decodeColor("nimbusBase", -0.008476257f, -0.1267857f, -0.109803945f, 0)
		Private color12 As Color = decodeColor("nimbusBase", -0.0034883022f, -0.042691052f, -0.21176472f, 0)
		Private color13 As Color = decodeColor("nimbusBase", -0.012613952f, -0.11610645f, -0.14901963f, 0)
		Private color14 As Color = decodeColor("nimbusBase", -0.0038217902f, -0.05238098f, -0.21960786f, 0)
		...
		Private Function decodeGradient1(ByVal s As Shape) As Paint
			...
			Return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.75f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color1, decodeColor(color1,color2,0.5f), color2})
		End Function
		...
		Private Function decodeGradient2(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.9567308f * w) + x, (0.06835443f * h) + y, (0.75f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color3, decodeColor(color3,color4,0.5f), color4})
		End Function
		...
		Private Function decodeGradient3(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.83536583f * w) + x, (0.9522059f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color6, decodeColor(color6,color7,0.5f), color7})
		End Function
		...
		Private Function decodeGradient4(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.8659696f * w) + x, (0.011049724f * h) + y, (0.24809887f * w) + x, (0.95027626f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color6, decodeColor(color6,color8,0.5f), color8})
		End Function
		...
		Private Function decodeGradient5(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.3511236f * w) + x, (0.09326425f * h) + y, (0.33426967f * w) + x, (0.9846154f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color9, decodeColor(color9,color10,0.5f), color10})
		End Function
		...
		Private Function decodeGradient6(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.3548387f * w) + x, (0.114285715f * h) + y, (0.48387095f * w) + x, (0.9809524f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color11, decodeColor(color11,color4,0.5f), color4})
		End Function
		...
		Private Function decodeGradient7(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.75f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color1, decodeColor(color1,color12,0.5f), color12})
		End Function
		...
		Private Function decodeGradient8(ByVal s As Shape) As Paint
			...
			Dim w As Single = CSng(bounds.width)
			Dim h As Single = CSng(bounds.height)
			Return decodeGradient((0.25f * w) + x, (0.0f * h) + y, (0.75f * w) + x, (1.0f * h) + y, New Single() { 0.0f,0.5f,1.0f }, New Color() { color13, decodeColor(color13,color14,0.5f), color14})
		End Function
