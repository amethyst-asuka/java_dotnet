...
Namespace javax.swing.plaf.nimbus
	...
	Friend NotInheritable Class ToolTipPainter
		...
		Private color2 As Color = decodeColor("info", 0.0f, 0.0f, 0.0f, 0)
		...
		Private Function decodeRect1() As Rectangle2D
				rect.rectect(decodeX(2.0f), decodeY(1.0f), decodeX(3.0f) - decodeX(2.0f), decodeY(2.0f) - decodeY(1.0f)) 'height - width - y - x
			Return rect
		End Function

		Private Function decodeRect2() As Rectangle2D
				rect.rectect(decodeX(0.0f), decodeY(1.0f), decodeX(1.0f) - decodeX(0.0f), decodeY(2.0f) - decodeY(1.0f)) 'height - width - y - x
			Return rect
		End Function

		Private Function decodeRect3() As Rectangle2D
				rect.rectect(decodeX(0.0f), decodeY(2.0f), decodeX(3.0f) - decodeX(0.0f), decodeY(3.0f) - decodeY(2.0f)) 'height - width - y - x
			Return rect
		End Function

		Private Function decodeRect4() As Rectangle2D
				rect.rectect(decodeX(0.0f), decodeY(0.0f), decodeX(3.0f) - decodeX(0.0f), decodeY(1.0f) - decodeY(0.0f)) 'height - width - y - x
			Return rect
		End Function
