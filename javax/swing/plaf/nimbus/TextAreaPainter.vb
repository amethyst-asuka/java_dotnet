...
Namespace javax.swing.plaf.nimbus
	...
	Friend NotInheritable Class TextAreaPainter
		...
		Friend Const BACKGROUND_DISABLED_NOTINSCROLLPANE As Integer = 3
		Friend Const BACKGROUND_ENABLED_NOTINSCROLLPANE As Integer = 4
		Friend Const BACKGROUND_SELECTED As Integer = 5
		Friend Const BORDER_DISABLED_NOTINSCROLLPANE As Integer = 6
		Friend Const BORDER_FOCUSED_NOTINSCROLLPANE As Integer = 7
		Friend Const BORDER_ENABLED_NOTINSCROLLPANE As Integer = 8
		...
		Private Sub paintBackgroundDisabledAndNotInScrollPane(ByVal g As Graphics2D)
			rect = decodeRect2()
			g.paint = color1
			g.fill(rect)
		...
		Private Sub paintBackgroundEnabledAndNotInScrollPane(ByVal g As Graphics2D)
			rect = decodeRect2()
			g.paint = CType(componentColors(0), Color)
			g.fill(rect)
		...
		Private Sub paintBorderDisabledAndNotInScrollPane(ByVal g As Graphics2D)
			rect = decodeRect3()
		...
		Private Sub paintBorderFocusedAndNotInScrollPane(ByVal g As Graphics2D)
			rect = decodeRect8()
		...
		Private Sub paintBorderEnabledAndNotInScrollPane(ByVal g As Graphics2D)
			rect = decodeRect8()
