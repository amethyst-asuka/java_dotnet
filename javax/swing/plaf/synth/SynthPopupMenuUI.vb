...
Namespace javax.swing.plaf.synth
	...
	''' <seealso cref="javax.swing.JPopupMenu"/>.
	''' 
	''' @author Georges Saab
	...
	Public Class SynthPopupMenuUI
		...
		Public Overrides Sub installDefaults()
			If popupMenu.layout Is Nothing OrElse TypeOf popupMenu.layout Is UIResource Then popupMenu.layout = New SynthMenuLayout(popupMenu, BoxLayout.Y_AXIS)
		...
		Protected Friend Overrides Sub installListeners()
			...
			popupMenu.addPropertyChangeListener(Me)
		End Sub
		...
		Protected Friend Overrides Sub uninstallDefaults()
			Dim ___context As SynthContext = getContext(popupMenu, ENABLED)

			style.uninstallDefaults(___context)
			___context.Dispose()
			style = Nothing

			If TypeOf popupMenu.layout Is UIResource Then popupMenu.layout = Nothing
		End Sub
		...
		Protected Friend Overrides Sub uninstallListeners()
			...
			popupMenu.removePropertyChangeListener(Me)
		End Sub
		...
		Public Overrides Sub update(ByVal g As java.awt.Graphics, ByVal c As JComponent)
			...
			___context.painter.paintPopupMenuBackground(___context, g, 0, 0, c.width, c.height)
			paint(___context, g)
			___context.Dispose()
		End Sub
		...
		Public Overrides Sub paintBorder(ByVal context As SynthContext, ByVal g As java.awt.Graphics, ByVal x As Integer, ByVal y As Integer, ByVal w As Integer, ByVal h As Integer) Implements SynthUI.paintBorder
			context.painter.paintPopupMenuBorder(context, g, x, y, w, h)
		End Sub
		...
		Public Overrides Sub propertyChange(ByVal e As java.beans.PropertyChangeEvent)
			If SynthLookAndFeel.shouldUpdateStyle(e) Then updateStyle(popupMenu)
		End Sub
	End Class
