...
Namespace javax.swing.plaf.synth
	...
	''' <seealso cref="javax.swing.JMenuItem"/>.
	''' 
	''' @author Georges Saab
	...
	Public Class SynthMenuItemUI
		...
		Private Sub updateStyle(ByVal mi As JMenuItem)
			...
			If oldStyle IsNot style Then
				...
				Dim value As Object = style.get(___context, prefix & ".textIconGap")
				If value IsNot Nothing Then LookAndFeel.installProperty(mi, "iconTextGap", value)
				defaultTextIconGap = mi.iconTextGap
		...
		Public Overrides Sub paintBorder(ByVal context As SynthContext, ByVal g As Graphics, ByVal x As Integer, ByVal y As Integer, ByVal w As Integer, ByVal h As Integer)
			context.painter.paintMenuItemBorder(context, g, x, y, w, h)
		End Sub
		...
		Public Overrides Sub propertyChange(ByVal e As java.beans.PropertyChangeEvent)
			If SynthLookAndFeel.shouldUpdateStyle(e) Then updateStyle(CType(e.source, JMenuItem))
		End Sub
	End Class
