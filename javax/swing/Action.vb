...
Namespace javax.swing
	...
	''' <seealso cref= AbstractAction </seealso>
...
'		public static final String SELECTED_KEY = "SwingSelectedKey";
		...
		''' avoid possible collisions with existing <code>Actions</code>.
		''' </summary>
		''' <seealso cref= AbstractButton#setDisplayedMnemonicIndex
		''' @since 1.6 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
...
'		public static final String LARGE_ICON_KEY = "SwingLargeIconKey";
		...
		''' using the associated key. </summary>
		''' <seealso cref= #putValue </seealso>
		...
		''' to listeners.
		''' </summary>
		''' <param name="key">    a <code>String</code> containing the key </param>
		''' <param name="value">  an <code>Object</code> value </param>
		Sub putValue(ByVal key As String, ByVal value As Object)
		...
		''' to listeners.
		''' </summary>
		''' <param name="b"> true to enable this <code>Action</code>, false to disable it </param>
		...
		''' </summary>
		''' <param name="listener">  a <code>PropertyChangeListener</code> object </param>
