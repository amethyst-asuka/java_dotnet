...
Namespace javax.swing.text
	...
	''' <ul>
	''' <li><seealso cref="#getLength()"/>
	''' <li><seealso cref="#getText(int, int)"/>
	''' <li><seealso cref="#getText(int, int, javax.swing.text.Segment)"/>
	''' </ul>
	...
	''' <ul>
	''' <li><seealso cref="#getDefaultRootElement()"/>
	''' <li><seealso cref="#getRootElements()"/>
	''' </ul>
	''' 
	...
	''' document content:
	''' <ul>
	''' <li><seealso cref="#insertString(int, java.lang.String, javax.swing.text.AttributeSet)"/>
	''' <li><seealso cref="#remove(int, int)"/>
	''' <li><seealso cref="#createPosition(int)"/>
	''' </ul>
	''' 
	...
	''' <ul>
	''' <li><seealso cref="#getProperty(java.lang.Object)"/>
	''' <li><seealso cref="#putProperty(java.lang.Object, java.lang.Object)"/>
	''' </ul>
	''' 
	...
	''' </summary>
	''' <seealso cref= javax.swing.event.DocumentEvent </seealso>
	''' <seealso cref= javax.swing.event.DocumentListener </seealso>
	''' <seealso cref= javax.swing.event.UndoableEditEvent </seealso>
	''' <seealso cref= javax.swing.event.UndoableEditListener </seealso>
	''' <seealso cref= Element </seealso>
	''' <seealso cref= Position </seealso>
	...
	Public Interface Document
		...
		Sub addDocumentListener(ByVal listener As DocumentListener)
		...
		Sub removeDocumentListener(ByVal listener As DocumentListener)
		...
		''' <param name="listener"> the observer to register </param>
		''' <seealso cref= javax.swing.event.UndoableEditEvent </seealso>
		Sub addUndoableEditListener(ByVal listener As UndoableEditListener)
		...
		''' <param name="listener"> the observer to register </param>
		''' <seealso cref= javax.swing.event.UndoableEditEvent </seealso>
		Sub removeUndoableEditListener(ByVal listener As UndoableEditListener)

		''' <summary>
		''' Gets the properties associated with the document.
		''' </summary>
		''' <param name="key"> a non-<code>null</code> property key </param>
		''' <returns> the properties </returns>
		''' <seealso cref= #putProperty(Object, Object) </seealso>
		Function getProperty(ByVal key As Object) As Object
		...
		''' <seealso cref= #getProperty(Object) </seealso>
		Sub putProperty(ByVal key As Object, ByVal value As Object)
		...
		''' <seealso cref= javax.swing.event.UndoableEditEvent </seealso>
		''' <seealso cref= javax.swing.event.UndoableEditListener </seealso>
		Sub remove(ByVal offs As Integer, ByVal len As Integer)
		...
		''' <seealso cref= javax.swing.event.UndoableEditEvent </seealso>
		''' <seealso cref= javax.swing.event.UndoableEditListener </seealso>
		Sub insertString(ByVal offset As Integer, ByVal str As String, ByVal a As AttributeSet)
		...
		'''   start of the text &gt;= 0 </param>
		''' <param name="length">  the length of the desired string &gt;= 0 </param>
		''' <returns> the text, in a String of length &gt;= 0 </returns>
		''' <exception cref="BadLocationException">  some portion of the given range
		'''   was not a valid part of the document.  The location in the exception
		'''   is the first bad position encountered. </exception>
		Function getText(ByVal offset As Integer, ByVal length As Integer) As String
		...
		'''   start of the text &gt;= 0 </param>
		''' <param name="length">  the length of the desired string &gt;= 0 </param>
		''' <param name="txt"> the Segment object to return the text in
		''' </param>
		''' <exception cref="BadLocationException">  Some portion of the given range
		'''   was not a valid part of the document.  The location in the exception
		'''   is the first bad position encountered. </exception>
		Sub getText(ByVal offset As Integer, ByVal length As Integer, ByVal txt As Segment)
		...
		ReadOnly Property startPosition As Position
		...
		''' </summary>
		''' <returns> the position </returns>
		ReadOnly Property endPosition As Position
		...
		Function createPosition(ByVal offs As Integer) As Position
		...
		ReadOnly Property rootElements As Element()
		...
		''' </summary>
		''' <returns> the root element </returns>
		ReadOnly Property defaultRootElement As Element
		...
		''' make any mutations.
		''' </summary>
		''' <param name="r"> a <code>Runnable</code> used to render the model </param>
		Sub render(ByVal r As Runnable)
