...
Namespace javax.swing
	...
	Public MustInherit Class InputVerifier
	  ...
	  ''' </summary>
	  ''' <param name="input"> the JComponent to verify </param>
	  ''' <returns> <code>true</code> when valid, <code>false</code> when invalid </returns>
	  ''' <seealso cref= JComponent#setInputVerifier </seealso>
	  ''' <seealso cref= JComponent#getInputVerifier
	  '''  </seealso>

	  Public MustOverride Function verify(ByVal input As JComponent) As Boolean
	  ...
	  Public Overridable Function shouldYieldFocus(ByVal input As JComponent) As Boolean
		Return verify(input)
	  End Function
