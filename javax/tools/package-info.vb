...
''' throw a <seealso cref="java.lang.NullPointerException"/> if given a
''' {@code null} argument or if given a
''' <seealso cref="java.lang.Iterable list or collection"/> containing
...
''' (<seealso cref="javax.tools.DiagnosticListener"/>) as well as a file
...
''' <seealso cref="javax.tools.ToolProvider"/>, for example:
''' 
...
''' through the {@link java.util.ServiceLoader service provider
''' mechanism}.
''' 
