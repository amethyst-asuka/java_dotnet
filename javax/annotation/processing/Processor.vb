...
Namespace javax.annotation.processing
	...
	''' round, a processor may be asked to <seealso cref="#process process"/> a
	...
	''' 
	''' <li>Next, the tool calls the <seealso cref="#init init"/> method with
	...
	''' 
	''' <li>As appropriate, the tool calls the <seealso cref="#process process"/>
	...
	''' {@link javax.tools.JavaCompiler.CompilationTask#setProcessors
	''' set directly} or controlled by a {@linkplain
	''' javax.tools.StandardLocation#ANNOTATION_PROCESSOR_PATH search path}
	''' used for a <seealso cref="java.util.ServiceLoader service-style"/>
	...
	''' processors the tool asks to <seealso cref="#process run"/> is a function
	''' of the types of the annotations <em><seealso cref="AnnotatedConstruct present"/></em>
	''' on the {@linkplain
	''' RoundEnvironment#getRootElements root elements}, what {@linkplain
	''' #getSupportedAnnotationTypes annotation types a processor
	''' supports}, and whether or not a processor {@link #process
	...
	''' present given in <seealso cref="AnnotatedConstruct"/>. In brief, an
	...
	''' round will indicate an {@link RoundEnvironment#errorRaised
	...
	''' RoundEnvironment per round} or {@link ProcessingEnvironment
	...
	''' </ol>
	''' 
	''' <p>The <seealso cref="Filer"/> interface discusses restrictions on how
	''' processors can operate on files.
	''' 
	''' <p>Note that implementors of this interface may find it convenient
	''' to extend <seealso cref="AbstractProcessor"/> rather than implementing this
	''' interface directly.
	''' 
	...
	Public Interface Processor
		...
		'''         empty collection if none </returns>
		''' <seealso cref= javax.annotation.processing.SupportedOptions </seealso>
		ReadOnly Property supportedOptions As java.util.Set(Of String)
		...
		''' </summary>
		''' <returns> the names of the annotation types supported by this processor </returns>
		''' <seealso cref= javax.annotation.processing.SupportedAnnotationTypes
		''' @jls 3.8 Identifiers
		''' @jls 6.5.5 Meaning of Type Names </seealso>
		ReadOnly Property supportedAnnotationTypes As java.util.Set(Of String)
		...
		''' <returns> the latest source version supported by this annotation
		''' processor. </returns>
		''' <seealso cref= javax.annotation.processing.SupportedSourceVersion </seealso>
		''' <seealso cref= ProcessingEnvironment#getSourceVersion </seealso>
		ReadOnly Property supportedSourceVersion As javax.lang.model.SourceVersion

		''' <summary>
		''' Initializes the processor with the processing environment.
		''' </summary>
		''' <param name="processingEnv"> environment for facilities the tool framework
		''' provides to the processor </param>
		Sub init(ByVal processingEnv As ProcessingEnvironment)
		...
		''' </summary>
		''' <param name="annotations"> the annotation types requested to be processed </param>
		''' <param name="roundEnv">  environment for information about the current and prior round </param>
		''' <returns> whether or not the set of annotation types are claimed by this processor </returns>
		Function process(Of T1 As TypeElement)(ByVal annotations As java.util.Set(Of T1), ByVal roundEnv As RoundEnvironment) As Boolean
	   ...
	   ''' ...
	   ''' return Arrays.asList(<seealso cref="Completions#of(String) of"/>(&quot;3&quot;),
	   '''                      of(&quot;7&quot;),
	   '''                      of(&quot;31&quot;),
	   '''                      of(&quot;127&quot;),
	   '''                      of(&quot;8191&quot;),
	   ...
	   ''' <blockquote>
	   ''' <pre>
	   ''' return Arrays.asList(<seealso cref="Completions#of(String, String) of"/>(&quot;3&quot;,          &quot;M2&quot;),
	   '''                      of(&quot;7&quot;,          &quot;M3&quot;),
	   '''                      of(&quot;31&quot;,         &quot;M5&quot;),
	   '''                      of(&quot;127&quot;,        &quot;M7&quot;),
	   '''                      of(&quot;8191&quot;,       &quot;M13&quot;),
	   ...
	   ''' </blockquote>
	   ''' </summary>
	   ''' <param name="element"> the element being annotated </param>
	   ''' <param name="annotation"> the (perhaps partial) annotation being
	   '''                   applied to the element </param>
	   ''' <param name="member"> the annotation member to return possible completions for </param>
	   ''' <param name="userText"> source code text to be completed
	   ''' </param>
	   ''' <returns> suggested completions to the annotation </returns>
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		Function getCompletions(ByVal element As Element, ByVal annotation As AnnotationMirror, ByVal member As ExecutableElement, ByVal userText As String) As IEnumerable(Of ? As Completion)
	End Interface
