...
Namespace javax.annotation.processing
	...
	''' created will be {@link RoundEnvironment#getRootElements
	...
	''' one for {@link javax.tools.StandardLocation#CLASS_OUTPUT new
	...
	''' a run will throw a <seealso cref="FilerException"/>, as will attempting to
	''' create both a class file and source file for the same type name or
	''' same package name.  The <seealso cref="Processor initial inputs"/> to
	...
	''' including an <seealso cref="javax.annotation.Generated @Generated"/>
	''' annotation.
	''' 
	...
	Public Interface Filer
		...
		''' {@link StandardLocation#SOURCE_OUTPUT root output location
		...
		''' for this run.
		''' </summary>
		''' <param name="name">  canonical (fully qualified) name of the principal type
		'''          being declared in this file or a package name followed by
		'''          {@code ".package-info"} for a package information file </param>
		''' <param name="originatingElements"> type or package elements causally
		''' associated with the creation of this file, may be elided or
		''' {@code null} </param>
		''' <returns> a {@code JavaFileObject} to write the new source file </returns>
		''' <exception cref="FilerException"> if the same pathname has already been
		''' created, the same type has already been created, or the name is
		''' not valid for a type </exception>
		''' <exception cref="IOException"> if the file cannot be created </exception>
		Function createSourceFile(ByVal name As CharSequence, ParamArray ByVal originatingElements As javax.lang.model.element.Element()) As JavaFileObject

		''' <summary>
		''' Creates a new class file, and returns an object to allow
		''' writing to it.  The file's name and path (relative to the
		''' {@link StandardLocation#CLASS_OUTPUT root output location
		...
		''' for this run.
		''' </summary>
		''' <param name="name"> binary name of the type being written or a package name followed by
		'''          {@code ".package-info"} for a package information file </param>
		''' <param name="originatingElements"> type or package elements causally
		''' associated with the creation of this file, may be elided or
		''' {@code null} </param>
		''' <returns> a {@code JavaFileObject} to write the new class file </returns>
		''' <exception cref="FilerException"> if the same pathname has already been
		''' created, the same type has already been created, or the name is
		''' not valid for a type </exception>
		''' <exception cref="IOException"> if the file cannot be created </exception>
		Function createClassFile(ByVal name As CharSequence, ParamArray ByVal originatingElements As javax.lang.model.element.Element()) As JavaFileObject
		...
		''' or new class file.
		''' </summary>
		''' <param name="location"> location of the new file </param>
		''' <param name="pkg"> package relative to which the file should be named,
		'''          or the empty string if none </param>
		''' <param name="relativeName"> final pathname components of the file </param>
		''' <param name="originatingElements"> type or package elements causally
		''' associated with the creation of this file, may be elided or
		''' {@code null} </param>
		''' <returns> a {@code FileObject} to write the new resource </returns>
		''' <exception cref="IOException"> if the file cannot be created </exception>
		''' <exception cref="FilerException"> if the same pathname has already been
		''' created </exception>
		''' <exception cref="IllegalArgumentException"> for an unsupported location </exception>
		''' <exception cref="IllegalArgumentException"> if {@code relativeName} is not relative </exception>
	   Function createResource(ByVal location As javax.tools.JavaFileManager.Location, ByVal pkg As CharSequence, ByVal relativeName As CharSequence, ParamArray ByVal originatingElements As javax.lang.model.element.Element()) As FileObject

		''' <summary>
		''' Returns an object for reading an existing resource.  The
		''' locations <seealso cref="StandardLocation#CLASS_OUTPUT CLASS_OUTPUT"/>
		''' and <seealso cref="StandardLocation#SOURCE_OUTPUT SOURCE_OUTPUT"/> must
		''' be supported.
		''' </summary>
		''' <param name="location"> location of the file </param>
		''' <param name="pkg"> package relative to which the file should be searched,
		'''          or the empty string if none </param>
		''' <param name="relativeName"> final pathname components of the file </param>
		''' <returns> an object to read the file </returns>
		''' <exception cref="FilerException"> if the same pathname has already been
		''' opened for writing </exception>
		''' <exception cref="IOException"> if the file cannot be opened </exception>
		''' <exception cref="IllegalArgumentException"> for an unsupported location </exception>
		''' <exception cref="IllegalArgumentException"> if {@code relativeName} is not relative </exception>
		Function getResource(ByVal location As javax.tools.JavaFileManager.Location, ByVal pkg As CharSequence, ByVal relativeName As CharSequence) As FileObject
	End Interface
