...
Namespace javax.security.auth.spi
	...
	Public Interface LoginModule
		...
		''' <p>
		''' </summary>
		''' <param name="subject"> the {@code Subject} to be authenticated. <p>
		''' </param>
		''' <param name="callbackHandler"> a {@code CallbackHandler} for communicating
		'''                  with the end user (prompting for usernames and
		'''                  passwords, for example). <p>
		''' </param>
		''' <param name="sharedState"> state shared with other configured LoginModules. <p>
		''' </param>
		''' <param name="options"> options specified in the login
		'''                  {@code Configuration} for this particular
		'''                  {@code LoginModule}. </param>
		Sub initialize(Of T1, T2)(ByVal subject As javax.security.auth.Subject, ByVal callbackHandler As CallbackHandler, ByVal sharedState As IDictionary(Of T1), ByVal options As IDictionary(Of T2))
		...
		''' <p>
		''' </summary>
		''' <exception cref="LoginException"> if the authentication fails
		''' </exception>
		''' <returns> true if the authentication succeeded, or false if this
		'''                  {@code LoginModule} should be ignored. </returns>
		...
		''' <p>
		''' </summary>
		''' <exception cref="LoginException"> if the commit fails
		''' </exception>
		...
		''' <p>
		''' </summary>
		''' <exception cref="LoginException"> if the abort fails
		''' </exception>
		''' <returns> true if this method succeeded, or false if this
		'''                  {@code LoginModule} should be ignored. </returns>
		Function abort() As Boolean
		...
		''' <p>
		''' </summary>
		''' <exception cref="LoginException"> if the logout fails
		''' </exception>
		''' <returns> true if this method succeeded, or false if this
		'''                  {@code LoginModule} should be ignored. </returns>
