...
Namespace javax.security.auth
	...
	''' 
	''' </summary>
	Public NotInheritable Class AuthPermission
		Inherits java.security.BasicPermission

		Private Const serialVersionUID As Long = 5806031445061587174L
		...
		''' <p>
		''' </summary>
		''' <param name="name"> the name of the AuthPermission
		''' </param>
		...
		Public Sub New(ByVal name As String)
			...
			MyBase.New(If("createLoginContext".Equals(name), "createLoginContext.*", name))
		End Sub
		...
		''' <p>
		''' </summary>
		''' <param name="name"> the name of the AuthPermission <p>
		''' </param>
		...
		Public Sub New(ByVal name As String, ByVal actions As String)
			' for backwards compatibility --
			' createLoginContext is deprecated in favor of createLoginContext.*
			MyBase.New(If("createLoginContext".Equals(name), "createLoginContext.*", name), actions)
		End Sub
	End Class
