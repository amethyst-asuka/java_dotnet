...
Namespace javax.security.auth.callback
	...
	Public Interface CallbackHandler
		...
		''' }</pre>
		''' </summary>
		''' <param name="callbacks"> an array of {@code Callback} objects provided
		'''          by an underlying security service which contains
		'''          the information requested to be retrieved or displayed.
		''' </param>
		''' <exception cref="java.io.IOException"> if an input or output error occurs. <p>
		''' </exception>
		''' <exception cref="UnsupportedCallbackException"> if the implementation of this
		'''          method does not support one or more of the Callbacks
		'''          specified in the {@code callbacks} parameter. </exception>
		Sub handle(ByVal callbacks As Callback())
	End Interface
