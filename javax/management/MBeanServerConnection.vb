...
Namespace javax.management
	...
	''' local or remote.  The <seealso cref="MBeanServer"/> interface, representing a
	...
	Public Interface MBeanServerConnection
		...
		''' <exception cref="RuntimeMBeanException"> If the MBean's constructor or its
		...
		''' <exception cref="IOException"> A communication problem occurred when
		''' talking to the MBean server. </exception>
		...
		''' <seealso cref="javax.management.MBeanRegistration MBeanRegistration"/>
		...
		''' interface) method of the MBean has thrown an exception. The
		''' MBean will not be registered. </exception>
		''' <exception cref="RuntimeMBeanException"> The MBean's constructor or its
		''' {@code preRegister} or {@code postRegister} method threw
		''' a {@code RuntimeException}. If the <CODE>postRegister</CODE>
		''' (<CODE>MBeanRegistration</CODE> interface) method of the MBean throws a
		''' <CODE>RuntimeException</CODE>, the <CODE>createMBean</CODE> method will
		...
		''' also be thrown by <CODE>preRegister</CODE>, in which case the MBean
		''' will not be registered. </exception>
		''' <exception cref="RuntimeErrorException"> If the <CODE>postRegister</CODE> method
		''' (<CODE>MBeanRegistration</CODE> interface) method of the MBean throws an
		''' <CODE>Error</CODE>, the <CODE>createMBean</CODE> method will
		''' throw a <CODE>RuntimeErrorException</CODE>, although the MBean creation
		''' and registration succeeded. In such a case, the MBean will be actually
		...
		''' name.
		''' </summary>
		''' <param name="name"> The object name of the MBean to be unregistered.
		''' </param>
		...
		''' <exception cref="RuntimeMBeanException"> If the <CODE>postDeregister</CODE>
		''' (<CODE>MBeanRegistration</CODE> interface) method of the MBean throws a
		...
		''' will remain registered. </exception>
		''' <exception cref="RuntimeErrorException"> If the <CODE>postDeregister</CODE>
		''' (<CODE>MBeanRegistration</CODE> interface) method of the MBean throws an
		...
		''' </summary>
		''' <param name="name"> The object name of the MBean to be checked.
		''' </param>
		...
		''' retrieved, call <seealso cref="#getAttribute getAttribute"/> for that attribute.</p>
		''' 
		...
		''' --><seealso cref="java.util.Arrays#asList Arrays.asList"/>(attrNames));
		...
		''' it will usually be possible to call <seealso cref="#setAttribute setAttribute"/>
		...
		''' through an {@link JMX#newMBeanProxy(MBeanServerConnection, ObjectName,
		...
		''' the operation is invoked </param>
		''' <param name="signature"> An array containing the signature of the
		''' operation, an array of class names in the format returned by
		''' <seealso cref="Class#getName()"/>. The class objects will be loaded using the same
		...
		''' <seealso cref="ObjectName#getDomain() getDomain()"/> is equal to that
		...
		''' talking to the MBean server.
		''' </exception>
		''' <seealso cref= #removeNotificationListener(ObjectName, NotificationListener) </seealso>
		''' <seealso cref= #removeNotificationListener(ObjectName, NotificationListener,
		...
		''' NotificationListener} interface. </exception>
		''' <exception cref="IOException"> A communication problem occurred when
		''' talking to the MBean server.
		''' </exception>
		''' <seealso cref= #removeNotificationListener(ObjectName, ObjectName) </seealso>
		...
		''' <param name="name"> The name of the MBean on which the listener should
		''' be removed. </param>
		''' <param name="listener"> The object name of the listener to be removed.
		''' </param>
		''' <exception cref="InstanceNotFoundException"> The MBean name provided
		''' does not match any of the registered MBeans. </exception>
		...
		''' talking to the MBean server.
		''' </exception>
		''' <seealso cref= #addNotificationListener(ObjectName, ObjectName,
		''' NotificationFilter, Object) </seealso>
		...
		''' talking to the MBean server.
		''' </exception>
		''' <seealso cref= #addNotificationListener(ObjectName, NotificationListener,
		''' NotificationFilter, Object) </seealso>
		...
		''' </summary>
		''' <param name="name"> The name of the MBean to analyze
		''' </param>
		...
		''' throws <seealso cref="InstanceNotFoundException"/>.</p>
		''' 
		''' <p>Otherwise, let<br>
		''' X be the MBean named by <code>name</code>,<br>
		''' L be the ClassLoader of X,<br>
		''' N be the class name in X's <seealso cref="MBeanInfo"/>.</p>
		''' 
		...
		''' <param name="className"> The name of the class.
		''' </param>
		...
		''' talking to the MBean server.
		''' </exception>
		''' <seealso cref= Class#isInstance </seealso>
