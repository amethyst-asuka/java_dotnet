...
Namespace javax.management.openmbean
	...
	''' of the <seealso cref="javax.management.Descriptor Descriptor"/> for an attribute or
	...
	Public Interface CompositeDataView
		...
		''' <seealso cref="CompositeDataSupport"/>, or a class that serializes as a
		...
		''' </summary>
		''' <param name="ct"> The expected {@code CompositeType} of the returned
		...
		''' <seealso cref="CompositeDataSupport"/> constructed with {@code ct} as its
		''' {@code CompositeType}.
		''' </param>
		''' <returns> the {@code CompositeData}. </returns>
		Function toCompositeData(ByVal ct As CompositeType) As CompositeData
	End Interface
