...
Namespace javax.management
	...
	''' to a field in a <seealso cref="Descriptor"/>.  This can be the Descriptor for
	...
	''' <seealso cref="MBeanAttributeInfo"/> for this attribute will have a
	...
	'''     <td>Class name from <seealso cref="Class#getName()"/>
	'''         (e.g. {@code "java.lang.Thread"})</td></tr>
	''' <tr><td>Enum constant (e.g. <seealso cref="ElementType#FIELD"/>)</td>
	'''     <td>Constant name from <seealso cref="Enum#name()"/>
