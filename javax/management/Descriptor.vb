...
Namespace javax.management
	...
	''' is associated with a <seealso cref="MBeanInfo"/>, <seealso cref="MBeanAttributeInfo"/>, etc.
	...
	''' in the result of the <seealso cref="#getFields"/> and <seealso cref="#getFieldNames"/>
	''' methods.</p>
	''' 
	...
	''' instances of <seealso cref="ImmutableDescriptor"/> or a subclass.  Mutable
	''' descriptors are usually instances of
	''' <seealso cref="javax.management.modelmbean.DescriptorSupport"/> or a subclass.
	''' 
	...
	''' below, and each one has a corresponding constant in the <seealso cref="JMX"/>
	''' class.  For example, the field {@code defaultValue} is represented
	''' by the constant <seealso cref="JMX#DEFAULT_VALUE_FIELD"/>.</p>
	''' 
	...
	''' <seealso cref="javax.management.openmbean"/>.</td>
	''' 
	...
	''' 
	''' <td>The base name for the <seealso cref="ResourceBundle"/> in which the key given in
	...
	''' its <seealso cref="MBeanNotificationInfo"/> array.</td></tr>
	''' 
	...
	''' returned by <seealso cref="Class#getName()"/>.  A Standard MBean or MXBean
	...
	''' <td>String</td><td>Any</td>
	''' 
	''' <td>The <seealso cref="Locale locale"/> of the description in this
	''' {@code MBeanInfo}, {@code MBeanAttributeInfo}, etc, as returned
	''' by <seealso cref="Locale#toString()"/>.</td>
	''' 
	...
	''' 
	''' <td>The string {@code "true"} or {@code "false"} according as this
	''' MBean is an <seealso cref="MXBean"/>.  A Standard MBean or MXBean registered
	''' directly with the MBean Server or created using the {@link
	''' StandardMBean} class will have this field in its MBeanInfo
	''' Descriptor.</td>
	''' 
	''' <tr id="openType"><td><i>openType</i><td><seealso cref="OpenType"/></td>
	...
	''' <seealso cref="MXBean"/> interface method that produced this {@code
	''' MBeanAttributeInfo} (etc).  For example, a method<br> <code>public
	''' </code> <seealso cref="MemoryUsage"/><code> getHeapMemoryUsage();</code><br>
	''' in an MXBean interface defines an attribute called {@code
	''' HeapMemoryUsage} of type <seealso cref="CompositeData"/>.  The {@code
	...
	Public Interface Descriptor
		Inherits java.io.Serializable, ICloneable

		''' <summary>
		''' Returns the value for a specific field name, or null if no value
		''' is present for that name.
		''' </summary>
		''' <param name="fieldName"> the field name.
		''' </param>
		''' <returns> the corresponding value, or null if the field is not present.
		''' </returns>
		''' <exception cref="RuntimeOperationsException"> if the field name is illegal. </exception>
		Function getFieldValue(ByVal fieldName As String) As Object
		...
		''' implementation.</p>
		''' </summary>
		''' <param name="fieldName"> The field name to be set. Cannot be null or empty. </param>
		''' <param name="fieldValue"> The field value to be set for the field
		''' name. Can be null if that is a valid value for the field.
		''' </param>
		''' <exception cref="RuntimeOperationsException"> if the field name or field value
		''' is illegal (wrapped exception is <seealso cref="IllegalArgumentException"/>); or
		''' if the descriptor is immutable (wrapped exception is
		''' <seealso cref="UnsupportedOperationException"/>). </exception>
		Sub setField(ByVal fieldName As String, ByVal fieldValue As Object)


		''' <summary>
		''' Returns all of the fields contained in this descriptor as a string array.
		''' </summary>
		''' <returns> String array of fields in the format <i>fieldName=fieldValue</i>
		...
		''' an empty array.
		''' </returns>
		''' <seealso cref= #setFields </seealso>
		...
		''' you will get an empty array. </returns>
		ReadOnly Property fieldNames As String()
		...
		''' </summary>
		''' <param name="fieldNames"> String array of the names of the fields that
		...
		''' returned by <seealso cref="#getFieldNames()"/>.  If a field name in the
		...
		''' </param>
		''' <returns> Object array of field values. If the list of {@code fieldNames}
		''' is empty, you will get an empty array. </returns>
		Function getFieldValues(ParamArray ByVal fieldNames As String()) As Object()
		...
		''' </summary>
		''' <param name="fieldNames"> String array of field names. The array and array
		''' elements cannot be null. </param>
		''' <param name="fieldValues"> Object array of the corresponding field values.
		''' The array cannot be null. Elements of the array can be null.
		''' </param>
		''' <exception cref="RuntimeOperationsException"> if the change fails for any reason.
		''' Wrapped exception is <seealso cref="IllegalArgumentException"/> if
		...
		''' Wrapped exception is <seealso cref="UnsupportedOperationException"/>
		''' if the descriptor is immutable, and the call would change
		''' its contents.
		''' </exception>
		''' <seealso cref= #getFields </seealso>
		Sub setFields(ByVal fieldNames As String(), ByVal fieldValues As Object())
		...
		''' it may fulfill this condition by returning itself.</p> </summary>
		''' <exception cref="RuntimeOperationsException"> for illegal value for field names
		''' or field values.
		''' If the descriptor construction fails for any reason, this exception will
		''' be thrown. </exception>
		''' <returns> A descriptor which is equal to this descriptor. </returns>
		...
		''' </returns>
		''' <exception cref="RuntimeOperationsException"> If the validity checking fails for
