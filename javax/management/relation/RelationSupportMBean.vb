...
Namespace javax.management.relation
	...
	Public Interface RelationSupportMBean
		...
		''' </summary>
		''' <returns> a Boolean equal to <seealso cref="Boolean#TRUE"/> if the object
		''' is still handled by the Relation Service and {@link
		''' Boolean#FALSE} otherwise. </returns>
		ReadOnly Property inRelationService As Boolean?
		...
		''' </summary>
		''' <param name="flag"> whether the relation is handled by the Relation Service.
		''' </param>
		''' <exception cref="IllegalArgumentException">  if null parameter </exception>
		WriteOnly Property relationServiceManagementFlag As Boolean?
	End Interface
