...
Namespace javax.management
	...
	'''      by <seealso cref="javax.management.openmbean"/>.  In this way, you can be
	...
	'''      <code>Usage</code> of type <seealso cref="MemoryUsage"/>.  The point of an
	...
	'''      <seealso cref="MBeanServer#getAttribute getAttribute"/> calls, then we could
	...
	'''      <seealso cref="javax.management.openmbean.CompositeData CompositeData"/> and
	'''      <seealso cref="javax.management.openmbean.TabularData TabularData"/> classes
	'''      from the standard <seealso cref="javax.management.openmbean"/> package, it
	...
	'''    mbeanServer.{@link MBeanServer#getAttribute
	'''    getAttribute}(objectName, "Name");
	''' <b><seealso cref="CompositeData"/></b> usage = (<b>CompositeData</b>)
	'''    mbeanServer.getAttribute(objectName, "Usage");
	''' <b>long used = (Long) usage.<seealso cref="CompositeData#get get"/>("used");</b>
	'''          </pre></td>
	'''    </table>
	''' 
	...
	'''      argument to <seealso cref="StandardMBean"/> and the resultant MBean
	...
	'''      <seealso cref="MBeanServer"/> interface, the object's class is examined
	'''      to determine what type of MBean it is:</p>
	''' 
	'''    <ul>
	'''      <li>If the class implements the interface <seealso cref="DynamicMBean"/>
	...
	'''      standard subclasses of <seealso cref="javax.management.openmbean.OpenType"/>.
	...
	'''        List<String>}<em>)</em>, is <seealso cref="ArrayType"/><code>(1, </code>{@link
	...
	'''          using <seealso cref="Arrays#asList Arrays.asList"/>.</li>
	'''    </ul>
	''' 
	...
	'''            (the types covered by <seealso cref="SimpleType"/>)</td>
	...
	'''          <td><seealso cref="TabularType"/><br>
	'''            (see below)</td>
	'''          <td><seealso cref="TabularData"/><br>
	'''            (see below)</td>
	'''        </tr>
	'''        <tr>
	...
	'''            (see below)</td>
	'''          <td><seealso cref="ObjectName"/><br>
	'''            (see below)</td>
	'''        </tr>
	'''        <tr>
	'''          <td>Any other type</td>
	'''          <td><seealso cref="CompositeType"/>,
	'''            if possible<br>
	'''            (see below)</td>
	'''          <td><seealso cref="CompositeData"/></td>
	'''      </tbody>
	'''    </table>
	''' 
	...
	'''      Map<String,ObjectName>}, has Open Type <seealso cref="TabularType"/> and is mapped
	'''        to a <seealso cref="TabularData"/>.
	...
	'''      Open Data is <seealso cref="TabularDataSupport"/>,
	...
	'''      is <seealso cref="MBeanServerInvocationHandler"/> or a subclass.</p>
	''' 
	...
	'''      result is an <seealso cref="InstanceAlreadyExistsException"/>.  Registering
	...
	'''      <seealso cref="NotificationBroadcaster"/>s.</p>
	''' 
	...
	'''      it to a <seealso cref="CompositeType"/> as follows.  The type name of this
	...
	'''      implements the interface <seealso cref="CompositeDataView"/>, then that
	...
	'''        using a <seealso cref="java.lang.reflect.Proxy"/> with a {@link
	...
	'''      reasons, its <seealso cref="MBeanInfo"/> is not an <seealso cref="OpenMBeanInfo"/>.
	...
	'''      <seealso cref="MBeanAttributeInfo"/>, <seealso cref="MBeanParameterInfo"/>, or
	'''      <seealso cref="MBeanOperationInfo"/> whose {@code getType()} or {@code
	...
	'''      <seealso cref="StandardMBean"/> class is derived in the same way as for
	...
	'''      not implement the <seealso cref="NotificationBroadcaster"/> interface.
	...
	'''    returned by <seealso cref="Class#getName()"/>.  Otherwise it is the value of
	...
	'''      Open types is signaled with an <seealso cref="OpenDataException"/>.  This
	...
	'''      Open types is signaled with an <seealso cref="InvalidObjectException"/>.
	...
	'''      exception such as <seealso cref="RuntimeMBeanException"/> or {@link
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	...
	Public Class MXBean
		...
		''' <summary>
		'''   True if the annotated interface is an MXBean interface. </summary>
		'''   <returns> true if the annotated interface is an MXBean interface. </returns>
