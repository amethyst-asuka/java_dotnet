...
Namespace javax.management.modelmbean
	...
	Public Interface ModelMBeanInfo
		...
		''' </summary>
		''' <param name="inDescriptorType"> value of descriptorType field that must be set for the descriptor
		...
		''' <exception cref="RuntimeOperationsException"> Wraps an IllegalArgumentException when the descriptorType in parameter is
		''' not one of: "mbean", "attribute", "operation", "constructor", "notification", empty or null.
		''' </exception>
		''' <seealso cref= #setDescriptors </seealso>
		Function getDescriptors(ByVal inDescriptorType As String) As javax.management.Descriptor()

		''' <summary>
		''' Adds or replaces descriptors in the ModelMBeanInfo.
		''' </summary>
		''' <param name="inDescriptors"> The descriptors to be set in the ModelMBeanInfo. Null
		''' elements of the list will be ignored.  All descriptors must have name and descriptorType fields.
		''' </param>
		''' <exception cref="RuntimeOperationsException"> Wraps an IllegalArgumentException for a null or invalid descriptor. </exception>
		''' <exception cref="MBeanException"> Wraps a distributed communication Exception.
		''' </exception>
		''' <seealso cref= #getDescriptors </seealso>
		WriteOnly Property descriptors As javax.management.Descriptor()

		''' <summary>
		''' Returns a Descriptor requested by name and descriptorType.
		''' </summary>
		''' <param name="inDescriptorName"> The name of the descriptor. </param>
		''' <param name="inDescriptorType"> The type of the descriptor being
		...
		''' </returns>
		''' <exception cref="MBeanException"> Wraps a distributed communication Exception. </exception>
		''' <exception cref="RuntimeOperationsException"> Wraps an IllegalArgumentException for a null descriptor name or null or invalid type.
		''' The type must be "mbean","attribute", "constructor", "operation", or "notification".
		''' </exception>
		''' <seealso cref= #setDescriptor </seealso>

		Function getDescriptor(ByVal inDescriptorName As String, ByVal inDescriptorType As String) As javax.management.Descriptor
		...
		''' </summary>
		''' <param name="inDescriptor"> The descriptor to be set in the
		''' ModelMBean. It must NOT be null.  All descriptors must have
		''' name and descriptorType fields. </param>
		''' <param name="inDescriptorType"> The type of the descriptor being
		...
		''' MBeanNotificationInfo or MBeanOperationInfo. </exception>
		''' <exception cref="MBeanException"> Wraps a distributed communication
		''' Exception.
		''' </exception>
		''' <seealso cref= #getDescriptor </seealso>

		Sub setDescriptor(ByVal inDescriptor As javax.management.Descriptor, ByVal inDescriptorType As String)
		...
		''' Exception.
		''' </exception>
		''' <exception cref="RuntimeOperationsException"> a {@link
		''' RuntimeException} occurred while getting the descriptor.
		''' </exception>
		''' <seealso cref= #setMBeanDescriptor </seealso>
		Property mBeanDescriptor As javax.management.Descriptor
		...
		''' </summary>
		''' <param name="inName"> The name of the ModelMBeanAttributeInfo to get.
		...
		Function getAttribute(ByVal inName As String) As ModelMBeanAttributeInfo


		''' <summary>
		''' Returns a ModelMBeanOperationInfo requested by name.
		''' </summary>
		''' <param name="inName"> The name of the ModelMBeanOperationInfo to get.
		...
		''' </returns>
		''' <exception cref="MBeanException"> Wraps a distributed communication Exception. </exception>
		''' <exception cref="RuntimeOperationsException"> Wraps an IllegalArgumentException for a null operation name.
		'''  </exception>

		Function getOperation(ByVal inName As String) As ModelMBeanOperationInfo


		''' <summary>
		''' Returns a ModelMBeanNotificationInfo requested by name.
		''' </summary>
		''' <param name="inName"> The name of the ModelMBeanNotificationInfo to get.
		...
		''' </returns>
		''' <exception cref="MBeanException"> Wraps a distributed communication Exception. </exception>
		''' <exception cref="RuntimeOperationsException"> Wraps an IllegalArgumentException for a null notification name.
		'''  </exception>
		Function getNotification(ByVal inName As String) As ModelMBeanNotificationInfo
