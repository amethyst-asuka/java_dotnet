...
Namespace javax.lang.model.util
	...
	''' </param>
	''' <seealso cref= SimpleElementVisitor6 </seealso>
	''' <seealso cref= SimpleElementVisitor7
	''' @since 1.8 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	Public Class SimpleElementVisitor8(Of R, P)
		Inherits SimpleElementVisitor7(Of R, P)
