...
Namespace javax.lang.model.util
	...
	''' </param>
	''' <seealso cref= ElementKindVisitor6 </seealso>
	''' <seealso cref= ElementKindVisitor8
	''' @since 1.7 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	Public Class ElementKindVisitor7(Of R, P)
		Inherits ElementKindVisitor6(Of R, P)
		...
		Public Overrides Function visitVariableAsResourceVariable(ByVal e As VariableElement, ByVal p As P) As R
