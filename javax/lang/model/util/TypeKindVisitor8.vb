...
Namespace javax.lang.model.util
	...
	''' <seealso cref= TypeKindVisitor7
	''' @since 1.8 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	Public Class TypeKindVisitor8(Of R, P)
		Inherits TypeKindVisitor7(Of R, P)
		...
		Public Overrides Function visitIntersection(ByVal t As IntersectionType, ByVal p As P) As R
