...
Namespace javax.lang.model.util
	...
	''' <seealso cref="SourceVersion#RELEASE_7 RELEASE_7"/> source version.
	''' 
	''' Visit methods corresponding to {@code RELEASE_8} and earlier
	''' language constructs call <seealso cref="#defaultAction defaultAction"/>,
	...
	''' </param>
	''' <seealso cref= SimpleTypeVisitor6 </seealso>
	''' <seealso cref= SimpleTypeVisitor7
	''' @since 1.8 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	Public Class SimpleTypeVisitor8(Of R, P)
		Inherits SimpleTypeVisitor7(Of R, P)
		...
		Public Overrides Function visitIntersection(ByVal t As javax.lang.model.type.IntersectionType, ByVal p As P) As R
