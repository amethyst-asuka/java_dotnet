...
Namespace javax.lang.model.util
	...
	''' </param>
	''' <seealso cref= SimpleAnnotationValueVisitor6 </seealso>
	''' <seealso cref= SimpleAnnotationValueVisitor7
	''' @since 1.8 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	Public Class SimpleAnnotationValueVisitor8(Of R, P)
		Inherits SimpleAnnotationValueVisitor7(Of R, P)
