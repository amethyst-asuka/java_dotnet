...
Namespace javax.lang.model.util
	...
	''' the <seealso cref="javax.lang.model.SourceVersion#RELEASE_7 RELEASE_7"/>
	''' source version.
	''' 
	...
	''' @since 1.7 </seealso>
	Public MustInherit Class AbstractTypeVisitor7(Of R, P)
		...
		Public MustOverride Function visitUnion(ByVal t As UnionType, ByVal p As P) As R
	End Class
