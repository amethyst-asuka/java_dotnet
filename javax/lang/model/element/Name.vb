...
Namespace javax.lang.model.element
    ...
    ''' general <seealso cref="Object#equals equals contract"/> when compared
    ...
    ''' include contexts where the {@link javax.annotation.processing
    ...
    ''' <seealso cref="javax.annotation.processing.RoundEnvironment rounds"/>.
    ''' 
    ''' @author Joseph D. Darcy
    ''' @author Scott Seligman
    ''' @author Peter von der Ah&eacute; </summary>
    ''' <seealso cref= javax.lang.model.util.Elements#getName
    ''' @since 1.6 </seealso>
    Public Interface Name
        Inherits CharSequence
        ...
        '''          name as this </returns>
        ''' <seealso cref= Element#equals </seealso>
        ...
        ''' </summary>
        ''' <returns> {@code true} if this name represents the same sequence
        ''' of {@code char} values as the specified sequence, {@code false}
        ''' otherwise
        ''' </returns>
        ''' <param name="cs"> The sequence to compare this name against </param>
        ''' <seealso cref= String#contentEquals(CharSequence) </seealso>
        Function contentEquals(ByVal cs As CharSequence) As Boolean
    End Interface
