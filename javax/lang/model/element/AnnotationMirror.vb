...
Namespace javax.lang.model.element
	...
	Public Interface AnnotationMirror
		...
		ReadOnly Property annotationType As javax.lang.model.type.DeclaredType
		...
		''' </summary>
		''' <returns> the values of this annotation's elements,
		'''          or an empty map if there are none </returns>
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		ReadOnly Property elementValues As IDictionary(Of ? As ExecutableElement, ? As AnnotationValue)
	End Interface
