...
Namespace javax.lang.model.type
    ...
    ''' @since 1.6 </seealso>
    Public Class MirroredTypesException(Of T1 As TypeMirror)
        Inherits Exception

        Private Const serialVersionUID As Long = 269

        <NonSerialized>
        Friend types As IList(Of TypeMirror) ' cannot be serialized
        ...
        Public Sub New(ByVal types As IList(Of T1))
        ...
        Public Overridable ReadOnly Property typeMirrors As IList(Of TypeMirror)
            Get
                Return types
            End Get
        End Property
