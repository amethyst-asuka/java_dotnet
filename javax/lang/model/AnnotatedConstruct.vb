...
Namespace javax.lang.model
    ...
    Public Interface AnnotatedConstruct
        ...
        ''' this construct.
        ''' </summary>
        ''' <returns> the annotations <em>directly present</em> on this
        ''' construct; an empty list if there are none </returns>
        ...
        ''' will result in a <seealso cref="MirroredTypeException"/>,
        ''' from which the corresponding <seealso cref="TypeMirror"/> may be extracted.
        ''' Similarly, attempting to read a {@code Class[]}-valued element
        ''' will result in a <seealso cref="MirroredTypesException"/>.
        ''' 
        ''' <blockquote>
        ...
        ''' </blockquote>
        ''' </summary>
        ''' @param <A>  the annotation type </param>
        ''' <param name="annotationType">  the {@code Class} object corresponding to
        '''          the annotation type </param>
        ''' <returns> this construct's annotation for the specified
        ''' annotation type if present, else {@code null}
        ''' </returns>
        ''' <seealso cref= #getAnnotationMirrors() </seealso>
        ''' <seealso cref= java.lang.reflect.AnnotatedElement#getAnnotation </seealso>
        ''' <seealso cref= EnumConstantNotPresentException </seealso>
        ''' <seealso cref= AnnotationTypeMismatchException </seealso>
        ''' <seealso cref= IncompleteAnnotationException </seealso>
        ''' <seealso cref= MirroredTypeException </seealso>
        ''' <seealso cref= MirroredTypesException
        ''' @jls 9.6.1 Annotation Type Elements </seealso>
        ...
        ''' </returns>
        ''' <seealso cref= #getAnnotationMirrors() </seealso>
        ''' <seealso cref= #getAnnotation(Class) </seealso>
        ''' <seealso cref= java.lang.reflect.AnnotatedElement#getAnnotationsByType(Class) </seealso>
        ''' <seealso cref= EnumConstantNotPresentException </seealso>
        ''' <seealso cref= AnnotationTypeMismatchException </seealso>
        ''' <seealso cref= IncompleteAnnotationException </seealso>
        ''' <seealso cref= MirroredTypeException </seealso>
        ...
        ''' @jls 9.6 Annotation Types
        ''' @jls 9.6.1 Annotation Type Elements </seealso>
        Function getAnnotationsByType(Of A As annotation)(ByVal annotationType As type) As A()
    End Interface
