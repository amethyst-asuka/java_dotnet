...
Namespace javax.naming
	...
	''' </summary>
	''' <seealso cref= Context#list </seealso>
	''' <seealso cref= Context#listBindings </seealso>
	''' <seealso cref= javax.naming.directory.DirContext#search </seealso>
	''' <seealso cref= javax.naming.directory.Attributes#getAll </seealso>
	''' <seealso cref= javax.naming.directory.Attributes#getIDs </seealso>
	''' <seealso cref= javax.naming.directory.Attribute#getAll
	''' @since 1.3 </seealso>
	Public Interface NamingEnumeration(Of T)
		Inherits System.Collections.IEnumerator(Of T)
		...
		'''     attribute values, and an attribute value can be null). </returns>
		''' <exception cref="NamingException"> If a naming exception is encountered while attempting
		'''                 to retrieve the next element. See NamingException
		'''                 and its subclasses for the possible naming exceptions. </exception>
		''' <exception cref="java.util.NoSuchElementException"> If attempting to get the next element when none is available. </exception>
		...
		''' by the application.
		''' </summary>
		''' <returns>         true if there is more in the enumeration ; false otherwise. </returns>
