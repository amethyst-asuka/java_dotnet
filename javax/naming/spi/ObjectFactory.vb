...
Namespace javax.naming.spi
	...
	''' <seealso cref= NamingManager#getObjectInstance </seealso>
	''' <seealso cref= NamingManager#getURLContext </seealso>
		Function getObjectInstance(Of T1)(ByVal obj As Object, ByVal name As Name, ByVal nameCtx As Context, ByVal environment As Dictionary(Of T1)) As Object
	End Interface
