...
Namespace javax.naming.spi
	...
	''' </summary>
	''' <seealso cref= NamingManager#getStateToBind </seealso>
	...
	'''              null if the factory is not returning any changes. </returns>
	...
	''' <seealso cref= NamingManager#getStateToBind </seealso>
	''' <seealso cref= DirectoryManager#getStateToBind </seealso>
		Function getStateToBind(Of T1)(ByVal obj As Object, ByVal name As Name, ByVal nameCtx As Context, ByVal environment As Dictionary(Of T1)) As Object
	End Interface
