...
Namespace javax.naming.spi
	...
	''' <seealso cref= DirObjectFactory
	''' @since 1.3 </seealso>
	Public Interface DirStateFactory
		Inherits StateFactory
	...
	''' <seealso cref="ObjectFactory#getObjectInstance ObjectFactory.getObjectInstance()"/>
	''' for details.
	...
	''' </summary>
	''' <param name="obj"> A possibly null object whose state is to be retrieved. </param>
	...
	'''              be used in the creation of the object's state. </param>
	''' <param name="inAttrs"> The possibly null attributes to be bound with the object.
	'''      The factory must not modify <tt>inAttrs</tt>. </param>
	''' <returns> A <tt>Result</tt> containing the object's state for binding
	''' and the corresponding
	''' attributes to be bound; null if the object don't use this factory. </returns>
	''' <exception cref="NamingException"> If this factory encountered an exception
