...
Namespace javax.naming.spi
	...
	''' </summary>
	''' <seealso cref= NamingManager#getObjectInstance </seealso>
	''' <seealso cref= DirectoryManager#getObjectInstance </seealso>
	''' <seealso cref= ObjectFactory
	''' @since 1.3 </seealso>
	...
	''' </summary>
	''' <param name="obj"> The possibly null object containing location or reference
	'''              information that can be used in creating an object. </param>
	...
	''' <param name="environment"> The possibly null environment that is used in
	'''              creating the object. </param>
	''' <param name="attrs"> The possibly null attributes containing some of <tt>obj</tt>'s
	...
	'''      The factory must not modify attrs. </param>
	''' <returns> The object created; null if an object cannot be created. </returns>
	''' <exception cref="Exception"> If this object factory encountered an exception
	''' while attempting to create an object, and no other object factories are
	''' to be tried.
	''' </exception>
	''' <seealso cref= DirectoryManager#getObjectInstance </seealso>
	''' <seealso cref= NamingManager#getURLContext </seealso>
		Function getObjectInstance(Of T1)(ByVal obj As Object, ByVal name As Name, ByVal nameCtx As Context, ByVal environment As Dictionary(Of T1), ByVal attrs As javax.naming.directory.Attributes) As Object
	End Interface
