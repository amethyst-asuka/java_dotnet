...
Namespace javax.naming.spi
	 ...
	 ''' <seealso cref= NamingManager#setObjectFactoryBuilder
	 ''' @since 1.3 </seealso>
	Public Interface ObjectFactoryBuilder
		...
		''' <param name="environment"> Environment to use when creating the factory.
		'''                 Can be null. </param>
		''' <returns> A non-null new instance of an ObjectFactory. </returns>
		''' <exception cref="NamingException"> If an object factory cannot be created.
		'''   </exception>
		Function createObjectFactory(Of T1)(ByVal obj As Object, ByVal environment As Dictionary(Of T1)) As ObjectFactory
	End Interface
