...
Namespace javax.naming.directory
	...
	Public Interface Attribute
		...
		''' is returned. </returns>
		''' <exception cref="NamingException">
		'''         If a naming exception was encountered while retrieving
		'''         the values. </exception>
		''' <seealso cref= #isOrdered </seealso>
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		ReadOnly Property all As javax.naming.NamingEnumeration(Of ?)
		...
		'''         If this attribute has no values. </exception>
		Function [get]() As Object

		''' <summary>
		''' Retrieves the number of values in this attribute.
		''' </summary>
		''' <returns> The nonnegative number of values in this attribute. </returns>
		Function size() As Integer

		''' <summary>
		''' Retrieves the id of this attribute.
		''' </summary>
		''' <returns> The id of this attribute. It cannot be null. </returns>
		...
		''' </summary>
		''' <param name="attrVal"> The possibly null value to check. If null, check
		'''  whether the attribute has an attribute value whose value is null. </param>
		''' <returns> true if attrVal is one of this attribute's values; false otherwise. </returns>
		''' <seealso cref= java.lang.Object#equals </seealso>
		''' <seealso cref= BasicAttribute#equals </seealso>
		Function contains(ByVal attrVal As Object) As Boolean
		''' <summary>
		...
		''' <tt>Object.equals()</tt> or schema information to determine equality.
		''' </summary>
		''' <param name="attrVal"> The new possibly null value to add. If null, null
		'''  is added as an attribute value. </param>
		''' <returns> true if a value was added; false otherwise. </returns>
		Function add(ByVal attrVal As Object) As Boolean
		...
		''' <tt>Object.equals()</tt> or schema information to determine equality.
		''' </summary>
		''' <param name="attrval"> The possibly null value to remove from this attribute.
		''' If null, remove the attribute value that is null. </param>
		''' <returns> true if the value was removed; false otherwise. </returns>
		Function remove(ByVal attrval As Object) As Boolean
		...
		'''    any schema information. </returns>
		''' <exception cref="OperationNotSupportedException"> If getting the schema
		'''         is not supported. </exception>
		''' <exception cref="NamingException"> If a naming exception occurs while getting
		'''         the schema. </exception>

		ReadOnly Property attributeSyntaxDefinition As DirContext
		...
		''' <exception cref="NamingException"> If a naming exception occurs while getting
		'''         the schema. </exception>
		ReadOnly Property attributeDefinition As DirContext
		...
		''' </summary>
		''' <returns> A non-null copy of the attribute. </returns>
		...
		''' in any order and there are no duplicate values. </summary>
		''' <returns> true if this attribute's values are ordered; false otherwise. </returns>
		''' <seealso cref= #get(int) </seealso>
		''' <seealso cref= #remove(int) </seealso>
		''' <seealso cref= #add(int, java.lang.Object) </seealso>
		''' <seealso cref= #set(int, java.lang.Object) </seealso>
		ReadOnly Property ordered As Boolean
		...
		''' this method returns the value that happens to be at that index. </summary>
		''' <param name="ix"> The index of the value in the ordered list of attribute values.
		''' {@code 0 <= ix < size()}. </param>
		''' <returns> The possibly null attribute value at index <tt>ix</tt>;
		'''   null if the attribute value is null. </returns>
		''' <exception cref="NamingException"> If a naming exception was encountered while
		''' retrieving the value. </exception>
		''' <exception cref="IndexOutOfBoundsException"> If <tt>ix</tt> is outside the specified range. </exception>
		Function [get](ByVal ix As Integer) As Object
		...
		''' </summary>
		''' <param name="ix"> The index of the value to remove.
		''' {@code 0 <= ix < size()}. </param>
		''' <returns> The possibly null attribute value at index <tt>ix</tt> that was removed;
		'''   null if the attribute value is null. </returns>
		''' <exception cref="IndexOutOfBoundsException"> If <tt>ix</tt> is outside the specified range. </exception>
		Function remove(ByVal ix As Integer) As Object
		...
		''' </summary>
		''' <param name="ix"> The index in the ordered list of attribute values to add the new value.
		''' {@code 0 <= ix <= size()}. </param>
		''' <param name="attrVal"> The possibly null attribute value to add; if null, null is
		''' the value added. </param>
		''' <exception cref="IndexOutOfBoundsException"> If <tt>ix</tt> is outside the specified range. </exception>
		''' <exception cref="IllegalStateException"> If the attribute values are unordered and
		''' <tt>attrVal</tt> is one of those values. </exception>
		Sub add(ByVal ix As Integer, ByVal attrVal As Object)
		...
		''' <param name="ix"> The index of the value in the ordered list of attribute values.
		''' {@code 0 <= ix < size()}. </param>
		''' <param name="attrVal"> The possibly null attribute value to use.
		''' If null, 'null' replaces the old value. </param>
		''' <returns> The possibly null attribute value at index ix that was replaced.
		'''   Null if the attribute value was null. </returns>
		''' <exception cref="IndexOutOfBoundsException"> If <tt>ix</tt> is outside the specified range. </exception>
		''' <exception cref="IllegalStateException"> If <tt>attrVal</tt> already exists and the
		'''    attribute values are unordered. </exception>
		Function [set](ByVal ix As Integer, ByVal attrVal As Object) As Object
