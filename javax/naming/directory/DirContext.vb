...
Namespace javax.naming.directory
	...
	''' @author R. Vasudevan
	''' </summary>
	''' <seealso cref= javax.naming.Context
	''' @since 1.3 </seealso>
	...
	Public Interface DirContext
		...
		''' </summary>
		''' <param name="name">
		'''          the name of the object from which to retrieve attributes </param>
		''' <returns>  the set of attributes associated with <code>name</code>.
		...
		''' </exception>
		''' <seealso cref= #getAttributes(String) </seealso>
		''' <seealso cref= #getAttributes(Name, String[]) </seealso>
		Function getAttributes(ByVal name As Name) As Attributes

		''' <summary>
		''' Retrieves all of the attributes associated with a named object.
		''' See <seealso cref="#getAttributes(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the object from which to retrieve attributes </param>
		''' <returns>  the set of attributes associated with <code>name</code>
		...
		Function getAttributes(ByVal name As String) As Attributes
		...
		'''          an empty array indicates that none should be retrieved. </param>
		''' <returns>  the requested attributes; never null
		''' </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function getAttributes(ByVal name As Name, ByVal attrIds As String()) As Attributes

		''' <summary>
		''' Retrieves selected attributes associated with a named object.
		''' See <seealso cref="#getAttributes(Name, String[])"/> for details.
		''' </summary>
		''' <param name="name">
		'''          The name of the object from which to retrieve attributes </param>
		''' <param name="attrIds">
		...
		''' </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function getAttributes(ByVal name As String, ByVal attrIds As String()) As Attributes
		...
		''' </summary>
		''' <seealso cref= ModificationItem </seealso>
		''' <seealso cref= #modifyAttributes </seealso>
...
'		public final static int REMOVE_ATTRIBUTE = 3;
		...
		''' </summary>
		''' <param name="name">
		'''          the name of the object whose attributes will be updated </param>
		''' <param name="mod_op">
		'''          the modification operation, one of:
		'''                  <code>ADD_ATTRIBUTE</code>,
		'''                  <code>REPLACE_ATTRIBUTE</code>,
		'''                  <code>REMOVE_ATTRIBUTE</code>. </param>
		''' <param name="attrs">
		'''          the attributes to be used for the modification; may not be null
		''' </param>
		''' <exception cref="AttributeModificationException"> if the modification cannot
		'''          be completed successfully </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #modifyAttributes(Name, ModificationItem[]) </seealso>
		Sub modifyAttributes(ByVal name As Name, ByVal mod_op As Integer, ByVal attrs As Attributes)

		''' <summary>
		''' Modifies the attributes associated with a named object.
		''' See <seealso cref="#modifyAttributes(Name, int, Attributes)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the object whose attributes will be updated </param>
		''' <param name="mod_op">
		...
		'''          be completed successfully </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Sub modifyAttributes(ByVal name As String, ByVal mod_op As Integer, ByVal attrs As Attributes)
		...
		'''          may not be null
		''' </param>
		''' <exception cref="AttributeModificationException"> if the modifications
		'''          cannot be completed successfully </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #modifyAttributes(Name, int, Attributes) </seealso>
		''' <seealso cref= ModificationItem </seealso>
		Sub modifyAttributes(ByVal name As Name, ByVal mods As ModificationItem())

		''' <summary>
		''' Modifies the attributes associated with a named object using
		''' an ordered list of modifications.
		''' See <seealso cref="#modifyAttributes(Name, ModificationItem[])"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the object whose attributes will be updated </param>
		''' <param name="mods">
		...
		'''          cannot be completed successfully </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Sub modifyAttributes(ByVal name As String, ByVal mods As ModificationItem())
		...
		''' </summary>
		''' <param name="name">
		'''          the name to bind; may not be empty </param>
		''' <param name="obj">
		'''          the object to bind; possibly null </param>
		''' <param name="attrs">
		'''          the attributes to associate with the binding
		''' </param>
		''' <exception cref="NameAlreadyBoundException"> if name is already bound </exception>
		''' <exception cref="InvalidAttributesException"> if some "mandatory" attributes
		'''          of the binding are not supplied </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= Context#bind(Name, Object) </seealso>
		''' <seealso cref= #rebind(Name, Object, Attributes) </seealso>
		Sub bind(ByVal name As Name, ByVal obj As Object, ByVal attrs As Attributes)

		''' <summary>
		''' Binds a name to an object, along with associated attributes.
		''' See <seealso cref="#bind(Name, Object, Attributes)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name to bind; may not be empty </param>
		''' <param name="obj">
		...
		'''          of the binding are not supplied </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Sub bind(ByVal name As String, ByVal obj As Object, ByVal attrs As Attributes)
		...
		''' </exception>
		''' <seealso cref= Context#bind(Name, Object) </seealso>
		''' <seealso cref= #bind(Name, Object, Attributes) </seealso>
		Sub rebind(ByVal name As Name, ByVal obj As Object, ByVal attrs As Attributes)

		''' <summary>
		''' Binds a name to an object, along with associated attributes,
		''' overwriting any existing binding.
		''' See <seealso cref="#rebind(Name, Object, Attributes)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name to bind; may not be empty </param>
		''' <param name="obj">
		...
		'''          of the binding are not supplied </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Sub rebind(ByVal name As String, ByVal obj As Object, ByVal attrs As Attributes)
		...
		''' </summary>
		''' <param name="name">
		'''          the name of the context to create; may not be empty </param>
		''' <param name="attrs">
		'''          the attributes to associate with the newly created context </param>
		''' <returns>  the newly created context
		''' </returns>
		''' <exception cref="NameAlreadyBoundException"> if the name is already bound </exception>
		''' <exception cref="InvalidAttributesException"> if <code>attrs</code> does not
		'''          contain all the mandatory attributes required for creation </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= Context#createSubcontext(Name) </seealso>
		Function createSubcontext(ByVal name As Name, ByVal attrs As Attributes) As DirContext

		''' <summary>
		''' Creates and binds a new context, along with associated attributes.
		''' See <seealso cref="#createSubcontext(Name, Attributes)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context to create; may not be empty </param>
		''' <param name="attrs">
		...
		'''          contain all the mandatory attributes required for creation </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function createSubcontext(ByVal name As String, ByVal attrs As Attributes) As DirContext
	...
	' -------------------- schema operations
		...
		''' </summary>
		''' <param name="name">
		'''          the name of the object whose schema is to be retrieved </param>
		''' <returns>  the schema associated with the context; never null </returns>
		''' <exception cref="OperationNotSupportedException"> if schema not supported </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function getSchema(ByVal name As Name) As DirContext

		''' <summary>
		''' Retrieves the schema associated with the named object.
		''' See <seealso cref="#getSchema(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the object whose schema is to be retrieved </param>
		''' <returns>  the schema associated with the context; never null </returns>
		''' <exception cref="OperationNotSupportedException"> if schema not supported </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function getSchema(ByVal name As String) As DirContext
		...
		'''          definition is to be retrieved </param>
		''' <returns>  the <tt>DirContext</tt> containing the named
		'''          object's class definitions; never null
		''' </returns>
		''' <exception cref="OperationNotSupportedException"> if schema not supported </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function getSchemaClassDefinition(ByVal name As Name) As DirContext

		''' <summary>
		''' Retrieves a context containing the schema objects of the
		''' named object's class definitions.
		''' See <seealso cref="#getSchemaClassDefinition(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the object whose object class
		'''          definition is to be retrieved </param>
		...
		''' <exception cref="OperationNotSupportedException"> if schema not supported </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function getSchemaClassDefinition(ByVal name As String) As DirContext
	...
	' -------------------- search operations
		...
		''' </summary>
		''' <param name="name">
		'''          the name of the context to search </param>
		''' <param name="matchingAttributes">
		'''          the attributes to search for.  If empty or null,
		'''          all objects in the target context are returned. </param>
		...
		'''          to the context named by <code>name</code>. </param>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= SearchControls </seealso>
		''' <seealso cref= SearchResult </seealso>
		''' <seealso cref= #search(Name, String, Object[], SearchControls) </seealso>
		Function search(ByVal name As Name, ByVal matchingAttributes As Attributes, ByVal attributesToReturn As String()) As NamingEnumeration(Of SearchResult)

		''' <summary>
		''' Searches in a single context for objects that contain a
		''' specified set of attributes, and retrieves selected attributes.
		''' See <seealso cref="#search(Name, Attributes, String[])"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context to search </param>
		''' <param name="matchingAttributes">
		'''          the attributes to search for </param>
		''' <param name="attributesToReturn">
		'''          the attributes to return </param>
		''' <returns>  a non-null enumeration of <tt>SearchResult</tt> objects </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function search(ByVal name As String, ByVal matchingAttributes As Attributes, ByVal attributesToReturn As String()) As NamingEnumeration(Of SearchResult)
		...
		''' <br>
		''' See <seealso cref="#search(Name, Attributes, String[])"/> for a full description.
		''' </summary>
		''' <param name="name">
		'''          the name of the context to search </param>
		''' <param name="matchingAttributes">
		'''          the attributes to search for </param>
		''' <returns>  an enumeration of <tt>SearchResult</tt> objects </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #search(Name, Attributes, String[]) </seealso>
		Function search(ByVal name As Name, ByVal matchingAttributes As Attributes) As NamingEnumeration(Of SearchResult)

		''' <summary>
		''' Searches in a single context for objects that contain a
		''' specified set of attributes.
		''' See <seealso cref="#search(Name, Attributes)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context to search </param>
		''' <param name="matchingAttributes">
		...
		''' <returns>  an enumeration of <tt>SearchResult</tt> objects </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function search(ByVal name As String, ByVal matchingAttributes As Attributes) As NamingEnumeration(Of SearchResult)
		...
		''' </summary>
		''' <param name="name">
		'''          the name of the context or object to search </param>
		''' <param name="filter">
		'''          the filter expression to use for the search; may not be null </param>
		''' <param name="cons">
		'''          the search controls that control the search.  If null,
		'''          the default search controls are used (equivalent
		'''          to <tt>(new SearchControls())</tt>). </param>
		''' <returns>  an enumeration of <tt>SearchResult</tt>s of
		'''          the objects that satisfy the filter; never null
		''' </returns>
		''' <exception cref="InvalidSearchFilterException"> if the search filter specified is
		'''          not supported or understood by the underlying directory </exception>
		''' <exception cref="InvalidSearchControlsException"> if the search controls
		'''          contain invalid settings </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #search(Name, String, Object[], SearchControls) </seealso>
		''' <seealso cref= SearchControls </seealso>
		''' <seealso cref= SearchResult </seealso>
		Function search(ByVal name As Name, ByVal filter As String, ByVal cons As SearchControls) As NamingEnumeration(Of SearchResult)

		''' <summary>
		''' Searches in the named context or object for entries that satisfy the
		''' given search filter.  Performs the search as specified by
		''' the search controls.
		''' See <seealso cref="#search(Name, String, SearchControls)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context or object to search </param>
		''' <param name="filter">
		...
		''' </param>
		''' <returns>  an enumeration of <tt>SearchResult</tt>s for
		'''          the objects that satisfy the filter. </returns>
		''' <exception cref="InvalidSearchFilterException"> if the search filter specified is
		'''          not supported or understood by the underlying directory </exception>
		''' <exception cref="InvalidSearchControlsException"> if the search controls
		'''          contain invalid settings </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function search(ByVal name As String, ByVal filter As String, ByVal cons As SearchControls) As NamingEnumeration(Of SearchResult)
		...
		'''          is a nonnegative integer.  May not be null. </param>
		''' <param name="filterArgs">
		...
		'''          If null, equivalent to an empty array. </param>
		''' <param name="cons">
		'''          the search controls that control the search.  If null,
		'''          the default search controls are used (equivalent
		'''          to <tt>(new SearchControls())</tt>). </param>
		''' <returns>  an enumeration of <tt>SearchResult</tt>s of the objects
		'''          that satisfy the filter; never null
		''' </returns>
		''' <exception cref="ArrayIndexOutOfBoundsException"> if <tt>filterExpr</tt> contains
		'''          <code>{i}</code> expressions where <code>i</code> is outside
		'''          the bounds of the array <code>filterArgs</code> </exception>
		''' <exception cref="InvalidSearchControlsException"> if <tt>cons</tt> contains
		'''          invalid settings </exception>
		''' <exception cref="InvalidSearchFilterException"> if <tt>filterExpr</tt> with
		'''          <tt>filterArgs</tt> represents an invalid search filter </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #search(Name, Attributes, String[]) </seealso>
		''' <seealso cref= java.text.MessageFormat </seealso>
		Function search(ByVal name As Name, ByVal filterExpr As String, ByVal filterArgs As Object(), ByVal cons As SearchControls) As NamingEnumeration(Of SearchResult)

		''' <summary>
		''' Searches in the named context or object for entries that satisfy the
		''' given search filter.  Performs the search as specified by
		''' the search controls.
		''' See <seealso cref="#search(Name, String, Object[], SearchControls)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context or object to search </param>
		''' <param name="filterExpr">
		...
		'''          <tt>filterArgs</tt> represents an invalid search filter </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function search(ByVal name As String, ByVal filterExpr As String, ByVal filterArgs As Object(), ByVal cons As SearchControls) As NamingEnumeration(Of SearchResult)
	End Interface
