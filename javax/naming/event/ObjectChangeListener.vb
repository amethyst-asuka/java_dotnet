...
Namespace javax.naming.event
	...
	''' <seealso cref= NamespaceChangeListener </seealso>
	...
	Public Interface ObjectChangeListener
		...
		''' can be obtained using <tt>evt.getOldBinding()</tt>. </summary>
		''' <param name="evt"> The nonnull naming event. </param>
		''' <seealso cref= NamingEvent#OBJECT_CHANGED </seealso>
		Sub objectChanged(ByVal evt As NamingEvent)
	End Interface
