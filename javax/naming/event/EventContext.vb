...
'		public final static int SUBTREE_SCOPE = 2;
		...
		''' for more information on threading issues.
		''' </summary>
		''' <param name="target"> A nonnull name to be resolved relative to this context. </param>
		''' <param name="scope"> One of <tt>OBJECT_SCOPE</tt>, <tt>ONELEVEL_SCOPE</tt>, or
		''' <tt>SUBTREE_SCOPE</tt>. </param>
		...
		''' <seealso cref= #removeNamingListener </seealso>
		Sub addNamingListener(ByVal target As javax.naming.Name, ByVal scope As Integer, ByVal l As NamingListener)
		...
		''' </summary>
		''' <param name="target"> The nonnull string name of the object resolved relative
		''' to this context. </param>
		''' <param name="scope"> One of <tt>OBJECT_SCOPE</tt>, <tt>ONELEVEL_SCOPE</tt>, or
		''' <tt>SUBTREE_SCOPE</tt>. </param>
		''' <param name="l">  The nonnull listener. </param>
		''' <exception cref="NamingException"> If a problem was encountered while
		''' adding the listener. </exception>
		''' <seealso cref= #removeNamingListener </seealso>
		Sub addNamingListener(ByVal target As String, ByVal scope As Integer, ByVal l As NamingListener)
		...
		''' <param name="l">  The nonnull listener. </param>
		''' <exception cref="NamingException"> If a problem was encountered while
		''' removing the listener. </exception>
		''' <seealso cref= #addNamingListener </seealso>
		Sub removeNamingListener(ByVal l As NamingListener)

		''' <summary>
		''' Determines whether a listener can register interest in a target
		''' that does not exist.
		''' </summary>
		''' <returns> true if the target must exist; false if the target need not exist. </returns>
		''' <exception cref="NamingException"> If the context's behavior in this regard cannot
		''' be determined. </exception>
		Function targetMustExist() As Boolean
	End Interface
