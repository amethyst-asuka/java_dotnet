...
Namespace javax.naming.event
	...
	Public Class NamingEvent
		...
		''' @serial
		''' </summary>
		Protected Friend changeInfo As Object
		...
		''' @serial
		''' </summary>
		Protected Friend oldBinding As javax.naming.Binding

		''' <summary>
		''' Contains information about the object after the change.
		''' @serial
		''' </summary>
		Protected Friend newBinding As javax.naming.Binding
