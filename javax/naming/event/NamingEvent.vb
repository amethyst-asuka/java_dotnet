...
Namespace javax.naming.event
    ...
    ''' </summary>
    ''' <seealso cref= NamingListener </seealso>
    ...
    Public Class NamingEvent
        ...
        ''' </summary>
        Public Const OBJECT_RENAMED As Integer = 2
        ...
        ''' </summary>
        Public Const OBJECT_CHANGED As Integer = 3

        ''' <summary>
        ''' Contains information about the change that generated this event.
        ''' @serial
        ''' </summary>
        Protected Friend _changeInfo As Object

        ''' <summary>
        ''' Contains the type of this event. </summary>
        ''' <seealso cref= #OBJECT_ADDED </seealso>
        ''' <seealso cref= #OBJECT_REMOVED </seealso>
        ''' <seealso cref= #OBJECT_RENAMED </seealso>
        ''' <seealso cref= #OBJECT_CHANGED
        ''' @serial </seealso>
        Protected Friend _type As Integer

        ''' <summary>
        ''' Contains information about the object before the change.
        ''' @serial
        ''' </summary>
        Protected Friend _oldBinding As javax.naming.Binding

        ''' <summary>
        ''' Contains information about the object after the change.
        ''' @serial
        ''' </summary>
        Protected Friend _newBinding As javax.naming.Binding
        ...
        ''' </summary>
        ''' <param name="source"> The non-null context that fired this event. </param>
        ''' <param name="type"> The type of the event. </param>
        ''' <param name="newBd"> A possibly null binding before the change. See method description. </param>
        ''' <param name="oldBd"> A possibly null binding after the change. See method description. </param>
        ''' <param name="changeInfo"> A possibly null object containing information about the change. </param>
        ''' <seealso cref= #OBJECT_ADDED </seealso>
        ''' <seealso cref= #OBJECT_REMOVED </seealso>
        ''' <seealso cref= #OBJECT_RENAMED </seealso>
        ''' <seealso cref= #OBJECT_CHANGED </seealso>
        Public Sub New(ByVal source As EventContext, ByVal type As Integer, ByVal newBd As javax.naming.Binding, ByVal oldBd As javax.naming.Binding, ByVal changeInfo As Object)
            MyBase.New(source)
            Me._type = type
            _oldBinding = oldBd
            _newBinding = newBd
            Me._changeInfo = changeInfo
        End Sub

        ''' <summary>
        ''' Returns the type of this event. </summary>
        ...
        Public Overridable ReadOnly Property eventContext As EventContext
            Get
        ...
        Public Overridable ReadOnly Property oldBinding As javax.naming.Binding
            Get
                Return _oldBinding
            End Get
        End Property
        ...
        ''' <a href=package-summary.html#THREADING>package description</a>
        ''' for more information on threading issues. </summary>
        ''' <param name="listener"> The nonnull listener. </param>
        Public Overridable Sub dispatch(ByVal listener As NamingListener)
            Select Case type
                Case OBJECT_ADDED
                    CType(listener, NamespaceChangeListener).objectAdded(Me)

                Case OBJECT_REMOVED
                    CType(listener, NamespaceChangeListener).objectRemoved(Me)

                Case OBJECT_RENAMED
                    CType(listener, NamespaceChangeListener).objectRenamed(Me)

                Case OBJECT_CHANGED
                    CType(listener, ObjectChangeListener).objectChanged(Me)
            End Select
        End Sub
        Private Const serialVersionUID As Long = -7126752885365133499L
    End Class
