...
Namespace javax.naming.ldap
	...
	Public Class StartTlsRequest
		...
		Public Overridable Property iD As String Implements ExtendedRequest.getID
			Get
				Return OID
			End Get
		End Property
		...
		Public Overridable Property encodedValue As SByte() Implements ExtendedRequest.getEncodedValue
			Get
				Return Nothing
			End Get
		End Property
