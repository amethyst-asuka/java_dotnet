...
Namespace javax.naming.ldap
	...
	''' @author Vincent Ryan
	''' </summary>
	''' <seealso cref= InitialLdapContext </seealso>
	''' <seealso cref= LdapReferralException#getReferralContext(java.util.Hashtable,javax.naming.ldap.Control[])
	''' @since 1.3 </seealso>

	Public Interface LdapContext
		Inherits javax.naming.directory.DirContext

	   ''' <summary>
	   ''' Performs an extended operation.
	   ''' 
	   ''' This method is used to support LDAPv3 extended operations. </summary>
	   ''' <param name="request"> The non-null request to be performed. </param>
	   ''' <returns> The possibly null response of the operation. null means
	   ''' the operation did not generate any response. </returns>
	   ''' <exception cref="NamingException"> If an error occurred while performing the
	   ''' extended operation. </exception>
		Function extendedOperation(ByVal request As ExtendedRequest) As ExtendedResponse
		...
		''' </summary>
		''' <param name="requestControls"> The possibly null request controls
		''' to use for the new context.
		''' If null, the context is initialized with no request controls.
		''' </param>
		''' <returns> A non-null <tt>LdapContext</tt> instance. </returns>
		''' <exception cref="NamingException"> If an error occurred while creating
		''' the new instance. </exception>
		''' <seealso cref= InitialLdapContext </seealso>
		Function newInstance(ByVal requestControls As Control()) As LdapContext
		...
		''' in the class description for implementation details. </summary>
		''' <param name="connCtls"> The possibly null controls to use. If null, no
		''' controls are used. </param>
		''' <exception cref="NamingException"> If an error occurred while reconnecting. </exception>
		''' <seealso cref= #getConnectControls </seealso>
		''' <seealso cref= #newInstance </seealso>
		Sub reconnect(ByVal connCtls As Control())
		...
		''' have been set for this context. </returns>
		''' <exception cref="NamingException"> If an error occurred while getting the request
		''' controls. </exception>
		ReadOnly Property connectControls As Control()
		...
		''' <tt>getRequestControls()</tt>. </summary>
		''' <param name="requestControls"> The possibly null controls to use. If null, no
		''' controls are used. </param>
		''' <exception cref="NamingException"> If an error occurred while setting the
		''' request controls. </exception>
		''' <seealso cref= #getRequestControls </seealso>
		Property requestControls As Control()
		...
		''' method invoked on this context did not produce any controls. </returns>
		''' <exception cref="NamingException"> If an error occurred while getting the response
		''' controls. </exception>
		ReadOnly Property responseControls As Control()
		...
		''' </summary>
		''' <seealso cref= ControlFactory </seealso>
		''' <seealso cref= javax.naming.Context#addToEnvironment </seealso>
		''' <seealso cref= javax.naming.Context#removeFromEnvironment </seealso>
