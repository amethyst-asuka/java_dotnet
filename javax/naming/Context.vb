...
Namespace javax.naming
	...
	''' synchronize.  Note that the <seealso cref="#lookup(Name) <tt>lookup</tt>"/>
	...
	''' <seealso cref="java.util.Properties#load <tt>java.util.Properties</tt>"/>),
	...
	''' <seealso cref="ClassLoader#getResources <tt>ClassLoader.getResources()</tt>"/>)
	...
	Public Interface Context
		...
		''' </exception>
		''' <seealso cref= #lookup(String) </seealso>
		''' <seealso cref= #lookupLink(Name) </seealso>
		Function lookup(ByVal name As Name) As Object

		''' <summary>
		''' Retrieves the named object.
		''' See <seealso cref="#lookup(Name)"/> for details. </summary>
		''' <param name="name">
		'''          the name of the object to look up </param>
		''' <returns>  the object bound to <tt>name</tt> </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function lookup(ByVal name As String) As Object
		...
		''' <exception cref="javax.naming.directory.InvalidAttributesException">
		'''          if object did not supply all mandatory attributes </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #bind(String, Object) </seealso>
		''' <seealso cref= #rebind(Name, Object) </seealso>
		''' <seealso cref= javax.naming.directory.DirContext#bind(Name, Object,
		'''          javax.naming.directory.Attributes) </seealso>
		Sub bind(ByVal name As Name, ByVal obj As Object)

		''' <summary>
		''' Binds a name to an object.
		''' See <seealso cref="#bind(Name, Object)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name to bind; may not be empty </param>
		''' <param name="obj">
		...
		'''          if object did not supply all mandatory attributes </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Sub bind(ByVal name As String, ByVal obj As Object)
		...
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #rebind(String, Object) </seealso>
		''' <seealso cref= #bind(Name, Object) </seealso>
		''' <seealso cref= javax.naming.directory.DirContext#rebind(Name, Object,
		'''          javax.naming.directory.Attributes) </seealso>
		''' <seealso cref= javax.naming.directory.DirContext </seealso>
		Sub rebind(ByVal name As Name, ByVal obj As Object)

		''' <summary>
		''' Binds a name to an object, overwriting any existing binding.
		''' See <seealso cref="#rebind(Name, Object)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name to bind; may not be empty </param>
		''' <param name="obj">
		...
		'''          if object did not supply all mandatory attributes </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Sub rebind(ByVal name As String, ByVal obj As Object)
		...
		''' </summary>
		''' <param name="name">
		'''          the name to unbind; may not be empty </param>
		''' <exception cref="NameNotFoundException"> if an intermediate context does not exist </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		''' <seealso cref= #unbind(String) </seealso>
		Sub unbind(ByVal name As Name)

		''' <summary>
		''' Unbinds the named object.
		''' See <seealso cref="#unbind(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name to unbind; may not be empty </param>
		''' <exception cref="NameNotFoundException"> if an intermediate context does not exist </exception>
		...
		''' </summary>
		''' <param name="oldName">
		'''          the name of the existing binding; may not be empty </param>
		''' <param name="newName">
		'''          the name of the new binding; may not be empty </param>
		''' <exception cref="NameAlreadyBoundException"> if <tt>newName</tt> is already bound </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #rename(String, String) </seealso>
		''' <seealso cref= #bind(Name, Object) </seealso>
		''' <seealso cref= #rebind(Name, Object) </seealso>
		Sub rename(ByVal oldName As Name, ByVal newName As Name)

		''' <summary>
		''' Binds a new name to the object bound to an old name, and unbinds
		''' the old name.
		''' See <seealso cref="#rename(Name, Name)"/> for details.
		''' </summary>
		''' <param name="oldName">
		'''          the name of the existing binding; may not be empty </param>
		''' <param name="newName">
		...
		''' </summary>
		''' <param name="name">
		'''          the name of the context to list </param>
		''' <returns>  an enumeration of the names and class names of the
		'''          bindings in this context.  Each element of the
		'''          enumeration is of type <tt>NameClassPair</tt>. </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #list(String) </seealso>
		''' <seealso cref= #listBindings(Name) </seealso>
		''' <seealso cref= NameClassPair </seealso>
		Function list(ByVal name As Name) As NamingEnumeration(Of NameClassPair)

		''' <summary>
		''' Enumerates the names bound in the named context, along with the
		''' class names of objects bound to them.
		''' See <seealso cref="#list(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context to list </param>
		''' <returns>  an enumeration of the names and class names of the
		...
		'''          enumeration is of type <tt>NameClassPair</tt>. </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function list(ByVal name As String) As NamingEnumeration(Of NameClassPair)
		...
		'''          <tt>Binding</tt>. </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #listBindings(String) </seealso>
		''' <seealso cref= #list(Name) </seealso>
		''' <seealso cref= Binding </seealso>
		Function listBindings(ByVal name As Name) As NamingEnumeration(Of Binding)

		''' <summary>
		''' Enumerates the names bound in the named context, along with the
		''' objects bound to them.
		''' See <seealso cref="#listBindings(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context to list </param>
		''' <returns>  an enumeration of the bindings in this context.
		...
		'''          <tt>Binding</tt>. </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function listBindings(ByVal name As String) As NamingEnumeration(Of Binding)
		...
		''' </summary>
		''' <param name="name">
		'''          the name of the context to be destroyed; may not be empty </param>
		''' <exception cref="NameNotFoundException"> if an intermediate context does not exist </exception>
		''' <exception cref="NotContextException"> if the name is bound but does not name a
		'''          context, or does not name a context of the appropriate type </exception>
		''' <exception cref="ContextNotEmptyException"> if the named context is not empty </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #destroySubcontext(String) </seealso>
		Sub destroySubcontext(ByVal name As Name)

		''' <summary>
		''' Destroys the named context and removes it from the namespace.
		''' See <seealso cref="#destroySubcontext(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context to be destroyed; may not be empty </param>
		''' <exception cref="NameNotFoundException"> if an intermediate context does not exist </exception>
		...
		''' <exception cref="ContextNotEmptyException"> if the named context is not empty </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Sub destroySubcontext(ByVal name As String)
		...
		'''          mandatory attributes </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #createSubcontext(String) </seealso>
		''' <seealso cref= javax.naming.directory.DirContext#createSubcontext </seealso>
		Function createSubcontext(ByVal name As Name) As Context

		''' <summary>
		''' Creates and binds a new context.
		''' See <seealso cref="#createSubcontext(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context to create; may not be empty </param>
		''' <returns>  the newly created context
		...
		'''          mandatory attributes </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function createSubcontext(ByVal name As String) As Context
		...
		''' <param name="name">
		'''          the name of the object to look up </param>
		''' <returns>  the object bound to <tt>name</tt>, not following the
		'''          terminal link (if any). </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #lookupLink(String) </seealso>
		Function lookupLink(ByVal name As Name) As Object

		''' <summary>
		''' Retrieves the named object, following links except
		''' for the terminal atomic component of the name.
		''' See <seealso cref="#lookupLink(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the object to look up </param>
		''' <returns>  the object bound to <tt>name</tt>, not following the
		'''          terminal link (if any) </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function lookupLink(ByVal name As String) As Object
		...
		''' </summary>
		''' <param name="name">
		'''          the name of the context from which to get the parser </param>
		''' <returns>  a name parser that can parse compound names into their atomic
		'''          components </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #getNameParser(String) </seealso>
		''' <seealso cref= CompoundName </seealso>
		Function getNameParser(ByVal name As Name) As NameParser

		''' <summary>
		''' Retrieves the parser associated with the named context.
		''' See <seealso cref="#getNameParser(Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          the name of the context from which to get the parser </param>
		''' <returns>  a name parser that can parse compound names into their atomic
		'''          components </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function getNameParser(ByVal name As String) As NameParser
		...
		''' </summary>
		''' <param name="name">
		'''          a name relative to this context </param>
		''' <param name="prefix">
		'''          the name of this context relative to one of its ancestors </param>
		''' <returns>  the composition of <code>prefix</code> and <code>name</code> </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #composeName(String, String) </seealso>
		Function composeName(ByVal name As Name, ByVal prefix As Name) As Name

		''' <summary>
		''' Composes the name of this context with a name relative to
		''' this context.
		''' See <seealso cref="#composeName(Name, Name)"/> for details.
		''' </summary>
		''' <param name="name">
		'''          a name relative to this context </param>
		''' <param name="prefix">
		...
		''' <returns>  the composition of <code>prefix</code> and <code>name</code> </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered </exception>
		Function composeName(ByVal name As String, ByVal prefix As String) As String
		...
		''' </summary>
		''' <param name="propName">
		'''          the name of the environment property to add; may not be null </param>
		''' <param name="propVal">
		'''          the value of the property to add; may not be null </param>
		''' <returns>  the previous value of the property, or null if the property was
		'''          not in the environment before </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #getEnvironment() </seealso>
		''' <seealso cref= #removeFromEnvironment(String) </seealso>
		Function addToEnvironment(ByVal propName As String, ByVal propVal As Object) As Object
		...
		''' </summary>
		''' <param name="propName">
		'''          the name of the environment property to remove; may not be null </param>
		''' <returns>  the previous value of the property, or null if the property was
		'''          not in the environment </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #getEnvironment() </seealso>
		''' <seealso cref= #addToEnvironment(String, Object) </seealso>
		Function removeFromEnvironment(ByVal propName As String) As Object
		...
		''' </summary>
		''' <returns>  the environment of this context; never null </returns>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' </exception>
		''' <seealso cref= #addToEnvironment(String, Object) </seealso>
		''' <seealso cref= #removeFromEnvironment(String) </seealso>
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		ReadOnly Property environment As Dictionary(Of ?, ?)
		...
		''' </summary>
		''' <returns>  this context's name in its own namespace; never null </returns>
		''' <exception cref="OperationNotSupportedException"> if the naming system does
		'''          not have the notion of a full name </exception>
		''' <exception cref="NamingException"> if a naming exception is encountered
		''' 
		''' @since 1.3 </exception>
		ReadOnly Property nameInNamespace As String
	...
	' because they are the default
		...
		''' <seealso cref= javax.naming.spi.InitialContextFactory </seealso>
		''' <seealso cref= NoInitialContextException </seealso>
		''' <seealso cref= #addToEnvironment(String, Object) </seealso>
		''' <seealso cref= #removeFromEnvironment(String) </seealso>
		''' <seealso cref= #APPLET </seealso>
...
'		String OBJECT_FACTORIES = "java.naming.factory.object";
		...
		''' </summary>
		''' <seealso cref= javax.naming.spi.NamingManager#getStateToBind </seealso>
		''' <seealso cref= javax.naming.spi.StateFactory </seealso>
		''' <seealso cref= #addToEnvironment(String, Object) </seealso>
		''' <seealso cref= #removeFromEnvironment(String) </seealso>
		''' <seealso cref= #APPLET
		''' @since 1.3 </seealso>
