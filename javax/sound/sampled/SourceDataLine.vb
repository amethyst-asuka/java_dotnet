...
Namespace javax.sound.sampled
	...
	''' <code><seealso cref="Mixer#getLine getLine"/></code> method of <code>Mixer</code> with
	''' an appropriate <code><seealso cref="DataLine.Info"/></code> object.
	''' <p>
	...
	''' stops due to underflow, a <code><seealso cref="LineEvent.Type#STOP STOP"/></code> event is
	''' generated.  A <code><seealso cref="LineEvent.Type#START START"/></code> event is generated
	''' when the audio output resumes.
	''' 
	''' @author Kara Kytle </summary>
	''' <seealso cref= Mixer </seealso>
	''' <seealso cref= DataLine </seealso>
	''' <seealso cref= TargetDataLine
	''' @since 1.3 </seealso>
	Public Interface SourceDataLine
		...
		''' <code><seealso cref="DataLine#getBufferSize"/></code>.
		''' <p>
		''' If this operation succeeds, the line is marked as open, and an
		''' <code><seealso cref="LineEvent.Type#OPEN OPEN"/></code> event is dispatched to the
		''' line's listeners.
		...
		''' currently be written (see <code><seealso cref="DataLine#available available"/></code>),
		...
		''' </summary>
		''' <param name="b"> a byte array containing data to be written to the data line </param>
		''' <param name="len"> the length, in bytes, of the valid data in the array
		''' (in other words, the requested amount of data to write, in bytes) </param>
		...
		Function write(ByVal b As SByte(), ByVal [off] As Integer, ByVal len As Integer) As Integer
		...
		''' value measures sample frames, not bytes. </summary>
		''' <returns> the number of sample frames currently available for writing </returns>
		''' <seealso cref= TargetDataLine#availableRead </seealso>
