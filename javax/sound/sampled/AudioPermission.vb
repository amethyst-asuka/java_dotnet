...
Namespace javax.sound.sampled
	...
	Public Class AudioPermission
		...
		''' all audio permissions. </summary>
		''' <param name="name"> the name of the new <code>AudioPermission</code>
		''' </param>
		...
		''' parameter is currently unused and should be <code>null</code>. </summary>
		''' <param name="name"> the name of the new <code>AudioPermission</code> </param>
		''' <param name="actions"> (unused; should be <code>null</code>)
		''' </param>
		''' <exception cref="NullPointerException"> if <code>name</code> is <code>null</code>. </exception>
		''' <exception cref="IllegalArgumentException"> if <code>name</code> is empty. </exception>
