...
Namespace javax.print
	...
	Public Interface AttributeException
		...
		''' </summary>
		''' <returns> unsupported attribute classes </returns>
		ReadOnly Property unsupportedAttributes As Type()
		...
		''' </summary>
		''' <returns> unsupported attribute values </returns>
		ReadOnly Property unsupportedValues As javax.print.attribute.Attribute()
