...
Namespace javax.print
	...
	''' proxy will call <seealso cref="#getDoc() getDoc()"/> one or more times
	...
	Public Interface MultiDoc
		...
		''' </summary>
		''' <returns>  Current doc object.
		''' </returns>
		''' <exception cref="IOException">
		'''     Thrown if a error occurred reading the document. </exception>
		ReadOnly Property doc As Doc
		...
		''' </returns>
		''' <exception cref="IOException">
		'''     Thrown if an error occurred locating the next document </exception>
		Function [next]() As MultiDoc
