...
Namespace javax.print
	...
	''' <UL>
	''' <LI>
	''' Determine the format, or "doc flavor" (class <seealso cref="DocFlavor DocFlavor"/>),
	...
	''' an <seealso cref="javax.print.attribute.DocAttributeSet javax.print.attribute.DocAttributeSet"/>.
	''' </UL>
	''' <P>
	...
	''' <seealso cref="#getPrintData() getPrintData()"/> will return the same
	...
	''' calls the <seealso cref="#getPrintData() getPrintData()"/> method).
	''' <P>
	...
	Public Interface Doc
		...
		ReadOnly Property docFlavor As DocFlavor
		...
		'''     error while constructing the stream. </exception>
		ReadOnly Property printData As Object
		...
		'''          set. </returns>
		ReadOnly Property attributes As javax.print.attribute.DocAttributeSet
		...
		''' </returns>
		''' <exception cref="IOException">
		'''     Thrown if there was an I/O error while creating the reader. </exception>
		ReadOnly Property readerForText As java.io.Reader
		...
		''' </returns>
		''' <exception cref="IOException">
		'''     Thrown if there was an I/O error while creating the input stream. </exception>
		ReadOnly Property streamForBytes As java.io.InputStream
