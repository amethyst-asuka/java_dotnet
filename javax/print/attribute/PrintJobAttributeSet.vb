...
Namespace javax.print.attribute
	...
	''' <P>
	''' A PrintJobAttributeSet is just an <seealso cref="AttributeSet AttributeSet"/> whose
	...
	''' instances of interface <seealso cref="PrintJobAttribute PrintJobAttribute"/>.
	...
	Public Interface PrintJobAttributeSet
		...
		'''     <seealso cref="PrintJobAttribute PrintJobAttribute"/>. </exception>
