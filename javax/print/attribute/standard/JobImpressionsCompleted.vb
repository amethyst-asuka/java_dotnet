...
Namespace javax.print.attribute.standard
	...
	Public NotInheritable Class JobImpressionsCompleted
		Inherits javax.print.attribute.IntegerSyntax
		Implements javax.print.attribute.PrintJobAttribute

		Private Const serialVersionUID As Long = 6722648442432393294L
		...
		'''          impressions completed attribute, false otherwise. </returns>
		Public Overrides Function Equals(ByVal [object] As Object) As Boolean
			Return (MyBase.Equals([object]) AndAlso TypeOf [object] Is JobImpressionsCompleted)
		End Function
		...
		Public Property category As Type
			Get
				Return GetType(JobImpressionsCompleted)
			End Get
		End Property
