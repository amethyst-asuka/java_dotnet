...
Namespace javax.print.attribute
	...
	''' <P>
	''' A PrintServiceAttributeSet is just an <seealso cref="AttributeSet AttributeSet"/>
	...
	''' instances of interface <seealso cref="PrintServiceAttribute PrintServiceAttribute"/>.
	...
	Public Interface PrintServiceAttributeSet
		...
		'''     <seealso cref="PrintServiceAttribute PrintServiceAttribute"/>. </exception>
		...
		'''     PrintServiceAttribute}. </exception>
		''' <exception cref="NullPointerException">
