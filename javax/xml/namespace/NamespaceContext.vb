...
Namespace javax.xml.namespace
	...
	''' <seealso cref= javax.xml.XMLConstants
	'''   javax.xml.XMLConstants for declarations of common XML values </seealso>
	''' <seealso cref= <a href="http://www.w3.org/TR/xmlschema-2/#QName">
	'''   XML Schema Part2: Datatypes</a> </seealso>
	...
	Public Interface NamespaceContext
		...
		''' </table>
		''' </summary>
		''' <param name="prefix"> prefix to look up
		''' </param>
		''' <returns> Namespace URI bound to prefix in the current scope
		''' </returns>
		''' <exception cref="IllegalArgumentException"> When <code>prefix</code> is
		...
		''' scope, use <seealso cref="#getPrefixes(String namespaceURI)"/>.</p>
		''' 
		...
		''' </table>
		''' </summary>
		''' <param name="namespaceURI"> URI of Namespace to lookup
		''' </param>
		''' <returns> prefix bound to Namespace URI in current context
		''' </returns>
		''' <exception cref="IllegalArgumentException"> When <code>namespaceURI</code> is
		'''   <code>null</code> </exception>
		Function getPrefix(ByVal namespaceURI As String) As String
		...
		''' <param name="namespaceURI"> URI of Namespace to lookup
		''' </param>
		''' <returns> <code>Iterator</code> for all prefixes bound to the
		'''   Namespace URI in the current scope
		''' </returns>
		''' <exception cref="IllegalArgumentException"> When <code>namespaceURI</code> is
		'''   <code>null</code> </exception>
		Function getPrefixes(ByVal namespaceURI As String) As IEnumerator
	End Interface
