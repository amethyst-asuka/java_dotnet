...
'JAVA TO VB CONVERTER TODO TASK: There is no VB equivalent to 'volatile':
		...
		''' service provider
		''' </param>
		''' <param name="cl"> ClassLoader to use to load the class, null means to use
		...
		Friend Shared Function find(Of T)(ByVal type As Type, ByVal fallbackClassName As String) As T
			...
			If fallbackClassName Is Nothing Then Throw New DatatypeConfigurationException("Provider for " & factoryId & " cannot be found")
...
'				Return java.security.AccessController.doPrivileged(New java.security.PrivilegedAction<T>()
	...
	'			});
			Catch e As java.util.ServiceConfigurationError
				Dim [error] As New DatatypeConfigurationException("Provider for " & type & " cannot be found", e)
				Throw [error]
			End Try
		End Function
