...
Namespace javax.xml.xpath
	...
	''' sure that one <seealso cref="XPathExpression"/> object is not used from
	...
	''' <seealso cref= <a href="http://www.w3.org/TR/xpath#section-Expressions">XML Path Language (XPath) Version 1.0, Expressions</a>
	''' @since 1.5 </seealso>
	Public Interface XPathExpression
		...
		''' </param>
		''' <returns> The <code>Object</code> that is the result of evaluating the expression and converting the result to
		...
		''' <exception cref="NullPointerException"> If  <code>returnType</code> is <code>null</code>. </exception>
		Function evaluate(ByVal item As Object, ByVal returnType As javax.xml.namespace.QName) As Object

		''' <summary>
		''' <p>Evaluate the compiled XPath expression in the specified context and return the result as a <code>String</code>.</p>
		''' 
		''' <p>This method calls <seealso cref="#evaluate(Object item, QName returnType)"/> with a <code>returnType</code> of
		...
		''' </returns>
		''' <exception cref="XPathExpressionException"> If the expression cannot be evaluated. </exception>
		Function evaluate(ByVal item As Object) As String
		...
		''' <seealso cref="#evaluate(Object item, QName returnType)"/> on the resulting document object.</p>
		''' 
		''' <p>See <a href="#XPathExpression-evaluation">Evaluation of XPath Expressions</a> for context item evaluation,
		''' variable, function and QName resolution and return type conversion.</p>
		''' 
		...
		''' </summary>
		''' <param name="source"> The <code>InputSource</code> of the document to evaluate over. </param>
		''' <param name="returnType"> The desired return type.
		''' </param>
		''' <returns> The <code>Object</code> that is the result of evaluating the expression and converting the result to
		'''   <code>returnType</code>.
		...
		''' <exception cref="XPathExpressionException"> If the expression cannot be evaluated. </exception>
		''' <exception cref="IllegalArgumentException"> If <code>returnType</code> is not one of the types defined in <seealso cref="XPathConstants"/>. </exception>
		''' <exception cref="NullPointerException"> If  <code>source</code> or <code>returnType</code> is <code>null</code>. </exception>
		Function evaluate(ByVal source As org.xml.sax.InputSource, ByVal returnType As javax.xml.namespace.QName) As Object
		...
		''' <code>String</code>.</p>
		''' 
		''' <p>This method calls <seealso cref="#evaluate(InputSource source, QName returnType)"/> with a <code>returnType</code> of
		''' <seealso cref="XPathConstants#STRING"/>.</p>
		''' 
		''' <p>See <a href="#XPathExpression-evaluation">Evaluation of XPath Expressions</a> for context item evaluation,
		''' variable, function and QName resolution and return type conversion.</p>
		...
		Function evaluate(ByVal source As org.xml.sax.InputSource) As String
	End Interface
