...
Namespace javax.xml.xpath
	...
	''' <seealso cref= <a href="http://www.w3.org/TR/xpath#corelib">XML Path Language (XPath) Version 1.0, Core Function Library</a>
	''' @since 1.5 </seealso>
	Public Interface XPathFunctionResolver
	  ...
	  ''' <param name="arity"> The number of arguments that the returned function must accept.
	  ''' </param>
	  ''' <returns> The function or <code>null</code> if no function named <code>functionName</code> with <code>arity</code> arguments exists.
	  ''' </returns>
	  ''' <exception cref="NullPointerException"> If <code>functionName</code> or <code>arity</code> is <code>null</code>. </exception>
	  Function resolveFunction(ByVal functionName As javax.xml.namespace.QName, ByVal arity As Integer) As XPathFunction
	End Interface
