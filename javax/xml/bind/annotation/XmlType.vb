...
Namespace javax.xml.bind.annotation
	...
	''' see @<seealso cref="XmlValue"/> annotation type.
	''' <p>
	...
	''' <seealso cref="XmlRootElement"/>, <seealso cref="XmlAccessorOrder"/>, <seealso cref="XmlAccessorType"/>,
	''' <seealso cref="XmlEnum"/>. However, {@link
	''' XmlAccessorOrder} and <seealso cref="XmlAccessorType"/> are ignored when this
	...
	''' <seealso cref= XmlAttribute </seealso>
	''' <seealso cref= XmlValue </seealso>
	''' <seealso cref= XmlSchema
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	...
	Public Class XmlType
		...
		'''     by @<seealso cref="XmlAccessorOrder"/>.
		''' </summary>
		...
		''' </summary>
		Type factoryClass() default GetType(DEFAULT)

		''' <summary>
		''' Used in <seealso cref="XmlType#factoryClass()"/> to
		''' signal that either factory mehod is not used or
		''' that it's in the class with this <seealso cref="XmlType"/> itself.
		''' </summary>
