...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	...
	Public Class XmlSchema
		...
		''' </summary>
		Friend Overridable Function xmlns() As XmlNs()
		End Function
		...
		''' <summary>
		''' Indicates that this namespace (specified by <seealso cref="#namespace()"/>)
		...
		''' 
		''' <p>
		''' Multiple <seealso cref="XmlSchema"/> annotations on multiple packages are allowed
		''' to govern the same <seealso cref="#namespace()"/>. In such case, all of them
		''' must have the same <seealso cref="#location()"/> values.
		''' 
		''' 
		...
		''' <summary>
		''' The default value of the <seealso cref="#location()"/> attribute,
