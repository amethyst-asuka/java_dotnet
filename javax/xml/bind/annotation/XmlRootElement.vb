...
Namespace javax.xml.bind.annotation
	...
	''' <seealso cref="XmlType"/>, <seealso cref="XmlEnum"/>, <seealso cref="XmlAccessorType"/>,
	''' <seealso cref="XmlAccessorOrder"/>.
	''' <p>
	''' 
	''' <p>
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	...
	Public Class XmlRootElement
		...
		''' from the package of the class ( <seealso cref="XmlSchema"/> ). If the
