...
Namespace javax.xml.bind.annotation
	...
	''' JavaBean property or from within <seealso cref="XmlElementRefs"/>
	''' <p>
	...
	''' </pre>
	''' <p>
	''' An element factory method annotated with  <seealso cref="XmlElementDecl"/> is
	...
	'''        <seealso cref="javax.xml.bind.JAXBElement"/>, then
	...
	'''        <seealso cref="javax.xml.bind.JAXBElement"/>, then the type referenced by the
	'''        property or field must be annotated  with <seealso cref="XmlRootElement"/>. </li>
	'''   <li> This annotation can be used with the following annotations:
	'''        <seealso cref="XmlElementWrapper"/>, <seealso cref="XmlJavaTypeAdapter"/>.
	'''   </ul>
	''' 
	...
	''' that doesn't have <seealso cref="XmlRootElement"/>. But they can't show up in an
	...
	'''     &#64;XmlElement
	'''     class Math {
	'''         //  The value of <seealso cref="#type()"/>is
	'''         //  JAXBElement.class , which indicates the XML
	'''         //  element name ObjectFactory - in general a class marked
	'''         //  with &#64;XmlRegistry. (See ObjectFactory below)
	'''         //
	'''         //  The <seealso cref="#name()"/> is "operator", a pointer to a
	'''         // factory method annotated with a
	'''         //  <seealso cref="XmlElementDecl"/> with the name "operator". Since
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	...
	Public Class XmlElementRef
		...
		''' <summary>
		''' This parameter and <seealso cref="#name()"/> are used to determine the
		''' XML element for the JavaBean property.
		''' 
		''' <p> If <tt>type()</tt> is <tt>JAXBElement.class</tt> , then
		''' <tt>namespace()</tt> and <tt>name()</tt>
		''' point to a factory method with <seealso cref="XmlElementDecl"/>. The XML
		''' element name is the element name from the factory method's
		''' <seealso cref="XmlElementDecl"/> annotation or if an element from its
		...
		''' <seealso cref="XmlElementDecl"/> on the substituted element.
		''' 
		''' <p> If <seealso cref="#type()"/> is not <tt>JAXBElement.class</tt>, then
		...
		''' an <seealso cref="XmlElementDecl"/>, then it is an error.
		''' 
		...
		''' <summary>
		''' Used in <seealso cref="XmlElementRef#type()"/> to
		...
		''' despite the fact that <seealso cref="XmlElement#required()"/> defaults to false.
		''' 
		''' @since 2.2
		''' </summary>
