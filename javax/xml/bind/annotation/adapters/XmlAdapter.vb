...
Namespace javax.xml.bind.annotation.adapters
	...
	'''      the <tt>ValueType</tt>. </param>
	''' @param <ValueType>
	'''      The type that JAXB knows how to handle out of the box.
	''' 
	''' @author <ul><li>Sekhar Vajjhala, Sun Microsystems Inc.</li> <li> Kohsuke Kawaguchi, Sun Microsystems Inc.</li></ul> </param>
	''' <seealso cref= XmlJavaTypeAdapter
	''' @since JAXB 2.0 </seealso>
	Public MustInherit Class XmlAdapter(Of ValueType, BoundType)
		...
		''' </summary>
		''' <param name="v">
		'''      The value to be converted. Can be null. </param>
		''' <exception cref="Exception">
		'''      if there's an error during the conversion. The caller is responsible for
		'''      reporting the error to the user through <seealso cref="javax.xml.bind.ValidationEventHandler"/>. </exception>
		Public MustOverride Function unmarshal(ByVal v As ValueType) As BoundType

		''' <summary>
		''' Convert a bound type to a value type.
		''' </summary>
		''' <param name="v">
		'''      The value to be convereted. Can be null. </param>
		''' <exception cref="Exception">
		'''      if there's an error during the conversion. The caller is responsible for
		'''      reporting the error to the user through <seealso cref="javax.xml.bind.ValidationEventHandler"/>. </exception>
		Public MustOverride Function marshal(ByVal v As BoundType) As ValueType
	End Class
