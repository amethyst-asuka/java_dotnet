...
Namespace javax.xml.bind.annotation
	...
	''' <seealso cref="JAXBElement"/> or instances with a class that is annotated with
	''' &#64;XmlRootElement.</li>
	''' <li>Unknown content that is not be bound to a JAXB mapped class is inserted
	''' as <seealso cref="Element"/>. (Assumes property annotated with &#64;XmlAnyElement)</li>
	''' </ul>
	''' 
