...
Namespace javax.xml.bind.annotation
	...
	''' <summary>
	''' Maps an enum constant in <seealso cref="Enum"/> type to XML representation.
	''' 
	''' <p> <b>Usage</b> </p>
	''' 
	...
	''' 
	''' <p>This annotation, together with <seealso cref="XmlEnum"/> provides a
	...
	''' <tt>@XmlEnum.value()</tt>
	''' 
	''' <p> In the absence of this annotation, <seealso cref="Enum#name()"/> is used
