...
Namespace javax.xml.ws
	...
	''' reference a remote web service endpoint. See the <seealso cref="Service"/> APIs
	''' that clients can use to that utilize an <code>EndpointReference</code>.
	''' See the <seealso cref="javax.xml.ws.Endpoint"/>, and
	''' <seealso cref="javax.xml.ws.BindingProvider"/> APIs on how
	...
	''' For example the <seealso cref="W3CEndpointReference"/> is for use
	...
	''' <code><seealso cref="EndpointReference#writeTo"/></code>
	''' method.
	''' <p>
	''' JAXB will bind this class to xs:anyType. If a better binding
	''' is desired, web services developers should use a concrete
	''' subclass such as <seealso cref="W3CEndpointReference"/>.
	''' </summary>
	''' <seealso cref= W3CEndpointReference </seealso>
	''' <seealso cref= Service
	''' @since JAX-WS 2.1 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	Public MustInherit Class EndpointReference ' to treat this class like Object as far as databinding is concerned (proposed JAXB 2.1 feature)
		'
		...
		''' implementation of the <seealso cref="javax.xml.ws.spi.Provider#readEndpointReference"/> method.
		''' </summary>
		''' <param name="eprInfoset"> The <code>EndpointReference</code> infoset to be unmarshalled
		''' </param>
		''' <returns> the EndpointReference unmarshalled from <code>eprInfoset</code>
		'''    never <code>null</code> </returns>
		''' <exception cref="WebServiceException">
		'''    if an error occurs while creating the
		'''    <code>EndpointReference</code> from the <CODE>eprInfoset</CODE> </exception>
		''' <exception cref="java.lang.IllegalArgumentException">
		'''     if the <code>null</code> <code>eprInfoset</code> value is given. </exception>
		Public Shared Function readFrom(ByVal eprInfoset As javax.xml.transform.Source) As EndpointReference
		...
		''' </summary>
		''' <param name="result"> for writing infoset </param>
		''' <exception cref="WebServiceException">
		'''   if there is an error writing the
		'''   <code>EndpointReference</code> to the specified <code>result</code>.
		''' </exception>
		''' <exception cref="java.lang.IllegalArgumentException">
		'''      If the <code>null</code> <code>result</code> value is given. </exception>
		Public MustOverride Sub writeTo(ByVal result As javax.xml.transform.Result)
		...
		Public Overridable Function getPort(Of T)(ByVal serviceEndpointInterface As Type, ParamArray ByVal features As WebServiceFeature()) As T
			Return javax.xml.ws.spi.Provider.provider().getPort(Me, serviceEndpointInterface, features)
		End Function
		...
		Public Overrides Function ToString() As String
			Dim w As New java.io.StringWriter
			writeTo(New javax.xml.transform.stream.StreamResult(w))
			Return w.ToString()
		End Function
	End Class
