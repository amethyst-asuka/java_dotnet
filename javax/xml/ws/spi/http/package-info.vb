...
'''  <ol>
'''  <li>Container creates <seealso cref="javax.xml.ws.Endpoint"/> objects for an
...
'''  <li>Container needs to create <seealso cref="javax.xml.ws.spi.http.HttpContext"/>
...
'''  <seealso cref="javax.xml.ws.Endpoint#publish(HttpContext)"/>. During publish(),
'''  JAX-WS runtime registers a <seealso cref="javax.xml.ws.spi.http.HttpHandler"/>
'''  callback to handle incoming requests or
'''  <seealso cref="javax.xml.ws.spi.http.HttpExchange"/> objects. The HttpExchange
