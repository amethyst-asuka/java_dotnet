...
Namespace javax.xml.soap
	...
	Public Interface SOAPEnvelope
		...
		Function createName(ByVal localName As String, ByVal prefix As String, ByVal uri As String) As Name
		...
		'''         local name </returns>
		''' <exception cref="SOAPException"> if there is a SOAP error </exception>
		Function createName(ByVal localName As String) As Name
		...
		''' been added.
		''' </summary>
		''' <returns> the <code>SOAPHeader</code> object or <code>null</code> if
		'''         there is none </returns>
		''' <exception cref="SOAPException"> if there is a problem obtaining the
		'''            <code>SOAPHeader</code> object </exception>
		ReadOnly Property header As SOAPHeader
		...
		''' been added.
		''' </summary>
		''' <returns> the <code>SOAPBody</code> object for this
		'''         <code>SOAPEnvelope</code> object or <code>null</code>
		'''         if there is none </returns>
		''' <exception cref="SOAPException"> if there is a problem obtaining the
		'''            <code>SOAPBody</code> object </exception>
		ReadOnly Property body As SOAPBody
		''' <summary>
		...
		''' </summary>
		''' <returns> the new <code>SOAPHeader</code> object
		''' </returns>
		''' <exception cref="SOAPException"> if this
		'''            <code>SOAPEnvelope</code> object already contains a
		'''            valid <code>SOAPHeader</code> object </exception>
		Function addHeader() As SOAPHeader
		''' <summary>
		...
		''' </summary>
		''' <returns> the new <code>SOAPBody</code> object
		''' </returns>
		''' <exception cref="SOAPException"> if this
		'''            <code>SOAPEnvelope</code> object already contains a
		'''            valid <code>SOAPBody</code> object </exception>
		Function addBody() As SOAPBody
	End Interface
