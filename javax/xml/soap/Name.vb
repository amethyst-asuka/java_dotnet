...
Namespace javax.xml.soap
	...
	''' in favor of <code>javax.xml.namespace.QName<code> </summary>
	''' <seealso cref= SOAPEnvelope#createName(String, String, String) SOAPEnvelope.createName </seealso>
	''' <seealso cref= SOAPFactory#createName(String, String, String) SOAPFactory.createName </seealso>
	Public Interface Name
		''' <summary>
		''' Gets the local name part of the XML name that this <code>Name</code>
		''' object represents.
		''' </summary>
		''' <returns> a string giving the local name </returns>
		...
		''' </summary>
		''' <returns> the namespace-qualified name as a string </returns>
