...
Namespace javax.xml.crypto
	...
	''' @since 1.6 </summary>
	''' <seealso cref= XMLSignatureFactory#getInstance XMLSignatureFactory.getInstance </seealso>
	''' <seealso cref= KeyInfoFactory#getInstance KeyInfoFactory.getInstance </seealso>
	Public Class NoSuchMechanismException
		Inherits Exception

		Private Const serialVersionUID As Long = 4189669069570660166L
