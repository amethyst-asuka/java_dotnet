...
Namespace javax.xml.crypto.dsig
	...
	''' newCanonicalizationMethod} method of the <seealso cref="XMLSignatureFactory"/> class.
	''' 
	''' @author Sean Mullan
	''' @author JSR 105 Expert Group
	''' @since 1.6 </summary>
	''' <seealso cref= XMLSignatureFactory#newCanonicalizationMethod(String, C14NMethodParameterSpec) </seealso>
...
'		final static String EXCLUSIVE_WITH_COMMENTS = "http://www.w3.org/2001/10/xml-exc-c14n#WithComments";
		...
		''' <seealso cref="C14NMethodParameterSpec"/> object.
		''' </summary>
