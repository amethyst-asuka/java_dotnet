...
Namespace javax.imageio
    ...
    '''  </seealso>
    Public Class IIOImage(Of T1 As java.awt.image.BufferedImage)
        ...
        Protected Friend thumbnails As IList(Of java.awt.image.BufferedImage) = Nothing
        ...
        Public Sub New(ByVal image As java.awt.image.RenderedImage, ByVal thumbnails As IList(Of T1), ByVal metadata As javax.imageio.metadata.IIOMetadata)
        ...
        ''' <code>null</code>. </exception>
        Public Sub New(ByVal raster As java.awt.image.Raster, ByVal thumbnails As IList(Of T1), ByVal metadata As javax.imageio.metadata.IIOMetadata)
        ...
        ''' <seealso cref= #setThumbnails </seealso>
        'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
        Public Overridable Property thumbnails As IList(Of java.awt.image.BufferedImage)
            Get
                Return thumbnails
            End Get
