...
Namespace javax.imageio.event
	...
	''' pixel updates.
	''' </summary>
	''' <seealso cref= javax.imageio.ImageReader#addIIOReadUpdateListener </seealso>
	''' <seealso cref= javax.imageio.ImageReader#removeIIOReadUpdateListener
	'''  </seealso>
	Public Interface IIOReadUpdateListener
		...
		''' <param name="pass"> the number of the pass that is about to begin,
		''' starting with 0. </param>
		...
		''' <param name="minX"> the X coordinate of the leftmost updated column
		''' of pixels. </param>
		''' <param name="minY"> the Y coordinate of the uppermost updated row
		''' of pixels. </param>
		''' <param name="periodX"> the horizontal spacing between updated pixels;
		''' a value of 1 means no gaps. </param>
		''' <param name="periodY"> the vertical spacing between updated pixels;
		''' a value of 1 means no gaps. </param>
		''' <param name="bands"> an array of <code>int</code>s indicating the the
		''' set bands that may be updated. </param>
		Sub passStarted(ByVal source As javax.imageio.ImageReader, ByVal theImage As java.awt.image.BufferedImage, ByVal pass As Integer, ByVal minPass As Integer, ByVal maxPass As Integer, ByVal minX As Integer, ByVal minY As Integer, ByVal periodX As Integer, ByVal periodY As Integer, ByVal bands As Integer())
		...
		''' <param name="minY"> the Y coordinate of the uppermost updated row
		''' of pixels. </param>
		''' <param name="width"> the number of updated pixels horizontally. </param>
		''' <param name="height"> the number of updated pixels vertically. </param>
		''' <param name="periodX"> the horizontal spacing between updated pixels;
		''' a value of 1 means no gaps. </param>
		''' <param name="periodY"> the vertical spacing between updated pixels;
		''' a value of 1 means no gaps. </param>
		''' <param name="bands"> an array of <code>int</code>s indicating which
		''' bands are being updated. </param>
		Sub imageUpdate(ByVal source As javax.imageio.ImageReader, ByVal theImage As java.awt.image.BufferedImage, ByVal minX As Integer, ByVal minY As Integer, ByVal width As Integer, ByVal height As Integer, ByVal periodX As Integer, ByVal periodY As Integer, ByVal bands As Integer())
		...
		''' <param name="source"> the <code>ImageReader</code> object calling this
		''' method. </param>
		''' <param name="theImage"> the <code>BufferedImage</code> being updated.
		''' </param>
		''' <seealso cref= javax.imageio.ImageReadParam#setSourceProgressivePasses(int, int) </seealso>
		Sub passComplete(ByVal source As javax.imageio.ImageReader, ByVal theImage As java.awt.image.BufferedImage)
		...
		''' </param>
		''' <seealso cref= #passStarted </seealso>
		Sub thumbnailPassStarted(ByVal source As javax.imageio.ImageReader, ByVal theThumbnail As java.awt.image.BufferedImage, ByVal pass As Integer, ByVal minPass As Integer, ByVal maxPass As Integer, ByVal minX As Integer, ByVal minY As Integer, ByVal periodX As Integer, ByVal periodY As Integer, ByVal bands As Integer())
		...
		Sub thumbnailUpdate(ByVal source As javax.imageio.ImageReader, ByVal theThumbnail As java.awt.image.BufferedImage, ByVal minX As Integer, ByVal minY As Integer, ByVal width As Integer, ByVal height As Integer, ByVal periodX As Integer, ByVal periodY As Integer, ByVal bands As Integer())
		...
		''' being updated.
		''' </param>
		''' <seealso cref= #passComplete </seealso>
		Sub thumbnailPassComplete(ByVal source As javax.imageio.ImageReader, ByVal theThumbnail As java.awt.image.BufferedImage)
	End Interface
