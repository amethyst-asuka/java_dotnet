...
Namespace javax.imageio.plugins.bmp
	...
	Public Class BMPImageWriteParam
		...
		Private topDown As Boolean = False
		...
		Public Sub New(ByVal locale As java.util.Locale)
			...
			compressionTypes = com.sun.imageio.plugins.bmp.BMPCompressionTypes.compressionTypes

			' Set compression flag.
			___canWriteCompressed = True
			compressionMode = MODE_COPY_FROM_METADATA
			compressionType = compressionTypes(com.sun.imageio.plugins.bmp.BMPConstants.BI_RGB)
		End Sub
		...
		''' </summary>
		''' <param name="topDown"> whether the data are written in top-down order. </param>
		Public Overridable Property topDown As Boolean
			Set(ByVal topDown As Boolean)
				Me.topDown = topDown
			End Set
			Get
				Return topDown
