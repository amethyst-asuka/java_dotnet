...
Namespace javax.imageio.metadata
	...
	''' </summary>
	''' <seealso cref= IIOMetadata#setController </seealso>
	''' <seealso cref= IIOMetadata#getController </seealso>
	''' <seealso cref= IIOMetadata#getDefaultController </seealso>
	''' <seealso cref= IIOMetadata#hasController </seealso>
	''' <seealso cref= IIOMetadata#activateController
	'''  </seealso>
	Public Interface IIOMetadataController
		...
		''' operation).
		''' </summary>
		''' <param name="metadata"> the <code>IIOMetadata</code> object to be modified.
		''' </param>
		''' <returns> <code>true</code> if the <code>IIOMetadata</code> has been
		''' modified, <code>false</code> otherwise.
		''' </returns>
		''' <exception cref="IllegalArgumentException"> if <code>metadata</code> is
		''' <code>null</code> or is not an instance of the correct class. </exception>
		Function activate(ByVal metadata As IIOMetadata) As Boolean
	End Interface
