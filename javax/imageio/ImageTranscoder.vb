...
Namespace javax.imageio
	...
	Public Interface ImageTranscoder
		...
		''' </summary>
		''' <param name="inData"> an <code>IIOMetadata</code> object representing
		...
		''' </returns>
		''' <exception cref="IllegalArgumentException"> if <code>inData</code> is
		''' <code>null</code>. </exception>
		Function convertStreamMetadata(ByVal inData As javax.imageio.metadata.IIOMetadata, ByVal param As ImageWriteParam) As javax.imageio.metadata.IIOMetadata
		...
		''' metadata will be associated. </param>
		''' <param name="param"> an <code>ImageWriteParam</code> that will be used to
		''' encode the image, or <code>null</code>.
		''' </param>
		''' <returns> an <code>IIOMetadata</code> object,
		''' or <code>null</code> if the plug-in does not provide
		''' metadata encoding capabilities.
		''' </returns>
		''' <exception cref="IllegalArgumentException"> if either of
		''' <code>inData</code> or <code>imageType</code> is
		''' <code>null</code>. </exception>
		Function convertImageMetadata(ByVal inData As javax.imageio.metadata.IIOMetadata, ByVal imageType As ImageTypeSpecifier, ByVal param As ImageWriteParam) As javax.imageio.metadata.IIOMetadata
	End Interface
