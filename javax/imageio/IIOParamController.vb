...
Namespace javax.imageio
	...
	''' </summary>
	''' <seealso cref= IIOParam#setController </seealso>
	''' <seealso cref= IIOParam#getController </seealso>
	''' <seealso cref= IIOParam#getDefaultController </seealso>
	''' <seealso cref= IIOParam#hasController </seealso>
	''' <seealso cref= IIOParam#activateController
	'''  </seealso>
	Public Interface IIOParamController
		...
		''' </summary>
		''' <param name="param"> the <code>IIOParam</code> object to be modified.
		''' </param>
		''' <returns> <code>true</code> if the <code>IIOParam</code> has been
		''' modified, <code>false</code> otherwise.
		''' </returns>
		''' <exception cref="IllegalArgumentException"> if <code>param</code> is
		''' <code>null</code> or is not an instance of the correct class. </exception>
		Function activate(ByVal param As IIOParam) As Boolean
	End Interface
