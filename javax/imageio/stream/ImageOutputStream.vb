...
Namespace javax.imageio.stream
	...
	''' </summary>
	''' <seealso cref= ImageInputStream
	'''  </seealso>
	Public Interface ImageOutputStream
		Inherits ImageInputStream, java.io.DataOutput
		...
		''' <seealso cref="ImageOutputStreamImpl#flushBits flushBits"/>
		''' method of <seealso cref="ImageOutputStreamImpl ImageOutputStreamImpl"/>
		''' to guarantee this.
		''' </summary>
		''' <param name="b"> an <code>int</code> whose lower 8 bits are to be
		''' written.
		''' </param>
		...
		''' write.
		''' </summary>
		''' <param name="b"> an array of <code>byte</code>s to be written.
		''' </param>
		...
		''' to guarantee this.
		''' </summary>
		''' <param name="b"> an array of <code>byte</code>s to be written. </param>
		''' <param name="off"> the start offset in the data. </param>
		''' <param name="len"> the number of <code>byte</code>s to write.
		''' </param>
		...
		''' write.
		''' </summary>
		''' <param name="v"> the <code>boolean</code> to be written.
		''' </param>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		...
		''' write.
		''' </summary>
		''' <param name="v"> an <code>int</code> containing the byte value to be
		''' written.
		''' </param>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		...
		''' write.
		''' </summary>
		''' <param name="v"> an <code>int</code> containing the short value to be
		''' written.
		''' </param>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		...
		''' <summary>
		''' This method is a synonym for <seealso cref="#writeShort writeShort"/>.
		''' </summary>
		''' <param name="v"> an <code>int</code> containing the char (unsigned
		''' short) value to be written.
		''' </param>
		''' <exception cref="IOException"> if an I/O error occurs.
		''' </exception>
		''' <seealso cref= #writeShort(int) </seealso>
		...
		''' write.
		''' </summary>
		''' <param name="v"> an <code>int</code> containing the value to be
		''' written.
		''' </param>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		...
		''' write.
		''' </summary>
		''' <param name="v"> a <code>long</code> containing the value to be
		''' written.
		''' </param>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		...
		''' write.
		''' </summary>
		''' <param name="v"> a <code>float</code> containing the value to be
		''' written.
		''' </param>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		...
		''' write.
		''' </summary>
		''' <param name="v"> a <code>double</code> containing the value to be
		''' written.
		''' </param>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		...
		''' write.
		''' </summary>
		''' <param name="s"> a <code>String</code> containing the value to be
		''' written.
		''' </param>
		...
		''' <exception cref="NullPointerException"> if <code>s</code> is
		''' <code>null</code>. </exception>
		''' <exception cref="java.io.UTFDataFormatException"> if the modified UTF-8
		''' representation of <code>s</code> requires more than 65536 bytes. </exception>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		...
		''' write.
		''' </summary>
		''' <param name="s"> an array of <code>short</code>s to be written. </param>
		''' <param name="off"> the start offset in the data. </param>
		''' <param name="len"> the number of <code>short</code>s to write.
		''' </param>
		''' <exception cref="IndexOutOfBoundsException"> if <code>off</code> is
		''' negative, <code>len</code> is negative, or <code>off +
		...
		''' <code>null</code>. </exception>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		Sub writeShorts(ByVal s As Short(), ByVal [off] As Integer, ByVal len As Integer)
		...
		''' write.
		''' </summary>
		''' <param name="c"> an array of <code>char</code>s to be written. </param>
		''' <param name="off"> the start offset in the data. </param>
		''' <param name="len"> the number of <code>char</code>s to write.
		''' </param>
		''' <exception cref="IndexOutOfBoundsException"> if <code>off</code> is
		''' negative, <code>len</code> is negative, or <code>off +
		...
		''' <code>null</code>. </exception>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		Sub writeChars(ByVal c As Char(), ByVal [off] As Integer, ByVal len As Integer)
		...
		''' write.
		''' </summary>
		''' <param name="i"> an array of <code>int</code>s to be written. </param>
		''' <param name="off"> the start offset in the data. </param>
		''' <param name="len"> the number of <code>int</code>s to write.
		''' </param>
		''' <exception cref="IndexOutOfBoundsException"> if <code>off</code> is
		''' negative, <code>len</code> is negative, or <code>off +
		...
		''' <code>null</code>. </exception>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		Sub writeInts(ByVal i As Integer(), ByVal [off] As Integer, ByVal len As Integer)
		...
		''' write.
		''' </summary>
		''' <param name="l"> an array of <code>long</code>s to be written. </param>
		''' <param name="off"> the start offset in the data. </param>
		''' <param name="len"> the number of <code>long</code>s to write.
		''' </param>
		''' <exception cref="IndexOutOfBoundsException"> if <code>off</code> is
		''' negative, <code>len</code> is negative, or <code>off +
		...
		''' <code>null</code>. </exception>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		Sub writeLongs(ByVal l As Long(), ByVal [off] As Integer, ByVal len As Integer)
		...
		''' write.
		''' </summary>
		''' <param name="f"> an array of <code>float</code>s to be written. </param>
		''' <param name="off"> the start offset in the data. </param>
		''' <param name="len"> the number of <code>float</code>s to write.
		''' </param>
		''' <exception cref="IndexOutOfBoundsException"> if <code>off</code> is
		''' negative, <code>len</code> is negative, or <code>off +
		...
		''' <code>null</code>. </exception>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		Sub writeFloats(ByVal f As Single(), ByVal [off] As Integer, ByVal len As Integer)
		...
		''' write.
		''' </summary>
		''' <param name="d"> an array of <code>doubles</code>s to be written. </param>
		''' <param name="off"> the start offset in the data. </param>
		''' <param name="len"> the number of <code>double</code>s to write.
		''' </param>
		''' <exception cref="IndexOutOfBoundsException"> if <code>off</code> is
		''' negative, <code>len</code> is negative, or <code>off +
		...
		''' <code>null</code>. </exception>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		Sub writeDoubles(ByVal d As Double(), ByVal [off] As Integer, ByVal len As Integer)
		...
		''' </summary>
		''' <param name="bit"> an <code>int</code> whose least significant bit
		''' is to be written to the stream.
		''' </param>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		Sub writeBit(ByVal bit As Integer)
		...
		''' bits will be set to 0 automatically.
		''' </summary>
		''' <param name="bits"> a <code>long</code> containing the bits to be
		''' written, starting with the bit in position <code>numBits -
		''' 1</code> down to the least significant bit.
		''' </param>
		''' <param name="numBits"> an <code>int</code> between 0 and 64, inclusive.
		''' </param>
		''' <exception cref="IllegalArgumentException"> if <code>numBits</code> is
		''' not between 0 and 64, inclusive. </exception>
		''' <exception cref="IOException"> if an I/O error occurs. </exception>
		Sub writeBits(ByVal bits As Long, ByVal numBits As Integer)
