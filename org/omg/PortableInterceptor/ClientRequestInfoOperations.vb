Namespace org.omg.PortableInterceptor
	...
	''' </ol>
	''' </summary>
	''' <seealso cref= ClientRequestInterceptor </seealso>
	Public Interface ClientRequestInfoOperations
		Inherits org.omg.PortableInterceptor.RequestInfoOperations

	  ''' <summary>
	  ''' Returns the object which the client called to perform the 
	  ''' operation. 
	  ''' </summary>
	  ''' <seealso cref= #effective_target </seealso>
	  Function target() As org.omg.CORBA.Object
	  ...
	  Function effective_target() As org.omg.CORBA.Object
	  ...
	  ''' </summary>
	  Function effective_profile() As org.omg.IOP.TaggedProfile
	  ...
	  ''' attribute.
	  ''' </summary>
	  ''' <seealso cref= #received_exception_id </seealso>
	  Function received_exception() As org.omg.CORBA.Any

	  ''' <summary>
	  ''' Returns the repository id of the exception to be returned to 
	  ''' the client.
	  ''' </summary>
	  ''' <seealso cref= #received_exception </seealso>
	  ...
	  Function received_exception_id() As String
	  ...
	  ''' </summary>
	  ''' <param name="id"> The component id of the component which 
	  '''     is to be returned. </param>
	  ''' <returns> The <code>IOP.TaggedComponent</code> obtained with the 
	  '''     given identifier. </returns>
	  ''' <exception cref="BAD_PARAM"> thrown, with a standard minor code of 28, if
	  '''     no component exists for the given component ID. </exception>
	  ''' <seealso cref= #get_effective_components </seealso>
	  Function get_effective_component(ByVal id As Integer) As org.omg.IOP.TaggedComponent

	  ''' <summary>
	  ''' Returns an array of all tagged components with the given ID from the 
	  ''' profile selected for this request. 
	  ''' </summary>
	  ''' <param name="id"> The component id of the components which are to be returned. </param>
	  ''' <returns> An array of <code>TaggedComponent</code> objects, each of 
	  '''     which contains the given identifier. </returns>
	  ''' <exception cref="BAD_PARAM"> thrown, with a standard minor code of 28, if
	  '''     no component exists for the given component ID. </exception>
	  ''' <seealso cref= #get_effective_component </seealso>
	  Function get_effective_components(ByVal id As Integer) As org.omg.IOP.TaggedComponent()

	  ''' <summary>
	  ''' Returns the given policy in effect for this operation. 
	  ''' </summary>
	  ''' <exception cref="INV_POLICY"> thrown, with a standard minor code of 1, if the 
	  ...
	  '''     is not associated with this Object </exception>
	  ''' <param name="type"> The policy type which specifies the policy to be 
	  '''     returned. </param>
	  ''' <returns> The <code>CORBA.Policy</code> obtained with the given type. </returns>
	  ''' <seealso cref= <a href="package-summary.html#unimpl">
	  '''     <code>PortableInterceptor</code> package comments for 
	  '''     limitations / unimplemented features</a> </seealso>
	  Function get_request_policy(ByVal type As Integer) As org.omg.CORBA.Policy
	  ...
	  ''' </summary>
	  ''' <param name="service_context"> The <code>IOP.ServiceContext</code> to be 
	  '''     added to the request. </param>
	  ''' <param name="replace"> Indicates the behavior of this operation when a 
	  ...
	  '''     replaced by the new one. </param>
	  Sub add_request_service_context(ByVal service_context As org.omg.IOP.ServiceContext, ByVal replace As Boolean)
	End Interface ' interface ClientRequestInfoOperations
