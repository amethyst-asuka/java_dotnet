Namespace org.omg.PortableInterceptor
	...
	''' </ol>
	''' </summary>
	''' <seealso cref= ServerRequestInterceptor </seealso>
	Public Interface ServerRequestInfoOperations
	  ...
	  ''' servant.
	  ''' </summary>
	  Function target_most_derived_interface() As String
	  ...
	  ''' </summary>
	  ''' <param name="type"> The <code>CORBA.PolicyType</code> which specifies the 
	  '''     policy to be returned. </param>
	  ''' <returns> The <code>CORBA.Policy</code> obtained with the given 
	  '''     policy type. </returns>
	  ''' <exception cref="INV_POLICY"> thrown, with a standard minor code of 2, if
	  '''     a policy for the given type was not registered via 
	  '''     <code>register_policy_factory</code>. </exception>
	  ''' <seealso cref= ORBInitInfo#register_policy_factory </seealso>
	  Function get_server_policy(ByVal type As Integer) As org.omg.CORBA.Policy
	  ...
	  ''' <param name="data"> The data, in the form of an any, to store in that slot. </param>
	  ''' <exception cref="InvalidSlot"> thrown if the ID does not define an allocated 
	  '''     slot. </exception>
	  ...
	  ''' false if it is not. 
	  ''' </summary>
	  ''' <param name="id"> The caller wants to know if the servant is this 
	  '''     repository id. </param>
	  ''' <returns> Is the servant the given RepositoryId? </returns>
	  Function target_is_a(ByVal id As String) As Boolean
	  ...
	  ''' </summary>
	  ''' <param name="service_context"> The <code>IOP.ServiceContext</code> to add to 
	  '''     the reply. </param>
	  ...
	  ''' <exception cref="BAD_INV_ORDER"> thrown, with a standard minor code of 15, if
	  '''     replace is false and a service context already exists with the
	  '''     given ID. </exception>
	  Sub add_reply_service_context(ByVal service_context As org.omg.IOP.ServiceContext, ByVal replace As Boolean)
	End Interface ' interface ServerRequestInfoOperations
