Namespace org.omg.PortableInterceptor
	...
	Public Interface IORInterceptorOperations
	  ...
	  ''' </summary>
	  ''' <param name="info"> The <code>IORInfo</code> instance used by the ORB 
	  '''     service to query applicable policies and add components to be 
	  '''     included in the generated IORs. </param>
	  Sub establish_components(ByVal info As org.omg.PortableInterceptor.IORInfo)
	End Interface ' interface IORInterceptorOperations
