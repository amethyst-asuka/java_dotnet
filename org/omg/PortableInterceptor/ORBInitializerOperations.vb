Namespace org.omg.PortableInterceptor
	...
	''' </summary>
	''' <seealso cref= ORBInitInfo </seealso>
	Public Interface ORBInitializerOperations
	  ...
	  ''' </summary>
	  ''' <param name="info"> provides initialization attributes and operations by 
	  '''     which Interceptors can be registered. </param>
	  Sub pre_init(ByVal info As org.omg.PortableInterceptor.ORBInitInfo)
	  ...
	  ''' </summary>
	  ''' <param name="info"> provides initialization attributes and 
	  '''     operations by which Interceptors can be registered. </param>
	  Sub post_init(ByVal info As org.omg.PortableInterceptor.ORBInitInfo)
	End Interface ' interface ORBInitializerOperations
