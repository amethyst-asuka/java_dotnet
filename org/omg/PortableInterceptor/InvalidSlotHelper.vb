...
Namespace org.omg.PortableInterceptor
	...
	Public MustInherit Class InvalidSlotHelper
	  Private Shared _id As String = "IDL:omg.org/PortableInterceptor/InvalidSlot:1.0"

	  Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As org.omg.PortableInterceptor.InvalidSlot)
	  ...
	  Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As org.omg.PortableInterceptor.InvalidSlot
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.PortableInterceptor.InvalidSlot
		Dim value As New org.omg.PortableInterceptor.InvalidSlot
		' read and discard the repository ID
		istream.read_string()
		Return value
	  End Function

	  Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As org.omg.PortableInterceptor.InvalidSlot)
