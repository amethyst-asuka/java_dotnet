Namespace org.omg.PortableInterceptor
	...
	Public Interface ServerRequestInterceptorOperations
	  ...
	  Sub receive_request_service_contexts(ByVal ri As org.omg.PortableInterceptor.ServerRequestInfo)
	  ...
	  '''     retry of the request should occur with the new object given in
	  '''     the exception. </exception>
	  Sub receive_request(ByVal ri As org.omg.PortableInterceptor.ServerRequestInfo)
	  ...
	  ''' </summary>
	  ''' <param name="ri"> Information about the current request being intercepted. </param>
	  Sub send_reply(ByVal ri As org.omg.PortableInterceptor.ServerRequestInfo)
	  ...
	  '''     retry of the request should occur with the new object given in
	  '''     the exception. </exception>
	  Sub send_exception(ByVal ri As org.omg.PortableInterceptor.ServerRequestInfo)
	  ...
	  '''     retry of the request should occur with the new object given in
	  '''     the exception. </exception>
	  Sub send_other(ByVal ri As org.omg.PortableInterceptor.ServerRequestInfo)
	End Interface ' interface ServerRequestInterceptorOperations
