...
Namespace org.omg.PortableInterceptor.ORBInitInfoPackage
	...
	Public MustInherit Class InvalidNameHelper
	  Private Shared _id As String = "IDL:omg.org/PortableInterceptor/ORBInitInfo/InvalidName:1.0"

	  Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidName)
	  ...
	  Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidName
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidName
		Dim value As New org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidName
		' read and discard the repository ID
		istream.read_string()
		Return value
	  End Function

	  Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As org.omg.PortableInterceptor.ORBInitInfoPackage.InvalidName)
