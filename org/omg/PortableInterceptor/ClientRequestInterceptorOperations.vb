Namespace org.omg.PortableInterceptor
	...
	Public Interface ClientRequestInterceptorOperations
		Inherits org.omg.PortableInterceptor.InterceptorOperations
	  ...
	  ''' </summary>
	  ''' <param name="ri"> Information about the current request being intercepted. </param>
	  ''' <exception cref="ForwardRequest"> If thrown, indicates to the ORB that a
	  '''     retry of the request should occur with the new object given in
	  '''     the exception. </exception>
	  Sub send_request(ByVal ri As org.omg.PortableInterceptor.ClientRequestInfo)
	  ...
	  ''' </summary>
	  ''' <param name="ri"> Information about the current request being intercepted. </param>
	  ''' <exception cref="TIMEOUT"> thrown if the response is not available before 
	  '''     the poll time-out expires </exception>
	  Sub send_poll(ByVal ri As org.omg.PortableInterceptor.ClientRequestInfo)
	  ...
	  ''' </summary>
	  ''' <param name="ri"> Information about the current request being intercepted. </param>
	  Sub receive_reply(ByVal ri As org.omg.PortableInterceptor.ClientRequestInfo)
	  ...
	  '''     retry of the request should occur with the new object given in
	  '''     the exception. </exception>
	  Sub receive_exception(ByVal ri As org.omg.PortableInterceptor.ClientRequestInfo)
	  ...
	  '''     retry of the request should occur with the new object given in
	  '''     the exception. </exception>
	  Sub receive_other(ByVal ri As org.omg.PortableInterceptor.ClientRequestInfo)
	End Interface ' interface ClientRequestInterceptorOperations
