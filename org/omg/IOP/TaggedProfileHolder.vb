Namespace org.omg.IOP
	...
	Public NotInheritable Class TaggedProfileHolder
		Implements org.omg.CORBA.portable.Streamable

	  Public value As org.omg.IOP.TaggedProfile = Nothing

	  Public Sub New()
	  End Sub

	  Public Sub New(ByVal initialValue As org.omg.IOP.TaggedProfile)
		value = initialValue
	  End Sub
