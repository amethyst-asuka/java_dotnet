...
Namespace org.omg.IOP.CodecPackage
	...
	Public MustInherit Class InvalidTypeForEncodingHelper
	  Private Shared _id As String = "IDL:omg.org/IOP/Codec/InvalidTypeForEncoding:1.0"

	  Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As org.omg.IOP.CodecPackage.InvalidTypeForEncoding)
	  ...
	  Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As org.omg.IOP.CodecPackage.InvalidTypeForEncoding
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.IOP.CodecPackage.InvalidTypeForEncoding
		Dim value As New org.omg.IOP.CodecPackage.InvalidTypeForEncoding
		' read and discard the repository ID
		istream.read_string()
		Return value
	  End Function

	  Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As org.omg.IOP.CodecPackage.InvalidTypeForEncoding)
