...
Namespace org.omg.IOP
	...
	Public MustInherit Class ServiceContextListHelper
	  Private Shared _id As String = "IDL:omg.org/IOP/ServiceContextList:1.0"
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.IOP.ServiceContext()
		Dim value As org.omg.IOP.ServiceContext() = Nothing
		Dim _len0 As Integer = istream.read_long()
		value = New org.omg.IOP.ServiceContext(_len0 - 1){}
