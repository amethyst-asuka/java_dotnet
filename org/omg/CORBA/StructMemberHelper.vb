...
Namespace org.omg.CORBA
	...
	Public MustInherit Class StructMemberHelper
	  Private Shared _id As String = "IDL:omg.org/CORBA/StructMember:1.0"

	  Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As org.omg.CORBA.StructMember)
	  ...
	  Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As org.omg.CORBA.StructMember
		...
		If __typeCode Is Nothing Then
		  SyncLock GetType(org.omg.CORBA.TypeCode)
			If __typeCode Is Nothing Then
			  ...
			  __active = True
			  Dim _members0 As org.omg.CORBA.StructMember() = New org.omg.CORBA.StructMember (2){}
			  ...
			  _members0(1) = New org.omg.CORBA.StructMember("type", _tcOf_members0, Nothing)
			  _tcOf_members0 = org.omg.CORBA.IDLTypeHelper.type()
			  _members0(2) = New org.omg.CORBA.StructMember("type_def", _tcOf_members0, Nothing)
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.CORBA.StructMember
		Dim value As New org.omg.CORBA.StructMember
	  ...
	  Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As org.omg.CORBA.StructMember)
