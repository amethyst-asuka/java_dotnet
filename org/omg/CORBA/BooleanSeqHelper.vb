...
Namespace org.omg.CORBA
	...
	Public MustInherit Class BooleanSeqHelper
		Private Shared _id As String = "IDL:omg.org/CORBA/BooleanSeq:1.0"

		Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As Boolean())
		...
		Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As Boolean()
		...
		Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As Boolean()
			Dim value As Boolean() = Nothing
			Dim _len0 As Integer = istream.read_long()
			value = New Boolean(_len0 - 1){}
			istream.read_boolean_array(value, 0, _len0)
			Return value
		End Function

		Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As Boolean())
