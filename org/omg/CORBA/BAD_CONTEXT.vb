...
Namespace org.omg.CORBA
	...
	Public NotInheritable Class BAD_CONTEXT
		...
		''' of 0 and a completion state of COMPLETED_NO. </summary>
		''' <param name="s"> a <code>String</code> object containing a detail message </param>
