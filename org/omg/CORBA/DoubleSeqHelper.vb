...
Namespace org.omg.CORBA
	...
	Public MustInherit Class DoubleSeqHelper
		Private Shared _id As String = "IDL:omg.org/CORBA/DoubleSeq:1.0"

		Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As Double())
		...
		Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As Double()
		...
		Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As Double()
			Dim value As Double() = Nothing
			Dim _len0 As Integer = istream.read_long()
			value = New Double(_len0 - 1){}
			istream.read_double_array(value, 0, _len0)
			Return value
		End Function

		Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As Double())
