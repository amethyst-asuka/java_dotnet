...
Namespace org.omg.CORBA
	...
	''' </summary>
	''' <seealso cref= Any </seealso>
	''' <seealso cref= ARG_IN </seealso>
	''' <seealso cref= ARG_INOUT </seealso>
	''' <seealso cref= ARG_OUT
	''' 
	''' @since       JDK1.2 </seealso>

	Public MustInherit Class NamedValue

		''' <summary>
		''' Retrieves the name for this <code>NamedValue</code> object.
		''' </summary>
		''' <returns>                  a <code>String</code> object representing
		'''                    the name of this <code>NamedValue</code> object </returns>
		...
		''' </summary>
		''' <returns>                  an <code>Any</code> object containing
		'''                    the value of this <code>NamedValue</code> object </returns>

		Public MustOverride Function value() As Any

		''' <summary>
		''' Retrieves the argument mode flag for this <code>NamedValue</code> object.
		''' </summary>
		''' <returns>                  an <code>int</code> representing the argument
		'''                    mode for this <code>NamedValue</code> object </returns>

		Public MustOverride Function flags() As Integer
