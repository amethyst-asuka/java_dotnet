...
Namespace org.omg.CORBA
	...
	''' @since       JDK1.2
	''' </summary>
	Public NotInheritable Class StringHolder
		...
		''' <param name="initial"> the <code>String</code> with which to initialize
		'''                the <code>value</code> field of the newly-created
		'''                <code>StringHolder</code> object </param>
		Public Sub New(ByVal initial As String)
			value = initial
		End Sub
		...
		''' </summary>
		''' <returns>    the type code of the value held in this <code>StringHolder</code>
		'''            object </returns>
