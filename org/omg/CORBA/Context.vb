...
Namespace org.omg.CORBA
	...
	Public MustInherit Class Context
		...
		''' </summary>
		''' <returns>                  the name of this <code>Context</code> object </returns>

		Public MustOverride Function context_name() As String


		''' <summary>
		''' Retrieves the parent of this <code>Context</code> object.
		''' </summary>
		''' <returns>                  the <code>Context</code> object that is the
		'''                    parent of this <code>Context</code> object </returns>

		Public MustOverride Function parent() As Context
		...
		''' 
		''' </summary>
		''' <param name="child_ctx_name">    the <code>String</code> object to be set as
		'''                        the name of the new <code>Context</code> object </param>
		''' <returns>                  the newly-created child <code>Context</code> object
		'''                    initialized with the specified name </returns>

		Public MustOverride Function create_child(ByVal child_ctx_name As String) As Context
		...
		''' <param name="propvalue">         the <code>Any</code> object to which the
		...
		'''                        <code>TCKind.tk_string</code>. </param>

		Public MustOverride Sub set_one_value(ByVal propname As String, ByVal propvalue As Any)
		...
		''' </summary>
		''' <param name="values">          an NVList containing the property
		'''                                    names and associated values to be set
		''' </param>
		''' <seealso cref= #get_values </seealso>
		''' <seealso cref= org.omg.CORBA.NamedValue </seealso>
		''' <seealso cref= org.omg.CORBA.Any </seealso>

		Public MustOverride Sub set_values(ByVal values As NVList)
		...
		Public MustOverride Sub delete_values(ByVal propname As String)
		...
		''' is returned.
		''' </summary>
		''' <param name="start_scope">               a <code>String</code> object indicating the
		...
		'''                          not found, an exception is returned. </param>
		''' <param name="op_flags">       an operation flag.  The one flag
		...
		'''                <code>Context</code> object. </param>
		''' <param name="pattern">           the property name whose values are to
		'''                          be retrieved. <code>pattern</code> may be a
		'''                name or a name with a
		'''                          trailing wildcard character ("*").
		''' </param>
		''' <returns>          an <code>NVList</code> containing all the property values
		'''                (in the form of <code>NamedValue</code> objects)
		'''                whose associated property name matches the given name or
		'''                name pattern </returns>
		''' <seealso cref= #set_values </seealso>
		''' <seealso cref= org.omg.CORBA.NamedValue </seealso>

		Public MustOverride Function get_values(ByVal start_scope As String, ByVal op_flags As Integer, ByVal pattern As String) As NVList
	End Class
