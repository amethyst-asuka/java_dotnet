...
Namespace org.omg.CORBA
	...
	''' IR objects must implement the IRObjectOperations interface. </summary>
	''' <seealso cref= IDLTypeOperations </seealso>
	...
	Public Interface IRObjectOperations
		...
		' read interface
		''' <summary>
		''' Returns the <code>DefinitionKind</code> corresponding to this Interface Repository object. </summary>
		''' <returns> the <code>DefinitionKind</code> corresponding to this Interface Repository object. </returns>
		Function def_kind() As org.omg.CORBA.DefinitionKind
		...
		''' with the minor code 1. </summary>
		''' <exception cref="BAD_INV_ORDER"> if this method is invoked on a repository or
		'''            <code>PrimitiveDef</code>, or if an attempt to destroy an
		'''            object would leave the repository in an incoherent state </exception>
		Sub destroy()
	End Interface ' interface IRObjectOperations
