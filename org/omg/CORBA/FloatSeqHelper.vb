...
Namespace org.omg.CORBA
	...
	Public MustInherit Class FloatSeqHelper
		Private Shared _id As String = "IDL:omg.org/CORBA/FloatSeq:1.0"

		Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As Single())
		...
		Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As Single()
		...
		Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As Single()
			Dim value As Single() = Nothing
			Dim _len0 As Integer = istream.read_long()
			value = New Single(_len0 - 1){}
			istream.read_float_array(value, 0, _len0)
			Return value
		End Function

		Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As Single())
