...
Namespace org.omg.CORBA
	...
	Public Interface PolicyOperations
	  ...
	  Function policy_type() As Integer
	  ...
	  ''' </summary>
	  ''' <returns> a copy of the <code>Policy</code> object </returns>
	  Function copy() As org.omg.CORBA.Policy
	  ...
	  ''' </summary>
	  Sub destroy()
	End Interface ' interface PolicyOperations
