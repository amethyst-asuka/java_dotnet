...
Namespace org.omg.PortableServer
	...
	Public MustInherit Class ForwardRequestHelper
	  Private Shared _id As String = "IDL:omg.org/PortableServer/ForwardRequest:1.0"

	  Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As org.omg.PortableServer.ForwardRequest)
	  ...
	  Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As org.omg.PortableServer.ForwardRequest
		...
		If __typeCode Is Nothing Then
		  SyncLock GetType(org.omg.CORBA.TypeCode)
			If __typeCode Is Nothing Then
			  ...
			  _members0(0) = New org.omg.CORBA.StructMember("forward_reference", _tcOf_members0, Nothing)
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.PortableServer.ForwardRequest
		Dim value As New org.omg.PortableServer.ForwardRequest
	  ...
	  Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As org.omg.PortableServer.ForwardRequest)
