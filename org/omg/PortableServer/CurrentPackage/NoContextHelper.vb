...
Namespace org.omg.PortableServer.CurrentPackage
	...
	Public MustInherit Class NoContextHelper
	  Private Shared _id As String = "IDL:omg.org/PortableServer/Current/NoContext:1.0"

	  Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As org.omg.PortableServer.CurrentPackage.NoContext)
	  ...
	  Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As org.omg.PortableServer.CurrentPackage.NoContext
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.PortableServer.CurrentPackage.NoContext
		Dim value As New org.omg.PortableServer.CurrentPackage.NoContext
		' read and discard the repository ID
		istream.read_string()
		Return value
	  End Function

	  Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As org.omg.PortableServer.CurrentPackage.NoContext)
