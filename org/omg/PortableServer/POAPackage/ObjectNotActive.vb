Namespace org.omg.PortableServer.POAPackage
	...
	Public NotInheritable Class ObjectNotActive
		Inherits org.omg.CORBA.UserException

	  Public Sub New()
		MyBase.New(ObjectNotActiveHelper.id())
	  End Sub ' ctor


	  Public Sub New(ByVal $reason As String)
		MyBase.New(ObjectNotActiveHelper.id() & "  " & $reason)
	  End Sub ' ctor

	End Class ' class ObjectNotActive
