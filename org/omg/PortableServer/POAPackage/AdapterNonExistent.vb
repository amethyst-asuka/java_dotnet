Namespace org.omg.PortableServer.POAPackage
	...
	Public NotInheritable Class AdapterNonExistent
		Inherits org.omg.CORBA.UserException

	  Public Sub New()
		MyBase.New(AdapterNonExistentHelper.id())
	  End Sub ' ctor


	  Public Sub New(ByVal $reason As String)
		MyBase.New(AdapterNonExistentHelper.id() & "  " & $reason)
	  End Sub ' ctor

	End Class ' class AdapterNonExistent
