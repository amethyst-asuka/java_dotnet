Namespace org.omg.PortableServer.POAPackage
	...
	Public NotInheritable Class ObjectAlreadyActive
		Inherits org.omg.CORBA.UserException

	  Public Sub New()
		MyBase.New(ObjectAlreadyActiveHelper.id())
	  End Sub ' ctor


	  Public Sub New(ByVal $reason As String)
		MyBase.New(ObjectAlreadyActiveHelper.id() & "  " & $reason)
	  End Sub ' ctor

	End Class ' class ObjectAlreadyActive
