Namespace org.omg.PortableServer.POAPackage
	...
	Public NotInheritable Class ServantAlreadyActive
		Inherits org.omg.CORBA.UserException

	  Public Sub New()
		MyBase.New(ServantAlreadyActiveHelper.id())
	  End Sub ' ctor


	  Public Sub New(ByVal $reason As String)
		MyBase.New(ServantAlreadyActiveHelper.id() & "  " & $reason)
	  End Sub ' ctor

	End Class ' class ServantAlreadyActive
