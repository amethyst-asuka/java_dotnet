Namespace org.omg.PortableServer.POAPackage
	...
	Public NotInheritable Class ServantNotActive
		Inherits org.omg.CORBA.UserException

	  Public Sub New()
		MyBase.New(ServantNotActiveHelper.id())
	  End Sub ' ctor


	  Public Sub New(ByVal $reason As String)
		MyBase.New(ServantNotActiveHelper.id() & "  " & $reason)
	  End Sub ' ctor

	End Class ' class ServantNotActive
