...
Namespace org.omg.DynamicAny.DynAnyPackage
	...
	Public MustInherit Class TypeMismatchHelper
	  Private Shared _id As String = "IDL:omg.org/DynamicAny/DynAny/TypeMismatch:1.0"

	  Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As org.omg.DynamicAny.DynAnyPackage.TypeMismatch)
	  ...
	  Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As org.omg.DynamicAny.DynAnyPackage.TypeMismatch
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.DynamicAny.DynAnyPackage.TypeMismatch
		Dim value As New org.omg.DynamicAny.DynAnyPackage.TypeMismatch
		' read and discard the repository ID
		istream.read_string()
		Return value
	  End Function

	  Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As org.omg.DynamicAny.DynAnyPackage.TypeMismatch)
