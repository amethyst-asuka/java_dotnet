...
Namespace org.omg.DynamicAny
	...
	Public MustInherit Class NameDynAnyPairHelper
	  Private Shared _id As String = "IDL:omg.org/DynamicAny/NameDynAnyPair:1.0"
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.DynamicAny.NameDynAnyPair
		Dim value As New org.omg.DynamicAny.NameDynAnyPair
