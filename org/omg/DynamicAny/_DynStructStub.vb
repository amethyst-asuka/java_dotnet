...
Namespace org.omg.DynamicAny
	...
	Public Class _DynStructStub
	  ...
	  Public Shared ReadOnly _opsClass As Type = GetType(DynStructOperations)
	  ...
	  Public Overridable Function current_member_name() As String
		  ...
		  Dim $self As DynStructOperations = CType($so.servant, DynStructOperations)
	  ...
	  Private Shared __ids As String() = { "IDL:omg.org/DynamicAny/DynStruct:1.0", "IDL:omg.org/DynamicAny/DynAny:1.0"}
	  ...
	  Private Sub writeObject(ByVal s As java.io.ObjectOutputStream)
	   ...
	   End Try
	  End Sub
	End Class ' class _DynStructStub
