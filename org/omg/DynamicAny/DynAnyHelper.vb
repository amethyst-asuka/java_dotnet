...
Namespace org.omg.DynamicAny
	...
	''' </summary>
	Public MustInherit Class DynAnyHelper
	  Private Shared _id As String = "IDL:omg.org/DynamicAny/DynAny:1.0"
	  ...
	  Public Shared Function type() As org.omg.CORBA.TypeCode
		If __typeCode Is Nothing Then __typeCode = org.omg.CORBA.ORB.init().create_interface_tc(org.omg.DynamicAny.DynAnyHelper.id(), "DynAny")
		Return __typeCode
	  End Function
	  ...
	  Public Shared Function narrow(ByVal obj As org.omg.CORBA.Object) As org.omg.DynamicAny.DynAny
		If obj Is Nothing Then
		  Return Nothing
		ElseIf TypeOf obj Is org.omg.DynamicAny.DynAny Then
		  Return CType(obj, org.omg.DynamicAny.DynAny)
		...
		Else
		  ...
		  Dim stub As New org.omg.DynamicAny._DynAnyStub
		  stub._set_delegate([delegate])
		  Return stub
		End If
	  End Function

	  Public Shared Function unchecked_narrow(ByVal obj As org.omg.CORBA.Object) As org.omg.DynamicAny.DynAny
		If obj Is Nothing Then
		  Return Nothing
		ElseIf TypeOf obj Is org.omg.DynamicAny.DynAny Then
		  Return CType(obj, org.omg.DynamicAny.DynAny)
