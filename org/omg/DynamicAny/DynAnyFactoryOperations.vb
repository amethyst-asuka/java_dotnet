Namespace org.omg.DynamicAny
	...
	Public Interface DynAnyFactoryOperations
	  ...
	  Function create_dyn_any(ByVal value As org.omg.CORBA.Any) As org.omg.DynamicAny.DynAny
	  ...
	  ''' </UL>
	  ''' </summary>
	  Function create_dyn_any_from_type_code(ByVal type As org.omg.CORBA.TypeCode) As org.omg.DynamicAny.DynAny
	End Interface ' interface DynAnyFactoryOperations
