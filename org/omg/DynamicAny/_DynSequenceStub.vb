...
Namespace org.omg.DynamicAny
	...
	Public Class _DynSequenceStub
	  ...
	  Public Shared ReadOnly _opsClass As Type = GetType(DynSequenceOperations)
	  ...
	  ''' </summary>
	  Public Overridable Function get_length() As Integer
		  Dim $so As org.omg.CORBA.portable.ServantObject = _servant_preinvoke("get_length", _opsClass)
		  Dim $self As DynSequenceOperations = CType($so.servant, DynSequenceOperations)
	  ...
	  Public Overridable Sub set_length(ByVal len As Integer)
		  Dim $so As org.omg.CORBA.portable.ServantObject = _servant_preinvoke("set_length", _opsClass)
		  Dim $self As DynSequenceOperations = CType($so.servant, DynSequenceOperations)
	  ...
	  ''' </summary>
	  Public Overridable Function get_elements() As org.omg.CORBA.Any()
		  Dim $so As org.omg.CORBA.portable.ServantObject = _servant_preinvoke("get_elements", _opsClass)
		  Dim $self As DynSequenceOperations = CType($so.servant, DynSequenceOperations)
	  ...
	  Public Overridable Sub set_elements(ByVal value As org.omg.CORBA.Any())
		  Dim $so As org.omg.CORBA.portable.ServantObject = _servant_preinvoke("set_elements", _opsClass)
		  Dim $self As DynSequenceOperations = CType($so.servant, DynSequenceOperations)
		  ...
		  Finally
			  _servant_postinvoke($so)
		  End Try
	  End Sub ' set_elements


	  ''' <summary>
	  ''' Returns the DynAnys representing the elements of the sequence.
	  ''' </summary>
	  Public Overridable Function get_elements_as_dyn_any() As org.omg.DynamicAny.DynAny()
		  Dim $so As org.omg.CORBA.portable.ServantObject = _servant_preinvoke("get_elements_as_dyn_any", _opsClass)
		  Dim $self As DynSequenceOperations = CType($so.servant, DynSequenceOperations)
		  ...
		  Finally
			  _servant_postinvoke($so)
		  End Try
	  End Function ' get_elements_as_dyn_any
	  ...
	  '''            to the element TypeCode of the DynSequence </exception>
	  ''' <exception cref="InvalidValue"> if the length of value exceeds the bound of a bounded sequence </exception>
	  Public Overridable Sub set_elements_as_dyn_any(ByVal value As org.omg.DynamicAny.DynAny())
		  Dim $so As org.omg.CORBA.portable.ServantObject = _servant_preinvoke("set_elements_as_dyn_any", _opsClass)
		  Dim $self As DynSequenceOperations = CType($so.servant, DynSequenceOperations)
		  ...
		  Finally
			  _servant_postinvoke($so)
		  End Try
	  End Sub ' set_elements_as_dyn_any
	  ...
	  Private Shared __ids As String() = { "IDL:omg.org/DynamicAny/DynSequence:1.0", "IDL:omg.org/DynamicAny/DynAny:1.0"}
	  ...
	  Private Sub writeObject(ByVal s As java.io.ObjectOutputStream)
	   ...
	   End Try
	  End Sub
	End Class ' class _DynSequenceStub
