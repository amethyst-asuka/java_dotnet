...
Namespace org.omg.DynamicAny
	...
	Public Class _DynFixedStub
	  ...
	  Public Shared ReadOnly _opsClass As Type = GetType(DynFixedOperations)
	  ...
	  ''' </summary>
	  Public Overridable Function get_value() As String
		  Dim $so As org.omg.CORBA.portable.ServantObject = _servant_preinvoke("get_value", _opsClass)
		  Dim $self As DynFixedOperations = CType($so.servant, DynFixedOperations)
	  ...
	  Public Overridable Function set_value(ByVal val As String) As Boolean
		  Dim $so As org.omg.CORBA.portable.ServantObject = _servant_preinvoke("set_value", _opsClass)
		  Dim $self As DynFixedOperations = CType($so.servant, DynFixedOperations)
	  ...
	  Private Shared __ids As String() = { "IDL:omg.org/DynamicAny/DynFixed:1.0", "IDL:omg.org/DynamicAny/DynAny:1.0"}
