...
Namespace org.omg.DynamicAny
	...
	Public Class _DynArrayStub
	  ...
	  Public Shared ReadOnly _opsClass As Type = GetType(DynArrayOperations)
	  ...
	  Public Overridable Function get_elements() As org.omg.CORBA.Any()
		  ...
		  Dim $self As DynArrayOperations = CType($so.servant, DynArrayOperations)
	  ...
	  Private Shared __ids As String() = { "IDL:omg.org/DynamicAny/DynArray:1.0", "IDL:omg.org/DynamicAny/DynAny:1.0"}
