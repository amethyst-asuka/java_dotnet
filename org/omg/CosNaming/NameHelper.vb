...
Namespace org.omg.CosNaming
	...
	''' </summary>
	Public MustInherit Class NameHelper
	  Private Shared _id As String = "IDL:omg.org/CosNaming/Name:1.0"
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.CosNaming.NameComponent()
		Dim value As org.omg.CosNaming.NameComponent() = Nothing
		Dim _len0 As Integer = istream.read_long()
		value = New org.omg.CosNaming.NameComponent(_len0 - 1){}
