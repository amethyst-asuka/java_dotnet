...
Namespace org.omg.CosNaming.NamingContextPackage
	...
	Public MustInherit Class CannotProceedHelper
	  Private Shared _id As String = "IDL:omg.org/CosNaming/NamingContext/CannotProceed:1.0"

	  Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As org.omg.CosNaming.NamingContextPackage.CannotProceed)
	  ...
	  Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As org.omg.CosNaming.NamingContextPackage.CannotProceed
		...
		If __typeCode Is Nothing Then
		  SyncLock GetType(org.omg.CORBA.TypeCode)
			If __typeCode Is Nothing Then
			  ...
			  _members0(0) = New org.omg.CORBA.StructMember("cxt", _tcOf_members0, Nothing)
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.CosNaming.NamingContextPackage.CannotProceed
		Dim value As New org.omg.CosNaming.NamingContextPackage.CannotProceed
	  ...
	  Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As org.omg.CosNaming.NamingContextPackage.CannotProceed)
