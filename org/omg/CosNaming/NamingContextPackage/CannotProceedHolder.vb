Namespace org.omg.CosNaming.NamingContextPackage
	...
	Public NotInheritable Class CannotProceedHolder
		Implements org.omg.CORBA.portable.Streamable

	  Public value As org.omg.CosNaming.NamingContextPackage.CannotProceed = Nothing

	  Public Sub New()
	  End Sub

	  Public Sub New(ByVal initialValue As org.omg.CosNaming.NamingContextPackage.CannotProceed)
		value = initialValue
	  End Sub
