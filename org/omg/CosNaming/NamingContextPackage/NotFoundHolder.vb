Namespace org.omg.CosNaming.NamingContextPackage
	...
	Public NotInheritable Class NotFoundHolder
		Implements org.omg.CORBA.portable.Streamable

	  Public value As org.omg.CosNaming.NamingContextPackage.NotFound = Nothing

	  Public Sub New()
	  End Sub

	  Public Sub New(ByVal initialValue As org.omg.CosNaming.NamingContextPackage.NotFound)
		value = initialValue
	  End Sub
