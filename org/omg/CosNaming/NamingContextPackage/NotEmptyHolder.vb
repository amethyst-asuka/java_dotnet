Namespace org.omg.CosNaming.NamingContextPackage
	...
	Public NotInheritable Class NotEmptyHolder
		Implements org.omg.CORBA.portable.Streamable

	  Public value As org.omg.CosNaming.NamingContextPackage.NotEmpty = Nothing

	  Public Sub New()
	  End Sub

	  Public Sub New(ByVal initialValue As org.omg.CosNaming.NamingContextPackage.NotEmpty)
		value = initialValue
	  End Sub
