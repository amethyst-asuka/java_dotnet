Namespace org.omg.CosNaming.NamingContextPackage
	...
	Public NotInheritable Class InvalidNameHolder
		Implements org.omg.CORBA.portable.Streamable

	  Public value As org.omg.CosNaming.NamingContextPackage.InvalidName = Nothing

	  Public Sub New()
	  End Sub

	  Public Sub New(ByVal initialValue As org.omg.CosNaming.NamingContextPackage.InvalidName)
		value = initialValue
	  End Sub
