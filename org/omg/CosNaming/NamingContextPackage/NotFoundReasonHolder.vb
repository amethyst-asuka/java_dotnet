Namespace org.omg.CosNaming.NamingContextPackage
	...
	''' </summary>
	Public NotInheritable Class NotFoundReasonHolder
		Implements org.omg.CORBA.portable.Streamable

	  Public value As org.omg.CosNaming.NamingContextPackage.NotFoundReason = Nothing

	  Public Sub New()
	  End Sub

	  Public Sub New(ByVal initialValue As org.omg.CosNaming.NamingContextPackage.NotFoundReason)
		value = initialValue
	  End Sub
