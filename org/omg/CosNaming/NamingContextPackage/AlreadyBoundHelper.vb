...
Namespace org.omg.CosNaming.NamingContextPackage
	...
	Public MustInherit Class AlreadyBoundHelper
	  Private Shared _id As String = "IDL:omg.org/CosNaming/NamingContext/AlreadyBound:1.0"

	  Public Shared Sub insert(ByVal a As org.omg.CORBA.Any, ByVal that As org.omg.CosNaming.NamingContextPackage.AlreadyBound)
	  ...
	  Public Shared Function extract(ByVal a As org.omg.CORBA.Any) As org.omg.CosNaming.NamingContextPackage.AlreadyBound
	  ...
	  Public Shared Function read(ByVal istream As org.omg.CORBA.portable.InputStream) As org.omg.CosNaming.NamingContextPackage.AlreadyBound
		Dim value As New org.omg.CosNaming.NamingContextPackage.AlreadyBound
		' read and discard the repository ID
		istream.read_string()
		Return value
	  End Function

	  Public Shared Sub write(ByVal ostream As org.omg.CORBA.portable.OutputStream, ByVal value As org.omg.CosNaming.NamingContextPackage.AlreadyBound)
