...
Namespace org.xml.sax.ext
	...
	''' <seealso cref="XMLReader#setEntityResolver XMLReader.setEntityResolver()"/> method
	...
	''' <seealso cref="EntityResolver#resolveEntity EntityResolver.resolveEntity()"/> method.
	''' 
	''' <blockquote>
	...
	''' <seealso cref="EntityResolver"/> method will be used.
	''' </p>
	''' 
	...
	''' </p>
	''' </summary>
	''' <seealso cref= org.xml.sax.XMLReader#setEntityResolver
	''' 
	''' @since SAX 2.0 (extensions 1.1 alpha)
	''' @author David Brownell </seealso>
	Public Interface EntityResolver2
		...
		''' through the <seealso cref="LexicalHandler#startDTD startDTD()"/> method as if
		...
		''' <seealso cref="#resolveEntity resolveEntity()"/> to gain benefits such as use
		...
		'''  a new InputStream or Reader, or an illegal URL. </exception>
		Function getExternalSubset(ByVal name As String, ByVal baseURI As String) As org.xml.sax.InputSource
		...
		''' properly declared.
		''' This method provides more flexibility than the <seealso cref="EntityResolver"/>
		...
		''' by <seealso cref="#getExternalSubset getExternalSubset()"/>.
		...
		''' used in the <seealso cref="LexicalHandler"/>, or in the {@link
		...
		''' <exception cref="IOException"> Probably indicating a failure to create
		'''  a new InputStream or Reader, or an illegal URL. </exception>
		Function resolveEntity(ByVal name As String, ByVal publicId As String, ByVal baseURI As String, ByVal systemId As String) As org.xml.sax.InputSource
	End Interface
