...
Namespace org.xml.sax.ext
	...
	Public Interface Locator2
		...
		''' available in the current parsing state. </returns>
		ReadOnly Property xMLVersion As String
		...
		''' 
		''' <p>When an <seealso cref="org.xml.sax.InputSource InputSource"/> is used
		...
		''' not yet available in the current parsing state. </returns>
