...
'		public static final short NODE_ADOPTED = 5;
		...
		''' the handler is DOM implementation dependent. </summary>
		...
		'''   renamed. This is <code>null</code> when the node is being deleted. </param>
		''' <param name="dst"> Specifies the node newly created if any, or
		'''   <code>null</code>. </param>
		Sub handle(ByVal operation As Short, ByVal key As String, ByVal data As Object, ByVal src As Node, ByVal dst As Node)
