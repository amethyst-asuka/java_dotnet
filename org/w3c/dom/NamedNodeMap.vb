...
Namespace org.w3c.dom
	...
	Public Interface NamedNodeMap
		...
		Function getNamedItem(ByVal name As String) As Node
		...
		'''   Entities. </exception>
		Function setNamedItem(ByVal arg As Node) As Node
		...
		''' <param name="name"> The <code>nodeName</code> of the node to remove. </param>
		...
		Function removeNamedItem(ByVal name As String) As Node
		...
		''' for methods if they wish to have no namespace. </summary>
		...
		Function getNamedItemNS(ByVal namespaceURI As String, ByVal localName As String) As Node
		...
		'''   Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]).
		''' @since DOM Level 2 </exception>
		Function setNamedItemNS(ByVal arg As Node) As Node
		...
		'''   Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]).
		''' @since DOM Level 2 </exception>
		Function removeNamedItemNS(ByVal namespaceURI As String, ByVal localName As String) As Node
