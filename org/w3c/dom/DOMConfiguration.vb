...
Namespace org.w3c.dom
	...
	Public Interface DOMConfiguration
		''' <summary>
		''' Set the value of a parameter. </summary>
		''' <param name="name"> The name of the parameter to set. </param>
		''' <param name="value">  The new value or <code>null</code> if the user wishes to
		...
		'''   <code>DOMErrorHandler</code>. </param>
		...
		'''   name is incompatible with the expected value type. </exception>
		Sub setParameter(ByVal name As String, ByVal value As Object)

		''' <summary>
		'''  Return the value of a parameter if known. </summary>
		...
		''' <exception cref="DOMException">
		'''    NOT_FOUND_ERR: Raised when the parameter name is not recognized. </exception>
		Function getParameter(ByVal name As String) As Object

		''' <summary>
		''' Check if setting a parameter to a specific value is supported. </summary>
		''' <param name="name"> The name of the parameter to check. </param>
		''' <param name="value">  An object. if <code>null</code>, the returned value is
		'''   <code>true</code>. </param>
		''' <returns>  <code>true</code> if the parameter could be successfully set
		...
		Function canSetParameter(ByVal name As String, ByVal value As Object) As Boolean
		...
		''' </summary>
		ReadOnly Property parameterNames As DOMStringList
