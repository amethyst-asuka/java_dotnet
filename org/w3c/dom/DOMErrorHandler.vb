...
Namespace org.w3c.dom
	...
	Public Interface DOMErrorHandler
		...
		''' equivalent of returning <code>true</code>. </summary>
		''' <param name="error">  The error object that describes the error. This object
		'''   may be reused by the DOM implementation across multiple calls to
		'''   the <code>handleError</code> method. </param>
		''' <returns>  If the <code>handleError</code> method returns
		...
		'''   <code>DOMError.severity</code>. </returns>
		Function handleError(ByVal [error] As DOMError) As Boolean
