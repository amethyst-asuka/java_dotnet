...
Namespace org.w3c.dom.ls
	...
	Public Interface LSParser
		...
		''' </dl>
		''' </summary>
		ReadOnly Property domConfig As org.w3c.dom.DOMConfiguration
		...
		''' filter.
		''' </summary>
		Property filter As LSParserFilter
		...
		'''   <code>LSParser.busy</code> attribute is <code>true</code>. </exception>
		...
		'''   error-handler</a>" if they wish to get details on the error. </exception>
		Function parse(ByVal input As LSInput) As org.w3c.dom.Document
		...
		''' this specification may define the behavior. </summary>
		...
		'''   attribute is <code>true</code>. </exception>
		''' <exception cref="LSException">
		'''    PARSE_ERR: Raised if the <code>LSParser</code> was unable to load
		'''   the XML document. DOM applications should attach a
		'''   <code>DOMErrorHandler</code> using the parameter "<a href='http://www.w3.org/TR/DOM-Level-3-Core/core.html#parameter-error-handler'>
		'''   error-handler</a>" if they wish to get details on the error. </exception>
		Function parseURI(ByVal uri As String) As org.w3c.dom.Document
...
'		public static final short ACTION_REPLACE = 5;
		...
		'''   <code>DOMErrorHandler</code> using the parameter "<a href='http://www.w3.org/TR/DOM-Level-3-Core/core.html#parameter-error-handler'>
		'''   error-handler</a>" if they wish to get details on the error. </exception>
		Function parseWithContext(ByVal input As LSInput, ByVal contextArg As org.w3c.dom.Node, ByVal action As Short) As org.w3c.dom.Node
