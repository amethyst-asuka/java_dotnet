...
'		public static final short FILTER_INTERRUPT = 4;
		...
		''' </li>
		''' </ul> Returning
		'''   any other values will result in unspecified behavior. </param>
		Function startElement(ByVal elementArg As org.w3c.dom.Element) As Short
		...
		''' and any of its descendants. </summary>
		...
		''' </li>
		''' </ul> </param>
		Function acceptNode(ByVal nodeArg As org.w3c.dom.Node) As Short
