...
Namespace org.w3c.dom.ls
	...
	Public Interface LSResourceResolver
		...
		''' other input source (including, for example, a dialog box). </summary>
		''' <param name="type">  The type of the resource being resolved. For XML [<a href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML 1.0</a>] resources
		...
		''' <param name="systemId">  The system identifier, a URI reference [<a href='http://www.ietf.org/rfc/rfc2396.txt'>IETF RFC 2396</a>], of the
		...
		'''   <code>null</code> if there is no base URI. </param>
		''' <returns>  A <code>LSInput</code> object describing the new input
		'''   source, or <code>null</code> to request that the parser open a
		'''   regular URI connection to the resource. </returns>
		Function resolveResource(ByVal type As String, ByVal namespaceURI As String, ByVal publicId As String, ByVal systemId As String, ByVal baseURI As String) As LSInput
