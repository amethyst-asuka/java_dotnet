...
'		public static final short MODE_ASYNCHRONOUS = 2;
		...
		'''  method. </summary>
		''' <param name="mode">  The <code>mode</code> argument is either
		...
		''' <returns>  The newly created <code>LSParser</code> object. This
		...
		'''   reference to the default error handler. </returns>
		''' <exception cref="DOMException">
		'''    NOT_SUPPORTED_ERR: Raised if the requested mode or schema type is
		'''   not supported. </exception>
		Function createLSParser(ByVal mode As Short, ByVal schemaType As String) As LSParser

		''' <summary>
		'''  Create a new <code>LSSerializer</code> object. </summary>
		''' <returns> The newly created <code>LSSerializer</code> object.
		...
		'''   reference to the default error handler. </returns>
		Function createLSSerializer() As LSSerializer
		...
		''' <code>LSInput.certifiedText</code> is false. </summary>
		''' <returns>  The newly created input object. </returns>
		Function createLSInput() As LSInput

		''' <summary>
		'''  Create a new empty output destination object where
		''' <code>LSOutput.characterStream</code>,
		''' <code>LSOutput.byteStream</code>, <code>LSOutput.systemId</code>,
		''' <code>LSOutput.encoding</code> are null. </summary>
		''' <returns>  The newly created output object. </returns>
		Function createLSOutput() As LSOutput
