...
Namespace org.w3c.dom.ls
	...
	Public Interface LSSerializer
		...
		''' </summary>
		Property filter As LSSerializerFilter
		...
		''' <returns>  Returns <code>true</code> if <code>node</code> was
		...
		Function write(ByVal nodeArg As org.w3c.dom.Node, ByVal destination As LSOutput) As Boolean
		...
		'''   <code>DOMErrorHandler</code> using the parameter "<a href='http://www.w3.org/TR/DOM-Level-3-Core/core.html#parameter-error-handler'>
		'''   error-handler</a>" if they wish to get details on the error. </exception>
		Function writeToURI(ByVal nodeArg As org.w3c.dom.Node, ByVal uri As String) As Boolean
		...
		''' <code>DOMString</code> object. </summary>
		''' <param name="nodeArg">  The node to serialize. </param>
		''' <returns>  Returns the serialized data. </returns>
		''' <exception cref="DOMException">
		'''    DOMSTRING_SIZE_ERR: Raised if the resulting string is too long to
		'''   fit in a <code>DOMString</code>. </exception>
		''' <exception cref="LSException">
		'''    SERIALIZE_ERR: Raised if the <code>LSSerializer</code> was unable to
		'''   serialize the node. DOM applications should attach a
		'''   <code>DOMErrorHandler</code> using the parameter "<a href='http://www.w3.org/TR/DOM-Level-3-Core/core.html#parameter-error-handler'>
		'''   error-handler</a>" if they wish to get details on the error. </exception>
		Function writeToString(ByVal nodeArg As org.w3c.dom.Node) As String
