...
Namespace org.w3c.dom
	...
	Public Interface DOMImplementation
		...
		''' version, as specified in <a href="http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/core.html#DOMFeatures">DOM Features</a>. </summary>
		...
		''' default attribute additions do not occur.. </summary>
		...
		Function createDocumentType(ByVal qualifiedName As String, ByVal publicId As String, ByVal systemId As String) As DocumentType
		...
		'''   create or <code>null</code>. </param>
		''' <param name="qualifiedName"> The qualified name of the document element to be
		'''   created or <code>null</code>. </param>
		''' <param name="doctype"> The type of document to be created or <code>null</code>.
		'''   When <code>doctype</code> is not <code>null</code>, its
		'''   <code>Node.ownerDocument</code> attribute is set to the document
		'''   being created. </param>
		''' <returns> A new <code>Document</code> object with its document element.
		'''   If the <code>NamespaceURI</code>, <code>qualifiedName</code>, and
		'''   <code>doctype</code> are <code>null</code>, the returned
		'''   <code>Document</code> is empty with no document element. </returns>
		''' <exception cref="DOMException">
		'''   INVALID_CHARACTER_ERR: Raised if the specified qualified name is not
		'''   an XML name according to [<a href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML 1.0</a>].
		'''   <br>NAMESPACE_ERR: Raised if the <code>qualifiedName</code> is
		...
		'''   Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]).
		''' @since DOM Level 2 </exception>
		Function createDocument(ByVal namespaceURI As String, ByVal qualifiedName As String, ByVal doctype As DocumentType) As Document
		...
		''' <code>DOMImplementation</code> interface. </summary>
