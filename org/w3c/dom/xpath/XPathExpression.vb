...
Namespace org.w3c.dom.xpath
	...
	Public Interface XPathExpression
		''' <summary>
		''' Evaluates this XPath expression and returns a result. </summary>
		...
		'''   <code>XPathExpression</code>. </exception>
		Function evaluate(ByVal contextNode As org.w3c.dom.Node, ByVal type As Short, ByVal result As Object) As Object
