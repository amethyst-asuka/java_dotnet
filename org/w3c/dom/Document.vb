...
Namespace org.w3c.dom
	...
	Public Interface Document
		...
		''' @since DOM Level 3
		''' </summary>
		ReadOnly Property doctype As DocumentType

		''' <summary>
		''' The <code>DOMImplementation</code> object that handles this document. A
		''' DOM application may use objects from multiple implementations.
		''' </summary>
		ReadOnly Property implementation As DOMImplementation
		...
		'''   <code>Document.xmlVersion</code> attribute. </exception>
		Function createElement(ByVal tagName As String) As Element
		...
		Function createTextNode(ByVal data As String) As Text

		''' <summary>
		''' Creates a <code>Comment</code> node given the specified string. </summary>
		''' <param name="data"> The data for the node. </param>
		''' <returns> The new <code>Comment</code> object. </returns>
		Function createComment(ByVal data As String) As Comment

		''' <summary>
		''' Creates a <code>CDATASection</code> node whose value is the specified
		''' string. </summary>
		''' <param name="data"> The data for the <code>CDATASection</code> contents. </param>
		...
		Function createCDATASection(ByVal data As String) As CDATASection
		...
		Function createProcessingInstruction(ByVal target As String, ByVal data As String) As ProcessingInstruction
		...
		'''   name according to the XML version in use specified in the
		'''   <code>Document.xmlVersion</code> attribute. </exception>
		Function createAttribute(ByVal name As String) As Attr
		...
		'''   <code>Document.xmlVersion</code> attribute.
		'''   <br>NOT_SUPPORTED_ERR: Raised if this document is an HTML document. </exception>
		Function createEntityReference(ByVal name As String) As EntityReference
		...
		Function getElementsByTagName(ByVal tagname As String) As NodeList
		...
		'''   <code>EntityReference</code> nodes. </param>
		...
		Function importNode(ByVal importedNode As Node, ByVal deep As Boolean) As Node

		''' <summary>
		''' Creates an element of the given qualified name and namespace URI.
		''' <br>Per [<a href='http://www.w3.org/TR/1999/REC-xml-names-19990114/'>XML Namespaces</a>]
		''' , applications must use the value <code>null</code> as the
		''' namespaceURI parameter for methods if they wish to have no namespace. </summary>
		...
		'''   defined by XML.
		''' @since DOM Level 2 </exception>
		Function createElementNS(ByVal namespaceURI As String, ByVal qualifiedName As String) As Element
		...
		'''   defined by XML.
		''' @since DOM Level 2 </exception>
		Function createAttributeNS(ByVal namespaceURI As String, ByVal qualifiedName As String) As Attr
		...
		'''   special value <code>"*"</code> matches all namespaces. </param>
		...
		Function getElementsByTagNameNS(ByVal namespaceURI As String, ByVal localName As String) As NodeList
		...
		''' ID unless so defined. </summary>
		''' <param name="elementId"> The unique <code>id</code> value for an element. </param>
		''' <returns> The matching element or <code>null</code> if there is none.
		''' @since DOM Level 2 </returns>
		Function getElementById(ByVal elementId As String) As Element
		...
		''' @since DOM Level 3
		''' </summary>
		ReadOnly Property inputEncoding As String
		...
		''' @since DOM Level 3
		''' </summary>
		ReadOnly Property xmlEncoding As String
		...
		''' version in use. </summary>
		''' <param name="source"> The node to move into this document. </param>
		''' <returns> The adopted node, or <code>null</code> if this operation
		...
		Function adoptNode(ByVal source As Node) As Node
		...
		''' @since DOM Level 3
		''' </summary>
		ReadOnly Property domConfig As DOMConfiguration
		...
		''' @since DOM Level 3 </exception>
		Function renameNode(ByVal n As Node, ByVal namespaceURI As String, ByVal qualifiedName As String) As Node
