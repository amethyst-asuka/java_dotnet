...
Namespace org.w3c.dom.traversal
	...
	Public Interface DocumentTraversal
		...
		''' <param name="root"> The node which will be iterated together with its
		...
		'''   root must not be <code>null</code>. </param>
		...
		'''   values.These flags can be combined using <code>OR</code>. </param>
		...
		Function createNodeIterator(ByVal root As org.w3c.dom.Node, ByVal whatToShow As Integer, ByVal filter As NodeFilter, ByVal entityReferenceExpansion As Boolean) As NodeIterator

		''' <summary>
		''' Create a new <code>TreeWalker</code> over the subtree rooted at the
		''' specified node. </summary>
		''' <param name="root"> The node which will serve as the <code>root</code> for the
		...
		'''    NOT_SUPPORTED_ERR: Raised if the specified <code>root</code> is
		'''   <code>null</code>. </exception>
		Function createTreeWalker(ByVal root As org.w3c.dom.Node, ByVal whatToShow As Integer, ByVal filter As NodeFilter, ByVal entityReferenceExpansion As Boolean) As TreeWalker
