...
Namespace org.w3c.dom
	...
	Public Interface Text
		...
		Function splitText(ByVal offset As Integer) As Text
		...
		''' @since DOM Level 3
		''' </summary>
		ReadOnly Property elementContentWhitespace As Boolean
		...
		''' "ent" contains an <code>Element</code> node which cannot be removed.</p> </summary>
		''' <param name="content"> The content of the replacing <code>Text</code> node. </param>
		''' <returns> The <code>Text</code> node created with the specified content. </returns>
		''' <exception cref="DOMException">
		'''   NO_MODIFICATION_ALLOWED_ERR: Raised if one of the <code>Text</code>
		'''   nodes being replaced is readonly.
		''' @since DOM Level 3 </exception>
		Function replaceWholeText(ByVal content As String) As Text
