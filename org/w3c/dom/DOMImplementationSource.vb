...
Namespace org.w3c.dom
	...
	Public Interface DOMImplementationSource
		...
		'''   <code>DOMImplementation.getFeature()</code>. </param>
		''' <returns> The first DOM implementation that support the desired
		'''   features, or <code>null</code> if this source has none. </returns>
		Function getDOMImplementation(ByVal features As String) As DOMImplementation
		...
		'''   features. </returns>
		Function getDOMImplementationList(ByVal features As String) As DOMImplementationList
