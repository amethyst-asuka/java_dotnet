...
Namespace org.w3c.dom
	...
	Public Interface TypeInfo
		...
		''' </summary>
		ReadOnly Property typeNamespace As String
...
'		public static final int DERIVATION_RESTRICTION = &H1;
		''' <summary>
		'''  If the document's schema is an XML Schema [<a href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/'>XML Schema Part 1</a>]
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public static final int DERIVATION_EXTENSION = &H2;
		''' <summary>
		'''  If the document's schema is an XML Schema [<a href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/'>XML Schema Part 1</a>]
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public static final int DERIVATION_UNION = &H4;
		''' <summary>
		'''  If the document's schema is an XML Schema [<a href='http://www.w3.org/TR/2001/REC-xmlschema-1-20010502/'>XML Schema Part 1</a>]
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public static final int DERIVATION_LIST = &H8;
		...
		Function isDerivedFrom(ByVal typeNamespaceArg As String, ByVal typeNameArg As String, ByVal derivationMethod As Integer) As Boolean
