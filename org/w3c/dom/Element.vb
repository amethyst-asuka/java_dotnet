...
Namespace org.w3c.dom
	...
	Public Interface Element
		...
		Function getAttribute(ByVal name As String) As String
		...
		Sub setAttribute(ByVal name As String, ByVal value As String)
		...
		''' <param name="name"> The name (<code>nodeName</code>) of the attribute to
		'''   retrieve. </param>
		''' <returns> The <code>Attr</code> node with the specified name (
		'''   <code>nodeName</code>) or <code>null</code> if there is no such
		'''   attribute. </returns>
		Function getAttributeNode(ByVal name As String) As Attr
		...
		''' <param name="newAttr"> The <code>Attr</code> node to add to the attribute list. </param>
		...
		'''   elements. </exception>
		Function setAttributeNode(ByVal newAttr As Attr) As Attr
		...
		''' information is up-to-date. </summary>
		''' <param name="oldAttr"> The <code>Attr</code> node to remove from the attribute
		'''   list. </param>
		...
		Function removeAttributeNode(ByVal oldAttr As Attr) As Attr

		''' <summary>
		''' Returns a <code>NodeList</code> of all descendant <code>Elements</code>
		''' with a given tag name, in document order. </summary>
		...
		Function getElementsByTagName(ByVal name As String) As NodeList
		...
		Function getAttributeNS(ByVal namespaceURI As String, ByVal localName As String) As String
		...
		'''   through the Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]).
		''' @since DOM Level 2 </exception>
		Sub setAttributeNS(ByVal namespaceURI As String, ByVal qualifiedName As String, ByVal value As String)
		...
		'''   through the Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]).
		''' @since DOM Level 2 </exception>
		Sub removeAttributeNS(ByVal namespaceURI As String, ByVal localName As String)
		...
		'''   through the Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]).
		''' @since DOM Level 2 </exception>
		Function getAttributeNodeNS(ByVal namespaceURI As String, ByVal localName As String) As Attr
		...
		'''   through the Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]).
		''' @since DOM Level 2 </exception>
		Function setAttributeNodeNS(ByVal newAttr As Attr) As Attr
		...
		'''   element, <code>false</code> otherwise. </returns>
		''' <exception cref="DOMException">
		'''   NOT_SUPPORTED_ERR: May be raised if the implementation does not
		'''   support the feature <code>"XML"</code> and the language exposed
		'''   through the Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]).
		''' @since DOM Level 2 </exception>
		Function hasAttributeNS(ByVal namespaceURI As String, ByVal localName As String) As Boolean

		''' <summary>
		'''  The type information associated with this element.
		''' @since DOM Level 3
		''' </summary>
		ReadOnly Property schemaTypeInfo As TypeInfo
		...
		''' <code>setIdAttributeNS</code> method. </summary>
		''' <param name="name"> The name of the attribute. </param>
		''' <param name="isId"> Whether the attribute is a of type ID. </param>
		''' <exception cref="DOMException">
		'''   NO_MODIFICATION_ALLOWED_ERR: Raised if this node is readonly.
		'''   <br>NOT_FOUND_ERR: Raised if the specified node is not an attribute
		'''   of this element.
		''' @since DOM Level 3 </exception>
		Sub setIdAttribute(ByVal name As String, ByVal isId As Boolean)
		...
		''' node. Use the value <code>false</code> for the parameter
		''' <code>isId</code> to undeclare an attribute for being a
		''' user-determined ID attribute. </summary>
		...
		'''   of this element.
		''' @since DOM Level 3 </exception>
		Sub setIdAttributeNS(ByVal namespaceURI As String, ByVal localName As String, ByVal isId As Boolean)
		...
		''' <code>isId</code> to undeclare an attribute for being a
		''' user-determined ID attribute. </summary>
		''' <param name="idAttr"> The attribute node. </param>
		''' <param name="isId"> Whether the attribute is a of type ID. </param>
		''' <exception cref="DOMException">
		'''   NO_MODIFICATION_ALLOWED_ERR: Raised if this node is readonly.
		'''   <br>NOT_FOUND_ERR: Raised if the specified node is not an attribute
		'''   of this element.
		''' @since DOM Level 3 </exception>
		Sub setIdAttributeNode(ByVal idAttr As Attr, ByVal isId As Boolean)
