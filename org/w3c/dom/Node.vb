...
'		public static final short NOTATION_NODE = 12;
		...
		''' including if the node is read-only. </summary>
		...
		''' </summary>
		ReadOnly Property nodeType As Short
		...
		''' nodes.
		''' </summary>
		ReadOnly Property childNodes As NodeList
		...
		''' <param name="refChild"> The reference node, i.e., the node before which the
		'''   new node must be inserted. </param>
		...
		Function insertBefore(ByVal newChild As Node, ByVal refChild As Node) As Node
		...
		''' 
		''' @since DOM Level 3 </exception>
		Function replaceChild(ByVal newChild As Node, ByVal oldChild As Node) As Node
		...
		''' 
		''' @since DOM Level 3 </exception>
		Function removeChild(ByVal oldChild As Node) As Node

		''' <summary>
		''' Adds the node <code>newChild</code> to the end of the list of children
		''' of this node. If the <code>newChild</code> is already in the tree, it
		''' is first removed. </summary>
		''' <param name="newChild"> The node to add.If it is a
		'''   <code>DocumentFragment</code> object, the entire contents of the
		'''   document fragment are moved into the child list of this node </param>
		...
		''' 
		''' @since DOM Level 3 </exception>
		Function appendChild(ByVal newChild As Node) As Node

		''' <summary>
		''' Returns whether this node has any children. </summary>
		''' <returns> Returns <code>true</code> if this node has any children,
		...
		''' <param name="deep"> If <code>true</code>, recursively clone the subtree under
		'''   the specified node; if <code>false</code>, clone only the node
		'''   itself (and its attributes, if it is an <code>Element</code>). </param>
		''' <returns> The duplicate node. </returns>
		Function cloneNode(ByVal deep As Boolean) As Node
		...
		''' that feature is supported by this node, as specified in . </summary>
		...
		Function isSupported(ByVal feature As String, ByVal version As String) As Boolean
		...
		''' <returns> Returns <code>true</code> if this node has any attributes,
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public static final short DOCUMENT_POSITION_DISCONNECTED = &H1;
		''' <summary>
		''' The second node precedes the reference node.
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public static final short DOCUMENT_POSITION_PRECEDING = &H2;
		''' <summary>
		''' The node follows the reference node.
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public static final short DOCUMENT_POSITION_FOLLOWING = &H4;
		''' <summary>
		''' The node contains the reference node. A node which contains is always
		''' preceding, too.
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public static final short DOCUMENT_POSITION_CONTAINS = &H8;
		''' <summary>
		''' The node is contained by the reference node. A node which is contained
		''' is always following, too.
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public static final short DOCUMENT_POSITION_CONTAINED_BY = &H10;
		''' <summary>
		''' The determination of preceding versus following is
		''' implementation-specific.
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public static final short DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC = &H20;
		...
		''' 
		''' @since DOM Level 3 </exception>
		Function compareDocumentPosition(ByVal other As Node) As Short
		...
		Function isSameNode(ByVal other As Node) As Boolean

		''' <summary>
		''' Look up the prefix associated to the given namespace URI, starting from
		''' this node. The default namespace declarations are ignored by this
		''' method.
		''' <br>See  for details on the algorithm used by this method. </summary>
		...
		''' 
		''' @since DOM Level 3 </returns>
		Function lookupPrefix(ByVal namespaceURI As String) As String

		''' <summary>
		'''  This method checks if the specified <code>namespaceURI</code> is the
		''' default namespace or not. </summary>
		''' <param name="namespaceURI"> The namespace URI to look for. </param>
		''' <returns> Returns <code>true</code> if the specified
		'''   <code>namespaceURI</code> is the default namespace,
		'''   <code>false</code> otherwise.
		''' 
		''' @since DOM Level 3 </returns>
		Function isDefaultNamespace(ByVal namespaceURI As String) As Boolean
		...
		'''   if any. </param>
		''' <returns> Returns the associated namespace URI or <code>null</code> if
		'''   none is found.
		''' 
		''' @since DOM Level 3 </returns>
		Function lookupNamespaceURI(ByVal prefix As String) As String
		...
		''' specification are expected to be updated accordingly. </summary>
		''' <param name="arg"> The node to compare equality with. </param>
		''' <returns> Returns <code>true</code> if the nodes are equal,
		'''   <code>false</code> otherwise.
		''' 
		''' @since DOM Level 3 </returns>
		Function isEqualNode(ByVal arg As Node) As Boolean
		...
		''' 
		''' @since DOM Level 3 </returns>
		Function getFeature(ByVal feature As String, ByVal version As String) As Object
		...
		''' <returns> Returns the <code>DOMUserData</code> previously associated to
		'''   the given key on this node, or <code>null</code> if there was none.
		''' 
		''' @since DOM Level 3 </returns>
		Function setUserData(ByVal key As String, ByVal data As Object, ByVal handler As UserDataHandler) As Object
		...
		''' <returns> Returns the <code>DOMUserData</code> associated to the given
		'''   key on this node, or <code>null</code> if there was none.
		''' 
		''' @since DOM Level 3 </returns>
		Function getUserData(ByVal key As String) As Object
