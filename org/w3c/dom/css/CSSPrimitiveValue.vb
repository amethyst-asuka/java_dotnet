...
'		public static final short CSS_RGBCOLOR = 25;
		...
		''' </summary>
		ReadOnly Property primitiveType As Short
		...
		Sub setFloatValue(ByVal unitType As Short, ByVal floatValue As Single)
		...
		'''   unit. </exception>
		Function getFloatValue(ByVal unitType As Short) As Single
		...
		'''   unit.
		'''   <br>NO_MODIFICATION_ALLOWED_ERR: Raised if this property is readonly. </exception>
		Sub setStringValue(ByVal stringType As Short, ByVal stringValue As String)
		...
		ReadOnly Property counterValue As Counter
		...
		ReadOnly Property rectValue As Rect
		...
		ReadOnly Property rGBColorValue As RGBColor
