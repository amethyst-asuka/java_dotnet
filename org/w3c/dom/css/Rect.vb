...
Namespace org.w3c.dom.css
	...
	Public Interface Rect
		...
		''' </summary>
		ReadOnly Property top As CSSPrimitiveValue

		''' <summary>
		'''  This attribute is used for the right of the rect.
		''' </summary>
		ReadOnly Property right As CSSPrimitiveValue

		''' <summary>
		'''  This attribute is used for the bottom of the rect.
		''' </summary>
		ReadOnly Property bottom As CSSPrimitiveValue

		''' <summary>
		'''  This attribute is used for the left of the rect.
		''' </summary>
		ReadOnly Property left As CSSPrimitiveValue
