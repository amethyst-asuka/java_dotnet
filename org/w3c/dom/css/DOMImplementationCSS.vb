...
Namespace org.w3c.dom.css
	...
	Public Interface DOMImplementationCSS
		...
		''' <param name="media">  The comma-separated list of media associated with the
		'''   new style sheet. See also the  section. </param>
		...
		Function createCSSStyleSheet(ByVal title As String, ByVal media As String) As CSSStyleSheet
