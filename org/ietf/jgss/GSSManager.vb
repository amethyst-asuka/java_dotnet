...
Namespace org.ietf.jgss
	...
	''' GSSName GSSName}, <seealso cref="GSSCredential GSSCredential"/>, and {@link
	...
	''' usage:  <seealso cref="#addProviderAtFront(Provider, Oid) addProviderAtFront"/> and
	''' <seealso cref="#addProviderAtEnd(Provider, Oid) addProviderAtEnd"/>. These methods
	...
	''' </pre>
	''' 
	''' @author Mayank Upadhyay </summary>
	''' <seealso cref= GSSName </seealso>
	''' <seealso cref= GSSCredential </seealso>
	''' <seealso cref= GSSContext
	''' @since 1.4 </seealso>
	Public MustInherit Class GSSManager

		''' <summary>
		''' Returns the default GSSManager implementation.
		''' </summary>
		''' <returns> a GSSManager implementation </returns>
		Public Property Shared instance As GSSManager
			Get
		...
		''' <seealso cref="#getInstance() getInstance()"/> method includes the Oid
		...
		''' installed). </returns>
		Public MustOverride ReadOnly Property mechs As Oid()
		...
		''' <seealso cref="GSSName#NT_HOSTBASED_SERVICE GSSName.NT_HOSTBASED_SERVICE"/>,
		''' <seealso cref="GSSName#NT_EXPORT_NAME GSSName.NT_EXPORT_NAME"/>, and the
		...
		''' the mechanism supports. </returns>
		''' <param name="mech"> the Oid of the mechanism to query
		''' </param>
		''' <seealso cref= #getMechsForName(Oid)
		''' </seealso>
		...
		Public MustOverride Function getNamesForMech(ByVal mech As Oid) As Oid()
		...
		''' <seealso cref="GSSName#NT_HOSTBASED_SERVICE GSSName.NT_HOSTBASED_SERVICE"/>,
		''' <seealso cref="GSSName#NT_EXPORT_NAME GSSName.NT_EXPORT_NAME"/>, or
		''' "1.2.840.113554.1.2.2.1".
		''' </summary>
		''' <returns> an array of Oid objects corresponding to the mechanisms that
		''' support the specified name type.  <code>null</code> is returned when no
		''' mechanisms are found to support the specified name type. </returns>
		''' <param name="nameType"> the Oid of the name type to look for
		''' </param>
		''' <seealso cref= #getNamesForMech(Oid) </seealso>
		Public MustOverride Function getMechsForName(ByVal nameType As Oid) As Oid()
		...
		''' Oid) createName}.
		''' </summary>
		''' <param name="nameStr"> the string representing a printable form of the name to
		''' create. </param>
		''' <param name="nameType"> the Oid specifying the namespace of the printable name
		...
		''' </returns>
		''' <seealso cref= GSSName </seealso>
		''' <seealso cref= GSSName#NT_EXPORT_NAME
		''' </seealso>
		''' <exception cref="GSSException"> containing the following
		''' major error codes:
		...
		'''    <seealso cref="GSSException#BAD_MECH GSSException.BAD_MECH"/>,
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createName(ByVal nameStr As String, ByVal nameType As Oid) As GSSName
		...
		''' </summary>
		''' <param name="name"> the byte array containing the name to create </param>
		''' <param name="nameType"> the Oid specifying the namespace of the name supplied
		...
		''' that examines the byte array. </param>
		''' <returns> a GSSName representing the indicated principal
		''' </returns>
		''' <seealso cref= GSSName </seealso>
		''' <seealso cref= GSSName#NT_EXPORT_NAME
		...
		'''    <seealso cref="GSSException#BAD_MECH GSSException.BAD_MECH"/>,
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createName(SByte ByVal As name(), ByVal nameType As Oid) As GSSName
		...
		''' It is not advisable to use the nametype NT_EXPORT_NAME with this
		''' method. </param>
		''' <param name="mech"> Oid specifying the mechanism for which the name should be
		''' canonicalized </param>
		''' <returns> a GSSName representing the indicated principal
		''' </returns>
		''' <seealso cref= GSSName#canonicalize(Oid) </seealso>
		''' <seealso cref= GSSName#NT_EXPORT_NAME
		''' </seealso>
		''' <exception cref="GSSException"> containing the following
		''' major error codes:
		...
		'''    <seealso cref="GSSException#BAD_MECH GSSException.BAD_MECH"/>,
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createName(ByVal nameStr As String, ByVal nameType As Oid, ByVal mech As Oid) As GSSName
		...
		'''    <seealso cref="GSSException#BAD_MECH GSSException.BAD_MECH"/>,
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createName(SByte ByVal As name(), ByVal nameType As Oid, ByVal mech As Oid) As GSSName
		...
		''' this method.
		''' </summary>
		''' <param name="usage"> The intended usage for this credential object. The value
		''' of this parameter must be one of:
		''' {@link GSSCredential#INITIATE_AND_ACCEPT
		''' GSSCredential.INITIATE_AND_ACCEPT},
		''' <seealso cref="GSSCredential#ACCEPT_ONLY GSSCredential.ACCEPT_ONLY"/>, and
		''' <seealso cref="GSSCredential#INITIATE_ONLY GSSCredential.INITIATE_ONLY"/>. </param>
		''' <returns> a GSSCredential of the requested type.
		''' </returns>
		''' <seealso cref= GSSCredential
		''' </seealso>
		''' <exception cref="GSSException"> containing the following
		''' major error codes:
		'''    <seealso cref="GSSException#BAD_MECH GSSException.BAD_MECH"/>,
		...
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createCredential(ByVal usage As Integer) As GSSCredential
		...
		''' <seealso cref="GSSCredential#getRemainingLifetime() getRemainingLifetime"/>
		''' on the returned credential.<p>
		''' </summary>
		''' <param name="name"> the name of the principal for whom this credential is to be
		''' acquired.  Use <code>null</code> to specify the default principal. </param>
		''' <param name="lifetime"> The number of seconds that credentials should remain
		...
		''' request default credential lifetime. </param>
		''' <param name="mech"> the Oid of the desired mechanism.  Use <code>(Oid) null
		''' </code> to request the default mechanism. </param>
		''' <param name="usage"> The intended usage for this credential object. The value
		''' of this parameter must be one of:
		''' {@link GSSCredential#INITIATE_AND_ACCEPT
		''' GSSCredential.INITIATE_AND_ACCEPT},
		...
		'''    <seealso cref="GSSException#NO_CRED GSSException.NO_CRED"/>,
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createCredential(ByVal name As GSSName, ByVal lifetime As Integer, ByVal mech As Oid, ByVal usage As Integer) As GSSCredential
		...
		''' GSSCredential#DEFAULT_LIFETIME GSSCredential.DEFAULT_LIFETIME} to
		''' request default credential lifetime. </param>
		''' <param name="mechs"> an array of Oid's indicating the mechanisms over which
		''' the credential is to be acquired.  Use <code>(Oid[]) null</code> for
		''' requesting a system specific default set of mechanisms. </param>
		''' <param name="usage"> The intended usage for this credential object. The value
		''' of this parameter must be one of:
		''' {@link GSSCredential#INITIATE_AND_ACCEPT
		''' GSSCredential.INITIATE_AND_ACCEPT},
		...
		'''    <seealso cref="GSSException#NO_CRED GSSException.NO_CRED"/>,
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createCredential(ByVal name As GSSName, ByVal lifetime As Integer, Oid ByVal As mechs(), ByVal usage As Integer) As GSSCredential
		...
		''' <seealso cref="GSSContext#getLifetime() getLifetime"/> on the returned
		''' context.<p>
		''' </summary>
		''' <param name="peer"> the name of the target peer. </param>
		''' <param name="mech"> the Oid of the desired mechanism.  Use <code>null</code>
		''' to request the default mechanism. </param>
		''' <param name="myCred"> the credentials of the initiator.  Use
		''' <code>null</code> to act as the default initiator principal. </param>
		''' <param name="lifetime"> the lifetime, in seconds, requested for the
		...
		'''    <seealso cref="GSSException#BAD_MECH GSSException.BAD_MECH"/>
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createContext(ByVal peer As GSSName, ByVal mech As Oid, ByVal myCred As GSSCredential, ByVal lifetime As Integer) As GSSContext
	   ...
	   ''' </summary>
	   ''' <param name="myCred"> the credentials for the acceptor.  Use
	   ''' <code>null</code> to act as a default acceptor principal. </param>
	   ''' <returns> an unestablished GSSContext
	   ''' </returns>
	   ''' <seealso cref= GSSContext
	   ''' </seealso>
	   ...
	   '''    <seealso cref="GSSException#BAD_MECH GSSException.BAD_MECH"/>
	   '''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createContext(ByVal myCred As GSSCredential) As GSSContext
		...
		''' the <seealso cref="GSSContext#isTransferable() GSSContext.isTransferable"/>
		...
		''' code <seealso cref="GSSException#UNAVAILABLE GSSException.UNAVAILABLE"/>.
		''' 
		''' Some mechanism providers might require that the caller be granted
		...
		''' </summary>
		''' <param name="interProcessToken"> the token previously emitted from the
		''' export method. </param>
		...
		'''    <seealso cref="GSSException#UNAUTHORIZED GSSException.UNAUTHORIZED"/>,
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Function createContext(ByVal interProcessToken As SByte ()) As GSSContext
		...
		''' </summary>
		''' <param name="p"> the provider instance that should be used whenever support
		''' is needed for mech. </param>
		''' <param name="mech"> the mechanism for which the provider is being set
		''' </param>
		''' <exception cref="GSSException"> containing the following
		''' major error codes:
		'''    <seealso cref="GSSException#UNAVAILABLE GSSException.UNAVAILABLE"/>,
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Sub addProviderAtFront(ByVal p As java.security.Provider, ByVal mech As Oid)
		...
		'''    <seealso cref="GSSException#UNAVAILABLE GSSException.UNAVAILABLE"/>,
		'''    <seealso cref="GSSException#FAILURE GSSException.FAILURE"/> </exception>
		Public MustOverride Sub addProviderAtEnd(ByVal p As java.security.Provider, ByVal mech As Oid)
	End Class
