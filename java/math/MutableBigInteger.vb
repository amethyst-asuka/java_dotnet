...
Namespace java.math
    ...
    Friend Class MutableBigInteger
        ...
        ''' </summary>
        Private ReadOnly Property magnitudeArray As Integer()
            Get
        ...
        ''' </summary>
        Friend Overridable ReadOnly Property one As Boolean
            Get
        ...
        ''' </summary>
        Friend Overridable ReadOnly Property zero As Boolean
            Get
                Return (intLen = 0)
            End Get
        End Property
        ...
        ''' </summary>
        Friend Overridable ReadOnly Property even As Boolean
            Get
        ...
        ''' </summary>
        Friend Overridable ReadOnly Property odd As Boolean
            Get
        ...
        ''' </summary>
        Friend Overridable ReadOnly Property normal As Boolean
            Get
        ...
        Friend Overridable Sub addDisjoint(ByVal addend As MutableBigInteger, ByVal n As Integer)
            ...
            Dim len As Integer = System.Math.Min(y, addend.value.Length - addend.offset)
        ...
        Friend Overridable Function divideKnuth(ByVal b As MutableBigInteger, ByVal quotient As MutableBigInteger, ByVal needRemainder As Boolean) As MutableBigInteger
            ...
            If intLen >= KNUTH_POW2_THRESH_LEN Then
                Dim trailingZeroBits As Integer = System.Math.Min(lowestSetBit, b.lowestSetBit)
        ...
        Friend Overridable Function divideAndRemainderBurnikelZiegler(ByVal b As MutableBigInteger, ByVal quotient As MutableBigInteger) As MutableBigInteger
            ...
            Else
                ...
                Dim sigma As Integer = CInt(Fix(System.Math.Max(0, n32 - b.bitLength()))) ' step 3: sigma = max{T | (2^T)*B < beta^n}
