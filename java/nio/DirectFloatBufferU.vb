...
Namespace java.nio
	...
	Friend Class DirectFloatBufferU
		...
		Public Overrides Function slice() As FloatBuffer
			...
			assert([off] >= 0)
			Return New DirectFloatBufferU(Me, -1, 0, [rem], [rem], [off])
		End Function

		Public Overrides Function duplicate() As FloatBuffer
			Return New DirectFloatBufferU(Me, Me.markValue(), Me.position(), Me.limit(), Me.capacity(), 0)
		End Function
		...
		Public Overrides Function put(ByVal src As FloatBuffer) As FloatBuffer
			...
			If TypeOf src Is DirectFloatBufferU Then
				If src Is Me Then Throw New IllegalArgumentException
				Dim sb As DirectFloatBufferU = CType(src, DirectFloatBufferU)
