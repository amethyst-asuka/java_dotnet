...
Namespace java.nio
	...
	Friend Class ByteBufferAsLongBufferL
		Inherits LongBuffer ' package-private
		...
		Public Overrides Function duplicate() As LongBuffer
			Return New ByteBufferAsLongBufferL(bb, Me.markValue(), Me.position(), Me.limit(), Me.capacity(), offset)
		End Function
