...
Namespace java.nio
	...
	Friend Class DirectCharBufferS
		Inherits CharBuffer
		...
		Public Overrides Function slice() As CharBuffer
			...
			assert([off] >= 0)
			Return New DirectCharBufferS(Me, -1, 0, [rem], [rem], [off])
		End Function

		Public Overrides Function duplicate() As CharBuffer
			Return New DirectCharBufferS(Me, Me.markValue(), Me.position(), Me.limit(), Me.capacity(), 0)
		End Function
		...
		Public Overrides Function put(ByVal src As CharBuffer) As CharBuffer
			...
			If TypeOf src Is DirectCharBufferS Then
				...
				Dim sb As DirectCharBufferS = CType(src, DirectCharBufferS)
		...
		Public Overrides Function subSequence(ByVal start As Integer, ByVal [end] As Integer) As CharBuffer
			...
			Return New DirectCharBufferS(Me, -1, pos + start, pos + [end], capacity(), offset)
		End Function
