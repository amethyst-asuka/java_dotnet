...
Namespace java.nio
	...
	Friend Class DirectIntBufferS
		...
		Private Shared ReadOnly arrayBaseOffset As Long = CLng(Fix(unsafe.arrayBaseOffset(GetType(Integer()))))
		...
		Public Overrides Function slice() As IntBuffer
			...
			assert([off] >= 0)
			Return New DirectIntBufferS(Me, -1, 0, [rem], [rem], [off])
		End Function

		Public Overrides Function duplicate() As IntBuffer
			Return New DirectIntBufferS(Me, Me.markValue(), Me.position(), Me.limit(), Me.capacity(), 0)
		End Function
		...
		Public Overrides Function [get](ByVal i As Integer) As Integer
		...
		Public Overrides Function [get](ByVal dst As Integer(), ByVal offset As Integer, ByVal length As Integer) As IntBuffer
		...
		Public Overrides Function put(ByVal src As IntBuffer) As IntBuffer
			...
			If TypeOf src Is DirectIntBufferS Then
				If src Is Me Then Throw New IllegalArgumentException
				Dim sb As DirectIntBufferS = CType(src, DirectIntBufferS)
