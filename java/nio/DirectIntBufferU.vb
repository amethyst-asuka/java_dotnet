...
Namespace java.nio
	...
	Friend Class DirectIntBufferU
		...
		Public Overrides Function slice() As IntBuffer
			...
			assert([off] >= 0)
			Return New DirectIntBufferU(Me, -1, 0, [rem], [rem], [off])
		End Function

		Public Overrides Function duplicate() As IntBuffer
			Return New DirectIntBufferU(Me, Me.markValue(), Me.position(), Me.limit(), Me.capacity(), 0)
		End Function
		...
		Public Overrides Function put(ByVal src As IntBuffer) As IntBuffer
			...
			If TypeOf src Is DirectIntBufferU Then
				If src Is Me Then Throw New IllegalArgumentException
				Dim sb As DirectIntBufferU = CType(src, DirectIntBufferU)
