...
Namespace java.nio.channels
	...
	''' 
	''' <ol>
	''' <li><pre><seealso cref="Future"/>&lt;V&gt; <em>operation</em>(<em>...</em>)</pre></li>
	...
	''' 
	''' <p> In the first form, the methods defined by the <seealso cref="Future Future"/>
	...
	''' channel's <seealso cref="#close close"/> method is invoked, then the I/O operation
	''' fails with the exception <seealso cref="AsynchronousCloseException"/>.
	''' 
	...
	''' <h2>Cancellation</h2>
	''' 
	''' <p> The {@code Future} interface defines the <seealso cref="Future#cancel cancel"/>
	''' method to cancel execution. This causes all threads waiting on the result of
	''' the I/O operation to throw <seealso cref="java.util.concurrent.CancellationException"/>.
	...
	''' 
	''' <p> Where the <seealso cref="Future#cancel cancel"/> method is invoked with the {@code
	...
	''' exception <seealso cref="AsynchronousCloseException"/>.
	''' 
	...
	Public Interface AsynchronousChannel
		...
		''' complete with the exception <seealso cref="AsynchronousCloseException"/>. After a
		''' channel is closed, further attempts to initiate asynchronous I/O
		''' operations complete immediately with cause <seealso cref="ClosedChannelException"/>.
		''' 
