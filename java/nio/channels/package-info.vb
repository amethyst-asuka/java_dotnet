...
''' <tr><td valign=top><tt><i><seealso cref="java.nio.channels.Channel"/></i></tt></td>
'''     <td>A nexus for I/O operations</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<i><seealso cref="java.nio.channels.ReadableByteChannel"/></i></tt></td>
'''     <td>Can read into a buffer</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i><seealso cref="java.nio.channels.ScatteringByteChannel"/>&nbsp;&nbsp;</i></tt></td>
'''     <td>Can read into a sequence of&nbsp;buffers</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<i><seealso cref="java.nio.channels.WritableByteChannel"/></i></tt></td>
'''     <td>Can write from a buffer</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i><seealso cref="java.nio.channels.GatheringByteChannel"/></i></tt></td>
'''     <td>Can write from a sequence of&nbsp;buffers</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<i><seealso cref="java.nio.channels.ByteChannel"/></i></tt></td>
'''     <td>Can read/write to/from a&nbsp;buffer</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i><seealso cref="java.nio.channels.SeekableByteChannel"/></i></tt></td>
'''     <td>A {@code ByteChannel} connected to an entity that contains a variable-length sequence of bytes</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<i><seealso cref="java.nio.channels.AsynchronousChannel"/></i></tt></td>
'''     <td>Supports asynchronous I/O operations.</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i><seealso cref="java.nio.channels.AsynchronousByteChannel"/></i></tt></td>
'''     <td>Can read and write bytes asynchronously</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<i><seealso cref="java.nio.channels.NetworkChannel"/></i></tt></td>
'''     <td>A channel to a network socket</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i><seealso cref="java.nio.channels.MulticastChannel"/></i></tt></td>
'''     <td>Can join Internet Protocol (IP) multicast groups</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.Channels"/></tt></td>
...
''' or writing.  As specified in the <seealso cref="java.nio.channels.Channel"/> interface,
''' channels are either open or closed, and they are both <i>asynchronously
''' closeable</i> and <i>interruptible</i>.
''' 
''' <p> The <seealso cref="java.nio.channels.Channel"/> interface is extended by several
''' other interfaces.
''' 
''' <p> The <seealso cref="java.nio.channels.ReadableByteChannel"/> interface specifies a
''' <seealso cref="java.nio.channels.ReadableByteChannel#read read"/> method that reads bytes
...
''' from a buffer to the channel. The <seealso cref="java.nio.channels.ByteChannel"/>
''' interface unifies these two interfaces for the common case of channels that can
''' both read and write bytes. The <seealso cref="java.nio.channels.SeekableByteChannel"/>
...
''' size}.
''' 
''' <p> The <seealso cref="java.nio.channels.ScatteringByteChannel"/> and {@link
...
''' 
''' <p> The <seealso cref="java.nio.channels.NetworkChannel"/> interface specifies methods
''' to <seealso cref="java.nio.channels.NetworkChannel#bind bind"/> the channel's socket,
...
''' 
''' <p> The <seealso cref="java.nio.channels.Channels"/> utility class defines static methods
...
''' channel can be constructed from an <seealso cref="java.io.InputStream"/> or an {@link
''' java.io.OutputStream}, and conversely an <seealso cref="java.io.InputStream"/> or an
''' <seealso cref="java.io.OutputStream"/> can be constructed from a channel.  A {@link
''' java.io.Reader} can be constructed that uses a given charset to decode bytes
''' from a given readable byte channel, and conversely a <seealso cref="java.io.Writer"/> can
...
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.FileChannel"/></tt></td>
'''     <td>Reads, writes, maps, and manipulates files</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.FileLock"/></tt></td>
'''     <td>A lock on a (region of a) file</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.MappedByteBuffer"/>&nbsp;&nbsp;</tt></td>
'''     <td>A direct byte buffer mapped to a region of a&nbsp;file</td></tr>
''' </table></blockquote>
''' 
''' <p> The <seealso cref="java.nio.channels.FileChannel"/> class supports the usual
...
''' instances of the <seealso cref="java.nio.channels.FileLock"/> class.  Finally, it defines
...
''' getChannel} method of a <seealso cref="java.io.FileInputStream"/>, {@link
''' java.io.FileOutputStream}, or <seealso cref="java.io.RandomAccessFile"/> to return a
''' file channel connected to the same underlying file as the <tt><seealso cref="java.io"/></tt>
''' class.
''' 
''' <a name="multiplex"></a>
...
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.SelectableChannel"/></tt></td>
'''     <td>A channel that can be multiplexed</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<seealso cref="java.nio.channels.DatagramChannel"/></tt></td>
'''     <td>A channel to a datagram-oriented socket</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<seealso cref="java.nio.channels.Pipe.SinkChannel"/></tt></td>
'''     <td>The write end of a pipe</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<seealso cref="java.nio.channels.Pipe.SourceChannel"/></tt></td>
'''     <td>The read end of a pipe</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<seealso cref="java.nio.channels.ServerSocketChannel"/>&nbsp;&nbsp;</tt></td>
'''     <td>A channel to a stream-oriented listening socket</td></tr>
''' <tr><td valign=top><tt>&nbsp;&nbsp;<seealso cref="java.nio.channels.SocketChannel"/></tt></td>
'''     <td>A channel for a stream-oriented connecting socket</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.Selector"/></tt></td>
'''     <td>A multiplexor of selectable channels</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.SelectionKey"/></tt></td>
'''     <td>A token representing the registration <br> of a channel
'''     with&nbsp;a&nbsp;selector</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.Pipe"/></tt></td>
...
''' java.net.DatagramSocket}, <seealso cref="java.net.ServerSocket"/>, and {@link
''' java.net.Socket} classes defined in the <tt><seealso cref="java.net"/></tt> package.
...
''' <seealso cref="java.nio.channels.spi.SelectorProvider"/> class defined in the <tt>{@link
...
''' only the <seealso cref="java.nio.channels.spi.AbstractSelector"/> and {@link
...
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.AsynchronousFileChannel"/></tt></td>
'''     <td>An asynchronous channel for reading, writing, and manipulating a file</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.AsynchronousSocketChannel"/></tt></td>
'''     <td>An asynchronous channel to a stream-oriented connecting socket</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.AsynchronousServerSocketChannel"/>&nbsp;&nbsp;</tt></td>
'''     <td>An asynchronous channel to a stream-oriented listening socket</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.CompletionHandler"/></tt></td>
'''     <td>A handler for consuming the result of an asynchronous operation</td></tr>
''' <tr><td valign=top><tt><seealso cref="java.nio.channels.AsynchronousChannelGroup"/></tt></td>
'''     <td>A grouping of asynchronous channels for the purpose of resource sharing</td></tr>
''' </table></blockquote>
''' 
''' <p> <seealso cref="java.nio.channels.AsynchronousChannel Asynchronous channels"/> are a
...
''' operations, returning a <seealso cref="java.util.concurrent.Future"/> representing the
...
''' specify a <seealso cref="java.nio.channels.CompletionHandler"/> to invoke when the
...
''' It also defines the <seealso cref="java.nio.channels.AsynchronousFileChannel"/> class
...
''' <tt><seealso cref="java.nio.channels.spi"/></tt> package.  It is not expected that many
