...
Namespace java.nio.channels
	...
	'''   <seealso cref="#keys() keys"/> method. </p></li>
	''' 
	...
	''' 
	''' <p> A thread blocked in one of the <seealso cref="#select()"/> or {@link
	''' #select(long)} methods may be interrupted by some other thread in one of
	''' three ways:
	''' 
	''' <ul>
	''' 
	'''   <li><p> By invoking the selector's <seealso cref="#wakeup wakeup"/> method,
	'''   </p></li>
	''' 
	'''   <li><p> By invoking the selector's <seealso cref="#close close"/> method, or
	'''   </p></li>
	''' 
	...
	''' </ul>
	''' 
	''' <p> The <seealso cref="#close close"/> method synchronizes on the selector and all
	...
	''' <seealso cref="java.util.ConcurrentModificationException"/> will be thrown. </p>
	''' 
	''' 
	...
	Public MustInherit Class Selector
		...
		Public Shared Function open() As Selector
			Return java.nio.channels.spi.SelectorProvider.provider().openSelector()
		End Function
		...
		Public MustOverride Function keys() As java.util.Set(Of SelectionKey)
		...
		''' <exception cref="ClosedSelectorException">
		'''          If this selector is closed </exception>
		Public MustOverride Function selectedKeys() As java.util.Set(Of SelectionKey)
		...
		''' of the <seealso cref="#wakeup wakeup"/> method.  </p>
		''' </summary>
		...
		''' <exception cref="ClosedSelectorException">
		'''          If this selector is closed </exception>
		Public MustOverride Function selectNow() As Integer
		...
		''' timeout as if by invoking the <seealso cref="Object#wait(long)"/> method. </p>
		''' </summary>
		...
		''' <exception cref="ClosedSelectorException">
		'''          If this selector is closed </exception>
		Public MustOverride Function [select]() As Integer
		...
		Public MustOverride Function wakeup() As Selector
		...
		''' <seealso cref="ClosedSelectorException"/> to be thrown. </p>
		''' </summary>
		''' <exception cref="IOException">
		'''          If an I/O error occurs </exception>
