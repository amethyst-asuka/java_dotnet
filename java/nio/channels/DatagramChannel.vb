...
Namespace java.nio.channels
	...
	''' 
	''' <p> A datagram channel is created by invoking one of the <seealso cref="#open open"/> methods
	...
	Public MustInherit Class DatagramChannel
		...
		''' connected.
		''' 
		''' <p> The <seealso cref="ProtocolFamily ProtocolFamily"/> of the channel's socket
		...
		Public Shared Function open() As DatagramChannel
			Return java.nio.channels.spi.SelectorProvider.provider().openDatagramChannel()
		End Function
		...
		Public NotOverridable Overrides Function validOps() As Integer
			Return (SelectionKey.OP_READ Or SelectionKey.OP_WRITE)
		End Function
		...
		''' declared in the <seealso cref="java.net.DatagramSocket"/> class.  </p>
		''' </summary>
		''' <returns>  A datagram socket associated with this channel </returns>
		Public MustOverride Function socket() As java.net.DatagramSocket
		...
		''' <exception cref="IOException">
		'''          If some other I/O error occurs </exception>
		Public MustOverride Function disconnect() As DatagramChannel
