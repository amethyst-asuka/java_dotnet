...
Namespace java.nio
    ...
    Friend Class DirectLongBufferU
        Inherits LongBuffer
        ...
        Public Overrides Function slice() As LongBuffer
            ...
            Assert([off] >= 0)
            Return New DirectLongBufferU(Me, -1, 0, [rem], [rem], [off])
        End Function

        Public Overrides Function duplicate() As LongBuffer
            Return New DirectLongBufferU(Me, Me.markValue(), Me.position(), Me.limit(), Me.capacity(), 0)
        End Function
        ...
        Public Overrides Function put(ByVal src As LongBuffer) As LongBuffer
            ...
            If TypeOf src Is DirectLongBufferU Then
                If src Is Me Then Throw New IllegalArgumentException
                Dim sb As DirectLongBufferU = CType(src, DirectLongBufferU)
