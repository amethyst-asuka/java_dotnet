...
Namespace java.nio.file
	...
	''' 
	''' <p> This interface extends <seealso cref="Watchable"/> interface so that a directory
	...
	''' <p> Paths may be used with the <seealso cref="Files"/> class to operate on files,
	...
	Public Interface Path
		Inherits Comparable(Of Path), Iterable(Of Path), Watchable

		''' <summary>
		''' Returns the file system that created this object.
		''' </summary>
		''' <returns>  the file system that created this object </returns>
		ReadOnly Property fileSystem As FileSystem
		...
		ReadOnly Property root As Path
		...
		ReadOnly Property fileName As Path
		...
		ReadOnly Property parent As Path
		...
		''' 
		''' <p> If the {@code other} parameter is an <seealso cref="#isAbsolute() absolute"/>
		...
		''' 
		''' <p> Relativization is the inverse of <seealso cref="#resolve(Path) resolution"/>.
		...
		''' 
		''' <p> For any two <seealso cref="#normalize normalized"/> paths <i>p</i> and
		...
		''' 
		''' <p> This method constructs an absolute <seealso cref="URI"/> with a {@link
		...
		''' path.
		''' 
		''' <p> If this path is already <seealso cref="Path#isAbsolute absolute"/> then this
		...
		Function toAbsolutePath() As Path
		...
		Function toFile() As java.io.File
		...
		''' </ul>
		''' 
		''' <p> The <seealso cref="WatchEvent#context context"/> for these events is the
		...
		Overrides Function [iterator]() As IEnumerator(Of Path)
