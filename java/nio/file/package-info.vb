...
''' <seealso cref="java.nio.file.attribute"/> package. The <seealso cref="java.nio.file.spi"/>
...
''' <p> The <seealso cref="java.io.File"/> class defines the {@link java.io.File#toPath
''' toPath} method to construct a <seealso cref="java.nio.file.Path"/> by converting
...
''' <p> The <seealso cref="java.nio.file.StandardOpenOption#SYNC SYNC"/> and {@link
...
''' will throw <seealso cref="java.nio.file.ClosedFileSystemException"/> when invoked on
''' objects associated with a <seealso cref="java.nio.file.FileSystem"/> that has been
''' <seealso cref="java.nio.file.FileSystem#close closed"/>. Additionally, any methods
...
''' with a <seealso cref="java.nio.file.FileSystem"/> that only provides read-only
''' access. </p>
''' 
...
''' will throw <seealso cref="java.nio.file.ProviderMismatchException"/>. </p>
''' 
''' <h3>Optional Specific Exceptions</h3>
''' Most of the methods defined by classes in this package that access the
''' file system specify that <seealso cref="java.io.IOException"/> be thrown when an I/O
