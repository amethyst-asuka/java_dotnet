...
Namespace java.nio.file
	...
	''' 
	''' <ul>
	'''   <li><p> The <seealso cref="#getPath getPath"/> method converts a system dependent
	'''     <em>path string</em>, returning a <seealso cref="Path"/> object that may be used
	'''     to locate and access a file. </p></li>
	'''   <li><p> The <seealso cref="#getPathMatcher  getPathMatcher"/> method is used
	'''     to create a <seealso cref="PathMatcher"/> that performs match operations on
	'''     paths. </p></li>
	'''   <li><p> The <seealso cref="#getFileStores getFileStores"/> method returns an iterator
	'''     over the underlying <seealso cref="FileStore file-stores"/>. </p></li>
	'''   <li><p> The <seealso cref="#getUserPrincipalLookupService getUserPrincipalLookupService"/>
	'''     method returns the <seealso cref="UserPrincipalLookupService"/> to lookup users or
	'''     groups by name. </p></li>
	'''   <li><p> The <seealso cref="#newWatchService newWatchService"/> method creates a
	...
	Public MustInherit Class FileSystem
		...
		Public MustOverride Function provider() As java.nio.file.spi.FileSystemProvider
		...
		Public MustOverride Overrides Sub close()
		...
		Public MustOverride ReadOnly Property open As Boolean
		...
		Public MustOverride ReadOnly Property separator As String
		...
		Public MustOverride ReadOnly Property rootDirectories As Iterable(Of Path)
		...
		Public MustOverride ReadOnly Property fileStores As Iterable(Of FileStore)
		...
		''' 
		''' <p> The <seealso cref="BasicFileAttributeView"/> is required to be supported and
		...
		'''          views </returns>
		Public MustOverride Function supportedFileAttributeViews() As java.util.Set(Of String)
		...
		''' characters.
		''' 
		''' <p> This method throws <seealso cref="InvalidPathException"/> when the path string
		...
		''' 
		'''   <li><p> The matching of <seealso cref="Path#getRoot root"/> components is highly
		...
		Public MustOverride ReadOnly Property userPrincipalLookupService As UserPrincipalLookupService
		...
		''' <exception cref="IOException">
		'''          If an I/O error occurs </exception>
		Public MustOverride Function newWatchService() As WatchService
	End Class
