...
Namespace java.nio.file
	...
	''' 
	''' <p> A <seealso cref="Watchable"/> object is registered with a watch service by invoking
	...
	Public Interface WatchService
		...
		''' 
		''' <p> If a thread is currently blocked in the <seealso cref="#take take"/> or {@link
