...
Namespace java.nio
	...
	Friend Class DirectCharBufferRU
		Inherits DirectCharBufferU
		...
		Public Overrides Function slice() As CharBuffer
			...
			assert([off] >= 0)
			Return New DirectCharBufferRU(Me, -1, 0, [rem], [rem], [off])
		End Function
		...
		Public Overrides Function subSequence(ByVal start As Integer, ByVal [end] As Integer) As CharBuffer
			...
			Return New DirectCharBufferRU(Me, -1, pos + start, pos + [end], capacity(), offset)
		End Function
