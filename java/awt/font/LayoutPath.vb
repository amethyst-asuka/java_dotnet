...
Namespace java.awt.font
	...
	''' @since 1.6
	''' </summary>
	Public MustInherit Class LayoutPath
		''' <summary>
		...
		''' the location with the smallest advance is chosen. </summary>
		''' <param name="point"> the point to convert.  If it is not the same
		''' object as location, point will remain unmodified by this call. </param>
		''' <param name="location"> a <code>Point2D</code> to hold the returned location.
		''' It can be the same object as point. </param>
		...
		''' whose location and slope is to be used to interpret the offset. </summary>
		''' <param name="location"> a <code>Point2D</code> representing the advance (in x) and
		''' offset (in y) of a location relative to the path.  If location
		''' is not the same object as point, location will remain
		''' unmodified by this call. </param>
		''' <param name="preceding"> if true, the portion preceding the advance
		''' should be used, if false the portion after should be used.
		''' This has no effect if the path does not break or bend sharply
		''' at the advance. </param>
		''' <param name="point"> a <code>Point2D</code> to hold the returned point.  It can be
