...
Namespace java.awt
	...
	Public Class Cursor
		...
		<Obsolete("As of JDK version 1.7, the <seealso cref="#getPredefinedCursor(int)"/>")> _
		...
		Friend type As Integer = DEFAULT_CURSOR
...
'JAVA TO VB CONVERTER TODO TASK: There is no VB equivalent to 'volatile':
		...
		Private Property pData As Long
		...
		''' </summary>
		Public Property Shared defaultCursor As Cursor
			Get
