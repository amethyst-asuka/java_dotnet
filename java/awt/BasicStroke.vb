...
Namespace java.awt
    ...
    Public Class BasicStroke
        ...
        Sub New(width As Float, cap As Integer, join As Integer, miterlimit As Float, dash() As Float, dash_phase As Float)
        ...
        ''' <exception cref="IllegalArgumentException"> if <code>join</code> is not
        '''         either JOIN_ROUND, JOIN_BEVEL, or JOIN_MITER </exception>
        Sub New(width As Single, cap As Integer, join As Integer, miterlimit As Single)
            Me.New(width, cap, join, miterlimit, Nothing, 0.0F)
        End Sub
        ''' <summary>
        ''' Constructs a solid <code>BasicStroke</code> with the specified
        ...
        ''' <exception cref="IllegalArgumentException"> if <code>join</code> is not
        '''         either JOIN_ROUND, JOIN_BEVEL, or JOIN_MITER </exception>
        Sub New(width As Single, cap As Integer, join As Integer)
            Me.New(width, cap, join, 10.0F, Nothing, 0.0F)
        End Sub
        ''' <summary>
        ''' Constructs a solid <code>BasicStroke</code> with the specified
        ...
        ''' <param name="width"> the width of the <code>BasicStroke</code> </param>
        ''' <exception cref="IllegalArgumentException"> if <code>width</code> is negative </exception>
        Sub New(width As Single)
            Me.New(width, CAP_SQUARE, JOIN_MITER, 10.0F, Nothing, 0.0F)
        End Sub
        ''' <summary>
        ...
        ''' </summary>
        Sub New()
            Me.New(1.0F, CAP_SQUARE, JOIN_MITER, 10.0F, Nothing, 0.0F)
        End Sub
        ...
        Public Function createStrokedShape(s As Shape) As Shape
        ...
        Public Function lineWidth() As Single
            Return width
        End Function
        ''' <summary>
        ...
        ''' styles. </returns>
        Public Function endCap() As Integer
            Return cap
        End Function
        ''' <summary>
        ...
        Public Function dashArray() As Single()
        ...
        Public Function dashPhase() As Single
            Return dash_phase
        End Function
        ''' <summary>
