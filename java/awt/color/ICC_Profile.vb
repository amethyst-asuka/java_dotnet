...
'			Me.profileActivator = New sun.java2d.cmm.ProfileActivator()
	...
	'     
		...
		Private Class PrivilegedActionAnonymousInnerClassHelper(Of T)
			...
			Public Overridable Function run() As ICC_Profile
	...
	'                                               profiles if necessary 
		...
		Friend Overridable Function getGamma(ByVal theTagSignature As Integer) As Single
	...
	'                                                  profiles if necessary 
		...
		Friend Overridable Function getTRC(ByVal theTagSignature As Integer) As Short()
		Dim theTRCData As SByte()
		Dim theTRC As Short()
