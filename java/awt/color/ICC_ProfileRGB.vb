...
Namespace java.awt.color
	...
	Public Class ICC_ProfileRGB
		...
		Public Property Overrides mediaWhitePoint As Single()
			Get
		...
		Public Overridable Property matrix As Single()()
			Get
				Dim theMatrix As Single()() = RectangularArrays.ReturnRectangularSingleArray(3, 3)
...
Partial Friend Class RectangularArrays
    Friend Shared Function ReturnRectangularSingleArray(ByVal Size1 As Integer, ByVal Size2 As Integer) As Single()()
        Dim Array As Single()() = New Single(Size1 - 1)() {}
        For Array1 As Integer = 0 To Size1 - 1
            Array(Array1) = New Single(Size2 - 1) {}
        Next Array1
        Return Array
    End Function
End Class