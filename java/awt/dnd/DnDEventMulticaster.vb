...
Namespace java.awt.dnd
	...
	Friend Class DnDEventMulticaster
		...
		Public Shared Function add(ByVal a As DragSourceListener, ByVal b As DragSourceListener) As DragSourceListener
		...
		Public Shared Function add(ByVal a As DragSourceMotionListener, ByVal b As DragSourceMotionListener) As DragSourceMotionListener
		...
		Public Shared Function remove(ByVal l As DragSourceListener, ByVal oldl As DragSourceListener) As DragSourceListener
		...
		Public Shared Function remove(ByVal l As DragSourceMotionListener, ByVal ol As DragSourceMotionListener) As DragSourceMotionListener
		...
		Protected Friend Overrides Function remove(ByVal oldl As java.util.EventListener) As java.util.EventListener
