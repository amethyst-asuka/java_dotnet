...
Namespace java.awt
	...
	''' </summary>
	''' <seealso cref= KeyboardFocusManager#addKeyEventDispatcher </seealso>
	''' <seealso cref= KeyboardFocusManager#removeKeyEventDispatcher
	''' @since 1.4 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	Public Interface KeyEventDispatcher
		...
		''' </summary>
		''' <param name="e"> the KeyEvent to dispatch </param>
		''' <returns> <code>true</code> if the KeyboardFocusManager should take no
