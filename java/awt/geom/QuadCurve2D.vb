...
Namespace java.awt.geom
    ...
    Public MustInherit Class QuadCurve2D
        ...
        Public Class Float
            ...
            ''' @since 1.2
            ''' </summary>
            Public Overrides ReadOnly Property ctrlX As Double
                Get
                    Return CDbl(ctrlX)
                End Get
            End Property
            ...
            ''' @since 1.2
            ''' </summary>
            Public Overrides ReadOnly Property ctrlY As Double
                Get
                    Return CDbl(ctrlY)
                End Get
            End Property
            ...
            ''' @since 1.2
            ''' </summary>
            Public Overrides ReadOnly Property ctrlPt As Point2D
                Get
        ...
        Public Class Double?
            ...
            ''' @since 1.2
            ''' </summary>
            Public Overridable ReadOnly Property bounds2D As Rectangle2D
                Get
