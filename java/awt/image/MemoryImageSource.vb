...
Namespace java.awt.image
    ...
    Public Class MemoryImageSource
		...
		Public Sub addConsumer(java.awt.image.ImageConsumer ic)
        ...
        ''' <param name="ic"> the specified <code>ImageConsumer</code> </param>
        ''' <seealso cref= ImageConsumer </seealso>
        Public Sub removeConsumer(java.awt.image.ImageConsumer ic)
        ...
        Public Sub animatedted(Boolean animated)
        ...
        Public Sub fullBufferUpdatestes(Boolean fullbuffers)
        ...
        Public Sub newPixels(Integer x, Integer y, Integer w, Integer h)
        ...
        ''' <seealso cref= #setAnimated </seealso>
        ''' <seealso cref= #setFullBufferUpdates </seealso>
        Public Sub newPixels(Integer x, Integer y, Integer w, Integer h, Boolean framenotify)
            If animating Then
                If fullbuffers Then
                    y = 0
                    x = y
        ...
        ''' <seealso cref= #newPixels(int, int, int, int, boolean) </seealso>
        ''' <seealso cref= #setAnimated </seealso>
        Public Sub newPixels(SByte() newpix, java.awt.image.ColorModel newmodel, Integer offset, Integer scansize)
            Me.pixels = newpix
            Me.model = newmodel
        ...
        ''' <seealso cref= #newPixels(int, int, int, int, boolean) </seealso>
        ''' <seealso cref= #setAnimated </seealso>
        Public Sub newPixels(Integer() newpix, java.awt.image.ColorModel newmodel, Integer offset, Integer scansize)
            Me.pixels = newpix
            Me.model = newmodel
            Me.pixeloffset = OffSet()
            Me.pixelscan = scansize
        ...
        Private Sub initConsumer(ic As java.awt.image.ImageConsumer)
