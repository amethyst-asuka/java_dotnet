...
Namespace java.awt.image
    ...
    Public NotInheritable Class BandedSampleModel
        ...
        ''' <exception cref="IllegalArgumentException"> if <code>dataType</code> is not
        '''         one of the supported data types </exception>
        Sub New(dataType As Integer, w As Integer, h As Integer, scanlineStride As Integer, bankIndices() As Integer, bandOffsets() As Integer)
            MyBase.New(dataType, w, h, 1, scanlineStride, bankIndices, bandOffsets)
        End Sub
        ...
        ''' <exception cref="IllegalArgumentException"> if <code>dataType</code> is not
        '''         one of the supported data types </exception>
        Public Function createSubsetSampleModel(bands() As Integer) As SampleModel
        ...
        Public Function createDataBuffer() As DataBuffer
        ...
        Public Function getPixel(x As Integer, y As Integer, iArray() As Integer, data As DataBuffer) As Integer()
            If (x < 0) OrElse (y < 0) OrElse (x >= width) OrElse (y >= height) Then Throw New ArrayIndexOutOfBoundsException("Coordinate out of bounds!")
        ...
        Public Function getPixels(x As Integer, y As Integer, w As Integer, h As Integer, iArray() As Integer, data As DataBuffer) As Integer()
        ...
        Public Function getSample(x As Integer, y As Integer, b As Integer, data As DataBuffer) As Integer
        ...
        Public Function getSampleFloat(x As Integer, y As Integer, b As Integer, data As DataBuffer) As Single
            ' Bounds check for 'b' will be performed automatically
            If (x < 0) OrElse (y < 0) OrElse (x >= width) OrElse (y >= height) Then Throw New ArrayIndexOutOfBoundsException("Coordinate out of bounds!")
        ...
        ''' band for the specified pixel. </returns>
        Public Function getSampleDouble(x As Integer, y As Integer, b As Integer, data As DataBuffer) As Double
            ' Bounds check for 'b' will be performed automatically
            If (x < 0) OrElse (y < 0) OrElse (x >= width) OrElse (y >= height) Then Throw New ArrayIndexOutOfBoundsException("Coordinate out of bounds!")
        ...
        Public Function getSamples(x As Integer, y As Integer, w As Integer, h As Integer, b As Integer, iArray() As Integer, data As DataBuffer) As Integer()
            ' Bounds check for 'b' will be performed automatically
        ...
        Public Sub dataElementsnts(x As Integer, y As Integer, obj As Object, data As DataBuffer)
            If (x < 0) OrElse (y < 0) OrElse (x >= width) OrElse (y >= height) Then Throw New ArrayIndexOutOfBoundsException("Coordinate out of bounds!")
            Dim type As Integer = transferType
            Dim numDataElems As Integer = numDataElements
            Dim pixelOffset As Integer = y * scanlineStride + x
        ...
        Public Sub pixelxel(x As Integer, y As Integer, iArray() As Integer, data As DataBuffer)
            If (x < 0) OrElse (y < 0) OrElse (x >= width) OrElse (y >= height) Then Throw New ArrayIndexOutOfBoundsException("Coordinate out of bounds!")
            Dim pixelOffset As Integer = y * scanlineStride + x
            For i As Integer = 0 To numBands - 1
                data.elemlem(bankIndices(i), pixelOffset + bandOffsets(i), iArray(i))
        ...
        Public Sub pixelsels(x As Integer, y As Integer, w As Integer, h As Integer, iArray() As Integer, data As DataBuffer)
            Dim x1 As Integer = x + w
            Dim y1 As Integer = y + h
        ...
        Public Sub sampleple(x As Integer, y As Integer, b As Integer, s As Integer, data As DataBuffer)
            ' Bounds check for 'b' will be performed automatically
            If (x < 0) OrElse (y < 0) OrElse (x >= width) OrElse (y >= height) Then Throw New ArrayIndexOutOfBoundsException("Coordinate out of bounds!")
        ...
        ''' <param name="data">      The DataBuffer containing the image data </param>
        ''' <seealso cref= #getSample(int, int, int, DataBuffer) </seealso>
        Public Sub sampleple(x As Integer, y As Integer, b As Integer, s As Single, data As DataBuffer)
            ' Bounds check for 'b' will be performed automatically
            If (x < 0) OrElse (y < 0) OrElse (x >= width) OrElse (y >= height) Then Throw New ArrayIndexOutOfBoundsException("Coordinate out of bounds!")
        ...
        ''' <param name="data">      The DataBuffer containing the image data </param>
        ''' <seealso cref= #getSample(int, int, int, DataBuffer) </seealso>
        Public Sub sampleple(x As Integer, y As Integer, b As Integer, s As Double, data As DataBuffer)
            ' Bounds check for 'b' will be performed automatically
            If (x < 0) OrElse (y < 0) OrElse (x >= width) OrElse (y >= height) Then Throw New ArrayIndexOutOfBoundsException("Coordinate out of bounds!")
        ...
        Public Sub samplesles(x As Integer, y As Integer, w As Integer, h As Integer, b As Integer, iArray() As Integer, data As DataBuffer)
            ' Bounds check for 'b' will be performed automatically
            If (x < 0) OrElse (y < 0) OrElse (x + w > width) OrElse (y + h > height) Then Throw New ArrayIndexOutOfBoundsException("Coordinate out of bounds!")
            Dim lineOffset As Integer = y * scanlineStride + x + bandOffsets(b)
            Dim srcOffset As Integer = 0
        ...
        Private Shared Function createOffsetArray(numBands As Integer) As Integer()
        ...
        Private Shared Function createIndicesArray(numBands As Integer) As Integer()
