...
Namespace java.awt.image
	...
	''' @since 1.4
	''' </summary>
	Public MustInherit Class VolatileImage
		...
		''' is undefined.
		''' </summary>
		Public Const IMAGE_INCOMPATIBLE As Integer = 2
		...
		Public MustOverride ReadOnly Property snapshot As BufferedImage
		...
		'''          image. </returns>
		Public MustOverride Function createGraphics() As java.awt.Graphics2D
		...
		Public MustOverride Function contentsLost() As Boolean
		...
		''' @since 1.4 </returns>
		Public MustOverride ReadOnly Property capabilities As java.awt.ImageCapabilities
		...
		''' @since 1.5 </seealso>
		Protected Friend transparency As Integer = TRANSLUCENT
