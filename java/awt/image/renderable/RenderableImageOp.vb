...
Namespace java.awt.image.renderable
	...
	Public Class RenderableImageOp
		...
		Public Overridable Property sources As List(Of RenderableImage) Implements RenderableImage.getSources
			Get
				Return renderableSources
			End Get
		End Property

		Private Property renderableSources As ArrayList
			Get
				Dim sources_Renamed As ArrayList = Nothing
    
				If paramBlock.numSources > 0 Then
					...
					Do While i < paramBlock.numSources
						...
						If TypeOf o Is RenderableImage Then
							sources_Renamed.Add(CType(o, RenderableImage))
							i += 1
						Else
							Exit Do
						End If
		...
		Public Overridable Property propertyNames As String() Implements RenderableImage.getPropertyNames
			Get
		...
		Public Overridable Property dynamic As Boolean Implements RenderableImage.isDynamic
			Get
		...
		Public Overridable Property width As Single Implements RenderableImage.getWidth
			Get
		...
		Public Overridable Property height As Single Implements RenderableImage.getHeight
			Get
				If boundingBox Is Nothing Then boundingBox = myCRIF.getBounds2D(paramBlock)
		...
		''' </summary>
		Public Overridable Property minX As Single Implements RenderableImage.getMinX
			Get
				If boundingBox Is Nothing Then boundingBox = myCRIF.getBounds2D(paramBlock)
		...
		''' </summary>
		Public Overridable Property minY As Single Implements RenderableImage.getMinY
			Get
				If boundingBox Is Nothing Then boundingBox = myCRIF.getBounds2D(paramBlock)
		...
		Public Overridable Property parameterBlock As ParameterBlock
			Get
				Return paramBlock
			End Get
		End Property
		...
		Public Overridable Function createRendering(ByVal renderContext As RenderContext) As java.awt.image.RenderedImage
			Dim image_Renamed As java.awt.image.RenderedImage = Nothing
