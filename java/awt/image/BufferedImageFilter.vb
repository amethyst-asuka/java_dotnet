...
Namespace java.awt.image
	...
	Public Class BufferedImageFilter
        ...
        '''                                int, int) </seealso>
        Public Sub setPixels(x As int, y As int, w As int, h As int, model As ColorModel, pixels() As Byte, off As Integer, scansize As Integer)
            ' Fix 4184230
        ...
        Public Sub imageComplete(status As Integer)
        ...
        Private Function createDCMraster() As WritableRaster
            Dim wr As WritableRaster
