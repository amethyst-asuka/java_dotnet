...
Namespace java.awt.event
	...
	Public MustInherit Class InputEvent
		...
		''' @since 7.0
		''' </summary>
		Private Property Shared buttonDownMasks As Integer()
			Get
...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		''' </summary>
		Public Overridable Property shiftDown As Boolean
			Get
		...
		''' </summary>
		Public Overridable Property controlDown As Boolean
			Get
		...
		''' </summary>
		Public Overridable Property metaDown As Boolean
			Get
		...
		''' </summary>
		Public Overridable Property altDown As Boolean
			Get
		...
		''' </summary>
		Public Overridable Property altGraphDown As Boolean
			Get
		...
		''' @since 1.4
		''' </summary>
		Public Overridable Property modifiersEx As Integer
			Get
