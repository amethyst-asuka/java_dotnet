...
Namespace java.awt
    ...
    Public Class Font : Inherits java.lang.Object
        ...
        Private Sub New(ByVal values As sun.font.AttributeValues, ByVal oldName As String, ByVal oldStyle As Integer, ByVal created As Boolean, ByVal handle As sun.font.Font2DHandle)
            ...
            If created Then
                ...
                If oldStyle = -1 Then
                    newStyle = -1
                Else
                    If values.weight >= 2.0F Then newStyle = BOLD
                    If values.posture >= 0.2F Then newStyle = newStyle Or ITALIC
        ...
        Private Sub initFromValues(ByVal values As sun.font.AttributeValues)
            ...
            If values.weight >= 2.0F Then ' not == 2f Me.style = Me.style Or BOLD
                If values.posture >= 0.2F Then ' not  == .2f Me.style = Me.style Or ITALIC
        ...
        Private Shared Function hasTempPermission() As Boolean
            ...
            If java.lang.System.securityManager Is Nothing Then Return True
        ...
        Public Overridable Property transform As java.awt.geom.AffineTransform
            Get
                ...
                If nonIdentityTx Then
                    ...
                    If values.isNonDefault(EWIDTH) Then at.scale(values.width, 1.0F)
        ...
        Private Shared ReadOnly ssinfo As Single() = {0.0F, 0.375F, 0.625F, 0.7916667F, 0.9027778F, 0.9768519F, 1.02623463F, 1.05915642F}
        ...
        Private Function defaultLineMetrics(ByVal frc As java.awt.font.FontRenderContext) As sun.font.FontLineMetrics
            ...
            If flmref Is Nothing OrElse flm Is Nothing OrElse (Not flm.frc.Equals(frc)) Then
                ...
                Dim baselineOffsets As Single() = {0, (descent / 2.0F - ascent) / 2.0F, -ascent}
        ...
        Private Shared Sub applyStyle(ByVal style As Integer, ByVal values As sun.font.AttributeValues)
            ...
            values.posture = If((style And ITALIC) <> 0, 0.2F, 0F)
        End Sub
