...
Namespace java.awt
	...
	'     
		...
		''' @since 1.7 </seealso>
		Private multipleMode As Boolean = False
...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		Public Overridable Property directory As String
			...
			Set(ByVal dir As String)
				Me.dir = If(dir IsNot Nothing AndAlso dir.Equals(""), Nothing, dir)
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
        Public Overridable Function getFile() As String 'JavaToDotNetTempPropertyGetfile
		...
		End Property
			...
			Me.file = If(file IsNot Nothing AndAlso file.Equals(""), Nothing, file)
			Dim peer_Renamed As java.awt.peer.FileDialogPeer = CType(Me.peer, java.awt.peer.FileDialogPeer)
