...
Namespace java.awt
	...
	Public MustInherit Class Toolkit
		...
		<Obsolete(" see java.awt.GraphicsEnvironment#getAllFonts")> _
		...
		<Obsolete(" As of JDK version 1.2, replaced by the <code>Font</code>")> _
...
'			sun.awt.AWTAccessor.setToolkitAccessor(New sun.awt.AWTAccessor.ToolkitAccessor()
	...
	'				});
		...
		Public Property systemEventQueue As EventQueue
			Get
		...
		Friend Property Shared eventQueue As EventQueue
			Get
...
'JAVA TO VB CONVERTER TODO TASK: There is no VB equivalent to 'volatile':
	...
	'     
		...
		''' <seealso cref=      java.awt.event.AWTEventListenerProxy
		''' @since 1.4 </seealso>
		Public Overridable Property aWTEventListeners As AWTEventListener()
			Get
				Dim security As SecurityManager = System.securityManager
				If security IsNot Nothing Then security.checkPermission(sun.security.util.SecurityConstants.AWT.ALL_AWT_EVENTS_PERMISSION)
				SyncLock Me
	...
	'     
		...
		Private Class SelectiveAWTEventListener
			...
			Public Overridable Property listener As AWTEventListener
				Get
					Return listener
				End Get
			End Property
			Public Overridable Property eventMask As Long
				...
				End Get
			End Property
			Public Overridable Property calls As Integer()
				Get
					Return calls
				End Get
			End Property
