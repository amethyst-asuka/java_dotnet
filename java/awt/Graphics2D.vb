...
Namespace java.awt
	...
	Public MustInherit Class Graphics2D
		Inherits Graphics
		...
		''' the current <code>Paint</code>. </summary>
		...
		''' and rendered using
		''' <seealso cref="#drawRenderedImage(RenderedImage, AffineTransform) drawRenderedImage"/>. </summary>
		''' <param name="img"> the image to be rendered. This method does
		'''            nothing if <code>img</code> is null. </param>
		''' <param name="xform"> the transformation from image space into user space </param>
		''' <seealso cref= #transform </seealso>
		...
		Public MustOverride ReadOnly Property deviceConfiguration As GraphicsConfiguration
		...
		Public MustOverride Property composite As Composite
		...
		Public MustOverride Property paint As Paint
		...
		Public MustOverride Property stroke As Stroke
		...
		''' <seealso cref= RenderingHints </seealso>
		Public MustOverride Property renderingHints(Of T1) As IDictionary(Of T1)
		...
		''' <seealso cref= AffineTransform </seealso>
		Public MustOverride Property transform As java.awt.geom.AffineTransform
		...
		Public MustOverride Property background As Color
		...
		Public MustOverride ReadOnly Property fontRenderContext As java.awt.font.FontRenderContext
