...
Namespace java.awt
	...
	'''   <td>Setting always-on-top property of the window: <seealso cref="Window#setAlwaysOnTop"/></td>
	...
	'''   <td>Creating <seealso cref="Dialog.ModalityType#TOOLKIT_MODAL TOOLKIT_MODAL"/> dialogs
	...
	Public NotInheritable Class AWTPermission
		Inherits java.security.BasicPermission

		''' <summary>
		''' use serialVersionUID from the Java 2 platform for interoperability </summary>
		Private Const serialVersionUID As Long = 8890392402588814465L
		...
		''' </summary>
		''' <param name="name"> the name of the AWTPermission
		''' </param>
		...
		''' </summary>
		''' <param name="name"> the name of the <code>AWTPermission</code> </param>
		''' <param name="actions"> should be <code>null</code>
		''' </param>
		''' <exception cref="NullPointerException"> if <code>name</code> is <code>null</code>. </exception>
		''' <exception cref="IllegalArgumentException"> if <code>name</code> is empty. </exception>
