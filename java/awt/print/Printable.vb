...
Namespace java.awt.print
	...
	''' <seealso cref="Pageable"/>, pairs of <seealso cref="PageFormat"/>
	...
	''' </ul>
	''' <p> </summary>
	''' <seealso cref= java.awt.print.Pageable </seealso>
	''' <seealso cref= java.awt.print.PageFormat </seealso>
	''' <seealso cref= java.awt.print.PrinterJob </seealso>
	Public Interface Printable

		''' <summary>
		''' Returned from <seealso cref="#print(Graphics, PageFormat, int)"/>
...
'		int NO_SUCH_PAGE = 1;
		...
		''' <seealso cref="Graphics"/> context in the specified
		...
		''' <seealso cref="PrinterGraphics"/> interface to provide additional
		''' information.  If the <code>Printable</code> object
		''' aborts the print job then it throws a <seealso cref="PrinterException"/>. </summary>
