...
Namespace java.awt
	...
	Public MustInherit Class FontMetrics
		...
		Protected Friend font_Renamed As Font
	...
	'     
		...
		''' @since 1.6 </returns>
		Public Overridable Property fontRenderContext As java.awt.font.FontRenderContext
			Get
				Return DEFAULT_FRC
			End Get
		End Property
		...
		Public Overridable Property leading As Integer
			Get
				Return 0
			End Get
		End Property
		...
		Public Overridable Property ascent As Integer
			Get
		...
		Public Overridable Property descent As Integer
			Get
				Return 0
			End Get
		End Property
		...
		''' <seealso cref=       #getAscent() </seealso>
		Public Overridable Property maxAscent As Integer
			Get
				Return ascent
			End Get
		End Property
		...
		''' <code>Font</code>. </returns>
		''' <seealso cref=       #getDescent() </seealso>
		Public Overridable Property maxDescent As Integer
			Get
				Return descent
			End Get
		End Property
		...
		<Obsolete("As of JDK version 1.1.1,")> _
		Public Overridable Property maxDecent As Integer
			Get
				Return maxDescent
			End Get
		End Property
		...
		Public Overridable Property maxAdvance As Integer
			Get
				Return -1
			End Get
		End Property
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
		...
		''' <seealso cref=       #charsWidth(char[], int, int) </seealso>
		''' <seealso cref=       #stringWidth(String) </seealso>
		public Integer bytesWidth(SByte data() , Integer off, Integer len)
		...
		public Integer() widths
			...
			For ch As Char = 0 To 255
				widths_Renamed(AscW(ch)) = charWidth(ch)
			Next ch
		...
		public java.awt.font.LineMetrics getLineMetrics(String str, Integer beginIndex, Integer limit, Graphics context)
		...
		public java.awt.font.LineMetrics getLineMetrics(Char () chars, Integer beginIndex, Integer limit, Graphics context)
		...
		public java.awt.font.LineMetrics getLineMetrics(java.text.CharacterIterator ci, Integer beginIndex, Integer limit, Graphics context)
		...
		public java.awt.geom.Rectangle2D getStringBounds(String str, Integer beginIndex, Integer limit, Graphics context)
	   ...
	   ''' <seealso cref= java.awt.Font#getStringBounds(char[], int, int, FontRenderContext) </seealso>
		public java.awt.geom.Rectangle2D getStringBounds(Char () chars, Integer beginIndex, Integer limit, Graphics context)
	   ...
	   ''' <seealso cref= java.awt.Font#getStringBounds(CharacterIterator, int, int, FontRenderContext) </seealso>
		public java.awt.geom.Rectangle2D getStringBounds(java.text.CharacterIterator ci, Integer beginIndex, Integer limit, Graphics context)
