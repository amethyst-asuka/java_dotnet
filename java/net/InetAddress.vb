...
Namespace java.net
	...
	Public Class InetAddress
		...
		Friend Class InetAddressHolder
			...
			''' </summary>
			Friend originalHostName As String
			...
			Friend Overridable Sub init(ByVal hostName As String, ByVal family As Integer)
				Me.originalHostName = hostName
				Me.hostName = hostName
				If family <> -1 Then Me.family = family
			End Sub
			...
			Friend Overridable Property address As Integer
				Get
					Return address
				End Get
			End Property
			...
			''' </summary>
			Friend family As Integer

			Friend Overridable Property family As Integer
				Get
					Return family
				End Get
			End Property
