...
Namespace java.net
	...
	Public NotInheritable Class NetPermission
		Inherits BasicPermission

		Private Const serialVersionUID As Long = -8343910153355041693L
		...
		''' </summary>
		''' <param name="name"> the name of the NetPermission.
		''' </param>
		...
		''' </summary>
		''' <param name="name"> the name of the NetPermission. </param>
