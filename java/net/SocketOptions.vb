...
Namespace java.net
	...
	Public Interface SocketOptions
		...
		''' </PRE>
		''' </summary>
		''' <param name="optID"> an {@code int} identifying the option to fetch </param>
		''' <returns> the value of the option </returns>
		''' <exception cref="SocketException"> if the socket is closed </exception>
		...
		''' <seealso cref= Socket#getTcpNoDelay </seealso>

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int TCP_NODELAY = &H1;
		...
		''' </summary>
		''' <seealso cref= Socket#getLocalAddress </seealso>
		''' <seealso cref= DatagramSocket#getLocalAddress </seealso>

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int SO_BINDADDR = &HF;
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int SO_REUSEADDR = &H4;
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int SO_BROADCAST = &H20;
		...
		''' </summary>
		''' <seealso cref= MulticastSocket#setInterface(InetAddress) </seealso>
		''' <seealso cref= MulticastSocket#getInterface() </seealso>

'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int IP_MULTICAST_IF = &H10;
		...
		''' 
		'''  NOTE: make sure there is no conflict with this </summary>
		''' <seealso cref= MulticastSocket#setNetworkInterface(NetworkInterface) </seealso>
		''' <seealso cref= MulticastSocket#getNetworkInterface()
		''' @since 1.4 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int IP_MULTICAST_IF2 = &H1f;
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int IP_MULTICAST_LOOP = &H12;
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int IP_TOS = &H3;
		...
		''' <seealso cref= Socket#getSoLinger </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int SO_LINGER = &H80;
		...
		''' </summary>
		''' <seealso cref= Socket#setSoTimeout </seealso>
		''' <seealso cref= ServerSocket#setSoTimeout </seealso>
		''' <seealso cref= DatagramSocket#setSoTimeout </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int SO_TIMEOUT = &H1006;
		...
		''' <seealso cref= Socket#getSendBufferSize </seealso>
		''' <seealso cref= DatagramSocket#setSendBufferSize </seealso>
		''' <seealso cref= DatagramSocket#getSendBufferSize </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int SO_SNDBUF = &H1001;
		...
		''' <seealso cref= Socket#getReceiveBufferSize </seealso>
		''' <seealso cref= DatagramSocket#setReceiveBufferSize </seealso>
		''' <seealso cref= DatagramSocket#getReceiveBufferSize </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int SO_RCVBUF = &H1002;
		...
		''' <seealso cref= Socket#getKeepAlive </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int SO_KEEPALIVE = &H8;
		...
		''' </summary>
		''' <seealso cref= Socket#setOOBInline </seealso>
		''' <seealso cref= Socket#getOOBInline </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'		public final static int SO_OOBINLINE = &H1003;
	End Interface
