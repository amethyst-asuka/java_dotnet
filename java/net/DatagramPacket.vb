...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
		...
		public DatagramPacket(SByte buf() , Integer length)
			Me(buf, 0, length)
		...
		''' 
		''' @since 1.2 </seealso>
		public DatagramPacket(SByte buf() , Integer offset, Integer length, InetAddress address, Integer port)
			dataata(buf, offset, length)
			address = address
			port = port
		...
		''' 
		''' @since 1.4 </seealso>
		public DatagramPacket(SByte buf() , Integer offset, Integer length, SocketAddress address)
			dataata(buf, offset, length)
		...
		public DatagramPacket(SByte buf() , Integer length, InetAddress address, Integer port)
		...
		''' @since 1.4 </exception>
		''' <seealso cref=     java.net.InetAddress </seealso>
		public DatagramPacket(SByte buf() , Integer length, SocketAddress address)
