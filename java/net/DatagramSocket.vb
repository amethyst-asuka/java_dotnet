...
Namespace java.net
    ...
    Public Class DatagramSocket
        ...
        ''' @since 1.4 </exception>
        Friend Overridable ReadOnly Property impl As DatagramSocketImpl
            Get
        ...
        ''' @since 1.4 </returns>
        Public Overridable ReadOnly Property bound As Boolean
        ...
        ''' </summary>
        ''' <returns> the address to which this socket is connected. </returns>
        Public Overridable ReadOnly Property inetAddress As InetAddress
            Get
        ...
        Public Overridable ReadOnly Property port As Integer
            Get
        ...
        ''' @since 1.4 </seealso>
        Public Overridable ReadOnly Property remoteSocketAddress As SocketAddress
            Get
        ...
        Public Overridable ReadOnly Property localSocketAddress As SocketAddress
            Get
        ...
        ''' @since   1.1 </returns>
        Public Overridable ReadOnly Property localAddress As InetAddress
            Get
                If closed Then Return Nothing
        ...
        ''' @since 1.4
        ''' @spec JSR-51 </returns>
        Public Overridable ReadOnly Property channel As java.nio.channels.DatagramChannel
            Get
                Return Nothing
            End Get
        End Property
