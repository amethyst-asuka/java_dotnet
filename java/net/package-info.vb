...
''' <p>The <seealso cref="java.net.InetAddress"/> class is the abstraction representing an
'''    IP (Internet Protocol) address.  It has two subclasses:
''' <ul>
'''       <li><seealso cref="java.net.Inet4Address"/> for IPv4 addresses.</li>
'''       <li><seealso cref="java.net.Inet6Address"/> for IPv6 addresses.</li>
''' </ul>
...
'''    more. While methods like <seealso cref="java.net.InetAddress#getByName"/> are
...
''' <ul>
'''       <li><seealso cref="java.net.Socket"/> is a TCP client API, and will typically
'''            be used to {@link java.net.Socket#connect(SocketAddress)
'''            connect} to a remote host.</li>
'''       <li><seealso cref="java.net.ServerSocket"/> is a TCP server API, and will
'''            typically <seealso cref="java.net.ServerSocket#accept accept"/>
'''            connections from client sockets.</li>
'''       <li><seealso cref="java.net.DatagramSocket"/> is a UDP endpoint API and is used
'''            to <seealso cref="java.net.DatagramSocket#send send"/> and
'''            <seealso cref="java.net.DatagramSocket#receive receive"/>
'''            <seealso cref="java.net.DatagramPacket datagram packets"/>.</li>
'''       <li><seealso cref="java.net.MulticastSocket"/> is a subclass of
...
'''    <seealso cref="java.net.Socket#getInputStream"/> and
'''    <seealso cref="java.net.Socket#getOutputStream"/> methods.</p>
''' <h2>Interfaces</h2>
''' <p>The <seealso cref="java.net.NetworkInterface"/> class provides APIs to browse and
...
''' <ul>
'''       <li><seealso cref="java.net.URI"/> is the class representing a
...
'''       <li><seealso cref="java.net.URL"/> is the class representing a
'''            Universal Resource Locator, which is both an older concept for
'''            URIs and a means to access the resources.</li>
'''       <li><seealso cref="java.net.URLConnection"/> is created from a URL and is the
...
'''       <li><seealso cref="java.net.HttpURLConnection"/> is a subclass of URLConnection
'''            and provides some additional functionalities specific to the
'''            HTTP protocol.</li>
''' </ul>
''' <p>The recommended usage is to use <seealso cref="java.net.URI"/> to identify
'''    resources, then convert it into a <seealso cref="java.net.URL"/> when it is time to
'''    access the resource. From that URL, you can either get the
'''    <seealso cref="java.net.URLConnection"/> for fine control, or get directly the
'''    InputStream.
...
'''    class <seealso cref="java.net.URLStreamHandler"/>.</p>
