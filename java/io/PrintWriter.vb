...
Namespace java.io
    ...
    Public Class PrintWriter
        ...
        Public Sub New(  out As Writer,   autoFlush As Boolean)
            MyBase.New(out)
            Me.out = out
        ...
        ' Private constructor 
        Private Sub New(  charset As java.nio.charset.Charset,   file_Renamed As File)
        ...
        Public Overrides Sub write(buf() As Char, off As Integer, len As Integer)
            Try
                SyncLock lock
                    ensureOpen()
        ...
        Public Overloads Sub write(buf() As Char)
        ...
        ''' <param name="off"> Offset from which to start writing characters </param>
        ''' <param name="len"> Number of characters to write </param>
        Public Overloads Sub write(s As String, off As Integer, len As Integer)
            Try
                SyncLock lock
                    ensureOpen()
                    out.write(s, off, len)
        ...
        Public Overloads Sub write(s As String)
            write(s, 0, s.Length())
        End Sub
        ...
        ''' 
        ''' @since  1.5 </returns>
        Public Function printf(format As String, ParamArray args As Object()) As PrintWriter
        ...
        ''' 
        ''' @since  1.5 </returns>
        Public Function printf(l As java.util.Locale, format As String, ParamArray args As Object()) As PrintWriter
        ...
        ''' 
        ''' @since  1.5 </returns>
        Public Function format(formats As String, ParamArray args As Object()) As PrintWriter
            Try
                SyncLock lock
                    ensureOpen()
        ...
        ''' 
        ''' @since  1.5 </returns>
        Public Function format(l As java.util.Locale, formats As String, ParamArray args As Object()) As PrintWriter
            Try
                SyncLock lock
                    ensureOpen()
        ...
        ''' 
        ''' @since  1.5 </returns>
        Public Overloads Function append(csq As CharSequence) As PrintWriter
        ...
        ''' 
        ''' @since  1.5 </exception>
        Public Overloads Function append(csq As CharSequence, start As Integer, [end] As Integer) As PrintWriter
        ...
        ''' 
        ''' @since 1.5 </returns>
        Public Overloads Function append(c As Char) As PrintWriter
            write(c)
            Return Me
        End Function
    End Class
