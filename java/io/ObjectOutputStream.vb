...
Namespace java.io
    ...
    Public Class ObjectOutputStream
        ...
        Public Sub New(out As OutputStream)
            ...
            [handles] = New HandleTable(10, CSng(3.0))
            subs = New ReplaceTable(10, CSng(3.0))
        ...
        ''' @since   1.2 </seealso>
        Public Overridable Sub useProtocolVersion(version As Integer)
        ...
        Public Sub writeObject(obj As Object) Implements ObjectOutput.writeObject
        ...
        ''' @since 1.2 </seealso>
        Protected Friend Overridable Sub writeObjectOverride(obj As Object)
        End Sub
        ...
        ''' @since 1.4 </exception>
        Public Overridable Sub writeUnshared(obj As Object)
            Try
        ...
        ''' <exception cref="IOException"> Any exception thrown by the underlying
        '''          OutputStream. </exception>
        Protected Friend Overridable Sub annotateClass(cl As [Class])
        End Sub
        ...
        ''' @since   1.3 </seealso>
        Protected Friend Overridable Sub annotateProxyClass(cl As [Class])
        End Sub
        ...
        ''' <exception cref="IOException"> Any exception thrown by the underlying
        '''          OutputStream. </exception>
        Protected Friend Overridable Function replaceObject(obj As Object) As Object
            Return obj
        End Function
        ...
        ''' <seealso cref= SecurityManager#checkPermission </seealso>
        ''' <seealso cref= java.io.SerializablePermission </seealso>
        Protected Friend Overridable Function enableReplaceObject(enable As Boolean) As Boolean
        ...
        ''' @since 1.3 </seealso>
        Protected Friend Overridable Sub writeClassDescriptor(desc As ObjectStreamClass)
        ...
        ''' <exception cref="IOException"> If an I/O error has occurred. </exception>
        Public Overrides Sub write(val As Integer) Implements ObjectOutput.write
            bout.write(val)
        End Sub
        ...
        ''' <exception cref="IOException"> If an I/O error has occurred. </exception>
        Public Overrides Sub write(buf As SByte()) Implements ObjectOutput.write
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeBoolean(val As Boolean) Implements DataOutput.writeBoolean
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeByte(val As Integer) Implements DataOutput.writeByte
            bout.writeByte(val)
        End Sub
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeShort(val As Integer) Implements DataOutput.writeShort
            bout.writeShort(val)
        End Sub
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeChar(val As Integer) Implements DataOutput.writeChar
            bout.writeChar(val)
        End Sub
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeInt(val As Integer) Implements DataOutput.writeInt
            bout.writeInt(val)
        End Sub
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeLong(val As Long) Implements DataOutput.writeLong
            bout.writeLong(val)
        End Sub
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeFloat(val As Single) Implements DataOutput.writeFloat
            bout.writeFloat(val)
        End Sub
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeDouble(val As Double) Implements DataOutput.writeDouble
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeBytes(str As String) Implements DataOutput.writeBytes
            bout.writeBytes(str)
        End Sub
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeChars(str As String) Implements DataOutput.writeChars
            bout.writeChars(str)
        End Sub
        ...
        ''' <exception cref="IOException"> if I/O errors occur while writing to the underlying
        '''          stream </exception>
        Public Overridable Sub writeUTF(str As String) Implements DataOutput.writeUTF
            bout.writeUTF(str)
        End Sub
        ...
        Public MustInherit Class PutField
            ...
            Public MustOverride Sub put(name As String, val As Boolean)
            ...
            Public MustOverride Sub put(name As String, val As SByte)
            ...
            Public MustOverride Sub put(name As String, val As Char)
            ...
            Public MustOverride Sub put(name As String, val As Short)
            ...
            Public MustOverride Sub put(name As String, val As Integer)
            ...
            Public MustOverride Sub put(name As String, val As Long)
            ...
            Public MustOverride Sub put(name As String, val As Single)
            ...
            Public MustOverride Sub put(name As String, val As Double)
            ...
            Public MustOverride Sub put(name As String, val As Object)
            ...
            Public MustOverride Sub write(out As ObjectOutput)
        End Class
        ...
        ''' </summary>
        Friend Overridable Sub writeTypeString(str As String)
        ...
        ''' </summary>
        Private Sub writeObject0(obj As Object, unshared As Boolean)
        ...
        ''' </summary>
        Private Sub writeHandle(handle As Integer)
        ...
        ''' </summary>
        Private Sub writeClass(cl As [Class], unshared As Boolean)
        ...
        ''' </summary>
        Private Sub writeClassDesc(desc As ObjectStreamClass, unshared As Boolean)
            Dim handle As Integer
        ...
        Private ReadOnly Property customSubclass As Boolean
            Get
        ...
        ''' </summary>
        Private Sub writeProxyDesc(desc As ObjectStreamClass, unshared As Boolean)
        ...
        ''' </summary>
        Private Sub writeNonProxyDesc(desc As ObjectStreamClass, unshared As Boolean)
        ...
        ''' </summary>
        Private Sub writeString(str As String, unshared As Boolean)
        ...
        ''' </summary>
        Private Sub writeArray(array As Object, desc As ObjectStreamClass, unshared As Boolean)
        ...
        ''' </summary>
        Private Sub writeEnum(Of T1)(en As System.Enum(Of T1), desc As ObjectStreamClass, unshared As Boolean)
        ...
        ''' stream.
        ''' </summary>
        Private Sub writeOrdinaryObject(obj As Object, desc As ObjectStreamClass, unshared As Boolean)
        ...
        ''' </summary>
        Private Sub writeExternalData(obj As Externalizable)
        ...
        ''' </summary>
        Private Sub writeSerialData(obj As Object, desc As ObjectStreamClass)
        ...
        ''' </summary>
        Private Sub defaultWriteFields(obj As Object, desc As ObjectStreamClass)
            Dim cl As [Class] = desc.forClass()
        ...
        ''' </summary>
        Private Sub writeFatalException(ex As IOException)
            '
        ...
        <DllImport("unknown")>
        Private Shared Sub floatsToBytes(src As Single(), srcpos As Integer, dst As SByte(), dstpos As Integer, nfloats As Integer)
        End Sub
        ...
        'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
        <DllImport("unknown")>
        Private Shared Sub doublesToBytes(src As Double(), srcpos As Integer, dst As SByte(), dstpos As Integer, ndoubles As Integer)
        End Sub
        ...
        Private Class PutFieldImpl
            ...
            ''' class descriptor.
            ''' </summary>
            Friend Sub New(outerInstance As ObjectOutputStream, desc As ObjectStreamClass)
            ...
            Public Overrides Sub put(name As String, val As Boolean)
                Bits.putBoolean(primVals, getFieldOffset(name, java.lang.[Boolean].TYPE), val)
            End Sub

            Public Overrides Sub put(name As String, val As SByte)
                primVals(getFieldOffset(name, java.lang.[Byte].TYPE)) = val
            End Sub

            Public Overrides Sub put(name As String, val As Char)
                Bits.putChar(primVals, getFieldOffset(name, Character.TYPE), val)
            End Sub

            Public Overrides Sub put(name As String, val As Short)
                Bits.putShort(primVals, getFieldOffset(name, java.lang.[Short].TYPE), val)
            End Sub

            Public Overrides Sub put(name As String, val As Integer)
                Bits.putInt(primVals, getFieldOffset(name, java.lang.[Integer].TYPE), val)
            End Sub

            Public Overrides Sub put(name As String, val As Single)
                Bits.putFloat(primVals, getFieldOffset(name, Float.TYPE), val)
            End Sub

            Public Overrides Sub put(name As String, val As Long)
                Bits.putLong(primVals, getFieldOffset(name, java.lang.[Long].TYPE), val)
            End Sub

            Public Overrides Sub put(name As String, val As Double)
                Bits.putDouble(primVals, getFieldOffset(name, java.lang.[Double].TYPE), val)
            End Sub

            Public Overrides Sub put(name As String, val As Object)
                objVals(getFieldOffset(name, GetType(java.lang.Object))) = val
            End Sub

            ' deprecated in ObjectOutputStream.PutField
            Public Overrides Sub write(out As ObjectOutput)
                '
        ...
        Private Class BlockDataOutputStream
            ...
            ''' </summary>
            Friend Sub New(out As OutputStream)
                Me.out = out
            ...
            ''' mode.
            ''' </summary>
            Friend Overridable Function setBlockDataMode(mode As Boolean) As Boolean
            ...
            Public Overrides Sub write(b As SByte()) Implements DataOutput.write
            ...
            ''' original byte array).
            ''' </summary>
            Friend Overridable Sub write(b As SByte(), [off] As Integer, len As Integer, copy As Boolean)
            ...
            ''' header.
            ''' </summary>
            Private Sub writeBlockHeader(len As Integer)
                If len <= &HFF Then
                    hbuf(0) = TC_BLOCKDATA
                    hbuf(1) = CByte(len)
                    out.write(hbuf, 0, 2)
            ...
            Public Overridable Sub writeBoolean(v As Boolean) Implements DataOutput.writeBoolean
                If pos >= MAX_BLOCK_SIZE Then drain()
                Bits.putBoolean(buf, pos, v)
                pos += 1
            End Sub

            Public Overridable Sub writeByte(v As Integer) Implements DataOutput.writeByte
                If pos >= MAX_BLOCK_SIZE Then drain()
                buf(pos) = CByte(v)
                pos += 1
            End Sub

            Public Overridable Sub writeChar(v As Integer) Implements DataOutput.writeChar
            ...
            Public Overridable Sub writeShort(v As Integer) Implements DataOutput.writeShort
                If pos + 2 <= MAX_BLOCK_SIZE Then
            ...
            Public Overridable Sub writeInt(v As Integer) Implements DataOutput.writeInt
            ...
            Public Overridable Sub writeFloat(v As Single) Implements DataOutput.writeFloat
                If pos + 4 <= MAX_BLOCK_SIZE Then
            ...
            Public Overridable Sub writeLong(v As Long) Implements DataOutput.writeLong
            ...
            Public Overridable Sub writeDouble(v As Double) Implements DataOutput.writeDouble
                If pos + 8 <= MAX_BLOCK_SIZE Then
            ...
            Public Overridable Sub writeBytes(s As String) Implements DataOutput.writeBytes
            ...
            Public Overridable Sub writeChars(s As String) Implements DataOutput.writeChars
                Dim endoff As Integer = s.Length()
                Dim [off] As Integer = 0
                Do While [off] < endoff
            ...
            Public Overridable Sub writeUTF(s As String) Implements DataOutput.writeUTF
            ...
            Friend Overridable Sub writeBooleans(v As Boolean(), [off] As Integer, len As Integer)
                Dim endoff As Integer = [off] + len
                Do While [off] < endoff
                    If pos >= MAX_BLOCK_SIZE Then drain()
            ...
            Friend Overridable Sub writeChars(v As Char(), [off] As Integer, len As Integer)
            ...
            Friend Overridable Sub writeShorts(v As Short(), [off] As Integer, len As Integer)
                Dim limit As Integer = MAX_BLOCK_SIZE - 2
                Dim endoff As Integer = [off] + len
                Do While [off] < endoff
                    If pos <= limit Then
            ...
            Friend Overridable Sub writeInts(v As Integer(), [off] As Integer, len As Integer)
            ...
            Friend Overridable Sub writeFloats(v As Single(), [off] As Integer, len As Integer)
                Dim limit As Integer = MAX_BLOCK_SIZE - 4
                Dim endoff As Integer = [off] + len
                Do While [off] < endoff
                    If pos <= limit Then
            ...
            Friend Overridable Sub writeLongs(v As Long(), [off] As Integer, len As Integer)
            ...
            Friend Overridable Sub writeDoubles(v As Double(), [off] As Integer, len As Integer)
                Dim limit As Integer = MAX_BLOCK_SIZE - 8
                Dim endoff As Integer = [off] + len
                Do While [off] < endoff
                    If pos <= limit Then
            ...
            ''' </summary>
            Friend Overridable Function getUTFLength(s As String) As Long
            ...
            ''' </summary>
            Friend Overridable Sub writeUTF(s As String, utflen As Long)
            ...
            ''' </summary>
            Friend Overridable Sub writeLongUTF(s As String)
            ...
            ''' </summary>
            Friend Overridable Sub writeLongUTF(s As String, utflen As Long)
                writeLong(utflen)
                If utflen = CLng(s.Length()) Then
                    writeBytes(s)
                Else
            ...
            ''' </summary>
            Private Sub writeUTFBody(s As String)
        ...
        Private Class HandleTable
            ...
            ''' </summary>
            Friend Sub New(initialCapacity As Integer, loadFactor As Single)
            ...
            ''' no mapping found.
            ''' </summary>
            Friend Overridable Function lookup(obj As Object) As Integer
            ...
            ''' </summary>
            Private Sub insert(obj As Object, handle As Integer)
                Dim index As Integer = hash(obj) Mod spine.Length
                objs(handle) = obj
            ...
            ''' </summary>
            Private Function hash(obj As Object) As Integer
        ...
        Private Class ReplaceTable
            ...
            ''' </summary>
            Friend Overridable Sub assign(obj As Object, rep As Object)
            ...
            ''' </summary>
            Friend Overridable Function lookup(obj As Object) As Object
        ...
        Private Class DebugTraceInfoStack
            ...
            ''' </summary>
            Friend Overridable Sub push(entry As String)
