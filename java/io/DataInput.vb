...
Namespace java.io
	...
	Public Interface DataInput
		...
		''' {@code DataOutput}.
		''' </summary>
		''' <returns>     the {@code char} value read. </returns>
		''' <exception cref="EOFException">  if this stream reaches the end before reading
		'''               all the bytes. </exception>
		''' <exception cref="IOException">   if an I/O error occurs. </exception>
		...
		''' method of interface {@code DataOutput}.
		''' </summary>
		''' <returns>     the {@code int} value read. </returns>
		''' <exception cref="EOFException">  if this stream reaches the end before reading
		'''               all the bytes. </exception>
		''' <exception cref="IOException">   if an I/O error occurs. </exception>
		...
		''' method of interface {@code DataOutput}.
		''' </summary>
		''' <returns>     the {@code long} value read. </returns>
		''' <exception cref="EOFException">  if this stream reaches the end before reading
		'''               all the bytes. </exception>
		''' <exception cref="IOException">   if an I/O error occurs. </exception>
		...
		''' method of interface {@code DataOutput}.
		''' </summary>
		''' <returns>     the {@code float} value read. </returns>
		''' <exception cref="EOFException">  if this stream reaches the end before reading
		'''               all the bytes. </exception>
		''' <exception cref="IOException">   if an I/O error occurs. </exception>
		...
		''' method of interface {@code DataOutput}.
		''' </summary>
		''' <returns>     the {@code double} value read. </returns>
		''' <exception cref="EOFException">  if this stream reaches the end before reading
		'''               all the bytes. </exception>
		''' <exception cref="IOException">   if an I/O error occurs. </exception>
		...
		''' for reading by this method. </summary>
		''' <returns>     a Unicode string. </returns>
		''' <exception cref="EOFException">            if this stream reaches the end
		'''               before reading all the bytes. </exception>
		''' <exception cref="IOException">             if an I/O error occurs. </exception>
		''' <exception cref="UTFDataFormatException">  if the bytes do not represent a
		'''               valid modified UTF-8 encoding of a string. </exception>
