...
Namespace java.util.spi
	...
	''' <seealso cref="java.text.spi.DateFormatProvider DateFormatProvider"/> class should
	...
	''' Otherwise, they call the <seealso cref="#isSupportedLocale(Locale) isSupportedLocale"/>
	...
	''' <seealso cref="java.util.ResourceBundle.Control#getCandidateLocales getCandidateLocales"/>
	...
	''' @since        1.6
	''' </summary>
	Public MustInherit Class LocaleServiceProvider
		...
		''' </summary>
		''' <returns> An array of all locales for which this locale service provider
		''' can provide localized objects or names. </returns>
		Public MustOverride ReadOnly Property availableLocales As java.util.Locale()
