...
Namespace java.util
	...
	''' specifier of <seealso cref="java.util.Formatter"/>.  This interface allows basic
	...
	''' }
	''' 
	''' <p> When used in conjunction with the <seealso cref="java.util.Formatter"/>, the above
	...
	Public Interface Formattable
		...
		''' <summary>
		''' Formats the object using the provided <seealso cref="Formatter formatter"/>.
		''' </summary>
		''' <param name="formatter">
		'''         The <seealso cref="Formatter formatter"/>.  Implementing classes may call
		'''         <seealso cref="Formatter#out() formatter.out()"/> or {@link
		'''         Formatter#locale() formatter.locale()} to obtain the {@link
		'''         Appendable} or <seealso cref="Locale"/> used by this
		'''         <tt>formatter</tt> respectively.
		''' </param>
		''' <param name="flags">
		'''         The flags modify the output format.  The value is interpreted as
		'''         a bitmask.  Any combination of the following flags may be set:
		'''         <seealso cref="FormattableFlags#LEFT_JUSTIFY"/>, {@link
		...
		'''         the <seealso cref="FormattableFlags#LEFT_JUSTIFY"/> flag is set then the
