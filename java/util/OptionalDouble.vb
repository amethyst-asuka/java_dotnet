...
Namespace java.util
	...
	Public NotInheritable Class OptionalDouble
		...
		Private Sub New(ByVal value As Double)
		...
		Public Shared Function [of](ByVal value As Double) As OptionalDouble
		...
		''' null </exception>
		Public Sub ifPresent(ByVal consumer As java.util.function.DoubleConsumer)
		...
		Public Function [orElse](ByVal other As Double) As Double
		...
		''' null </exception>
		Public Function orElseGet(ByVal other As java.util.function.DoubleSupplier) As Double
		...
		Public Function orElseThrow(Of X As Throwable)(ByVal exceptionSupplier As java.util.function.Supplier(Of X)) As Double
