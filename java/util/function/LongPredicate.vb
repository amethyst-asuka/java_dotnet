...
Namespace java.util.function
	...
	''' whose functional method is <seealso cref="#test(long)"/>.
	''' </summary>
	''' <seealso cref= Predicate
	''' @since 1.8 </seealso>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	Public Interface LongPredicate
		...
		Function test(ByVal value As Long) As Boolean
		...
		default Function [and](ByVal other As LongPredicate) As LongPredicate
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
		...
		''' <returns> a predicate that represents the logical negation of this
		''' predicate </returns>
		default Function negate() As LongPredicate
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
		...
		''' <exception cref="NullPointerException"> if other is null </exception>
		default Function [or](ByVal other As LongPredicate) As LongPredicate
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			java.util.Objects.requireNonNull(other);
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			Return (value) -> test(value) || other.test(value);
