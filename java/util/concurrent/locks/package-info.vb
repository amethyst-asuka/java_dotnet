...
''' 
''' <p>The <seealso cref="java.util.concurrent.locks.Lock"/> interface supports
''' locking disciplines that differ in semantics (reentrant, fair, etc),
''' and that can be used in non-block-structured contexts including
''' hand-over-hand and lock reordering algorithms.  The main implementation
''' is <seealso cref="java.util.concurrent.locks.ReentrantLock"/>.
''' 
''' <p>The <seealso cref="java.util.concurrent.locks.ReadWriteLock"/> interface
...
''' 
''' <p>The <seealso cref="java.util.concurrent.locks.Condition"/> interface
...
''' 
''' <p>The <seealso cref="java.util.concurrent.locks.AbstractQueuedSynchronizer"/>
...
''' synchronization.  The <seealso cref="java.util.concurrent.locks.LockSupport"/>
