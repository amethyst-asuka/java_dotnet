...
Namespace java.util.concurrent
	...
	''' 
	''' <p>The <seealso cref="Executors"/> class provides factory methods for the
	...
	Public Interface ExecutorService
		...
		'''         or the security manager's {@code checkAccess} method
		'''         denies access. </exception>
		Function shutdownNow() As IList(Of Runnable)

		''' <summary>
		''' Returns {@code true} if this executor has been shut down.
		''' </summary>
		''' <returns> {@code true} if this executor has been shut down </returns>
		ReadOnly Property shutdown As Boolean
		...
		ReadOnly Property terminated As Boolean
		...
		''' 
		''' <p>Note: The <seealso cref="Executors"/> class includes a set of methods
