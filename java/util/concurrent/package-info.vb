...
''' <seealso cref="java.util.concurrent.locks"/> and
''' <seealso cref="java.util.concurrent.atomic"/> packages.
''' 
''' <h2>Executors</h2>
''' 
''' <b>Interfaces.</b>
''' 
''' <seealso cref="java.util.concurrent.Executor"/> is a simple standardized
...
''' 
''' <seealso cref="java.util.concurrent.ExecutorService"/> provides a more
''' complete asynchronous task execution framework.  An
''' ExecutorService manages queuing and scheduling of tasks,
''' and allows controlled shutdown.
''' 
''' The <seealso cref="java.util.concurrent.ScheduledExecutorService"/>
...
''' function expressed as <seealso cref="java.util.concurrent.Callable"/>,
''' the result-bearing analog of <seealso cref="java.lang.Runnable"/>.
''' 
''' A <seealso cref="java.util.concurrent.Future"/> returns the results of
''' a function, allows determination of whether execution has
''' completed, and provides a means to cancel execution.
''' 
''' A <seealso cref="java.util.concurrent.RunnableFuture"/> is a {@code Future}
...
''' <b>Implementations.</b>
''' 
''' Classes <seealso cref="java.util.concurrent.ThreadPoolExecutor"/> and
''' <seealso cref="java.util.concurrent.ScheduledThreadPoolExecutor"/>
''' provide tunable, flexible thread pools.
''' 
''' The <seealso cref="java.util.concurrent.Executors"/> class provides
''' factory methods for the most common kinds and configurations
''' of Executors, as well as a few utility methods for using
''' them.  Other utilities based on {@code Executors} include the
''' concrete class <seealso cref="java.util.concurrent.FutureTask"/>
''' providing a common extensible implementation of Futures, and
''' <seealso cref="java.util.concurrent.ExecutorCompletionService"/>, that
''' assists in coordinating the processing of groups of
''' asynchronous tasks.
''' 
''' <p>Class <seealso cref="java.util.concurrent.ForkJoinPool"/> provides an
...
''' <h2>Queues</h2>
''' 
''' The <seealso cref="java.util.concurrent.ConcurrentLinkedQueue"/> class
''' supplies an efficient scalable thread-safe non-blocking FIFO queue.
''' The <seealso cref="java.util.concurrent.ConcurrentLinkedDeque"/> class is
''' similar, but additionally supports the <seealso cref="java.util.Deque"/>
''' interface.
''' 
''' <p>Five implementations in {@code java.util.concurrent} support
''' the extended <seealso cref="java.util.concurrent.BlockingQueue"/>
''' interface, that defines blocking versions of put and take:
''' <seealso cref="java.util.concurrent.LinkedBlockingQueue"/>,
''' <seealso cref="java.util.concurrent.ArrayBlockingQueue"/>,
''' <seealso cref="java.util.concurrent.SynchronousQueue"/>,
''' <seealso cref="java.util.concurrent.PriorityBlockingQueue"/>, and
''' <seealso cref="java.util.concurrent.DelayQueue"/>.
''' The different classes cover the most common usage contexts
''' for producer-consumer, messaging, parallel tasking, and
''' related concurrent designs.
''' 
''' <p>Extended interface <seealso cref="java.util.concurrent.TransferQueue"/>,
''' and implementation <seealso cref="java.util.concurrent.LinkedTransferQueue"/>
''' introduce a synchronous {@code transfer} method (along with related
''' features) in which a producer may optionally block awaiting its
''' consumer.
''' 
''' <p>The <seealso cref="java.util.concurrent.BlockingDeque"/> interface
''' extends {@code BlockingQueue} to support both FIFO and LIFO
''' (stack-based) operations.
''' Class <seealso cref="java.util.concurrent.LinkedBlockingDeque"/>
''' provides an implementation.
''' 
''' <h2>Timing</h2>
''' 
''' The <seealso cref="java.util.concurrent.TimeUnit"/> class provides
...
''' <ul>
''' 
''' <li><seealso cref="java.util.concurrent.Semaphore"/> is a classic concurrency tool.
''' 
''' <li><seealso cref="java.util.concurrent.CountDownLatch"/> is a very simple yet
''' very common utility for blocking until a given number of signals,
''' events, or conditions hold.
''' 
''' <li>A <seealso cref="java.util.concurrent.CyclicBarrier"/> is a resettable
''' multiway synchronization point useful in some styles of parallel
''' programming.
''' 
''' <li>A <seealso cref="java.util.concurrent.Phaser"/> provides
''' a more flexible form of barrier that may be used to control phased
''' computation among multiple threads.
''' 
''' <li>An <seealso cref="java.util.concurrent.Exchanger"/> allows two threads to
...
''' <seealso cref="java.util.concurrent.ConcurrentHashMap"/>,
''' <seealso cref="java.util.concurrent.ConcurrentSkipListMap"/>,
''' <seealso cref="java.util.concurrent.ConcurrentSkipListSet"/>,
''' <seealso cref="java.util.concurrent.CopyOnWriteArrayList"/>, and
''' <seealso cref="java.util.concurrent.CopyOnWriteArraySet"/>.
...
''' conventions in that their <seealso cref="java.util.Iterator Iterators"/>
''' and <seealso cref="java.util.Spliterator Spliterators"/> provide
