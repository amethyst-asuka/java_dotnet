...
Namespace java.util.concurrent.atomic
    ...
    Public MustInherit Class AtomicReferenceFieldUpdater(Of T, V)
        ...
        Private NotInheritable Class AtomicReferenceFieldUpdaterImpl
            ...
            Friend Sub New(  tclass As [Class],   vclass As [Class],   fieldName As String,   caller As [Class])
                ...
                If vclass.isPrimitive Then Throw New IllegalArgumentException("Must be reference type")
            ...
            Private Class PrivilegedExceptionActionAnonymousInnerClassHelper(Of T)
                ...
                Public Overridable Function run() As Field Implements java.security.PrivilegedExceptionAction(Of T).run
