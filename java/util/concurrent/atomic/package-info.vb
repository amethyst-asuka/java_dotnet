...
''' <seealso cref="java.util.concurrent.atomic.AtomicBoolean"/>,
''' <seealso cref="java.util.concurrent.atomic.AtomicInteger"/>,
''' <seealso cref="java.util.concurrent.atomic.AtomicLong"/>, and
''' <seealso cref="java.util.concurrent.atomic.AtomicReference"/>
...
''' 
''' <seealso cref="java.util.concurrent.atomic.AtomicReferenceFieldUpdater"/>,
''' <seealso cref="java.util.concurrent.atomic.AtomicIntegerFieldUpdater"/>, and
''' <seealso cref="java.util.concurrent.atomic.AtomicLongFieldUpdater"/> are
...
''' 
''' <p>The
''' <seealso cref="java.util.concurrent.atomic.AtomicIntegerArray"/>,
''' <seealso cref="java.util.concurrent.atomic.AtomicLongArray"/>, and
''' <seealso cref="java.util.concurrent.atomic.AtomicReferenceArray"/> classes
...
''' rarely otherwise.
''' 
''' <p>The <seealso cref="java.util.concurrent.atomic.AtomicMarkableReference"/>
''' class associates a single boolean with a reference.  For example, this
''' bit might be used inside a data structure to mean that the object
''' being referenced has logically been deleted.
''' 
''' The <seealso cref="java.util.concurrent.atomic.AtomicStampedReference"/>
...
''' <seealso cref="java.lang.Float#floatToRawIntBits"/> and
''' <seealso cref="java.lang.Float#intBitsToFloat"/> conversions, and doubles using
''' <seealso cref="java.lang.Double#doubleToRawLongBits"/> and
''' <seealso cref="java.lang.Double#longBitsToDouble"/> conversions.
''' 
''' @since 1.5
''' </summary>
