...
Namespace java.util
	...
	Public NotInheritable Class Locale
		...
		Public Property Shared [default] As Locale
			Get
		...
		Public Property Shared iSOCountries As String()
			Get
		...
		Public Property Shared iSOLanguages As String()
			Get
		...
		''' no extensions.
		''' @since 1.7 </returns>
		Public Property extensionKeys As [Set](Of Character)
			Get
		...
		''' @since 1.7 </returns>
		Public Property unicodeLocaleAttributes As [Set](Of String)
			Get
				If Not hasExtensions() Then Return Collections.emptySet()
		...
		''' @since 1.7 </returns>
		Public Property unicodeLocaleKeys As [Set](Of String)
			Get
		...
		Friend Property baseLocale As sun.util.locale.BaseLocale
			Get
				Return baseLocale
			End Get
		End Property
		...
		Public Property iSO3Language As String
			Get
		...
		Public Property iSO3Country As String
			Get
		...
		'''     <seealso cref="Locale.Category#DISPLAY DISPLAY"/> locale
		''' @since 1.7 </returns>
		Public Property displayScript As String
			Get
		...
		Public Property displayCountry As String
			Get
		...
		Public Property displayVariant As String
			Get
