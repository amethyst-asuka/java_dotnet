...
Namespace java.util
	...
	''' bulk computation.
	''' 
	''' <p>A Spliterator also reports a set of <seealso cref="#characteristics()"/> of its
	...
	''' @since 1.8 </seealso>
	Public Interface Spliterator(Of T)
		''' <summary>
...
'JAVA TO VB CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
		...
		''' 
		''' <p>If this Spliterator is <seealso cref="#ORDERED"/>, the returned Spliterator
		...
		Function trySplit() As Spliterator(Of T)
		...
		''' 
		''' <p>If this Spliterator is <seealso cref="#SIZED"/> and has not yet been partially
...
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		ReadOnly Property default comparator As Comparator(Of ?)
			throw Function IllegalStateException() As New
		...
		''' 
		''' <p>A <seealso cref="Collection"/> has an encounter order if the corresponding
...
'		public interface OfPrimitive(Of T, T_CONS, T_SPLITR As Spliterator.OfPrimitive(Of T, T_CONS, T_SPLITR)) extends Spliterator(Of T)
	'	{
	...
	'	}
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interface inner types are not converted:
'		public interface OfInt extends OfPrimitive(Of java.lang.Integer, java.util.function.IntConsumer, OfInt)
	'	{
	'
	...
	'		''' </summary>
	'		@Override default boolean tryAdvance(Consumer<? MyBase java.lang.Integer> action)
	'		{
	...
	'	}
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interface inner types are not converted:
'		public interface OfLong extends OfPrimitive(Of java.lang.Long, java.util.function.LongConsumer, OfLong)
	'	{
	'
	...
	'		''' </summary>
	'		@Override default boolean tryAdvance(Consumer<? MyBase java.lang.Long> action)
	'		{
	...
	'	}
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interface inner types are not converted:
'		public interface OfDouble extends OfPrimitive(Of java.lang.Double, java.util.function.DoubleConsumer, OfDouble)
	'	{
	'
	...
	'		''' </summary>
	'		@Override default boolean tryAdvance(Consumer<? MyBase java.lang.Double> action)
	'		{
...
'JAVA TO VB CONVERTER TODO TASK: Interface inner types are not converted:
'	private static class IteratorSpliteratorAnonymousInnerClassHelper(Of T) extends IteratorSpliterator(Of T)
	'{
	'	@Override public Comparator<? MyBase E> getComparator()
	'	{
