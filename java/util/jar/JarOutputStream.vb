...
Namespace java.util.jar
	...
	Public Class JarOutputStream
		...
		Public Sub New(ByVal out As OutputStream, ByVal man As Manifest)
			MyBase.New(out)
		...
		''' <exception cref="IOException"> if an I/O error has occurred </exception>
		Public Overrides Sub putNextEntry(ByVal ze As ZipEntry)
			If firstEntry Then
	...
	'     
		Private Shared Function hasMagic(ByVal edata As SByte()) As Boolean
			Try
				Dim i As Integer = 0
	...
	'     
		Private Shared Sub set16(ByVal b As SByte(), ByVal [off] As Integer, ByVal value As Integer)
			b([off]+0) = CByte(value)
