...
Namespace java.util
    ...
    Public Class Hashtable(Of K, V)
        ...
        Public Sub New(  initialCapacity As Integer,   loadFactor As Single)
            ...
            'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
            table = New Entry(Of K, V)(initialCapacity - 1) {}
        ...
        <MethodImpl(MethodImplOptions.Synchronized)>
        Public Overrides ReadOnly Property empty As Boolean Implements Map(Of K, V).empty
            Get
                Return count = 0
            End Get
        End Property
        ...
        ''' <seealso cref=     Map </seealso>
        <MethodImpl(MethodImplOptions.Synchronized)>
        Public Overrides Function keys() As Enumeration(Of K)
        ...
        ''' <seealso cref=     Map </seealso>
        <MethodImpl(MethodImplOptions.Synchronized)>
        Public Overrides Function elements() As Enumeration(Of V)
        ...
        Private Class KeySet
            ...
            Public Overrides Function [iterator]() As [Iterator](Of K)
