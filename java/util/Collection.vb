...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			Return Spliterators.spliterator(Me, 0);
		...
		''' @since 1.8 </returns>
		default Function stream() As java.util.stream.Stream(Of E)
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
		...
		''' collection
		''' @since 1.8 </returns>
		default Function parallelStream() As java.util.stream.Stream(Of E)
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
