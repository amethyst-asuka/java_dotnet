...
Namespace java.util
    ...
    Public Interface Collection(Of E)
        Inherits Iterable(Of E)

        ' Query Operations

        ''' <summary>
        ''' Returns the number of elements in this collection.  If this collection
        ''' contains more than <tt> java.lang.[Integer].MAX_VALUE</tt> elements, returns
...
'			Return removed;
        ...
        Function parallelStream() As java.util.stream.Stream(Of E)
        Function stream() As java.util.stream.Stream(Of E)
        Function spliterator() As Spliterator(Of E)
    End Interface
    ...
    Public Module Collection
        ...
        ''' @since 1.8 </returns>
        <Extension> Public Function spliterator(Of E)(list As Collection(Of E)) As Spliterator(Of E)
        ...
        ''' 
        ''' <p>This method should be overridden when the <seealso cref="#spliterator()"/>
        ...
        ''' @since 1.8 </returns>
        <Extension> Public Function stream(Of E)(list As Collection(Of E)) As java.util.stream.Stream(Of E)
        ...
        ''' collection
        ''' @since 1.8 </returns>
        <Extension> Public Function parallelStream(Of E)(list As Collection(Of E)) As java.util.stream.Stream(Of E)
            'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
            Return java.util.stream.StreamSupport.stream(list.spliterator(), True)
        End Function
    End Module
End Namespace