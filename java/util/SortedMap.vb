...
Namespace java.util
	...
	''' <summary>
	''' A <seealso cref="Map"/> that further provides a <em>total ordering</em> on its keys.
	''' The map is ordered according to the {@link Comparable natural
	''' ordering} of its keys, or by a <seealso cref="Comparator"/> typically
	''' provided at sorted map creation time.  This order is reflected when
	''' iterating over the sorted map's collection views (returned by the
	''' {@code entrySet}, {@code keySet} and {@code values} methods).
	''' Several additional operations are provided to take advantage of the
	''' ordering.  (This interface is the map analogue of <seealso cref="SortedSet"/>.)
	''' 
	...
	Public Interface SortedMap(Of K, V)
		Inherits Map(Of K, V)

		''' <summary>
		''' Returns the comparator used to order the keys in this map, or
		''' {@code null} if this map uses the {@link Comparable
...
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		Function comparator() As Comparator(Of ?)
		...
		''' </summary>
		''' <param name="fromKey"> low endpoint (inclusive) of the keys in the returned map </param>
		''' <param name="toKey"> high endpoint (exclusive) of the keys in the returned map </param>
		''' <returns> a view of the portion of this map whose keys range from
		'''         {@code fromKey}, inclusive, to {@code toKey}, exclusive </returns>
		...
		''' <exception cref="NullPointerException"> if {@code toKey} is null and
		'''         this map does not permit null keys </exception>
		...
		'''         than or equal to {@code fromKey} </returns>
		...
		'''         currently in the map. </exception>
		''' <exception cref="NullPointerException"> if {@code fromKey} is null and
		'''         this map does not permit null keys </exception>
		''' <exception cref="IllegalArgumentException"> if this map itself has a
		...
		''' <exception cref="NoSuchElementException"> if this map is empty </exception>
		Function firstKey() As K
