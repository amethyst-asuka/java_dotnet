...
Namespace java.util
	...
	Public Interface List(Of E)
		...
		'''         (<a href="Collection.html#optional-restrictions">optional</a>)
		''' @since 1.8 </exception>
		default Sub replaceAll(ByVal [operator] As java.util.function.UnaryOperator(Of E))
...
'JAVA TO VB CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
		default Sub sort(Of T1)(ByVal c As Comparator(Of T1))
'JAVA TO VB CONVERTER TODO TASK: Interfaces cannot contain fields in .NET:
'			Object[] a = Me.toArray();
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			Return Spliterators.spliterator(Me, Spliterator.ORDERED);
	End Interface
