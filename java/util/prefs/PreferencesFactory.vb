...
Namespace java.util.prefs
	...
	''' new <seealso cref="Preferences"/> implementations should provide corresponding
	...
	Public Interface PreferencesFactory
		...
		''' method will return the same object reference.) </summary>
		''' <returns> the system root preference node </returns>
		Function systemRoot() As Preferences
		...
		''' some implicit client-context. </summary>
		''' <returns> the user root preference node corresponding to the calling
		''' user </returns>
		Function userRoot() As Preferences
	End Interface
