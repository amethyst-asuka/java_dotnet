...
''' classes <seealso cref="java.util.stream.Stream"/>, <seealso cref="java.util.stream.IntStream"/>,
''' <seealso cref="java.util.stream.LongStream"/>, and <seealso cref="java.util.stream.DoubleStream"/>
...
'''     the life of a stream. Like an <seealso cref="java.util.Iterator"/>, a new stream
...
''' <ul>
'''     <li>From a <seealso cref="java.util.Collection"/> via the {@code stream()} and
'''     {@code parallelStream()} methods;</li>
'''     <li>From an array via <seealso cref="java.util.Arrays#stream(Object[])"/>;</li>
'''     <li>From static factory methods on the stream classes, such as
'''     <seealso cref="java.util.stream.Stream#of(Object[])"/>,
'''     <seealso cref="java.util.stream.IntStream#range(int, int)"/>
'''     or <seealso cref="java.util.stream.Stream#iterate(Object, UnaryOperator)"/>;</li>
'''     <li>The lines of a file can be obtained from <seealso cref="java.io.BufferedReader#lines()"/>;</li>
'''     <li>Streams of file paths can be obtained from methods in <seealso cref="java.nio.file.Files"/>;</li>
'''     <li>Streams of random numbers can be obtained from <seealso cref="java.util.Random#ints()"/>;</li>
'''     <li>Numerous other stream-bearing methods in the JDK, including
'''     <seealso cref="java.util.BitSet#stream()"/>,
'''     <seealso cref="java.util.regex.Pattern#splitAsStream(java.lang.CharSequence)"/>,
'''     and <seealso cref="java.util.jar.JarFile#stream()"/>.</li>
''' </ul>
''' 
...
''' <seealso cref="java.util.Collection#stream"/> and <seealso cref="java.util.Collection#parallelStream"/>,
''' which produce sequential and parallel streams respectively; other
''' stream-bearing methods such as <seealso cref="java.util.stream.IntStream#range(int, int)"/>
''' produce sequential streams but these streams can be efficiently parallelized by
''' invoking their <seealso cref="java.util.stream.BaseStream#parallel()"/> method.
...
''' <seealso cref="java.util.stream.BaseStream#sequential()"/> and
''' <seealso cref="java.util.stream.BaseStream#parallel()"/> operations.  When the terminal
...
''' ordered stream unordered, such as <seealso cref="java.util.stream.BaseStream#unordered()"/>.
...
''' the stream with <seealso cref="java.util.stream.BaseStream#unordered() unordered()"/> may
...
''' <seealso cref="java.util.stream.Stream#reduce(java.util.function.BinaryOperator) reduce()"/>
''' and <seealso cref="java.util.stream.Stream#collect(java.util.stream.Collector) collect()"/>,
''' as well as multiple specialized reduction forms such as
''' <seealso cref="java.util.stream.IntStream#sum() sum()"/>, <seealso cref="java.util.stream.IntStream#max() max()"/>,
''' or <seealso cref="java.util.stream.IntStream#count() count()"/>.
''' 
...
''' the results into a <seealso cref="java.lang.StringBuilder"/>, which is a mutable
...
''' <seealso cref="java.util.stream.Stream#collect(Collector) collect()"/>,
...
''' {@code ArrayList}, and the combiner simply uses <seealso cref="java.util.ArrayList#addAll addAll"/>
...
''' <seealso cref="java.util.stream.Collector"/> to capture all three aspects.  The
...
''' composability.  The class <seealso cref="java.util.stream.Collectors"/> contains a
...
''' <seealso cref="java.util.stream.Collectors#groupingBy(java.util.function.Function, java.util.stream.Collector) groupingBy"/>:
''' 
''' <pre>{@code
...
''' }</pre>
''' 
''' <p>Here, equivalence generally means according to <seealso cref="java.lang.Object#equals(Object)"/>.
...
''' <seealso cref="java.util.concurrent.ConcurrentHashMap"/>. In that case, the parallel
...
''' 
''' <p>A <seealso cref="java.util.stream.Collector"/> that supports concurrent reduction is
''' marked with the <seealso cref="java.util.stream.Collector.Characteristics#CONCURRENT"/>
...
''' stream being processed. The <seealso cref="java.util.stream.Stream#collect(Collector)"/>
''' implementation will only perform a concurrent reduction if
''' <ul>
''' <li>The stream is parallel;</li>
''' <li>The collector has the
''' <seealso cref="java.util.stream.Collector.Characteristics#CONCURRENT"/> characteristic,
''' and;</li>
''' <li>Either the stream is unordered, or the collector has the
''' <seealso cref="java.util.stream.Collector.Characteristics#UNORDERED"/> characteristic.
''' </ul>
''' You can ensure the stream is unordered by using the
''' <seealso cref="java.util.stream.BaseStream#unordered()"/> method.  For example:
''' <pre>{@code
'''     Map<Buyer, List<Transaction>> salesByBuyer
'''         = txns.parallelStream()
'''               .unordered()
...
''' }</pre>
''' (where <seealso cref="java.util.stream.Collectors#groupingByConcurrent"/> is the
...
''' <seealso cref="java.util.Collection#stream()"/> or <seealso cref="java.util.Arrays#stream(Object[])"/>
''' to obtain a stream.  How are those stream-bearing methods implemented?
''' 
''' <p>The class <seealso cref="java.util.stream.StreamSupport"/> has a number of
''' low-level methods for creating a stream, all using some form of a
''' <seealso cref="java.util.Spliterator"/>. A spliterator is the parallel analogue of an
''' <seealso cref="java.util.Iterator"/>; it describes a (possibly infinite) collection of
...
''' <seealso cref="java.util.Spliterators#spliteratorUnknownSize(java.util.Iterator, int)"/>.
...
''' <seealso cref="java.util.Spliterator#characteristics() characteristics"/> of the
...
''' <seealso cref="java.util.stream.StreamSupport#stream(Supplier, int, boolean) stream()"/>.
