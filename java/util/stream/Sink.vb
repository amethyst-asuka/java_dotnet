...
Namespace java.util.stream
	...
	''' 
	''' <p>The specialized subtypes such as <seealso cref="Sink.OfInt"/> override
	...
	''' {@code accept}.
	''' 
	''' <p>The chaining subtypes such as <seealso cref="ChainedInt"/> not only implement
	...
	''' @since 1.8 </param>
	Friend Interface Sink(Of T)
		Inherits java.util.function.Consumer(Of T)
		...
		default Function cancellationRequested() As Boolean
...
'		interface OfDouble extends Sink(Of java.lang.Double), java.util.function.DoubleConsumer
	...
	'	}
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interface inner types are not converted:
'		static abstract class ChainedReference(Of T, E_OUT) implements Sink(Of T)
	'	{
	'		protected final Sink<? MyBase E_OUT> downstream;
	'
	'		public ChainedReference(Sink<? MyBase E_OUT> downstream)
	'		{
	...
	'	}
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interface inner types are not converted:
'		static abstract class ChainedInt(Of E_OUT) implements Sink.OfInt
	'	{
	'		protected final Sink<? MyBase E_OUT> downstream;
	'
	'		public ChainedInt(Sink<? MyBase E_OUT> downstream)
	'		{
	'			Me.downstream = Objects.requireNonNull(downstream);
	'		}
	'
	...
	'	}
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interface inner types are not converted:
'		static abstract class ChainedLong(Of E_OUT) implements Sink.OfLong
	'	{
	'		protected final Sink<? MyBase E_OUT> downstream;
	'
	'		public ChainedLong(Sink<? MyBase E_OUT> downstream)
	'		{
	'			Me.downstream = Objects.requireNonNull(downstream);
	'		}
	'
	...
	'	}
		...
		''' </summary>
'JAVA TO VB CONVERTER TODO TASK: Interface inner types are not converted:
'		static abstract class ChainedDouble(Of E_OUT) implements Sink.OfDouble
	'	{
	'		protected final Sink<? MyBase E_OUT> downstream;
	'
	'		public ChainedDouble(Sink<? MyBase E_OUT> downstream)
	'		{
	'			Me.downstream = Objects.requireNonNull(downstream);
	'		}
	'
