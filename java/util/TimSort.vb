...
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		Private ReadOnly c As Comparator(Of ?)
...
'JAVA TO VB CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
		Private Sub New(Of T1)(ByVal a As T(), ByVal c As Comparator(Of T1), ByVal work As T(), ByVal workBase As Integer, ByVal workLen As Integer)
			Me.a = a
			Me.c = c
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	...
	'     
		...
		''' @since 1.8 </param>
'JAVA TO VB CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
		Friend Shared Sub sort(Of T, T1)(ByVal a As T(), ByVal lo As Integer, ByVal hi As Integer, ByVal c As Comparator(Of T1), ByVal work As T(), ByVal workBase As Integer, ByVal workLen As Integer)
			...
			''' </summary>
			Dim ts As New TimSort(Of T)(a, c, work, workBase, workLen)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
		Private Shared Sub binarySort(Of T, T1)(ByVal a As T(), ByVal lo As Integer, ByVal hi As Integer, ByVal start As Integer, ByVal c As Comparator(Of T1))
...
'JAVA TO VB CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
		Private Shared Function countRunAndMakeAscending(Of T, T1)(ByVal a As T(), ByVal lo As Integer, ByVal hi As Integer, ByVal c As Comparator(Of T1)) As Integer
			Debug.Assert(lo < hi)
