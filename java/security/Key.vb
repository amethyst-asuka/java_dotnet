...
Namespace java.security
	...
	''' <seealso cref="#getAlgorithm() getAlgorithm"/> method.
	''' 
	''' <LI>An Encoded Form
	''' 
	...
	''' is returned using the <seealso cref="#getEncoded() getEncoded"/> method.
	...
	''' by the <seealso cref="#getFormat() getFormat"/> method.
	''' 
	''' </UL>
	''' 
	...
	''' factory (see <seealso cref="KeyFactory"/>).
	''' 
...
'		static final long serialVersionUID = 6603384152749567654L;
		...
		''' {@code "PKCS#8"}.
		''' </summary>
		''' <returns> the primary encoding format of the key. </returns>
		...
		''' encoding. </returns>
		ReadOnly Property encoded As SByte()
	End Interface
