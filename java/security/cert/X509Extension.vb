...
Namespace java.security.cert
	...
	''' <seealso cref="X509Certificate Certificates"/> and v2
	''' <seealso cref="X509CRL CRLs"/> (Certificate Revocation
	...
	Public Interface X509Extension
		...
		''' </summary>
		''' <returns> {@code true} if a critical extension is found that is
		''' not supported, otherwise {@code false}. </returns>
		Function hasUnsupportedCriticalExtension() As Boolean
		...
		''' null. </returns>
		ReadOnly Property criticalExtensionOIDs As java.util.Set(Of String)
		...
		''' If there are no extensions present at all, then this method returns
		''' null. </returns>
		ReadOnly Property nonCriticalExtensionOIDs As java.util.Set(Of String)
