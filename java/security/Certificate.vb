...
Namespace java.security
	...
	''' 
	''' @author Benjamin Renaud </summary>
	...
	<Obsolete("A new certificate handling package is created in the Java platform.")> _
	Public Interface Certificate
		...
		''' binding. </returns>
		ReadOnly Property guarantor As Principal
		...
		ReadOnly Property principal As Principal
		...
		ReadOnly Property publicKey As PublicKey
