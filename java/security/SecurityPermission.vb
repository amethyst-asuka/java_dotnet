...
Namespace java.security
	...
	''' code <seealso cref="java.security.AllPermission"/>.</td>
	''' </tr>
	''' 
	''' <tr>
	...
	''' associated with classes that have been deprecated: <seealso cref="Identity"/>,
	''' <seealso cref="IdentityScope"/>, <seealso cref="Signer"/>. Use of them is discouraged. See the
	...
	''' <seealso cref="java.security.Provider#getName"/> method. Also, there is an equivalent
	...
	Public NotInheritable Class SecurityPermission
		...
		Private Const serialVersionUID As Long = 5236109936224050470L
		...
		''' </summary>
		''' <param name="name"> the name of the SecurityPermission
		''' </param>
		...
		''' </summary>
		''' <param name="name"> the name of the SecurityPermission </param>
