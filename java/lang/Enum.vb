...
Namespace java.lang
	...
	''' @since   1.5 </seealso>
	<Serializable> _
	Public MustInherit Class [Enum](Of E As System.Enum(Of E))
...
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
			Dim other As System.Enum(Of ?) = CType(o, Enum(Of ?))
			Dim self As System.Enum(Of E) = Me
			If self.GetType() IsNot other.GetType() AndAlso self.declaringClass IsNot other.declaringClass Then ' optimization Throw New ClassCastException
