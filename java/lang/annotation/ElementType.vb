...
Namespace java.lang.annotation
	...
	''' 
	''' <p>The constants <seealso cref="#ANNOTATION_TYPE"/> , <seealso cref="#CONSTRUCTOR"/> , {@link
	...
	''' field declaration.
	''' 
	''' <p>The constant <seealso cref="#TYPE_USE"/> corresponds to the 15 type contexts in JLS
