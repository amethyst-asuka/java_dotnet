...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		''' @since 1.5 </returns>
		Public Property annotation As Boolean
			Get
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		...
		Friend Property classLoader0 As ClassLoader
			Get
				Return classLoader
			End Get
		End Property
		...
		''' @since 1.5 </exception>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		Public Property typeParameters As TypeVariable(Of [Class])()
			Get
...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		''' @since 1.5 </returns>
		Public Property genericSuperclass As Type
			Get
				Dim info As sun.reflect.generics.repository.ClassRepository = genericInfo
		...
		Public Property interfaces As Class()
			Get
...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		''' @since 1.5 </returns>
		Public Property genericInterfaces As Type()
			Get
				Dim info As sun.reflect.generics.repository.ClassRepository = genericInfo
...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		''' @since 1.5 </exception>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		Public Property enclosingMethod As Method
			Get
...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		Private Property enclosingMethodInfo As EnclosingMethodInfo
			Get
		...
		Private NotInheritable Class EnclosingMethodInfo
			...
			Friend Property descriptor As String
				Get
					Return descriptor
				End Get
			End Property
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		Public Property enclosingConstructor As Constructor(Of ?)
			Get
				Dim enclosingInfo As EnclosingMethodInfo = enclosingMethodInfo
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		...
		''' @since 1.5 </returns>
		Public Property anonymousClass As Boolean
			Get
		...
		''' @since 1.5 </returns>
		Public Property localClass As Boolean
			Get
		...
		''' @since 1.5 </returns>
		Public Property memberClass As Boolean
			Get
		...
		''' class.
		''' </summary>
		Private Property simpleBinaryName As String
			Get
				Dim enclosingClass_Renamed As Class = enclosingClass
		...
		''' </summary>
		Private Property localOrAnonymousClass As Boolean
			Get
				' JVM Spec 4.8.6: A class must have an EnclosingMethod
				' attribute if and only if it is a local class or an
				' anonymous class.
		...
		''' @since JDK1.1 </exception>
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		Public Property classes As Class()
			Get
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
'JAVA TO VB CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
		Public Property constructors As Constructor(Of ?)()
			Get
				checkMemberAccess(Member.PUBLIC, sun.reflect.Reflection.callerClass, True)
