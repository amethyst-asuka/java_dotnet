...
Namespace java.lang
    ...
    <Serializable>
    Public NotInheritable Class [String] : Inherits java.lang.Object
        Implements Comparable(Of String), CharSequence

        Public Shared Widening Operator CType(s As String) As [String]
            Return New [String](s)
        End Operator

        Public Shared Narrowing Operator CType(s As [String]) As String
        ...
        Public Sub getChars(srcBegin As Integer, srcEnd As Integer, dst() As Char, dstBegin As Integer)
        ...
        Public Sub getBytes(srcBegin As Integer, srcEnd As Integer, dst() As SByte, dstBegin As Integer)
            If srcBegin < 0 Then Throw New StringIndexOutOfBoundsException(srcBegin)
            If srcEnd > value.Length Then Throw New StringIndexOutOfBoundsException(srcEnd)
            If srcBegin > srcEnd Then Throw New StringIndexOutOfBoundsException(srcEnd - srcBegin)
        ...
        ''' 
        ''' @since  JDK1.1 </exception>
        Public Function getBytes(charsetName As String) As SByte() 'throws java.io.UnsupportedEncodingException
        ...
        ''' 
        ''' @since  1.6 </returns>
        Public Function getBytes(charset As java.nio.charset.Charset) As SByte()
        ...
        Public Overrides Function Equals(anObject As Object) As Boolean
        ...
        ''' 
        ''' @since  1.4 </returns>
        Public Function contentEquals(sb As StringBuffer) As Boolean
            Return contentEquals(CType(sb, CharSequence))
        End Function
        Private Function nonSyncContentEquals(sb As AbstractStringBuilder) As Boolean
            Dim v1 As Char() = value
        ...
        ''' 
        ''' @since  1.5 </returns>
        Public Function contentEquals(cs As CharSequence) As Boolean
        ...
        Public Function equalsIgnoreCase(anotherString As String) As Boolean
        ...
        Public Function compareTo(anotherString As String) As Integer
        ...
        ''' @since   1.2 </seealso>
        Public Shared CASE_INSENSITIVE_ORDER  IComparer(Of String) = New CaseInsensitiveComparator

		Private Class CaseInsensitiveComparator : Implements IComparer(Of String), java.io.Serializable
            ' use serialVersionUID from JDK 1.2.2 for interoperability
            Private Shared serialVersionUID As Long = 8575799808933029326L
            ...
            ''' <seealso cref=     java.text.Collator#compare(String, String)
            ''' @since   1.2 </seealso>
            Public Function compareToIgnoreCase(str As String) As Integer
            ...
            Public Function regionMatches(toffset As Integer, other As String, ooffset As Integer, len As Integer) As Boolean
            ...
            '''          argument. </returns>
            Public Function regionMatches(ignoreCase As Boolean, toffset As Integer, other As String, ooffset As Integer, len As Integer) As Boolean
                Dim ta As Char() = value
                Dim [to] As Integer = toffset
                Dim pa As Char() = other.value
                Dim po As Integer = ooffset
            ...
            '''          </pre> </returns>
            Public Function StartsWith(prefix As String, toffset As Integer) As Boolean
                Dim ta As Char() = value
                Dim [to] As Integer = toffset
            ...
            Public Function EndsWith(suffix As String) As Boolean
            ...
            Public Function IndexOf(ch As Integer) As Integer
                Return IndexOf(ch, 0)
            End Function
            ''' <summary>
            ...
            Public Function IndexOf(ch As Integer, fromIndex As Integer) As Integer
            ...
            ''' </summary>
            Private Function indexOfSupplementary(ch As Integer, fromIndex As Integer) As Integer
            ...
            '''          character sequence represented by this object, or
            '''          {@code -1} if the character does not occur. </returns>
            Public Function LastIndexOf(ch As Integer) As Integer
	...
	'                                * is the write location in result 
            ...
            For i As Integer = firstUpper To len - 1 Step srcCount
				...
				Else
					srcCount = 1
				End If
            If localeDependent OrElse srcChar = ChrW(&H3A3) OrElse srcChar = ChrW(&H130) Then ' LATIN CAPITAL LETTER I WITH DOT ABOVE -  GREEK CAPITAL LETTER SIGMA
