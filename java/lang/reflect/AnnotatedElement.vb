...
Namespace java.lang.reflect
	...
	''' 
	''' <p>The <seealso cref="#getAnnotationsByType(Class)"/> and {@link
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
	   ...
	   ''' @since 1.5 </exception>
		...
		''' @since 1.5 </returns>
		ReadOnly Property annotations As Annotation()
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			java.util.Objects.requireNonNull(annotationClass);
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
			Return sun.reflect.annotation.AnnotationSupport.getDirectlyAndIndirectlyPresent(java.util.Arrays.stream(getDeclaredAnnotations()).collect(java.util.stream.Collectors.toMap(Annotation::annotationType, java.util.function.Function.identity(), ((first,second) -> first), java.util.LinkedHashMap::New)), annotationClass);
		...
		''' @since 1.5 </returns>
		ReadOnly Property declaredAnnotations As Annotation()
	End Interface
