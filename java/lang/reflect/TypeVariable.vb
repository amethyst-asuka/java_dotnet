...
Namespace java.lang.reflect
	...
	''' 
	''' @since 1.5 </param>
	Public Interface TypeVariable(Of D As GenericDeclaration)
		Inherits Type, AnnotatedElement
		...
		ReadOnly Property bounds As Type()
		...
		''' 
		''' @since 1.5 </returns>
		ReadOnly Property genericDeclaration As D
