...
Namespace java.lang.management
	...
	Public Interface ThreadMXBean
		...
		ReadOnly Property threadCount As Integer
		...
		ReadOnly Property peakThreadCount As Integer
		...
		ReadOnly Property totalStartedThreadCount As Long

		''' <summary>
		''' Returns the current number of live daemon threads.
		''' </summary>
		''' <returns> the current number of live daemon threads. </returns>
		ReadOnly Property daemonThreadCount As Integer
		...
		ReadOnly Property allThreadIds As Long()
		...
		''' </summary>
		ReadOnly Property threadContentionMonitoringSupported As Boolean
		...
		Property threadContentionMonitoringEnabled As Boolean
		...
		ReadOnly Property currentThreadCpuTime As Long
		...
		''' <seealso cref= #isThreadCpuTimeEnabled </seealso>
		''' <seealso cref= #setThreadCpuTimeEnabled </seealso>
		ReadOnly Property currentThreadUserTime As Long
		...
		'''   <tt>false</tt> otherwise.
		''' </summary>
		ReadOnly Property threadCpuTimeSupported As Boolean
		...
		'''   <tt>false</tt> otherwise.
		''' </summary>
		ReadOnly Property currentThreadCpuTimeSupported As Boolean
		...
		''' <seealso cref= #isThreadCpuTimeSupported </seealso>
		''' <seealso cref= #isCurrentThreadCpuTimeSupported </seealso>
		Property threadCpuTimeEnabled As Boolean
		...
		Function findMonitorDeadlockedThreads() As Long()
		...
		''' @since 1.6 </seealso>
		Function findDeadlockedThreads() As Long()
		...
		''' @since 1.6 </seealso>
		ReadOnly Property objectMonitorUsageSupported As Boolean
		...
		''' <seealso cref= #dumpAllThreads
		''' @since 1.6 </seealso>
		ReadOnly Property synchronizerUsageSupported As Boolean
