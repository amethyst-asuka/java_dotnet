...
Namespace java.lang.management
	...
	Public Interface MemoryPoolMXBean
		...
		Function [getType]() As MemoryType
		...
		ReadOnly Property usage As MemoryUsage
		...
		'''  </returns>
		ReadOnly Property peakUsage As MemoryUsage
		...
		ReadOnly Property memoryManagerNames As String()
		...
		Property usageThreshold As Long
		...
		ReadOnly Property usageThresholdExceeded As Boolean
		...
		''' <exception cref="UnsupportedOperationException"> if this memory pool
		''' does not support a usage threshold. </exception>
		ReadOnly Property usageThresholdCount As Long
		...
		''' <tt>false</tt> otherwise. </returns>
		ReadOnly Property usageThresholdSupported As Boolean
		...
		Property collectionUsageThreshold As Long
		...
		''' <exception cref="UnsupportedOperationException"> if this memory pool
		'''         does not support a usage threshold. </exception>
		ReadOnly Property collectionUsageThresholdExceeded As Boolean
		...
		''' </exception>
		''' <seealso cref= #isCollectionUsageThresholdSupported </seealso>
		ReadOnly Property collectionUsageThresholdCount As Long
		...
		ReadOnly Property collectionUsage As MemoryUsage
		...
		ReadOnly Property collectionUsageThresholdSupported As Boolean
	End Interface
