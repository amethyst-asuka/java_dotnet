...
Namespace java.lang
	...
	Public NotInheritable Class Character
		...
		''' @since   1.0.2
		''' </summary>
		Public Shared ReadOnly MIN_VALUE As Char = ChrW(&H0000)
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
	...
	'     
		...
		Public NotInheritable Class UnicodeBlock
			...
			<Obsolete("As of J2SE 5, use <seealso cref="#HIGH_SURROGATES"/>,")> _
...
'JAVA TO VB CONVERTER TODO TASK: The following line could not be converted:
		...
		<Obsolete("Replaced by isJavaIdentifierStart(char).")> _
		...
		<Obsolete("Replaced by isJavaIdentifierPart(char).")> _
		...
		<Obsolete("Replaced by isWhitespace(char).")> _
		...
		''' @since   1.5 </seealso>
		public static Integer [getType](Integer codePoint)
		...
		'''          locale-dependent.
		''' @since   1.2 </returns>
		public Integer compareTo(Character anotherCharacter)
		...
		''' @since 1.7 </returns>
		public static Integer compare(Char x, Char y)
			Return x - y
		...
		''' 
		''' @since 1.7 </exception>
		public static String getName(Integer codePoint)
			If Not isValidCodePoint(codePoint) Then Throw New IllegalArgumentException
