...
Namespace java.lang
	...
	''' @since JDK1.0
	''' </summary>
	Public NotInheritable Class Double?
		Inherits Number
		Implements Comparable(Of Double?)
		...
		''' @since 1.6
		''' </summary>
		Public Shared ReadOnly MIN_NORMAL As Double = &H1.0p-1022 ' 2.2250738585072014E-308
		...
		''' @since 1.6
		''' </summary>
		Public Const MAX_EXPONENT As Integer = 1023
		...
		''' @since 1.6
		''' </summary>
		Public Const MIN_EXPONENT As Integer = -1022
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		Public Shared ReadOnly TYPE As Class = CType(Class.getPrimitiveClass("double"), [Class])
		...
		''' produced by the method <seealso cref="Integer#toString(int)"/>.
		''' </ul>
		''' </ul>
	...
	'         
			...
			Else
				...
				If d = 0.0 Then
					answer.append("0.0p0")
				Else
					Dim subnormal As Boolean = (d < sun.misc.DoubleConsts.MIN_NORMAL)

					' Isolate significand bits and OR in a high-order bit
					' so that the string representation has a known
					' length.
					Dim signifBits As Long = (Double.doubleToLongBits(d) And sun.misc.DoubleConsts.SIGNIF_BIT_MASK) Or &H1000000000000000L

					' Subnormal values have a 0 implicit bit; normal
					' values have a 1 implicit bit.
					answer.append(If(subnormal, "0.", "1."))
		...
		''' #MAX_VALUE} + <seealso cref="Math#ulp(double) ulp(MAX_VALUE)"/>/2),
		...
		''' <returns>     a {@code Double} object holding the value
		...
		''' <seealso cref="#Double(double)"/>, as this method is likely to yield
		...
		''' <exception cref="NumberFormatException"> if the string does not contain
		...
		''' arguments).
		''' </summary>
		''' <param name="d"> the {@code double} value to be tested </param>
		...
		Function java.lang.Double(ByVal value As Double) As [Public]
			Me.value = value
		End Function
		...
		''' </summary>
		''' <param name="s">  a string to be converted to a {@code Double}. </param>
		''' <exception cref="NumberFormatException">  if the string does not contain a
		'''            parsable number. </exception>
		''' <seealso cref=       java.lang.Double#valueOf(java.lang.String) </seealso>
		Function java.lang.Double(ByVal s As String) As [Public]
			value = parseDouble(s)
		End Function
		...
		''' </summary>
		''' <returns>  the {@code double} value represented by this object
		'''          converted to type {@code int} </returns>
		...
		''' </summary>
		''' <returns> the {@code double} value represented by this object </returns>
		...
		''' produced by the method <seealso cref="#doubleToLongBits(double)"/>, of
		''' the primitive {@code double} value represented by this
		...
		''' @since 1.8 </returns>
		Public Shared Function GetHashCode(ByVal value As Double) As Integer
		...
		''' </ul>
		''' This definition allows hash tables to operate properly. </summary>
		...
		''' given to the <seealso cref="#longBitsToDouble(long)"/> method, will produce a
		...
		Public Shared Function doubleToLongBits(ByVal value As Double) As Long
			...
			If ((result And sun.misc.DoubleConsts.EXP_BIT_MASK) = sun.misc.DoubleConsts.EXP_BIT_MASK) AndAlso (result And sun.misc.DoubleConsts.SIGNIF_BIT_MASK) <> 0L Then result = &H7ff8000000000000L
			Return result
		End Function
		...
		''' when given to the <seealso cref="#longBitsToDouble(long)"/> method, will
...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		''' with equals</i>.
		''' </summary>
		''' <param name="anotherDouble">   the {@code Double} to be compared. </param>
		''' <returns>  the value {@code 0} if {@code anotherDouble} is
		...
		''' </pre>
		''' </summary>
		''' <param name="d1">        the first {@code double} to compare </param>
		''' <param name="d2">        the second {@code double} to compare </param>
		''' <returns>  the value {@code 0} if {@code d1} is
		...
		Private Const serialVersionUID As Long = -9172774392245257468L
	End Class
