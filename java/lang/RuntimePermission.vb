...
Namespace java.lang
	...
	Public NotInheritable Class RuntimePermission
		Inherits BasicPermission

		Private Const serialVersionUID As Long = 7399184964622342223L
		...
		''' </summary>
		''' <param name="name"> the name of the RuntimePermission.
		''' </param>
		...
		''' </summary>
		''' <param name="name"> the name of the RuntimePermission. </param>
