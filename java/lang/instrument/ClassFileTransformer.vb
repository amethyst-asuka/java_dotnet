...
Namespace java.lang.instrument
	...
	Public Interface ClassFileTransformer
		...
		Function transform(ByVal loader As  [Class]Loader, ByVal className As String, ByVal classBeingRedefined As [Class], ByVal protectionDomain As java.security.ProtectionDomain, ByVal classfileBuffer As SByte()) As SByte()
	End Interface
