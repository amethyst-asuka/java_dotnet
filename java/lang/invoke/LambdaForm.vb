...
'JAVA TO VB CONVERTER TODO TASK: Enum values must be single integer values in .NET:
			J_TYPE("J"c, java.lang.[Long].Class, sun.invoke.util.Wrapper.Long),
'JAVA TO VB CONVERTER TODO TASK: Enum values must be single integer values in .NET:
			F_TYPE("F"c, float.Class, sun.invoke.util.Wrapper.FLOAT),
'JAVA TO VB CONVERTER TODO TASK: Enum values must be single integer values in .NET:
			D_TYPE("D"c, java.lang.[Double].Class, sun.invoke.util.Wrapper.Double), ' all primitive types
'JAVA TO VB CONVERTER TODO TASK: Enum values must be single integer values in .NET:
...
'			private static boolean checkBasicType()
	...
	'		}
        ...
        Private Function normalize() As Integer
            ...
            End If
            Assert(nameRefsAreLegal())
            Dim maxInterned As Integer = System.Math.min(arity_Renamed, INTERNED_ARGUMENT_LIMIT)
        ...
        Friend Class NamedFunction : Inherits java.lang.Object
        ...
        Friend NotInheritable Class Name : Inherits java.lang.Object
