...
''' <ul>
''' <li>The class <seealso cref="java.lang.invoke.MethodHandle MethodHandle"/> contains
...
''' the classes <seealso cref="java.lang.invoke.MethodHandle MethodHandle"/> and <seealso cref="java.lang.invoke.MethodType MethodType"/>.
''' </li>
''' </ul>
''' 
...
''' and which must produce a <seealso cref="java.lang.invoke.MethodHandle method handle"/>
...
''' bootstrap method, and resolving a <seealso cref="java.lang.invoke.MethodType MethodType"/> object for
...
''' <seealso cref="java.lang.invoke.MethodHandle#invoke MethodHandle.invoke"/>.
''' The returned result must be a <seealso cref="java.lang.invoke.CallSite CallSite"/> (or a subclass).
...
''' by a <seealso cref="java.lang.BootstrapMethodError BootstrapMethodError"/>,
...
''' <seealso cref="java.lang.invoke.CallSite CallSite"/> objects, one for each linkage request.
...
''' and the <seealso cref="java.lang.invoke.MethodHandle#asVarargsCollector asVarargsCollector"/> transformation.)
''' <p>
