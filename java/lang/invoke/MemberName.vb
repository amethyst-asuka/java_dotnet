...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		...
		''' </summary>
		Public Property definition As MemberName
			Get
		...
		''' </summary>
		Public Overrides Function Equals(ByVal that As MemberName) As Boolean
		...
		Public Sub New(ByVal refKind As SByte, ByVal defClass As Class, ByVal name As String, ByVal type As Object)
			...
			ElseIf refKind = REF_newInvokeSpecial Then
				...
				If Not(TypeOf type Is MethodType) OrElse (Not CONSTRUCTOR_NAME.Equals(name)) Then Throw newIllegalArgumentException("not a constructor type or name")
			Else
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		...
		'non-public
	 Friend Property Shared factory As Factory
		 Get
