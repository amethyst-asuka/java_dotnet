...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		''' </summary>
		Public Const [in] As InputStream = Nothing
		...
		Public Const out As PrintStream = Nothing
		...
		''' </summary>
		Public Const err As PrintStream = Nothing

	'     The security manager for the system.
	'     
'JAVA TO VB CONVERTER TODO TASK: There is no VB equivalent to 'volatile':
		Private Shared security As SecurityManager = Nothing
		...
		Public Shared Property [in] As InputStream
			Set(ByVal [in] As InputStream)
				checkIO()
				in0 = [in]
			End Set
		End Property
		...
		''' 
		''' @since   JDK1.1 </seealso>
		Public Shared Property out As PrintStream
			Set(ByVal out As PrintStream)
				checkIO()
				out0 = out
			End Set
		End Property
		...
		''' 
		''' @since   JDK1.1 </seealso>
		Public Shared Property err As PrintStream
			Set(ByVal err As PrintStream)
				checkIO()
				err0 = err
			End Set
		End Property
...
'JAVA TO VB CONVERTER TODO TASK: There is no VB equivalent to 'volatile':
		Private Shared cons As Console = Nothing
		''' <summary>
		...
		''' 
		''' @since   1.6 </returns>
		 Public Shared Function console() As Console
...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		Private Shared Property securityManager0 As SecurityManager
			Set(ByVal s As SecurityManager)
				...
				If (s IsNot Nothing) AndAlso (s.GetType().classLoader IsNot Nothing) Then java.security.AccessController.doPrivileged(New PrivilegedActionAnonymousInnerClassHelper(Of T)
		...
		''' <seealso cref=     #setSecurityManager </seealso>
		Public Property Shared securityManager As SecurityManager
			Get
				Return security
			End Get
		End Property
...
'JAVA TO VB CONVERTER TODO TASK: Replace 'unknown' with the appropriate dll name:
		...
		Public Property Shared properties As java.util.Properties
			Get
				Dim sm As SecurityManager = securityManager
		...
		''' @since 1.7 </returns>
		Public Shared Function lineSeparator() As String
			Return lineSeparator_Renamed
		End Function

		Private Shared lineSeparator_Renamed As String
...
'JAVA TO VB CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
		Public Shared Sub load(ByVal filename As String)
			Runtime.runtime.load0(sun.reflect.Reflection.callerClass, filename)
		End Sub
