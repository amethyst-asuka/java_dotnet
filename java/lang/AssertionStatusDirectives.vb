...
Namespace java.lang
	...
	''' @author Josh Bloch
	''' </summary>
	Friend Class AssertionStatusDirectives
		''' <summary>
		...
		''' </summary>
		Friend classEnabled As Boolean()
