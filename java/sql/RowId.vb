...
Namespace java.sql
	...
	''' </summary>
	''' <seealso cref= java.sql.DatabaseMetaData
	''' @since 1.6 </seealso>
	...
	Public Interface RowId
		...
		''' </summary>
		''' <param name="obj"> the <code>Object</code> to compare this <code>RowId</code> object
		'''     against. </param>
		...
		'''     java.sql.RowId object. </returns>
		 ReadOnly Property bytes As SByte()
		 ...
		 '''     by this <code>java.sql.RowId</code>  object. </returns>
		 Function ToString() As String

		 ''' <summary>
		 ''' Returns a hash code value of this <code>RowId</code> object.
		 ''' </summary>
		 ''' <returns> a hash code for the <code>RowId</code> </returns>
