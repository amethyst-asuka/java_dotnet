...
Namespace java.sql
	...
	Public Interface SQLData
	 ...
	 '''            when this object was constructed and populated </returns>
	 ''' <exception cref="SQLException"> if there is a database access error </exception>
	 ...
	 ''' </summary>
	 ''' <param name="stream"> the <code>SQLInput</code> object from which to read the data for
	 ...
	 ''' @since 1.2 </seealso>
	  ...
	  ''' </summary>
	  ''' <param name="stream"> the <code>SQLOutput</code> object to which to write the data for
