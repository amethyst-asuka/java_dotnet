...
Namespace java.sql
	...
	''' </summary>
	''' <seealso cref= Statement#executeQuery </seealso>
	''' <seealso cref= Statement#getResultSet </seealso>
	''' <seealso cref= ResultSetMetaData </seealso>
	...
	Public Interface ResultSet
		...
		''' </summary>
		''' <returns> <code>true</code> if the new current row is valid;
		''' <code>false</code> if there are no more rows </returns>
		''' <exception cref="SQLException"> if a database access error occurs or this method is
		...
		''' SQL <code>NULL</code>.
		''' </summary>
		''' <returns> <code>true</code> if the last column value read was SQL
		'''         <code>NULL</code> and <code>false</code> otherwise </returns>
		''' <exception cref="SQLException"> if a database access error occurs or this method is
		'''            called on a closed result set </exception>
		...
		''' <returns> the column value; if the value is SQL <code>NULL</code>, the
		''' value returned is <code>null</code> </returns>
		...
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <returns> the column value; if the value is SQL <code>NULL</code>, the
		''' value returned is <code>false</code> </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs or this method is
		'''            called on a closed result set </exception>
		...
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <returns> the column value; if the value is SQL <code>NULL</code>, the
		''' value returned is <code>0</code> </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs or this method is
		'''            called on a closed result set </exception>
		...
		''' a <code>String</code> in the Java programming language.
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
		''' <returns> the column value; if the value is SQL <code>NULL</code>, the
		''' value returned is <code>null</code> </returns>
		...
		''' the value returned is <code>null</code> </returns>
		''' <exception cref="SQLException"> if the columnLabel is not valid;
		''' if a database access error occurs or this method is
		'''            called on a closed result set </exception>
		...
		''' <returns> a Java input stream that delivers the database column value
		''' as a stream of uninterpreted bytes;
		''' if the value is SQL <code>NULL</code>, the result is <code>null</code> </returns>
		''' <exception cref="SQLException"> if the columnLabel is not valid;
		''' if a database access error occurs or this method is
		'''            called on a closed result set </exception>
		...
		''' </summary>
		''' <returns> the first <code>SQLWarning</code> object reported or
		...
		''' </summary>
		''' <returns> the SQL name for this <code>ResultSet</code> object's cursor </returns>
		''' <exception cref="SQLException"> if a database access error occurs or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method </exception>
		ReadOnly Property cursorName As String

		''' <summary>
		''' Retrieves the  number, types and properties of
		''' this <code>ResultSet</code> object's columns.
		''' </summary>
		''' <returns> the description of this <code>ResultSet</code> object's columns </returns>
		''' <exception cref="SQLException"> if a database access error occurs or this method is
		'''            called on a closed result set </exception>
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <returns> a <code>java.lang.Object</code> holding the column value </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs or this method is
		'''            called on a closed result set </exception>
		...
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
		''' <returns> the column index of the given column name </returns>
		...
		''' <code>java.io.Reader</code> object. </summary>
		''' <returns> a <code>java.io.Reader</code> object that contains the column
		...
		''' this method
		''' @since 1.2 </exception>
		ReadOnly Property beforeFirst As Boolean
		...
		''' this method
		''' @since 1.2 </exception>
		ReadOnly Property afterLast As Boolean
		...
		''' this method
		''' @since 1.2 </exception>
		ReadOnly Property first As Boolean
		...
		''' is optional for <code>ResultSet</code>s with a result
		''' set type of <code>TYPE_FORWARD_ONLY</code> </summary>
		...
		''' </summary>
		''' <exception cref="SQLException"> if a database access error
		''' occurs; this method is called on a closed result set or the
		''' result set type is <code>TYPE_FORWARD_ONLY</code> </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.2 </exception>
		Sub beforeFirst()
		...
		''' last row. This method has no effect if the result set contains no rows. </summary>
		''' <exception cref="SQLException"> if a database access error
		''' occurs; this method is called on a closed result set
		''' or the result set type is <code>TYPE_FORWARD_ONLY</code> </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.2 </exception>
		Sub afterLast()
		...
		''' this <code>ResultSet</code> object.
		''' </summary>
		''' <returns> <code>true</code> if the cursor is on a valid row;
		''' <code>false</code> if there are no rows in the result set </returns>
		''' <exception cref="SQLException"> if a database access error
		''' occurs; this method is called on a closed result set
		''' or the result set type is <code>TYPE_FORWARD_ONLY</code> </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		...
		''' set type of <code>TYPE_FORWARD_ONLY</code>
		''' </summary>
		''' <returns> the current row number; <code>0</code> if there is no current row </returns>
		...
		''' </summary>
		''' <param name="row"> the number of the row to which the cursor should move.
		...
		'''        indicates the row number counting from the end of the result set </param>
		''' <returns> <code>true</code> if the cursor is moved to a position in this
		''' <code>ResultSet</code> object;
		...
		''' </summary>
		''' <param name="rows"> an <code>int</code> specifying the number of rows to
		'''        move from the current row; a positive number moves the cursor
		'''        forward; a negative number moves the cursor backward </param>
		''' <returns> <code>true</code> if the cursor is on a row;
		'''         <code>false</code> otherwise </returns>
		...
		'''            <code>TYPE_FORWARD_ONLY</code> </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.2 </exception>
		...
		''' <p>
		''' </summary>
		''' <returns> <code>true</code> if the cursor is now positioned on a valid row;
		''' <code>false</code> if the cursor is positioned before the first row </returns>
		''' <exception cref="SQLException"> if a database access error
		''' occurs; this method is called on a closed result set
		''' or the result set type is <code>TYPE_FORWARD_ONLY</code> </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
...
'		int FETCH_UNKNOWN = 1002;
		...
		''' </summary>
		''' <param name="direction"> an <code>int</code> specifying the suggested
		...
		''' @since 1.2 </exception>
		''' <seealso cref= Statement#setFetchDirection </seealso>
...
'		int TYPE_SCROLL_SENSITIVE = 1005;
		...
		''' </summary>
		''' <returns> <code>ResultSet.TYPE_FORWARD_ONLY</code>,
		'''         <code>ResultSet.TYPE_SCROLL_INSENSITIVE</code>,
		'''         or <code>ResultSet.TYPE_SCROLL_SENSITIVE</code> </returns>
		''' <exception cref="SQLException"> if a database access error occurs
...
'		int CONCUR_UPDATABLE = 1008;
		...
		'''         or <code>ResultSet.CONCUR_UPDATABLE</code> </returns>
		''' <exception cref="SQLException"> if a database access error occurs
		''' or this method is called on a closed result set
		''' @since 1.2 </exception>
		ReadOnly Property concurrency As Integer
		...
		''' concurrency of <code>CONCUR_READ_ONLY</code> </summary>
		''' <returns> <code>true</code> if the current row is detected to
		''' have been visibly updated by the owner or another; <code>false</code> otherwise </returns>
		''' <exception cref="SQLException"> if a database access error occurs
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method </exception>
		''' <seealso cref= DatabaseMetaData#updatesAreDetected
		''' @since 1.2 </seealso>
		Function rowUpdated() As Boolean
		...
		''' concurrency of <code>CONCUR_READ_ONLY</code> </summary>
		''' <returns> <code>true</code> if the current row is detected to
		''' have been inserted; <code>false</code> otherwise </returns>
		''' <exception cref="SQLException"> if a database access error occurs
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' </exception>
		''' <seealso cref= DatabaseMetaData#insertsAreDetected
		''' @since 1.2 </seealso>
		Function rowInserted() As Boolean
		...
		''' concurrency of <code>CONCUR_READ_ONLY</code> </summary>
		''' <returns> <code>true</code> if the current row is detected to
		''' have been deleted by the owner or another; <code>false</code> otherwise </returns>
		''' <exception cref="SQLException"> if a database access error occurs
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' </exception>
		''' <seealso cref= DatabaseMetaData#deletesAreDetected
		''' @since 1.2 </seealso>
		Function rowDeleted() As Boolean
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <param name="x"> the new column value </param>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs;
		''' the result set concurrency is <code>CONCUR_READ_ONLY</code>
		''' or this method is called on a closed result set </exception>
		...
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <param name="x"> the new column value </param>
		''' <param name="scaleOrLength"> for an object of <code>java.math.BigDecimal</code> ,
		...
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
		''' <param name="reader"> the <code>java.io.Reader</code> object containing
		'''        the new column value </param>
		''' <param name="length"> the length of the stream </param>
		''' <exception cref="SQLException"> if the columnLabel is not valid;
		''' if a database access error occurs;
		''' the result set concurrency is <code>CONCUR_READ_ONLY</code>
		...
		''' the insert row have been given a non-null value </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.2 </exception>
		Sub insertRow()
		...
		''' if this method is called when the cursor is on the insert row </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.2 </exception>
		Sub updateRow()
		...
		''' the result set concurrency is <code>CONCUR_READ_ONLY</code>;
		''' this method is called on a closed result set
		''' or if this method is called when the cursor is on the insert row </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.2 </exception>
		Sub deleteRow()
		...
		''' method is called when the cursor is on the insert row </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		...
		'''            on the insert row </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.2 </exception>
		Sub cancelRowUpdates()
		...
		''' or the result set concurrency is <code>CONCUR_READ_ONLY</code> </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.2 </exception>
		Sub moveToInsertRow()
		...
		''' <code>null</code>.
		''' </summary>
		''' <returns> the <code>Statement</code> object that produced
		''' this <code>ResultSet</code> object or <code>null</code>
		''' if the result set was produced some other way </returns>
		''' <exception cref="SQLException"> if a database access error occurs
		''' or this method is called on a closed result set
		''' @since 1.2 </exception>
		ReadOnly Property statement As Statement
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <param name="map"> a <code>java.util.Map</code> object that contains the mapping
		''' from SQL type names to classes in the Java programming language </param>
		''' <returns> an <code>Object</code> in the Java programming language
		''' representing the SQL value </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <returns> a <code>Ref</code> object representing an SQL <code>REF</code>
		'''         value </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set </exception>
		...
		'''         <code>BLOB</code> value in the specified column </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		...
		'''         <code>CLOB</code> value in the specified column </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		...
		'''         <code>ARRAY</code> value in the specified column </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		...
		''' <param name="map"> a <code>java.util.Map</code> object that contains the mapping
		''' from SQL type names to classes in the Java programming language </param>
		''' <returns> an <code>Object</code> representing the SQL value in the
		...
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
		''' <returns> a <code>Ref</code> object representing the SQL <code>REF</code>
		'''         value in the specified column </returns>
		''' <exception cref="SQLException"> if the columnLabel is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		...
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
		''' <returns> a <code>Blob</code> object representing the SQL <code>BLOB</code>
		'''         value in the specified column </returns>
		''' <exception cref="SQLException"> if the columnLabel is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set </exception>
		...
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
		''' <returns> a <code>Clob</code> object representing the SQL <code>CLOB</code>
		''' value in the specified column </returns>
		''' <exception cref="SQLException"> if the columnLabel is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set </exception>
		...
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
		''' <returns> an <code>Array</code> object representing the SQL <code>ARRAY</code> value in
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <param name="cal"> the <code>java.util.Calendar</code> object
		''' to use in constructing the date </param>
		''' <returns> the column value as a <code>java.sql.Date</code> object;
		''' if the value is SQL <code>NULL</code>,
		''' the value returned is <code>null</code> in the Java programming language </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set
		''' @since 1.2 </exception>
		...
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <param name="cal"> the <code>java.util.Calendar</code> object
		''' to use in constructing the time </param>
		''' <returns> the column value as a <code>java.sql.Time</code> object;
		''' if the value is SQL <code>NULL</code>,
		''' the value returned is <code>null</code> in the Java programming language </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs
		...
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <param name="cal"> the <code>java.util.Calendar</code> object
		''' to use in constructing the timestamp </param>
		''' <returns> the column value as a <code>java.sql.Timestamp</code> object;
		''' if the value is SQL <code>NULL</code>,
		''' the value returned is <code>null</code> in the Java programming language </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs
		...
		''' if the value is SQL <code>NULL</code>,
		''' the value returned is <code>null</code> in the Java programming language </returns>
		''' <exception cref="SQLException"> if the columnLabel is not valid or
		''' if a database access error occurs
		''' or this method is called on a closed result set
		''' @since 1.2 </exception>
...
'		int CLOSE_CURSORS_AT_COMMIT = 2;
		...
		''' </summary>
		''' <param name="columnIndex"> the index of the column 1 is the first, 2 is the second,... </param>
		''' <returns> the column value as a <code>java.net.URL</code> object;
		''' if the value is SQL <code>NULL</code>,
		''' the value returned is <code>null</code> in the Java programming language </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs; this method
		''' is called on a closed result set or if a URL is malformed </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.4 </exception>
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second 2, ... </param>
		''' <returns> the column value; if the value is a SQL <code>NULL</code> the
		'''     value returned is <code>null</code> </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs
		''' or this method is called on a closed result set </exception>
		...
		''' <returns>  either <code>ResultSet.HOLD_CURSORS_OVER_COMMIT</code> or <code>ResultSet.CLOSE_CURSORS_AT_COMMIT</code> </returns>
		''' <exception cref="SQLException"> if a database access error occurs
		''' or this method is called on a closed result set
		''' @since 1.6 </exception>
		ReadOnly Property holdability As Integer

		''' <summary>
		''' Retrieves whether this <code>ResultSet</code> object has been closed. A <code>ResultSet</code> is closed if the
		''' method close has been called on it, or if it is automatically closed.
		''' </summary>
		''' <returns> true if this <code>ResultSet</code> object is closed; false if it is still open </returns>
		''' <exception cref="SQLException"> if a database access error occurs
		''' @since 1.6 </exception>
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second 2, ... </param>
		''' <param name="nString"> the value for the column to be updated </param>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if the driver does not support national
		'''         character sets;  if the driver can detect that a data conversion
		'''  error could occur; this method is called on a closed result set;
		''' the result set concurrency is <code>CONCUR_READ_ONLY</code>
		''' or if a database access error occurs </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.6 </exception>
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second 2, ... </param>
		''' <param name="nClob"> the value for the column to be updated </param>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if the driver does not support national
		'''         character sets;  if the driver can detect that a data conversion
		'''  error could occur; this method is called on a closed result set;
		''' if a database access error occurs or
		''' the result set concurrency is <code>CONCUR_READ_ONLY</code> </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.6 </exception>
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <returns> a <code>NClob</code> object representing the SQL
		'''         <code>NCLOB</code> value in the specified column </returns>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if the driver does not support national
		'''         character sets;  if the driver can detect that a data conversion
		'''  error could occur; this method is called on a closed result set
	  ...
	  ''' </summary>
	  ''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
	  ''' <returns> a <code>NClob</code> object representing the SQL <code>NCLOB</code>
	  ''' value in the specified column </returns>
	  ''' <exception cref="SQLException"> if the columnLabel is not valid;
	  ''' if the driver does not support national
	  '''         character sets;  if the driver can detect that a data conversion
	  ...
	  ''' @since 1.6 </exception>
		...
		''' </summary>
		''' <param name="columnIndex"> the first column is 1, the second 2, ... </param>
		''' <param name="xmlObject"> the value for the column to be updated </param>
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs; this method
		...
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
		''' <param name="xmlObject"> the column value </param>
		''' <exception cref="SQLException"> if the columnLabel is not valid;
		''' if a database access error occurs; this method
		'''  is called on a closed result set;
		''' the <code>java.xml.transform.Result</code>,
		...
		''' <exception cref="SQLException"> if the columnIndex is not valid;
		''' if a database access error occurs;
		''' the result set concurrency is <code>CONCUR_READ_ONLY</code> or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		''' @since 1.6 </exception>
	   ...
	   ''' @since 1.6 </exception>
		...
		''' <param name="reader"> the <code>java.io.Reader</code> object containing
		'''        the new column value </param>
		''' <exception cref="SQLException"> if the columnLabel is not valid; if a database access error occurs;
		''' the result set concurrency is <code>CONCUR_READ_ONLY</code>
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
		...
		''' <param name="inputStream"> An object that contains the data to set the parameter
		''' value to. </param>
		''' <exception cref="SQLException"> if the columnIndex is not valid; if a database access error occurs;
		''' the result set concurrency is <code>CONCUR_READ_ONLY</code>
		''' or this method is called on a closed result set </exception>
		''' <exception cref="SQLFeatureNotSupportedException"> if the JDBC driver does not support
		''' this method
	   ...
	   ''' @since 1.6 </exception>
		...
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.  If the SQL AS clause was not specified, then the label is the name of the column </param>
		''' <param name="reader"> An object that contains the data to set the parameter value to. </param>
		''' <exception cref="SQLException"> if the columnLabel is not valid; if the driver does not support national
		'''         character sets;  if the driver can detect that a data conversion
		'''  error could occur; this method is called on a closed result set;
		'''  if a database access error occurs or
		''' the result set concurrency is <code>CONCUR_READ_ONLY</code> </exception>
		...
		''' Additional conversions may be supported and are vendor defined. </summary>
		''' @param <T> the type of the class modeled by this Class object </param>
		''' <param name="columnIndex"> the first column is 1, the second is 2, ... </param>
		''' <param name="type"> Class representing the Java data type to convert the designated
		''' column to. </param>
		''' <returns> an instance of {@code type} holding the column value </returns>
		...
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS clause.
		...
		''' <param name="scaleOrLength"> for an object of {@code java.math.BigDecimal} ,
		'''          this is the number of digits after the decimal point. For
		...
		''' support this method; if the JDBC driver does not support the specified targetSqlType </exception>
		...
		''' The default implementation will throw {@code SQLFeatureNotSupportedException}
		''' </summary>
		''' <param name="columnLabel"> the label for the column specified with the SQL AS
