...
'		int NO_GENERATED_KEYS = 2;
	   ...
	   ''' @since 1.4 </exception>
		...
		''' @since 1.8 </seealso>
		ReadOnly Property default largeUpdateCount As Long
			throw Function UnsupportedOperationException("getLargeUpdateCount not implemented" ByVal  As ) As New
		...
		''' @since 1.8 </seealso>
		default Property largeMaxRows As Long
			throw Function UnsupportedOperationException("setLargeMaxRows not implemented" ByVal  As ) As New
...
'			Return 0;
		...
		''' <seealso cref= DatabaseMetaData#supportsBatchUpdates
		''' @since 1.8 </seealso>
		default Function executeLargeBatch() As Long()
			throw Function UnsupportedOperationException("executeLargeBatch not implemented" ByVal  As ) As New
		...
		''' the currently running {@code Statement}
		''' @since 1.8 </exception>
		default Function executeLargeUpdate(ByVal sql As String) As Long
		...
		''' the currently running {@code Statement}
		''' @since 1.8 </exception>
		default Function executeLargeUpdate(ByVal sql As String, ByVal autoGeneratedKeys As Integer) As Long
			throw Function SQLFeatureNotSupportedException("executeLargeUpdate not implemented" ByVal  As ) As New
		...
		''' the currently running {@code Statement}
		''' @since 1.8 </exception>
		default Function executeLargeUpdate(ByVal sql As String, ByVal columnIndexes As Integer()) As Long
			throw Function SQLFeatureNotSupportedException("executeLargeUpdate not implemented" ByVal  As ) As New
		...
		''' the currently running {@code Statement}
		''' @since 1.8 </exception>
		default Function executeLargeUpdate(ByVal sql As String, ByVal columnNames As String()) As Long
			throw Function SQLFeatureNotSupportedException("executeLargeUpdate not implemented" ByVal  As ) As New
	End Interface
