...
Namespace java.sql
	...
	''' <summary>
	''' The subclass of <seealso cref="SQLException"/> for the SQLState class
	...
	Public Class SQLTransientConnectionException
		Inherits java.sql.SQLTransientException
	   ...
	   ''' @since 1.6 </param>
		...
		Private Shadows Const serialVersionUID As Long = -2520155553543391200L
	End Class
