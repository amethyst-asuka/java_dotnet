...
Namespace java.sql
	...
	Public NotInheritable Class SQLPermission
		...
		''' </summary>
		''' <param name="name"> the name of this <code>SQLPermission</code> object, which must
		''' be either {@code  setLog}, {@code callAbort}, {@code setSyncFactory},
		'''  {@code deregisterDriver}, or {@code setNetworkTimeout} </param>
		...
		''' compatibility.
		''' </summary>
		Friend Const serialVersionUID As Long = -1439323187199563495L
