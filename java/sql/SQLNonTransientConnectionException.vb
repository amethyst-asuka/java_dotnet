...
Namespace java.sql
	...
	''' <summary>
	''' The subclass of <seealso cref="SQLException"/> thrown for the SQLState
	...
	Public Class SQLNonTransientConnectionException
		Inherits java.sql.SQLNonTransientException
		...
		Private Shadows Const serialVersionUID As Long = -5852318857474782892L
