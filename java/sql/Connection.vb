...
Namespace java.sql
	...
	Public Interface Connection
		...
		Function createStatement() As Statement
		...
		''' <exception cref="SQLException"> if a database access error occurs
		''' or this method is called on a closed connection </exception>
		ReadOnly Property metaData As DatabaseMetaData
...
'		int TRANSACTION_SERIALIZABLE = 8;
		...
		''' @since 1.4 </seealso>
		Function setSavepoint() As Savepoint
		...
		''' this data type
		''' @since 1.6 </exception>
		Function createSQLXML() As SQLXML
			...
			''' is called on a closed connection
			'''  </exception>
			 Property clientInfo As java.util.Properties
	...
	''' @since 1.6 </exception>
	 Function createStruct(  typeName As String,   attributes As Object()) As Struct
	   ...
	   ''' @since 1.7 </seealso>
		...
		''' <code>java.lang.SecurityException</code>. </summary>
		...
		''' @since 1.7 </seealso>
		ReadOnly Property networkTimeout As Integer
	End Interface
