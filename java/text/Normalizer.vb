...
Namespace java.text
	...
	''' @since 1.6
	''' </summary>
	Public NotInheritable Class Normalizer
	   ...
	   End Sub
		...
		'''                   <seealso cref="java.text.Normalizer.Form#NFC"/>,
		'''                   <seealso cref="java.text.Normalizer.Form#NFD"/>,
		'''                   <seealso cref="java.text.Normalizer.Form#NFKC"/>,
		'''                   <seealso cref="java.text.Normalizer.Form#NFKD"/> </param>
		...
		''' <summary>
		''' Determines if the given sequence of char values is normalized. </summary>
