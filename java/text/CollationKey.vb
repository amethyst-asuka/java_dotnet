...
Namespace java.text
	...
	Public MustInherit Class CollationKey
		Implements Comparable(Of CollationKey)
		...
		Public Overridable Property sourceString As String
			Get
				Return source
			End Get
		End Property
		...
		Public MustOverride Function toByteArray() As SByte()
