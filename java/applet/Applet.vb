...
Namespace java.applet
    ...
    Public Class Applet
        ...
        Public Overridable ReadOnly Property documentBase As java.net.URL
            Get
        ...
        Public Overridable ReadOnly Property codeBase As java.net.URL
            Get
        ...
        Public ReadOnly Property validateRoot As Boolean
            Get
                Return True
            End Get
        End Property
        ...
        Public Overridable ReadOnly Property appletInfo As String
            Get
                Return Nothing
            End Get
        End Property
        ...
        Friend Shadows _accessibleContext As AccessibleContext = Nothing
        ...
        Public ReadOnly Property accessibleContext As AccessibleContext
            Get
                If _accessibleContext Is Nothing Then _accessibleContext = New AccessibleApplet(Me)
